...
<head>
	...
	<title>Bharat mata samuha | Home</title>
	...
	<link rel="stylesheet" href="assets/css/clientslider.css">
...
<body>
	...
	<?php 
		...
		$query ="select * from tbl_testimonial where is_deleted ='N' limit 3";
		$queryResult = mysqli_query($conn,$query);
		
		$query1 = "select * from tbl_about_us where is_deleted ='N'";
		$queryResult1 = mysqli_query($conn,$query1);
		$data = mysqli_fetch_array($queryResult1);
		
		$query2 = "select * from tbl_service where is_deleted ='N' limit 3 ";
		$queryResult2 = mysqli_query($conn,$query2);
		
		$query3 = "select * from tbl_gallary where media_type ='VIDEO' and is_deleted ='N' limit 3 ";
		$queryResult3 = mysqli_query($conn,$query3);
		
		$query4 = "select * from tbl_client where is_deleted ='N'";
		$queryResult4 = mysqli_query($conn,$query4);
	        ...
	        <div class="offcanvas_menu_wrapper">
	            ...
	            <div id="menu" class="text-left ">
	                <ul class="offcanvas_main_menu">
						...
						<li class="menu-item-has-children"><a href="career.php">Careers</a></li>
	...
	<!-- Start Hero Area -->
	<section class="hero-area section-bg" style="background-image: url(assets/img/img4.webp);background-size: cover;">
		<div class="hero-shap">
			...
			<div class="row">
				...
				<div class="col-lg-6 align-self-center order-lg-first order-last">
					<div class="hero-caption">
						...
						<h2>We are government licensed <Span>Electrical Service</span> Providers capable of doing turnkey electrical services</h2>
	...
	<section class="about-area section-padding">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="about-img">
						<img src="admin/assets/img/about/<?php echo $data['image'];?> " alt="about">
					</div>
				</div>
				<div class="col-lg-6 align-self-center">
					<div class="about-content">
						...
						<h2>Your Trusted Service Partner!</h2>
							...
							<p style="text-align:justify"><?php echo $data['about_us'];?> </p>
	...
	<section class="section-padding-2 section-bg">
		<div class="container">
			...
			<div class="row">
				<!-- Services Single -->
				<?php $i=1; while($row = mysqli_fetch_array($queryResult2)){?>
				<div class="col-lg-4 col-md-6 mb-30">
					<div class="services-box" style="height:410px;">
						<div class="count">
						...
						<p><?php echo $string2 = substr($row['service_description'],0,100);?>...</p>
						<a class="read_details" href="services-details.php?sid=<?php echo $row['id'];?>">View Details</a>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-4 services" style="margin-left: 90px;">
						<a class="service" href="services.php">View More Services</a>
					</div>
					<div class="col-md-4"></div>
				</div>
	...
	<section class="section-padding">
		<div class="container">
			...
			<div class="row portfolio-full portF">
				<!-- Single -->
				<?php while($row = mysqli_fetch_array($queryResult3)){ ?>
				<div class="col-lg-4 col-md-6 mb-30 mix design app">
						<div class="portfolio-item">
							<iframe width="420" height="315" src="<?php echo $row['media'];?>"> </iframe>
			...
			<div class="row">
				<div class="col-md-4"></div>
				<div class="col-md-4 services" style="margin-left: 90px;">
					<a class="service" href="video.php">View More Videos</a>
					<div>
						<div class="col-md-4"></div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="testimonial-full owl-carousel">
				 <?php while($row = mysqli_fetch_array($queryResult)){ ?>
					<!-- single -->
					<div class="testimonial-single" style="height:315px;">
						<div class="testimonial-single-header">
						
							<div class="testimonial-title">
								<h4><?php echo $row['testimonial_name']; ?></h4>
						...
						<div class="testimonial-single-footer">
							<p><?php echo $string2 = substr($row["testimonial_description"], 0,200); ?>...</p>
						</div>
					</div>
				 <?php } ?>
	...
	<section class="section-padding-2 section-bg" style="padding-top:0px;">
	
		<h2>Our  Partners/ Our Clients</h2>
		<section class="customer-logos slider">
		<?php while($row = mysqli_fetch_array($queryResult4)){ ?>
		  <div class="slide"><img src="admin/assets/img/client/<?php echo $row['client_image'];?>" height="185px"></div>
		  <?php } ?>
		</section>
				...
				<div class="row">
					...
					<div class="col-lg-5 col-md-8 mb-30">
						<div class="footer_w_item">
							...
							<p><?php echo $string_data = substr($data['about_us'], 0,200); ?> </p>
					...
					<!-- Single -->
					<div class="col-lg-3 col-md-8 mb-30">
						<div class="footer_w_item">
							<h3>Get In Touch</h3>
							<div class="footer-get-in">
								<div class="single">
									...
									<div class="con">
										<h4>Locations</h4>
										<p> S. No.50/1/1, Atharv Heights
Flat No.10, Pimple Gurav, Pune 27.</p>
									</div>
								</div>
								<div class="single">
									<div class="icon">
									...
									<div class="con">
										<h4>Email</h4>
										<p> bharatmatasamuha@gmail.com</p>
									</div>
								</div>
								<div class="single">
									<div class="icon">
				...
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="f_copy_text">
							<p>&copy; 2022 <strong>Bharat Mata Samuha</strong>, All Rights Reserved. With Love by <a href="#">Bharat Mata Samuha</a></p>
						</div>
					</div>
				</div>
			</div>
