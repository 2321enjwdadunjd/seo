...
?>
	...
	<?
		$banner=mysqli_query($db,"select * from front_banner_top order by id desc") or die(mysqli_error($db));
    ...
    <div class="banner section">
	  ...
	  <? 
		   while($banner_row=mysqli_fetch_assoc($banner))
		   {
   	 ?>
	  
        <div class="item"><a href="<?=$banner_row['buttonurl'] ?>"><img src="uploads/front_banner_top/<?=$banner_row['photo']?>" alt="Main Banner" class="img-responsive" /></a></div>
	<? } ?>	
    ...
    <div class="container">
          ...
          <div class="subtitle-part subtitle-part1 col-lg-3 col-4 text-center text-lg-left">
            <div class="subtitle-part-inner">
              <div class="subtitile">
                ...
                <div class="subtitile2">We deliver always on time</div>
              </div>
            </div>
          </div>
          <div class="subtitle-part subtitle-part2 col-lg-3 col-4 text-center text-lg-left">
            <div class="subtitle-part-inner">
              <div class="subtitile">
                ...
                <div class="subtitile2">Enjoy our free delivery</div>
              </div>
            </div>
          </div>
	  ...
	  <?
			$main_cat=mysqli_query($db,"select * from product_category where merchant=0 order by position asc") or die(mysqli_error($db));
			if(mysqli_num_rows($main_cat)>0)
			{
		?>	
      ...
      <div class="category-banner-block">
        ...
        <div class="row">
		 ...
		 <? 
		  	while($row_main_cat=mysqli_fetch_assoc($main_cat))
			  {
		?>
          ...
          <div class="product-layout">
            <div class="product-thumb transition text-center">
              <div class="caption categoryname">
                <h4><a href="category.php?category[]=<?=$row_main_cat['id'] ?>"><?=$row_main_cat['name'] ?></a></h4>
              </div>
              <div class="image"><a href="category.php?category[]=<?=$row_main_cat['id'] ?>"><img src="<?="uploads/category/".$row_main_cat['icon'] ?>" alt="<?=$row_main_cat['name'] ?>" title="<?=$row_main_cat['name'] ?>" class="img-responsive"></a></div>
            </div>
          </div>
      ...
      <!-- =====  PRODUCT CATEGORY END  ===== -->
	   ...
	   $sql_new=mysqli_query($db, "select * from product where merchant=0 and active=1 order by RAND() limit 10");
	   $num_new=mysqli_num_rows($sql_new);
		...
		?>
            ...
            <div class=" product-items col-6 col-sm-4 col-md-4 col-lg-3">
              <div class="product-thumb transition">
               <div class="image">
                  <div class="first_image"> <a href="product-details.php?pid=<?=base64_encode($data_new['id']); ?>"> <img src="uploads/products/<?=$data_new['photo'] ?>" alt="<?=$data_new['name'] ?>" title="<?=$data_new['name'] ?>" class="img-responsive"> </a> </div>
				  
                  <div class="swap_image"> <a href="product-details.php?pid=<?=base64_encode($data_new['id']); ?>"> <img 
				  <? if($data_new['photo2']) { ?>
				  src="uploads/products/<?=$data_new['photo2'] ?>" 
				  <? } else { ?>
				   src="uploads/products/<?=$data_new['photo'] ?>"
				  <? }  ?>
				  alt="<?=$data_new['name'] ?>" title="<?=$data_new['name'] ?>" class="img-responsive"> </a></div>
				  
                </div>
                <div class="product-details">
                  <div class="caption">
                    <h4><a href="product-details.php?pid=<?=base64_encode($data_new['id']); ?>" title="<?=$data_new['name'] ?>"><?=mb_strimwidth($data_new['name'] , 0, 25, "...") ?></a></h4>
                    ...
                    <div class="product_option">
					  ...
					  <div class="form-group button-group">
                        ...
                        <p class="pull-right"><del><i class="fa fa-inr"></i><?=$data_new['price'] ?></del></p>
                      </div>
					  
					  <div class="form-group button-group">
                        <label class="control-label">Our Price</label>
                        <p class="pull-right"><i class="fa fa-inr"></i><?=$data_new['disc_price'] ?></p>
                      </div>
		  ...
		  <div class="col-sm-12 text-center">
            <div class="btn btn-primary viewall"><a href="category.php">View All</a></div>
          </div>
	  ...
	  <? 
			   ...
			   $sql_new=mysqli_query($db, "select * from product where featured='1' and merchant=0 and active=1 order by RAND() limit 10");
			   $num_new=mysqli_num_rows($sql_new);
      ...
      <!-- =====  featured section end ===== -->
		...
		<?
			$banner=mysqli_query($db,"select * from front_banner_bottom order by id desc") or die(mysqli_error($db));
			if(mysqli_num_rows($banner)>0)
			{
      ...
      <div class="subbanner-section section mt-20">
		...
		?>
          <div class="home-subbanner">
            <div class="home-img"><a href="<?=$banner_row['buttonurl']?>"><img class="leftbanner" src="uploads/front_banner_bottom/<?=$banner_row['photo']?>" alt="Offers"></a></div>
	  ...
	  <? 
		   ...
		   $sql_new=mysqli_query($db, "select * from product where price!=disc_price and merchant=0 and active=1 order by RAND() limit 10");
		   $num_new=mysqli_num_rows($sql_new);
	  ...
	  <div class="featured_product section mt-30">
        <div class="row">
          <div class="col-12">
            <div class="section_title">On Sale</div>
          </div>
          <div class="section-product grid section">
      ...
      <div id="brand_carouse" class="section text-center mt-30 pb-15">
        <div class="row">
          ...
          <div class="col-sm-12">
            <div class="brand owl-carousel">
              <div class="product-thumb"><div class="item text-center"> <a href="#"><img src="images/brand/Maggi.png" alt="Maggi" class="img-responsive" /></a> </div></div>
              <div class="product-thumb"><div class="item text-center"> <a href="#"><img src="images/brand/NesCafe.png" alt="Nescafe" class="img-responsive" /></a> </div></div>
              <div class="product-thumb"><div class="item text-center"> <a href="#"><img src="images/brand/Pepsi.png" alt="Pepsi" class="img-responsive" /></a> </div></div>
              <div class="product-thumb"><div class="item text-center"> <a href="#"><img src="images/brand/SunSilk.png" alt="Sunsilk" class="img-responsive" /></a> </div></div>
              <div class="product-thumb"><div class="item text-center"> <a href="#"><img src="images/brand/CocaCola.png" alt="Coca Cola" class="img-responsive" /></a> </div></div>
              <div class="product-thumb"><div class="item text-center"> <a href="#"><img src="images/brand/LifeBuoy.png" alt="LifeBuoy" class="img-responsive" /></a> </div></div>
              <div class="product-thumb"><div class="item text-center"> <a href="#"><img src="images/brand/Lays.png" alt="Lays" class="img-responsive" /></a> </div></div>
              <div class="product-thumb"><div class="item text-center"> <a href="#"><img src="images/brand/SunSilk.png" alt="Sunsilk" class="img-responsive" /></a> </div></div>
            </div>
          </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="col-10">
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-12 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="images/logo.png" class="logo" alt="logo"  height="50" style="margin-bottom:20px">
							
                            <p>Fill up the details and our Customer Care Executive will call you shortly.</p>
                            <form action="do_subscribe.php" method="get">
                                <div class="form-group inp50_50 d-flex justify-content-between">
                                    <input type="text" class="form-control form-control-white" placeholder="Name" aria-label="Name" name="name" required >
                                    
                                    <input type="text" class="form-control form-control-white" placeholder="Your City" aria-label="City" name="city" required>
                                 ...
                                 <div class="form-group ">
                                    <input type="text" class="form-control form-control-white" placeholder="Phone Number" aria-label="Phone Number" name="phone" required>
                             
                                </div>
                           
                            <div class="form-group">
                               <button class="btn btn-sm btn-minwidth btn-outline-primary-2" type="submit">Register</button>
