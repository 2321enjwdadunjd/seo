...
<html lang="zxx">
    <head>
        ...
        <title>Search My Floor | Property in India – Real Estate in India- Buy/Sell Property in India</title> 
		<meta name="keywords" content="" />
        <meta name="description" content="" />
        <meta name="facebook-domain-verification" content="1l1l2s08j9ojx8bs1a3znpni6bsuvy" />
         <!-- Google Tag Manager -->
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-N8F965W');</script>
      ...
      <div class="clearfix"></div>
        ...
        <div class="slider-wraper">
            <div class="main_crousel">
				...
				$sqlQuery="SELECT id, title, media FROM slider order by id ASC";
				$result = mysqli_query($db,$sqlQuery); 
				while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){ 
				?>
                <div class="single-items" style="padding:0;">
                <div class="property-img">
                <a href="#"><img src="admin/uploads/slider/<?php echo rawurlencode($row['media']);?>" class="img-fluid mx-auto" alt="<?php echo $row['title'];?>" /></a>
                </div>
                </div>
                <?php } ?>
            </div>
	        ...
	        <!-- search box -slider-->    
             <div class="container hero-inner-two main-slide-2">
          <div class="row justify-content-center">
            <div class="col-lg-12 col-md-11 col-sm-12">
              <div class="inner-banner-text text-center">
                <!--<p class="lead-i">-->
                <!--</p>-->
                <h2><span class="font-normal">Lets find your dream Home</h2>
              </div>
         <form action="search.php" method="post">     
       <div class="hero-search-content">
         <!-- all city-->
          <div class="dropdown all-city">
            <select class="form-control"  name="city" id="city">
              <option value = ""> All Cities </option>
			  <?php
				$db = mysqli_connect(DB_HOSTNAME,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
				$stsqlQueryst="SELECT * FROM state where country_name='india' order by state_name ASC";
				$st_resultdata = mysqli_query($db,$stsqlQueryst); 
				while($strowd = mysqli_fetch_array($st_resultdata,MYSQLI_ASSOC)){ 
				?>
              <option value="<?php echo $strowd['state_name'];?>"><?php echo $strowd['state_name'];?></option>
				<?php }?>
            </select>
          </div>
           <!-- all city end here-->
        ...
        <!-- main search baar-->
        <div class="form-group search_main">
        <div class="input-with-icon">
        <input type="text" id="search-box" name="proname" class="form-control" autocomplete="off" placeholder="Project Name" />
    	<img src="assets/img/pin.svg" width="20">
        </div>
        <div id="suggesstion-box"></div>
        </div> <!-- main search baar end-->

          <!-- budget search start here-->         
          <div class="dropdown budget">
          <button class="btn search-btn dropdown-toggle form-control" type="button" id="budgetsearch" data-bs-toggle="dropdown" aria-expanded="false">
         Budget
          </button>
          <ul class="dropdown-menu" aria-labelledby="budgetsearch">
            <div class="inr-price">
              <div class="min-price">
                <select name="minprice" class="form-control">
                <option value="">Min(INR)</option>
                <option value="500000">Rs5 L</option>
                <option value="1000000">Rs 10 L</option>
                <option value="2000000">Rs 20 L</option>
                <option value="3000000">Rs 30 L</option>
                <option value="4000000">Rs 40 L</option>
                <option value="5000000">Rs 50 L</option>
                <option value="6000000">Rs 60 L</option>
                <option value="7000000">Rs 70 L</option>
                <option value="8000000">Rs 80 L</option>
                <option value="9000000">Rs 90 L</option>
                <option value="10000000">Rs 1 Cr</option>
                <option value="11000000">Rs 1.1 Cr L</option>
                <option value="12000000">Rs 1.2 Cr</option>
                <option value="13000000">Rs 1.3 Cr</option>
                <option value="14000000">Rs 1.4 Cr</option>
                <option value="15000000">Rs 1.5 Cr</option>
				<option value="16000000">Rs 1.6 Cr</option>
                <option value="17000000">Rs 1.7 Cr</option>
                <option value="20000000">Rs 2 Cr</option>
                <option value="22500000">Rs 2.25 Cr</option>
                <option value="25000000">Rs 2.5 Cr</option>
                <option value="30000000">Rs 3 Cr</option>
                <option value="35000000">Rs 3.5 Cr</option>
                <option value="40000000">Rs 4 Cr</option>
                <option value="45000000">Rs 4.5 Cr</option>
                <option value="50000000">Rs 5 Cr</option>
                <option value="60000000">Rs 6 Cr</option>
                <option value="70000000">Rs 7 Cr</option>
                <option value="80000000">Rs 8 Cr</option>
                <option value="90000000">Rs 9 Cr</option>
                <option value="100000000">Rs 10 Cr</option>
                <option value="200000000">Rs 20 Cr</option>
                <option value="300000000">Rs 30 Cr</option>
          ...
          </div> <!-- budget search end here-->  


          <!-- property type search start here-->         
          <div class="dropdown more-option">
          <button class="btn search-btn dropdown-toggle form-control" type="button" id="propertytype" data-bs-toggle="dropdown" aria-expanded="false">
         Property Type
          </button>
          <ul class="dropdown-menu" aria-labelledby="propertytype">
          <div class="form-check">
          <div class="choose-propert-type">
          <ul>
          <li>
          <input id="cp-1" class="checkbox-custom" name="propertytype" id="propertytype" value="Residential" type="radio" checked="">
          <label for="cp-1" class="checkbox-custom-label">
Residential</label>
          </li>
          <li>
          <input id="cp-2" class="checkbox-custom" name="propertytype" id="propertytype" value="Commercial" type="radio">
          <label for="cp-2" class="checkbox-custom-label">Commercial</label>
          </li>
          ...
          </div> <!-- property type search end here-->  

            <!-- search baar start-->
            <div class="form-group bnr-search">
            <input type="submit" value="Search" class="btn search-btn black p-0" name="submit" id="submit">
            </div> <!-- search baar end-->
                </div>
             </form>  
...
<!-- banner end here-->
      ...
      <!--============ all cities, projects, developer, customer, worth=============-->

      <!--<section class="city-project-details pt-0 pb-0">-->
      <!--  <div class="container">-->
      <!--    <div class="row justify-content-center text-center">-->
      <!--      <div class="col-md-2 col-half-offset">-->
      <!--        <div class="city-proprty-line">-->
      <!--        <div class="propery-img">-->
      <!--        <img src="assets/img/city-icons/buildings.svg" width="35">-->
      <!--        </div>-->
      ...
      <!--        <div class="city-proprty-line">-->
      <!--        <div class="propery-img">-->
      <!--          <img src="assets/img/city-icons/project.svg" width="35">-->
      <!--       </div>-->
      <!--        <span class="counter"> 3892 </span>-->
      <!--        <p> Project </p>-->
      <!--      </div>-->
      <!--    </div>-->
      <!--       <div class="col-md-2 col-half-offset">-->
      <!--        <div class="city-proprty-line">-->
      <!--        <div class="propery-img">-->
      <!--         <img src="assets/img/city-icons/buy-a-house.svg" width="35">-->
      <!--       </div>-->
      ...
      <!--        <div class="city-proprty-line">-->
      <!--        <div class="propery-img">-->
      <!--         <img src="assets/img/city-icons/value.svg" width="35">-->
      <!--       </div>-->
      <!--       <p> <span class="counter"> 1200 </span> + </p>-->
      <!--        <p> Customers </p>-->
      <!--      </div>-->
      <!--    </div>-->
      <!--       <div class="col-md-2 col-half-offset">-->
      <!--        <div class="city-proprty-line">-->
      <!--        <div class="propery-img">-->
      <!--         <img src="assets/img/city-icons/sold.svg" width="35">-->
      <!--       </div>-->
      <!--       <p> <span class="counter"> 720</span> Cr+ </p>-->
      <!--        <p> Worth Project Sold </p>-->
      <!--      </div>-->
      <!--    </div>-->
      <!--    </div>-->
      <!--  </div>-->
      ...
      <div class="clearfix"></div>
       <!--============ all cities, projects, developer end =============-->
    ...
    <section class="pt-5">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 col-md-10 text-center">
              <div class="sec-heading center mb-4">
                <h2>Properties in <span> India </span> </h2>
                <p>Listed below are the best properties across India curated only for you.</p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <div class="property-india">
                <div class="row">
			    <?php
				$db = mysqli_connect(DB_HOSTNAME,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
				$stsqlQuery="SELECT * FROM state where country_name='india' order by state_name ASC";
				$st_result = mysqli_query($db,$stsqlQuery); 
				while($strow = mysqli_fetch_array($st_result,MYSQLI_ASSOC)){ 
				?>
				<div class="col-md-6">
                <div class="single-items">
                    <div class="property-img">
                        <a href="<?php echo BASE_URL.'property-in-'.strtolower($strow['state_name']);?>">
				            <img src="admin/uploads/state/<?php echo $strow['media'];?>" class="img-fluid mx-auto" alt="" />
                            <div class="property-name">
                                <h5> <?php echo $strow['state_name'];?> </h5>
                            </div>
				        </a>
                    </div>
                </div>
     ...
     <!-- ================= property in india end here ==================
      =====================================================-->

      <!-- ============== feature builders ==================
        ======================================================= -->

        <section class="builder-part pt-3">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-md-10 text-center">
                        <div class="sec-heading center mb-4">
                            <h2> Leading Real <span>Estate Developers</span></h2>
                            <p> Our trusted partners bring you their best properties </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="row row justify-content-center">
					    <?php 
				        $db = mysqli_connect(DB_HOSTNAME,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
				        $buildersqlQuery="SELECT id, title, description, media FROM our_builders order by id ASC";
				        $builderresult = mysqli_query($db,$buildersqlQuery); 
				        while($builderrow = mysqli_fetch_array($builderresult,MYSQLI_ASSOC)){ 
				        ?>
                        <div class="col-lg-2 col-6">
                            <div class="builder-section">
                                <div class="img-builders">
                                    <img src="admin/uploads/builders/<?php echo rawurlencode($builderrow['media']);?>" alt="<?php echo $builderrow['title'];?>">
                                </div>
                                <!--<div class="builders-content">-->
                                <!--    <h3> <?php echo $builderrow['title'];?> </h3>-->
                                <!--    <?php echo $builderrow['description'];?>-->
                                <!--</div>-->
                            </div>
                        </div>
						<?php }?>
 ...
 ======================================================= -->
    ...
    <section class="pt-2">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 col-md-10 text-center">
              <div class="sec-heading center mb-4">
                <h2>Our Trending <span> Properties</span> </h2>
                <p>Have a look at the trending properties across the country.</p>
              </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <?php
				$db = mysqli_connect(DB_HOSTNAME,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
				$prosqlQuery="SELECT * FROM our_property order by id DESC";
				$property_result = mysqli_query($db,$prosqlQuery); 
				while($prorow = mysqli_fetch_array($property_result,MYSQLI_ASSOC)){ 
				?>
                <!-- Single Property -->
                <div class="single-items">
                    <div class="property-listing shadow-none property-2 border">
                        <div class="listing-img-wrapper">
                            <a href="property-in-<?php echo strtolower($prorow['State']);?>/<?php echo $prorow['slug'];?>">
				            <img src="admin/uploads/property/<?php echo $prorow['Media'];?>" class="img-fluid mx-auto" alt="" />
				            </a>
                        </div>
                        <div class="property-details">
                            <h6 class="propery-name"> <?php echo $prorow['Project_Name'];?>   <span class="rera-approve">  RERA <i class="fas fa-check text-success"></i> </span> </h6>
                            <span class="developer-name"> By <?php echo $prorow['Project_Developer'];?>   </span>
                            <span class="propery-location"> <?php echo $prorow['Address'];?>, <?php echo $prorow['State'];?>  </span>
                            <span class="property-size"> <?php echo $prorow['Projectbhk'];?> </span>
                            <h6 class="property-sqft">  <?php echo $prorow['sqft'];?> sq ft  <span> <?php
                            // echo date("d F Y", strtotime($prorow['Possession_Start_Date']));
                            echo $prorow['Status']
                            ?></span> </h6>
                            <h6 class="property-price">  
                                <span class="price-with-icon"> <img src="assets/img/rupee.svg" width="10"> <?php echo $prorow['Price_start'];?> - <?php echo $prorow['Price_end'];?> </span>
                                <span class="property-contact"> 
                                    <a href="JavaScript:Void(0);" data-bs-toggle="modal" data-bs-target="#enqurynow"> Contact</a>
                                </span>
                            </h6>
                        </div>
                    </div>
    ...
    <!--   <section class="pt-5">
      ...
      <!-- ===================== Completed assistance===============
        =======================================================-->
      <section class="pt-2 how-it-work">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-7 col-md-10 text-center">
              <div class="sec-heading center">
                 
                <h2>Collections <span>for you </span> </h2>
          ...
          <div class="row">
            <div class="col-lg-2 col-md-2 col-6">
             ...
             <img src="assets/icons/budget-homes.png" class="img-fluid">
             <span> Budget Homes </span>
             </div>
            </div>
            
            <div class="col-lg-2 col-md-2 col-6">
                <div class="work-icons">
            <img src="assets/icons/luxury-home.png" class="img-fluid">
          ...
          <div class="col-lg-2 col-md-2 col-6">
              <div class="work-icons">
             <img src="assets/icons/kids-friendly.png" class="img-fluid">
             <span>  Kids Friendly Homes </span>
             </div>
            </div>

              <div class="col-lg-2 col-md-2 col-6">
                  <div class="work-icons">
             <img src="assets/icons/home-office.png" class="img-fluid">
             <span>  Home office homes  </span>
             </div>
            </div>
            
             <div class="col-lg-2 col-md-2 col-6">
                 <div class="work-icons">
             <img src="assets/icons/styles-homes.png" class="img-fluid">
             <span>stylish homes   </span>
             </div>
            </div>
            
             <div class="col-lg-2 col-md-2 col-6">
                 <div class="work-icons">
             <img src="assets/icons/nature-homes.png" class="img-fluid">
             <span> Nature Homes  </span>
             </div>
            </div>
      ...
      <!--===================== Completed assistance end here===============
        =================================================================-->


        <!--================= our export sales person =================
          ============================================================= -->
        <!--<div class="row justify-content-center">
            <div class="col-lg-7 col-md-10 text-center mb-5">
                <div class="sec-heading center">
                    <h2>Our professional & Expert <span>Sales Team </span> </h2>
                    <p>The visionaries that inspire us to succeed</p>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="row">
					    <?php 
				        $db = mysqli_connect(DB_HOSTNAME,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
				        $salessqlQuery="SELECT id, name, position, media FROM sales_team order by id ASC";
				        $salesresult = mysqli_query($db,$salessqlQuery); 
				        while($salesrow = mysqli_fetch_array($salesresult,MYSQLI_ASSOC)){ 
				        ?>
                        <div class="col-lg-3 mb-4">
                            <div class="sales-team">
                                <span>
                                    <img src="admin/uploads/sales_team/<?php echo rawurlencode($salesrow['media']);?>" class="img-responsive">
                                </span>
                                <div class="sales-team-intro">
                                    <h2><?php echo $salesrow['name'];?></h2>
                                    <p><?php echo $salesrow['position'];?></p>
                                </div>
                            </div>
                        </div> 
						<?php } ?>
        ...
        <section class="bg-white pt-2">
            <div class="container">
                <!--<div class="row justify-content-center">-->
                <!--    <div class="col-lg-7 col-md-10 text-center">-->
                <!--        <div class="sec-heading center pb-4">-->
                <!--            <h2>Good Reviews by <span>Customers </span></h2>-->
                <!--        </div>-->
                <!--    </div>-->
                <!--</div>-->
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <!--    <source src="/assets/video-client/seema-puri.mp4" type="video/mp4" />-->
                        <!--    </video>-->
                            
                        <!--    <div class="review-name">-->
                        <!--       <h5> mrs. seema puri</h5>-->
                        <!--    <p>proud customer Search My Floor</p> -->
                        ...
                        <div class="smart-textimonials smart-center" id="smart-textimonials">
							...
							<?php 
				            $db = mysqli_connect(DB_HOSTNAME,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
				            $customersqlQuery="SELECT id, name, position, description, media FROM customers_testimonials order by id DESC";
				            $customerresult = mysqli_query($db,$customersqlQuery); 
				            while($customerrow = mysqli_fetch_array($customerresult,MYSQLI_ASSOC)){ 
				            ?>
				             <!--<div class="item">-->
                            <!--    <div class="item-box">-->
                            ...
                            <!--                    <img src="admin/uploads/customers_testimonials/<?php echo rawurlencode($customerrow['media']);?>" class="img-fluid" alt="" />-->
                            <!--                </div>-->
                            <!--            </div>-->
                            <!--        </div>-->
                            <!--        <div class="smart-tes-content">-->
                            <!--            <?php echo $customerrow['description'];?>-->
                            <!--        </div>-->
                            <!--        <div class="st-author-info">-->
                            <!--            <h4 class="st-author-title"><?php echo $customerrow['name'];?></h4>-->
                            <!--            <span class="st-author-subtitle"><?php echo $customerrow['position'];?></span>-->
                            <!--        </div>-->
                            <!--    </div>-->
                            <!--</div>-->
							<?php } ?>
