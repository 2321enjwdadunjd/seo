...
?>
 ...
 require_once('getdetailsdb.php');
  ?>
 
  <!--<div class="feedbackenqdivopen" id="feedbdiv" style="      height: auto;
    width: 254px;
    position: absolute;
    ...
    border: solid #D73240;
    z-index: 120;
    background: rgb(255, 255, 255);" class="">
    ...
    position: absolute; ">Instant Enquiry  </span>
    </div>
   ...
   <div class="col-xs-12 " style=" margin-bottom:10px; margin-top:10px;">
			<div class="input-style-1 type-2 color-2">
							  	<input  style="height:30px; border: 1px solid #333;font-weight: bold;" type="text" id="callbacknameinse" name="cname" required="" placeholder="Your Name" >
	</div>
  </div>
   <div class="col-xs-12 " style=" margin-bottom:10px;">
			<div class="input-style-1 type-2 color-2">
							  	<input  style="height:30px; border: 1px solid #333;font-weight: bold;" type="text"  id="callbackmobileinse" name="cmobile" required="" placeholder="Phone Number" >
                              <span style="color: #D73240; font-size: 14px; " id="scallbackmobileinse"></span>
	</div>
  </div>
    <div class="col-xs-12 " style=" margin-bottom:10px;">
							<div class="input-style-1 type-2 color-2">
							  	<input  style="height:30px; border: 1px solid #333;font-weight: bold;" type="email" name="cemail" id="callbackemailinse" required="" placeholder="Email Id" >
                                <span style="color: #D73240; font-size: 14px;" id="scallbackemailinse"></span>
	</div>

	</div>
<div class="col-xs-12 " style=" margin-bottom:10px; margin-top:10px;">
			<div class="input-style-1 type-2 color-2">
							  	<input  style="height:57px; border: 1px solid #333;font-weight: bold;" type="text" id="callbackmessageinse" name="cmsg" required="" placeholder="Enter Your Message" >
	</div>
  </div>
   <div class="col-xs-12" style=" margin-bottom:20px;">
                         	<div class="text-center">
								<button type="submit" id="submitcallbackinse" value="Submit" class="c-button bg-dr-blue-2 hv-dr-blue-2-o" style="padding: 10px 18px; " ><span>submit</span></button>
							</div>
                         </div>
...
" onclick="openenquiry();">
   ...
   <div class="feedbackenqdivopen" id="feedbdiv" style="height: auto;
    ...
    margin-top: 8px;
    font-family: Tahoma, Geneva, sans-serif;
    position: absolute; ">Instant Enquiry <i class="fa fa-times-circle"  style="
    position: absolute;
    font-size: 35px;
    margin-top: 0px;
    margin-left: 50px;
" onclick="closeenquiry();"></i> </span>
     <script>
         function closeenquiry()
         {
            var a = document. getElementById("feedbdiv");
         ...
         {
              var b = document. getElementById("feedbdiv");
         ...
         function openenquiry2()
         {
 var c = document. getElementById("feedbdiv");
...
<div class="col-xs-12 " style=" margin-bottom:10px; margin-top:10px;">
   ...
   <div class="col-xs-12" style=" margin-bottom:20px;">
	...
	<div id="wowslider-container1" style="margin-top:80px;">
	<div class="ws_images"><ul>
		<li><img src="data1/images/slider_1.jpg" alt="The Golden Sunset" title="Relax Or Enjoy In A Heaven On Earth" id="wows1_0"/></li>
		<li><img src="data1/images/slider_2.jpg" alt="Nature And You Hand In Hand" title="Nature And You Hand In Hand" id="wows1_1"/></li>
		<li><img src="data1/images/slider_3.jpg" alt="Relax In Nature's Arms" title="Relax In Nature's Arms" id="wows1_2"/></li>
		<li><img src="data1/images/slider_4.jpg" alt="bootstrap carousel" title="Experience Nature Like Never Before" id="wows1_3"/></li>
		<li><img src="data1/images/slider_5.jpg" alt="Enjoy The Gondola Ride in Gulmarg " title="Enjoy The Gondola Ride in Gulmarg" id="wows1_4"/></li>
	</ul></div>
	<div class="ws_bullets"><div>
		<a href="#" title="The Golden Sunset"><span><img src="data1/tooltips/slider_1.jpg" alt="The Golden Sunset"/>1</span></a>
		<a href="#" title="Nature And You Hand In Hand"><span><img src="data1/tooltips/slider_2.jpg" alt="Nature And You Hand In Hand"/>2</span></a>
		<a href="#" title="Relax In Nature's Arms"><span><img src="data1/tooltips/slider_3.jpg" alt="Relax In Nature's Arms"/>3</span></a>
		<a href="#" title="Experience Nature Like Never Before"><span><img src="data1/tooltips/slider_4.jpg" alt="Experience Nature Like Never Before"/>4</span></a>
		<a href="#" title="Serene And Calm Location"><span><img src="data1/tooltips/slider_5.jpg" alt="Serene And Calm Location"/>5</span></a>
	</div></div>
    		...
    		<div class="row">
    			<div class="col-md-12">
    				<div class="second-title" style="padding-top:20px;">
    					<h2>Travels Tea Pot<br> Top Tours</h2>
    					  <p class="color-dark-2" style="font-weight: bold;">Trip to The Paradise on Earth</p>
    				</div>
    			</div>
    		</div>
    		<div class="row">
    			...
    			<?php
                  ...
                  $prd ="All";
			   $sql = "SELECT * FROM `recholidays` inner join `heavenspackages` on recholidays.holidayid = heavenspackages.id;";
        
            $data = new getData();
			$value = $data->getInfo($prd,$sql);
			if(is_resource($value)){
    			...
    			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
    				<div class="radius-mask tour-block hover-aqua">
    				  <div class="clip">
						 <div class="bg bg-bg-chrome act" style="background-image:url('images/packages/<?php echo $row['imdet'];?>')">
						 </div>
					  </div>
					  <div class="tour-layer delay-1"></div>
					  <div class="tour-caption">
					  	 <div class="vertical-align">
					  	 	<h3 class="hover-it"> <a href="holidaydetails.php?pid=<?php echo $row['id'];?>"><?php echo $row['package'];?></a></h3>
					  	 ...
					  	 <div class="vertical-bottom">
					  	   <div class="fl">
					  	 	<div class="tour-info">
					  	 		<img src="calendar_icon_grey.png" alt="">
					  	 		  <span class="font-style-2 color-grey-4"><strong class="color-white"><?php echo $row['duration'];?></strong> </span>
					  	 	</div>
					  	 	
					  	   </div>	
					  	 	<a href="holidaydetails.php?pid=<?php echo $row['id'];?>" class="c-button b-50 bg-aqua hv-transparent fr"><img src="flag_icon.png" alt=""><span>view more</span></a>
					  	 </div>
					  </div>
    				</div>
    			</div>
    ...
    <div class="main-wraper padd-20">
    	<div class="container">
    		<div class="row">
    			<div class="col-md-12">
    				<div class="second-title" style="padding-top:20px;">
    					<h2>Make your Own Choice <br> Hotels & More</h2>
    					  <p class="color-dark-2"style="font-weight: bold;"> Luxury &amp; Comfort</p>
    				</div>
    			</div>
    		</div>
    		<div class="row">
    			...
    			<?php
                  ...
                  $prd ="All";
			 $sql = "SELECT * FROM `tophotels` inner join `heavenshotels` on tophotels.hotelid = heavenshotels.id;";
			...
			if(is_resource($value)){
    			...
    			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
    				<div class="radius-mask tour-block hover-aqua">
    				  <div class="clip">
						 <div class="bg bg-bg-chrome act" style="background-image:url('images/hotels/<?php echo $row['imga'];?>')">
						 </div>
					  </div>
					  <div class="tour-layer delay-1"></div>
					  <div class="tour-caption">
					  	 <div class="vertical-align">
					  	 	<h3 class="hover-it"> <a href="hoteldetails.php?pid=<?php echo $row['id'];?>"><?php echo $row['name'];?></a></h3>
					  	 ...
					  	 <div class="vertical-bottom">
					  	   <div class="fl">
					  	 	<div class="tour-info">
					  	 		<img src="loc_icon.png" alt="">
					  	 		  <span class="font-style-2 color-grey-4"><strong class="color-white"><?php echo $row['location'];?></strong> </span>
					  	 	</div>
					  	 	
					  	   </div>	
					  	 	<a href="hoteldetails.php?pid=<?php echo $row['id'];?>" class="c-button b-50 bg-aqua hv-transparent fr"><img src="flag_icon.png" alt=""><span>view more</span></a>
					  	 </div>
					  </div>
    				</div>
    			</div>
    	...
    	<div class="container-fluid">
    			...
    			<div class="col-md-12">
    				<div class="second-title">
    					<h2>Beautiful Trips</h2>
    					  <p class="color-dark-2" style="font-weight: bold;">Experience the Picturesique and Full of Color Nature At Its Best</p>
    				</div>
    			</div>
    		</div>
    		<div class="row col-no-padd">
    			<?php
                  ...
                  $prd ="All";
			  $sql = "SELECT * FROM `rectrips` inner join `heavenspackages` on rectrips.tripsid = heavenspackages.id;";
			...
			if(is_resource($value)){
    			...
    			<a target="_blank" href="holidaydetails.php?pid=<?php echo $row['id'];?>"><div class="photo-block hover-aqua">
    				  <div class="tour-layer delay-1"></div>
    					<img src="images/packages/<?php echo $row['imdet'];?>" alt="">
    					   <div class="vertical-align">
   					   	     <div class="photo-title">
   					   	  
    					   	    <a class="hover-it" href="holidaydetails.php?pid=<?php echo $row['id'];?>"><h3><?php echo $row['package'];?></h3></a>
								
    					   	     <h5 class="delay-1"><?php echo $row['duration'];?></h5>
    					   	 </div>
    					   </div>
    				</div>
				</a>
    ...
    <div class="main-wraper">
    			...
    			<div class="col-md-12">
    				<div class="second-title">
    					<h2>Adventure Tours</h2>
    					  <p class="color-dark-2" style="font-weight: bold;">Look forward to excitement, daring and unusual experiences</p>
    				</div>
    			</div>
    		</div>
    		<div class="row">
    		  <div class="top-baner arrows">
				<div class="swiper-container offers-slider swiper-swiper-unique-id-2 initialized pagination-hidden" data-autoplay="5000" data-loop="1" data-speed="500" data-slides-per-view="responsive" data-mob-slides="1" data-xs-slides="2" data-sm-slides="2" data-md-slides="3" data-lg-slides="3" data-add-slides="3" id="swiper-unique-id-2">
				  <div class="swiper-wrapper" style="width: 3510px; transform: translate3d(-780px, 0px, 0px); transition-duration: 0.5s; height: 450px;">
                 ...
                 <?php
                  ...
                  $prd ="All";
				  $sql = "SELECT * FROM `advholidays` inner join `heavenspackages` on advholidays.advholidayid = heavenspackages.id;";
		...
		$mycount=$mycount + 1;
                ...
                ?>
                  ...
                  <div class="swiper-slide" data-val="<?php echo $mycount;?>" style="width: 390px; height: 450px;">
					   <div class="offers-block radius-mask">
						 ...
						 <div class="vertical-bottom">
							...
							<a href="holidaydetails.php?pid=<?php echo $row['id'];?>" class="c-button bg-aqua hv-aqua-o b-40"><span>view more</span></a>
						 </div>
					   </div> 
					</div>
     ...
     <?php
				  ...
				  <div class="pagination  poin-style-1 pagination-hidden pagination-swiper-unique-id-2"><span class="swiper-pagination-switch swiper-visible-switch" style="display: inline-block;"></span><span class="swiper-pagination-switch swiper-visible-switch" style="display: none;"></span><span class="swiper-pagination-switch swiper-visible-switch swiper-active-switch" style="display: none;"></span></div>
				</div>
    			...
    			<div class="col-md-12">
    				<div class="second-title">
    					<h2>Most Popular Travel Destinations</h2>
    					  <p class="color-dark-2"style="font-weight: bold;">Know About Famous Tourist Attractions</p>
    				</div>
    			</div>
    		</div>
    		<div class="row">
    			<div class="col-xs-12 col-md-6 col-md-push-6 col-sm-12">
    				<div class="popular-desc text-left">
    					...
    					<div class="vertical-align">
    						<h3>Kashmir, Jammu & Kashmir</h3>
    						  <p class="color-dark-2">The largest city of the Kashmir Valley and the summer capital of the Indian state of Jammu and Kashmir. It lies on the banks of the Jhelum River, a tributary of the Indus, and Dal and Anchar lakes. The city is famous for its gardens, waterfronts and houseboats.  </p>
    						  <h4>best attractions</h4>
    						    <div class="row">
    						    	<div class="col-md-4 col-sm-4 col-xs-4">
    						    		<ul>
    						    		    <li><a href="gulmarg.php" style="color:#ca6309;"><b>Gulmarg</b></a></li>
    						    		    <li><a href="pahalgam.php" style="color:#ca6309;"><b>Pahalgam</b></a></li>
    						    		    <li><a href="sonmarg.php" style="color:#ca6309;"><b>Sonmarg</b></a></li>
    						    		    <li><a href="dallake.php" style="color:#ca6309;"><b>Dal Lake</b></a></li>
    						    			<li><a href="harvan.php" style="color:#ca6309;"><b>Harwan Garden</b></a></li>
    						    			
    						    			<!--<li><a href="#" style="color:#333;"><b>Gulmarg</b></a></li>-->
    						    		</ul>
    						    	</div>
    						    	<div class="col-md-4 col-sm-4 col-xs-4">
    						    	<!--	<ul>
    						    			<li><a href="#" style="color:#333;"><b>Nishat Bagh</b></a></li>
    						    			<li><a href="#" style="color:#333;"><b>Chashmashai</b></a></li>
    						    			<li><a href="/#">Genoa</a></li>
    						    			<li><a href="http://demo.nrgthemes.com/projects/travel/#">Turin</a></li> 
    						    		</ul>-->
    						    	</div>
    						     	<div class="col-md-4 col-sm-4 col-xs-4">
    						    	<!-- 	<ul>
    						    			<li><a href="http://demo.nrgthemes.com/projects/travel/#">Milan</a></li>
    						    			<li><a href="http://demo.nrgthemes.com/projects/travel/#">Capri</a></li>
    						    			<li><a href="http://demo.nrgthemes.com/projects/travel/#">Matera</a></li>
    						    			<li><a href="http://demo.nrgthemes.com/projects/travel/#">Pompeii</a></li>
    						    		</ul>-->
    						    	</div>
    						    </div>
    						<!--<a href="#" class="c-button bg-aqua hv-transparent b-50 custom-icon">
    							<img class="img-hide" src="flag_icon.png" alt="">
    							<img class="img-hov" src="flag_icon_aqua.png" alt="">
    				...
    				<div class="row">
    					<div class="col-md-6 col-sm-6 col-xs-12">
    					  <div class="radius-mask popular-img">
    						 <div class="clip">
								<div class="bg bg-bg-chrome act" style="background-image:url(know1.jpg)">
								</div>
							 </div>
							 <div class="tour-layer delay-1"></div>
							 <div class="vertical-bottom">
								 <h4><a href="dallake.php">Dal Lake</a></h4>
				                  <!--<h5><b class="color-aqua">Relish Shikara Rides, Char Chinar</b></h5>-->
					         </div>
						  </div>
    					</div>
    					<div class="col-md-6 col-sm-6 col-xs-12">
    					  <div class="radius-mask popular-img">
    						 <div class="clip">
								<div class="bg bg-bg-chrome act" style="background-image:url(know2.jpg)">
								</div>
							 </div>
							 <div class="tour-layer delay-1"></div>
							 <div class="vertical-bottom">
				                <h4><a href="gulmarg.php">Gulmarg</a></h4>
				                  <!--<h5><b class="color-aqua">Revel in Lush Green Meadows</b></h5>-->
					         </div>
						  </div>
    					</div>
    					<div class="col-md-6 col-sm-6 col-xs-12">
    					  <div class="radius-mask popular-img">
    						 <div class="clip">
								<div class="bg bg-bg-chrome act" style="background-image:url(know3.jpg)">
								</div>
							 </div>
							 <div class="tour-layer delay-1"></div>
							 <div class="vertical-bottom">
				                <h4><a href="kokernag.php">Kokernag</a></h4>
				                  <!--<h5><b class="color-aqua">Take Pleasure in Flowing Waters</b></h5>-->
					         </div>
						  </div>
    					</div>
    					<div class="col-md-6 col-sm-6 col-xs-12">
    					  <div class="radius-mask popular-img">
    						 <div class="clip">
								<div class="bg bg-bg-chrome act" style="background-image:url(know4.jpg)">
								</div>
							 </div>
							 <div class="tour-layer delay-1"></div>
							 <div class="vertical-bottom">
				                <h4><a href="pahalgam.php">Pahalgam</a></h4>
				                  <!--<h5><b class="color-aqua">Enjoy the View of Valley and River</b></h5>-->
					         </div>
						  </div>
    					</div>
    				</div>
    		...
    		<div class="row">
    			<div class="col-xs-12 col-md-6 col-sm-12">
    				<div class="popular-desc text-right">
    					...
    					<div class="vertical-align">
    						<h3 style="color:#037473;">Jammu, Jammu & Kashmir</h3>
    						  <p class="color-dark-2">The winter capital of state of Jammu and Kashmir. It is situated on Tawi River. Place is famous for its temples, historic places and parks  </p>
    						  <h4 style="color:#037473;">best attractions</h4>
    						    <div class="row">
    						    	<div class="col-md-4 col-sm-4 col-xs-4">
    						    		<!--	<ul>
    						    			<li><a href="http://demo.nrgthemes.com/projects/travel/#">Milan</a></li>
    						    	...
    						    	<div class="col-md-4 col-sm-4 col-xs-4">
    						    	<!--	<ul>
    						    			<li><a href="http://demo.nrgthemes.com/projects/travel/#">Bologna</a></li>
    						    			<li><a href="http://demo.nrgthemes.com/projects/travel/#">Florence</a></li>
    						    			<li><a href="http://demo.nrgthemes.com/projects/travel/#">Genoa</a></li>
    						    			<li><a href="http://demo.nrgthemes.com/projects/travel/#">Turin</a></li>
    						    		</ul>-->
    						    	</div>
    						    	<div class="col-md-4 col-sm-4 col-xs-4">
                                        ...
                                        <ul>
    						    			<li><a href="vaishno.php" style="color:#ca6309;"><b>Mata Vaishno Devi</b></a></li>
    						    			<li><a href="patnitop.php" style="color:#ca6309;"><b>Patnitop</b></a></li>
    						    			<li><a href="mansar.php" style="color:#ca6309;"><b>Mansar Lake</b></a></li>
    						    			<li><a href="ranbireshwar.php" style="color:#ca6309;"><b>Ranbireshwar Temple</b></a></li>
    						    			<!--<li><a href="#" style="color:#333;"><b>Bagh e Bahu Fort</b></a></li>
    						    			<li><a href="#" style="color:#333;"><b>Ragunath Temple</b></a></li>-->
    						    		</ul>
    						    	</div>
    						    </div> 
    					<!--	<a href="#" class="c-button bg-aqua hv-transparent b-50 custom-icon">
    			...
    			<div class="col-xs-12 col-md-6 col-sm-12">
    				<div class="row">
    					<div class="col-md-6 col-sm-6 col-xs-12">
    					  <div class="radius-mask popular-img">
    						 <div class="clip">
								<div class="bg bg-bg-chrome act" style="background-image:url(know5.jpg)">
								</div>
							 </div>
							 <div class="tour-layer delay-1"></div>
							 <div class="vertical-bottom">
				                <h4><a href="mansar.php">Mansar Lake</a></h4>
				                  <h5><b class="color-aqua"></h5>
					         </div>
						  </div>
    					</div>
    					<div class="col-md-6 col-sm-6 col-xs-12">
    					  <div class="radius-mask popular-img">
    						 <div class="clip">
								<div class="bg bg-bg-chrome act" style="background-image:url(know6.jpg)">
								</div>
							 </div>
							 <div class="tour-layer delay-1"></div>
							 <div class="vertical-bottom">
				                <h4><a href="surinsar.php">Surinsar Lake</a></h4>
				                  <h5><b class="color-aqua"></h5>
					         </div>
						  </div>
    					</div>
    					<div class="col-md-6 col-sm-6 col-xs-12">
    					  <div class="radius-mask popular-img">
    						 <div class="clip">
								<div class="bg bg-bg-chrome act" style="background-image:url(know7.jpg)">
								</div>
							 </div>
							 <div class="tour-layer delay-1"></div>
							 <div class="vertical-bottom">
				                <h4><a href="kirimachi.php">Kirmachi Temple</a></h4>
				                  <h5><b class="color-aqua"></h5>
					         </div>
						  </div>
    					</div>
    					<div class="col-md-6 col-sm-6 col-xs-12">
    					  <div class="radius-mask popular-img">
    						 <div class="clip">
								<div class="bg bg-bg-chrome act" style="background-image:url(know8.jpg)">
								</div>
							 </div>
							 <div class="tour-layer delay-1"></div>
							 <div class="vertical-bottom">
				                <h4><a href="ranbireshwar.php">Ranbireshwar Temple</a></h4>
				                  <h5><b class="color-aqua"></h5>
					         </div>
						  </div>
    					</div>
...
.mobile-button img {
    ...
    width: 30%;
        ...
        <div class="mobile-button hidden-lg hidden-md hidden-sm">
            <div class="container">
                <a href="whatsapp://send?phone=+91-7889520873"&amp;text=Hi, I want to talk to you"><img src="images/email-icon.jpg" alt="Whatsapp"></a>
                <a href="sms:+91-7889520873"> <img src="images/send-message.jpg" alt="SMS"></a>
                <a href="tel:+91-7889520873"><img src="images/call-icon.jpg" alt="Call"></a>
            </div>
        </div>

<script >
      
      $("#instantcallb").keypress(function (e) {
            //if the letter is not digit then display error and don't type anything
            if (e.which != 8 && e.which != 0 && e.which != 43 && (e.which < 48 || e.which > 57)) {
      
                //display error message
                $("#sinstantcallb").html("Digits Only").show().fadeOut("slow");
       
                return false;
            }
        });
      
      $("#instantcode").keypress(function (e) {
            //if the letter is not digit then display error and don't type anything
            if (e.which != 8 && e.which != 0 && e.which != 43 && (e.which < 48 || e.which > 57)) {
      
                //display error message
                $("#sinstantcode").html("Digits Only").show().fadeOut("slow");
         ...
         $("#instantcallbsub").click(function (e) {
                      
      
            if ( $("#instantcallb").val() != "" && $("#instantcode").val() != "" )
                    {
          

        
          
        var insmob = $("#instantcallb").val();
        var inscod = $("#instantcode").val();
    
         
                //alert("All Fields Are Filled");
        
        $.post('instantcallback.php',{smobile:insmob, scode:inscod },
        function(data, status){
          alert(data);
      
        document.getElementById("instantcallb").value="";
        document.getElementById("instantcode").value="";
         ...
         $("#instantcallbc").keypress(function (e) {
            //if the letter is not digit then display error and don't type anything
            if (e.which != 8 && e.which != 0 && e.which != 43 && (e.which < 48 || e.which > 57)) {
      
                //display error message
                $("#sinstantcallbc").html("Digits Only").show().fadeOut("slow");
       
                return false;
            }
        });
      
      $("#instantcodebc").keypress(function (e) {
            //if the letter is not digit then display error and don't type anything
            if (e.which != 8 && e.which != 0 && e.which != 43 && (e.which < 48 || e.which > 57)) {
         ...
         $("#instantcallbsubbc").click(function (e) {
                      
      
            if ( $("#instantcallbc").val() != "" && $("#instantcodebc").val() != "" )
                    {
          

        
          
        var insmob = $("#instantcallbc").val();
        var inscod = $("#instantcodebc").val();
        ...
        document.getElementById("instantcallbc").value="";
        document.getElementById("instantcodebc").value="";
