...
<?php   
       ...
       $resultab = mysqli_query($conn, $query); 

       $query = "SELECT * FROM admin";
       $resultpro = mysqli_query($conn, $query); 
       
       $query = "SELECT * FROM service ORDER BY ID DESC LIMIT 1";
...
<body>
    ...
    <div class="wrapper">
       ...
       ?>
        ...
        <!-- Start Slider Area -->
         <div class="slider__container">
            <div class="slider__activation__wrap owl-carousel owl-theme">
                <!-- Start Single Slide -->
                <div class="slide slider__fixed--height slide__align--center" data--black__overlay="6"  style="background: rgba(0, 0, 0, 0) url(images/bg/home-1.jpg) no-repeat scroll 0 0 / cover;">
                    <div class="container">
                        <div class="row">
                ...
                <!-- End Single Slide -->
                <!-- Start Single Slide -->
                <div class="slide slider__fixed--height slide__align--center" data--black__overlay="6"  style="background: rgba(0, 0, 0, 0) url(images/bg/home.jpg) no-repeat scroll 0 0 / cover;">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="slider__inner">
                ...
                <!-- End Single Slide -->
                <!-- Start Single Slide -->
                <div class="slide slider__fixed--height slide__align--center" data--black__overlay="6"  style="background: rgba(0, 0, 0, 0) url(images/bg/play.jpg) no-repeat scroll 0 0 / cover;">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="slider__inner">
                ...
                <div class="row">
                    <div class="col-lg-12">
                          ...
                          if (mysqli_num_rows($resultab) >   0) {
                           ...
                           while($dataab = mysqli_fetch_assoc($resultab)) {
                            ?>
                        <div class="section__title text-center">
                            <h2 class="title__line"><?php echo $dataab['Heading_1']; ?></h2>
                            </div>
                            <br>
                            <p><?php echo $dataab['About_1']; ?></p>
                            <br><div class=" text-center">
                            <a class="htc__btn" href="about.php">Know More</a>
                            <?php
                              }} else { ?>
        ...
        <!-- End About Area -->
        <!-- start About Area -->
        <section class="htc__service__area service--2 bg__gray ptb--100 text__pos">
            <div class="container">
                <div class="row">
                                <div class="col-xs-12">
                                    <div class="section__title text-center"><br>
                                        <h2 class="title__line">OUR <span class="text--theme">SERVICES</span></h2><br>
                                    </div>
                                        <p class=" text-center">A great construction company doesn't just build structures, it builds trust, excellence, and a legacy that stands the test of time.</p>
<br>
                                    <div class=" text-center">
                            <a class="htc__btn" href="service.php">Know More</a>
        ...
        <section class="htc__project__details__page ptb--80 bg__white">
            <div class="container">
                <?php
                          if (mysqli_num_rows($resultpr) >   0) {

                           while($datapr = mysqli_fetch_assoc($resultpr)) { 

                            ?>
                <div class="row">
                    <div class="section__title text-center"><br>
                                        <h2 class="title__line">OUR <span class="text--theme">PROJECTS</span></h2><br>
                                    </div>
                                    <hr>
                    <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                                ...
                                <div class="ht-portfolio-pic-show">
                                    <div class="ht-portfolio-full-image tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
                                            <br>
                                            <img src="./admin/images/project/<?php echo $datapr['Image1']; ?>" alt="full-image" width="780" height="300">
                                        </div>
                        ...
                        <div class="row col-md-11 col-lg-11">
                            <br>
                                <h2><b><?php echo $datapr['Name']; ?></b></h2>
                                <p>Introducing Aurigaa - the perfect residential project located on Sarjapura Road in Bangalore. With two wings consisting of a total of 65 units of 2 and 2.5 BHK apartments, Aurigaa offers a comfortable and luxurious living experience to its residents. The project is designed with modern amenities and state-of-the-art facilities to provide a hassle-free lifestyle. The building is B+G+7 floors, offering ample space and beautiful views of the city. The apartments are spacious and well-ventilated, with abundant natural light and air circulation.</p>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="single__project__rightsidebar">
                            ...
                            <div class="pro__dtl__inner bg__gray">
                                ...
                                <div class="pro__dtl__content">
                                    ...
                                    <ul class="pro__dtl__list">
                                        <li><?php echo $datapr['City']; ?></li>
                                        <li><?php echo $datapr['Size']; ?></li>
                                        <li><?php echo $datapr['Type']; ?></li>
                                        <li><?php echo $datapr['Status']; ?></li>
                                    </ul>
                                </div>
                            ...
                            <div class="download__project bg__gray">
                                <a class="htc__btn" href="project.php">Know More</a>
                            </div>
                            <!-- End Single Item -->
                        </div>
                    </div>
        ...
        <section class="htc__testimonial__area ptb--130" data--gray__overlay="9.5" style="background: rgba(0, 0, 0, 0) url(images/bg/1.jpg) no-repeat fixed center center / cover ;">
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-lg-10  col-lg-offset-1 col-sm-12 col-xs-12 smt-40">
                        <div class="reguest__quote">
                            <div class="section__title text-left">
                                <h2 class="title__line">SEND US A <span class="text--theme">Message</span></h2>
                                <p>"The best construction company is one that not only builds impressive structures, but also prioritizes safety, sustainability, and customer satisfaction throughout every step of the construction process."</p>
                            </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="newsletter__wrap">
                            ...
                            <p>The best construction company should have a strong reputation for delivering high-quality projects on time and within budget, with a focus on safety, sustainability, innovation, and customer satisfaction.</p>
                        
                        <?php 

$sql = mysqli_query($conn, "SELECT * From contact_details");
    ...
    ?>
                        <div class="htc__address__container">
                            ...
                            <div class="ct__address">
                                ...
                                <div class="ct__details">
                                    <p><a href="#"><?php echo $row['Email_id']; ?></a></p>
                                </div>
                            </div>
                            <!-- End Single Address -->
                        </div>
...
$sql = mysqli_query($conn, "SELECT * From contact_details");
    ...
    <script async src='https://d2mpatx37cqexb.cloudfront.net/delightchat-whatsapp-widget/embeds/embed.min.js'></script>
        <script>
          var wa_btnSetting = {"btnColor":"#16BE45","ctaText":"","cornerRadius":40,"marginBottom":20,"marginLeft":20,"marginRight":20,"btnPosition":"left","whatsAppNumber":"91<?php echo $row['Mobile']; ?>","welcomeMessage":"Hello, Thank You for contacting us. Please leave your message. Our representative will get back to you shortly...!","zIndex":999999,"btnColorScheme":"light"};
          window.onload = () => {
