...
$query = "SELECT * FROM service where Service_Status='Active' ORDER BY ID DESC LIMIT 3";

$resultsr = mysqli_query($conn, $query);
?>
<?php
...
<div class="banner-slider">
  <img src="images/consultant.jpg" class="active">
</div>

<script>
$(document).ready(function() {
  // Set the time interval for auto slide
  var slideInterval = 5000;

  // Start the slider
  setInterval(function() {
    var currentSlide = $('.banner-slider img.active');
    var nextSlide = currentSlide.next('img');
    if (nextSlide.length === 0) {
      nextSlide = $('.banner-slider img:first');
    }
  ...
  <div class="container">
	<div class="row">
	  ...
	  <div class="col-md-12">
        ...
        <?php
$query = "SELECT * FROM property ORDER BY ID DESC LIMIT 4";
$result = mysqli_query($conn, $query);
        while ($row = mysqli_fetch_assoc($result)) {
          $id = $row['User_id'];

          $sql = mysqli_query($conn, "SELECT * From property_image where property_id = '$id' AND category = 'Main Image' ORDER BY ID DESC LIMIT 1");
          $image = '';
          if (mysqli_num_rows($sql) > 0) {
            $rowi = mysqli_fetch_assoc($sql);
            $image = $rowi['image'];
          }
          ...
          <!-- Listing Item -->
           ...
           <div class="utf-carousel-item-area">
				<div class="utf-listing-item"> 
				  <a href="single-property.php?id=<?php echo $row['ID']; ?>" class="utf-smt-listing-img-container">
				  <div class="utf-listing-badges-item"> 
					<span class="featured">Featured</span> 
					<span class="for-sale"> <?php echo $row['title']; ?></span> 
				  </div>
				  <div class="utf-listing-carousel-item">
					<?php if ($image) { ?>
                  <img src="../admin/images/<?php echo $image; ?>" alt="" style="height:200px;">
                <?php } else { ?>
                ...
                <?php } ?>
				  ...
				  <div class="utf-listing-content">				
					<div class="utf-listing-title">
					  <span class="utf-listing-price"><?php echo $row['price']; ?>/-</span> 						  	
					  <h4><a href="single-property-page-1.html"><?php echo $row['name']; ?></a></h4>
					  <span class="utf-listing-address"><i class="icon-material-outline-location-on"></i><?php echo $row['address']; ?></span> 											  
					</div>				
					<ul class="utf-listing-features">
					  <li><i class="fa fa-bed"></i> Beds<span><?php echo $row['bedrooms']; ?></span></li>
					  <li><i class="icon-feather-codepen"></i> Baths<span><?php echo $row['bathrooms']; ?></span></li>		  					 
					  <li><i class="icon-line-awesome-arrows"></i> Sq Ft<span><?php echo $row['size']; ?></span></li>
					</ul>
					</div>
				</div>
			  </div>
  ...
  <!-- Photo Section -->
	<div class="utf-photo-section-block  margin-top-65 margin-bottom-70" >
		<div class="utf-photo-text-content white-font">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<h2>About Us	</h2>
						<h3 style="color: white;">SKILINK Consultants: Your Trusted Property Advisor!</h3><br>
						<p>SKILINK Consultants is a leading property Advisory firm that was established with a team of highly skilled and experienced professionals. SKILINK Consultants has quickly become a trusted name in the real estate industry. The firm's mission is to provide expert guidance and tailored solutions to individuals and businesses seeking assistance with their property needs.</p>	
						<br>
						<h3 style="color: white;">Expertise and Services</h3><br>
						<p>SKILINK Consultants is a professional firm that provides a comprehensive range of services to meet the unique and varied needs of its clients. The company is a specialist in three key areas, namely property investment consulting, property management, and investment advisory services. Whether you're seeking expert guidance on real estate investment opportunities, require assistance with managing your properties, or need sound advice on investment strategies, SKILINK Consultants has the expertise and experience to deliver results that meet your expectations.</p>
						<a href="about.php" class="button margin-top-15">Read  More</a> 
						<br>
						<br>
						<br>
					</div>
  ...
  <div class="container">
	<div class="row">
		<div class="col-md-12">	
			<div class="utf-section-headline-item centered margin-bottom-30 margin-top-0">
			  <h3 class="headline"><span>Our Services</span> Most Popular Services</h3>
			  <div class="utf-headline-display-inner-item">Our Services</div>
			</div>  
		</div>
		<?php
                          if (mysqli_num_rows($resultsr) >   0) {

                           while($datasr = mysqli_fetch_assoc($resultsr)) {
                            ?>
					<div class="col-md-4">
                                <div class="blog-post">
                                    <a href="single-services.php?id=<?php echo $datasr['ID']; ?>" class="post-img"> 
                          <img src="./admin/images/<?php echo $datasr['Service_Image']; ?>" width="auto" height="250" alt="service images">
                                         </a>
                                            <div class="utf-post-content-area">
                                                <h3 class="text-center"><a href="single-services.php?id=<?php echo $datasr['ID']; ?>"></a><?php echo $datasr['Service_Name']; ?></h3>
                                               
                                                <div class="text-center">
                                                    <a href="single-services.php?id=<?php echo $datasr['ID']; ?>" class="button margin-top-10">Read</a>
                                                </div>
                                            </div>
	...
	<div class="row">
		...
		<div class="col-md-4 col-sm-6"> 
			<a href="#" class="img-box"> 
				<img src="images/istockphoto-1184398225-612x612.jpg" alt="" />
		  ...
		  <div class="col-md-4 col-sm-6"> 
			<a href="#" class="img-box"> 
				<img src="images/shutterstock-137913986.webp" alt="" />
				<div class="utf-cat-img-box-content visible">
				  <h4>Banglore</h4>
		  ...
		  <div class="col-md-4 col-sm-6"> 
			<a href="#" class="img-box"> 
				<img src="images/best-invest-in-nagpur.webp" alt="" />
				<div class="utf-cat-img-box-content visible">
				  <h4>Nagpur</h4>
				  <span>2 Properties</span> 
				</div>
  ...
  <!-- Parallax -->
  <div class="parallax margin-top-70" data-background="images/search.jpg" data-color="#36383e" data-color-opacity="0.7" data-img-width="800" data-img-height="505"> 
	<!-- Infobox -->
	<div class="text-content white-font">
	  <div class="container">
		<div class="row">
		  <div class="col-lg-6 col-sm-12 col-sm-push-3 smart-utf-listing-item">
			<h2>Search Smarter, From Anywhere</h2>
			<p>Enhance your search with our powerful platform, for up-to-date listings and a seamless user experience.</p>
			<a href="find-property.php" class="button margin-top-15">Search Now</a> 
		  </div>
		</div>
	  </div>
	</div>
