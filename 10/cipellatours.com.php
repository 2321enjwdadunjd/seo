...
<div class="col-xs-12 " style=" margin-bottom:10px; margin-top:10px;">
   ...
   <div class="col-xs-12" style=" margin-bottom:20px;">
	...
	<div id="wowslider-container1" style="margin-top:140px;">
    		...
    		<div class="row">
    			<div class="col-md-12">
    				<div class="second-title" style="padding-top:20px;">
    					<h2>Cipella Travels<br> Top Tours</h2>
    		...
    		<div class="row">
    			<div class="col-xs-12 col-md-6 col-sm-12">
    				<div class="popular-desc text-right">
    					...
    					<div class="vertical-align">
    						<h3 style="color:#037473;">Leh-Ladakh</h3>
    						  <p class="color-dark-2">Ladakh is a region administered by India as a union territory which constitutes a part of the larger Kashmir region.  </p>
    						  <h4 style="color:#037473;">best attractions</h4>
    						    <div class="row">
    						    	...
    						    	<div class="col-md-4 col-sm-4 col-xs-4">
                                        ...
                                        <ul>
    						    			<li><a href="ladakh.php" style="color:#ca6309;"><b>Leh-Ladakh</b></a></li>
    						    			<li><a href="surinsar.php" style="color:#ca6309;"><b>Surinsar Lake</b></a></li>
    						    			<li><a href="mansar.php" style="color:#ca6309;"><b>Mansar Lake</b></a></li>
    						    			<li><a href="pangong.php" style="color:#ca6309;"><b>Pangong Lake</b></a></li>
    			...
    			<div class="col-xs-12 col-md-6 col-sm-12">
    				<div class="row">
    					...
    					<div class="col-md-6 col-sm-6 col-xs-12">
    					  <div class="radius-mask popular-img">
    						 <div class="clip">
								<div class="bg bg-bg-chrome act" style="background-image:url(Pangong.jpg)">
								</div>
							 </div>
							 <div class="tour-layer delay-1"></div>
							 <div class="vertical-bottom">
				                <h4><a href="kirimachi.php">Pangong Lake</a></h4>
				                  <h5><b class="color-aqua"></h5>
					         </div>
						  </div>
    					</div>
    					<div class="col-md-6 col-sm-6 col-xs-12">
    					  <div class="radius-mask popular-img">
    						 <div class="clip">
								<div class="bg bg-bg-chrome act" style="background-image:url(ladakh.jpg)">
								</div>
							 </div>
							 <div class="tour-layer delay-1"></div>
							 <div class="vertical-bottom">
				                <h4><a href="ranbireshwar.php">Leh-Ladakh</a></h4>
				                  <h5><b class="color-aqua"></h5>
					         </div>
						  </div>
    					</div>
...
.mobile-button img {
    ...
    width: 30%;
        ...
        <div class="mobile-button hidden-lg hidden-md hidden-sm">
            <div class="container">
                <a href="whatsapp://send?phone=+91-6006779374"&amp;text=Hi, I want to talk to you"><img src="images/email-icon.jpg" alt="Whatsapp"></a>
                <a href="sms:+91-6006779374"> <img src="images/send-message.jpg" alt="SMS"></a>
                <a href="tel:+91-6006779374"><img src="images/call-icon.jpg" alt="Call"></a>
            </div>
        </div>
