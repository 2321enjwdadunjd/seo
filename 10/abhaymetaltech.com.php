...
<!-- Mirrored from th3s.com/pro/demo/quper/quper/index-dark1.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Jan 2023 07:25:32 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Abhay Metal Tech">
    <link rel="shortcut icon" href="assets/img/dd-favicon.png" type="image/x-icon">
    <title>Abhay Metal Tech | Top 10 Metal Components Manufacturers, Best Metal Components Manufacturers in Jamnagar</title>
    <meta property="og:title" content="Abhay Metal Tech - Manufacturer &amp; exporter of Customize Metal Solution Provider" />
    <meta property="og:description" content="Abhay metal tech is leading quality metal parts manufacturer, our products are SS, Stainless Steel, MS, Copper, Metal Product, Brass Cnc Turned Components, Brass Surgical Parts, Brass Auto Component, Brass Earthing, Brass Electrical Component, Brass Sanitary Fittings Component, Brass Gas Parts, Brass Brake Fittings, Brass Ball Valve, Brass Hose Fittings Parts, Brass Nozzle, Brass Split Bolt Connector" />
	<meta property="og:url" content="https://abhaymetaltech.com/" />
	<meta property="og:site_name" content="Abhay Metal Tech" />
    <!-- Bootstrap CSS -->
...
<?php include("header.php");?>
        ...
        <section class="main_slider_area">
            ...
            <div class="ws_images"><ul>
                    <li><img src="data1/images/abhay_metal_tech_slider_1.jpg" alt="Abhay Metal Tech Slider 1" title="Abhay Metal Tech Slider 1" id="wows1_0"/></li>
                    <li><a href="index.php"><img src="data1/images/abhay_metal_tech_slider_2.jpg" alt="javascript slider" title="Abhay Metal Tech Slider 2" id="wows1_1"/></a></li>
                    <li><img src="data1/images/abhay_metal_tech_slider_3.jpg" alt="Abhay Metal Tech Slider 3" title="Abhay Metal Tech Slider 3" id="wows1_2"/></li>
                </ul></div>
                <div class="ws_bullets"><div>
                    <a href="#" title="Abhay Metal Tech Slider 1"><span><img src="data1/tooltips/abhay_metal_tech_slider_1.jpg" alt="Abhay Metal Tech Slider 1"/>1</span></a>
                    <a href="#" title="Abhay Metal Tech Slider 2"><span><img src="data1/tooltips/abhay_metal_tech_slider_2.jpg" alt="Abhay Metal Tech Slider 2"/>2</span></a>
                    <a href="#" title="Abhay Metal Tech Slider 3"><span><img src="data1/tooltips/abhay_metal_tech_slider_3.jpg" alt="Abhay Metal Tech Slider 3"/>3</span></a>
                </div></div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        ...
                        <img class="one" src="assets/img/home-one/about.jpg" alt="">
                            <img class="two" src="assets/img/home-one/about-bg.jpg" alt="">
                            <img class="dot" src="assets/img/home_one_dark/dots.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="cons_about_content">
                            <h6 class="title_top">Abhay Metal Tech</h6>
                            <h2 class="title_head">About Us</h2>
                            <p style="text-align: justify;">Welcome to Abhay metal tech, your number one source for all things metal products. We’re dedicated to providing you the very best of Metal part products, with an emphasis on Quality, Product range, Service.<br>
                            Founded in 2021 by Niraj Patel, Abhay metal tech has come a long way from its beginnings in Jamnagar. When Niraj Patel first started out, his passion for best qulity metal products drove them to start their own business.<br>We hope you enjoy our products as much as we enjoy offering them to you. If you have any questions or Query, please don’t hesitate to contact us.
                            </p>
...
<section class="cons_work_process_area">
            <div class="container">
                <div class="section_title_one text-center">
                    <h6 class="title_top">Process</h6>
                    <h2 class="title_head">Our work process</h2>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        <div class="work_process_item text-center">
                            <div class="arrow"><i class="fas fa-long-arrow-alt-right"></i></div>
                            <i class="icon-blueprint1"></i>
                            <a href="about.php">
                                <h3>Document Workflows</h3>
                            </a>
                            <p>Both Party will discuss about goal of meeting, future planing and meeting objectives.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="work_process_item text-center">
                            ...
                            <p>We'll analyze market and other perspective of bussiness before production
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="work_process_item text-center">
                            ...
                            <p>After market analysation, production phase will start. 
                            </p>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-5">
                        <div class="cons_about_content">
                            <h6 class="title_top">Abhay Metal Tech</h6>
                            <h2 class="title_head">Why Choose Us</h2>
                            <p style="text-align: justify";>We are Abhay MetalTech is Deemand as One of the leading Manufactures & Exporter of Customize Metal Solution Provider.Top 10 Brass Components Manufacturers. The Components offered by us are reckoned in the market for corrosion resistance and high tensile Strength.
                                <ul>
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="team_img_info">
                            <img class="dot_middle" src="assets/img/home-one/feature_dot.png" alt="">
                            <div class="row">
                                <div class="col-6 cons_team_col">
                                    <a href="#" class="cons_team_item" data-parallax='{"x": 0, "y": 50}'>
                                        <img src="assets/img/home-one/why1.jpg" alt="">
                                    </a>
                                </div>
                                <div class="col-6 cons_team_col">
                                    <a href="#" class="cons_team_item" data-parallax='{"x": 0, "y": -50}'>
                                        <img src="assets/img/home-one/why2.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
...
<!-- cons_projects_area  -->
<section class="cons_projects_area_three">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <div class="section_title_one mb-0 wow fadeInUp">
                                <h6 class="title_top">Abhay Metal Tech</h6>
                                <h2 class="title_head">Our Products</h2>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="cons_project_slider_three">
                    <?php
                    include 'amt_admin/conn.php';
                    $query = "select * from category where type='NO'";
                    $res = mysqli_query($link, $query) or die ("not execute");
                    while($row = mysqli_fetch_assoc($res)){
                ?>
                        <div class="item">
                            <div class="pr_slider_item">
                            <?php echo '<img src="category/'.$row['category_image'].'" alt="'.$row['category_name'].'">';?>
                                <div class="hover-content">
                                   
                                    <h4>
                                    <a href="product.php?category_id=<?php echo $row['category_id']; ?>&<?php echo $row['category_name']; ?>"> <?php echo $row['category_name']; ?></a></a>
                                    </h4>
                        ...
                        <?php
                    include 'amt_admin/conn.php';
                    $query = "select * from category where type='YES'";
                    $res = mysqli_query($link, $query) or die ("not execute");
                    while($row = mysqli_fetch_assoc($res)){
                ?>
                        <div class="item">
                            ...
                            <?php echo '<img src="category/'.$row['category_image'].'" alt="'.$row['category_name'].'">';?>
                                <div class="hover-content">
                                    ...
                                    <h4>
                                    <a href="subcat.php?category_id=<?php echo $row['category_id']; ?>&<?php echo $row['category_name']; ?>"> <?php echo $row['category_name']; ?></a></a>
                                    </h4>
...
<!-- Mirrored from th3s.com/pro/demo/quper/quper/index-dark1.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Jan 2023 07:25:35 GMT -->
</html>