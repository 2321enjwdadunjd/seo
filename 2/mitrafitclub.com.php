...
<body>
<!--Weight loose gain confidence..-->
<!--start your new life with mitra fit club.-->

	<div class="details" id="details">
		<div class="one">
			<h3>Mitra Fit Club ?</h3>
			<h6>Mitra fit club is a community that inspires the society to adopt a healthy and active lifestyle and helps them to achieve their goal. </h6>
			<p>it was started as a mission on 8th April 2016 by Mr. Kiran kumar sahu in a small town saraipali chhattisgarh. and today it has reached Odisa, Madhya Pradesh, and maharashtra. so far thousands of people have got their fitness Benefits <br>Currently 10K+ members</p>
			<a href="trial_form.php"> Become a Member today</a>
		</div>
		<div class="two">
			<h3>Working hours</h3>
			<br>
...
<div class="results" id="results" style="padding-bottom:1.5rem">
		<p class="para">Let's Congratulate</p>
		<h2 class="h2">Our Brand New Transformations</h2>
<?php require('result_slide.php'); ?>
		<div style="text-align: center; padding: 15px;">
			<a href="result.php" style="padding: 15px 50px;background:forestgreen;color:#fff" class="btn">see more</a>
		</div>
	</div>
	...
	<div class="instructor" >
		<div class="about">
			<h2>Hello, we are Mitra fit club</h2>
			<p>Mitra fit club is a community that inspires the society to adopt a healthy and active lifestyle and helps them to achieve their goal.<br>
				<br>
				it was started as a mission on 8th April 2016 by Mr. Kiran kumar sahu in a small town saraipali chhattisgarh. and today it has reached Odisa, Madhya Pradesh, and maharashtra. so far thousands of people have got their fitness Benefits <br> Currently 10K+ members.
			</p>
		</div>
		<div class="people">
			...
			<div class="team1">
				<div class="img">
					<img src="img/founder/IMG-20230110-WA0009.jpg" alt="">
				</div>
				<div class="teamdetails">
					<div class="name">
						<h4>Mr. Kiran kumar sahu</h4>
						<a href="https://m.facebook.com/100064027688305/"><i class="fa fa-facebook"></i></a>
					</div>
					<div class="pro">
						<p>Founder of Mitra fit club</p>
						<a href="https://instagram.com/mitra_fitclub?igshid=YmMyMTA2M2Y="><i class="fa fa-instagram"></i></a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="class">
		...
		<h2 class="h2">Our Services & Program</h2>
		<div class="classmenu">
		<?php
			$sql2="select * from program order by id desc limit 3";
			$res2=mysqli_query($con,$sql2);
			$i=1;
				while($row2=mysqli_fetch_assoc($res2)){
			?>
			<div class="team1">
			    <a href="trial_form.php" style="text-decoration:none">
				<div class="img">
					<img src="admin/media/program/<?php echo $row2['img']?>" alt="" oncontextmenu="return false">
				</div>
				<div class="teamdetails">
					<div class="name">
						<div class="namedetails">
							<h4><?php echo $row2['name']?></h4>
							<p>Trained By - <b><?php echo $row2['trainer']?></b></p>
						</div>
						<div class="num">
							<h5>Free</h5>
						</div>
	...
	if(isset($_POST['submit'])){
		...
		$msg=str_replace("\n","%0A",$message);
		mysqli_query($con,"insert into query(name,email,msg) values('$name','$email','$message')");
	
	?>
	<script>
alert("Messege has been sent.");
	</script>
	<?php
		}
		?>
		...
		<div class="form">
			...
			<form action="" method="post">
				<div class="submit">
					...
					<a><button type="submit" name="submit" id="payment-button" class="btn" id="btn_register" style="background: transparent;color:#fff;font-size:1rem;border:none">Sent Message</button></a>
				</div>
			</form>
		</div>
		<div class="map">
			<h2>Where you can find us</h2>
			<p><i class="fa fa-map-marker"></i> In front of Gaurav Vidya Mandir School, Saraipali, Chhattisgarh 493558</p>
			
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3716.8383226506717!2d83.01598489999999!3d21.317403899999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a268da31b02a915%3A0x310e4603814dedb1!2sMitra%20Fit%20Club!5e0!3m2!1sen!2sin!4v1673689178795!5m2!1sen!2sin" width="1290" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
