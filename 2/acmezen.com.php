  ...
  <body class="main-layout">
   ...
   <div class="header_section">
       <div class="container">
           <div class="row">
               <div class="col-sm-3">
                   <div class="logo"><a href="index.php"><img src="images/logo.png" width="75%"></a></div>
               </div>
               <div class="col-sm-9">
               ...
               <div class="carousel-item active">
                   ...
                   <div class="col-sm-5">
                       <div class="banner_taital">
                           ...
                           <h1 class="mens_text"><strong>Moochmooche Bikaneri Bhujia</strong></h1>
                           <h1 class="banner_text">Available in ₹10 & ₹65 </h1>
                           <p class="lorem_text">Feeling chompy? Have Moochmooche</p>
                           <a href="contact_us.php"><button class="buy_bt">Contact Us</button></a>
                           <a href="products.php"><button class="more_bt">More Products</button></a>
                       </div>
                   </div>
                   <div class="col-sm-5">
                       <div class="shoes_img"><img src="images/product1.png"></div>
                   </div>
               </div>
               </div>
               <div class="carousel-item">
                   ...
                   <div class="col-sm-5">
                       <div class="banner_taital">
                           ...
                           <h1 class="mens_text"><strong>MoochMooche Tak Jhal Misti Chanachur</strong></h1>
                           <h1 class="banner_text">Available in ₹5 & ₹65 </h1>
                           <p class="lorem_text">Feeling chompy? Have Moochmooche</p>
                           <button class="buy_bt">Contact Us</button>
                           <button class="more_bt">More Products</button>
                       </div>
                   </div>
                   <div class="col-sm-5">
                       <div class="shoes_img"><img src="images/product6.png"></div>
                   </div>
               </div>
               </div>
           <!--     <div class="carousel-item">
                   ...
                   <div class="col-sm-2 padding_0">
                       <p class="mens_taital">Men Shoes</p>
                       <div class="page_no">3/2</div>
                       <p class="mens_taital_2">Men Shoes</p>
                   </div>
                   <div class="col-sm-5">
                       <div class="banner_taital">
                           <h1 class="banner_text">New Arrivals </h1>
                           <h1 class="mens_text"><strong>Moochmooche Bikaneri Bhujia</strong></h1>
                           <p class="lorem_text">Feeling chompy? Have Moochmoochey</p>
                           <button class="buy_bt">Contact Us</button>
                           <button class="more_bt">More Products</button>
                       </div>
                   </div>
   ...
   <div class="layout_padding collection_section">
       <div class="container">
           <h1 class="new_text"><strong> <span class="underline1">New  Arrivals </span></strong></h1>
           <!-- <p class="consectetur_text">consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation</p> -->
           <div class="collection_section_2">
               <div class="row">
                   <div class="col-md-8">
                       <div class="about-img">
                           <div class="shoes-img2"><img src="images/tea.jpg" width="80%"></div>
                           <p class="sport_text">Moochmooche Healthy Diet Chiwda</p>
                           <div class="dolar_text">₹<strong style="color: #0e0543;">50</strong> </div>
                           <div class="star_icon">
                               <ul>
                   ...
                   <!-- <div class="col-md-6">
                       <div class="about-img2">
                           ...
                           <div class="shoes-img"><img src="images/product3.png" width="65%"></div>
                           <p class="sport_text">Moochmooche Healthy Diet Chiwda</p>
                           <div class="dolar_text">₹<strong style="color: #0e0543;">60</strong> </div>
                           <div class="star_icon">
                               <ul>
                                   <li><a href="#"><img src="images/star-icon.png"></a></li>
                                   <li><a href="#"><img src="images/star-icon.png"></a></li>
   ...
   <div class="collection_section">
       <div class="container">
           <h1 class="new_text "><strong><span class="underline1"> Our Process</span>  </strong></h1>
           <!-- <p class="consectetur_text">consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation</p> -->
       </div>
   </div>
   <div class="collectipn_section_3 layuot_padding">
       <div class="container">
           <div class="racing_shoes">
               <div class="row">
                   <div class="col-md-6">
                       <div class="shoes-img3"><img src="images/mp4.png" width="80%"></div>
                   </div>
                   <div class="col-md-6">
                       <div class="sale_text1"><strong>Raw Materials<br><span style="color: #0e0543;">  Procurement </span> <br>From </strong></div>
                       <div class="number_text1"><strong> <span style="color: #0e0543">Trusted Vendors</span></strong></div>
           ...
           <div class="racing_shoes">
               <div class="row">
                   ...
                   <div class="col-md-6">
                       <div class="sale_text1"><strong>Through<br><span style="color: #0e0543;">  Inspection & </span> <br>Checks Of </strong></div>
                       <div class="number_text1"><strong> <span style="color: #0e0543">Raw Materials</span></strong></div>
                       <!-- <button class="seemore">See More</button> -->
                   </div>
                   <div class="col-md-6">
                       <div class="shoes-img3"><img src="images/mp6.png" width="80%"></div>
                   </div>
               </div>
           </div>
           ...
           <div class="racing_shoes">
               <div class="row">
                   <div class="col-md-6">
                       <div class="shoes-img3"><img src="images/mp7.png" width="80%"></div>
                   </div>
                   <div class="col-md-6">
                       <div class="sale_text1"><strong>Automated<br><span style="color: #0e0543;">  Manufacturing </span> <br> </strong></div>
                       <div class="number_text1"><strong> <span style="color: #0e0543">Processes</span></strong></div>
                       <!-- <button class="seemore">See More</button> -->
                   </div>
               </div>
           </div>
   ...
   <div class="collection_section layout_padding">
       <div class="container">
           <h1 class="new_text"><strong> <span class="underline1">Our Products</span> </strong></h1>
           <!-- <p class="consectetur_text">consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation</p> -->
       </div>
   </div>
   ...
   <div class="layout_padding gallery_section">
       <div class="container">
           <div class="row">
               <div class="col-sm-4">
                   <div class="best_shoes">
                       <p class="best_text">Bikaneri Bhujia </p>
                       <div class="shoes_icon"><img src="images/product1.png"></div>
                       <div class="star_text">
                           <div class="left_part">
                               <ul>
                                   <li><a href="#"><img src="images/star-icon.png"></a></li>
                           ...
                           <div class="right_part">
                               <div class="shoes_price">₹ <span style="color: #0e0543;">10, </span>₹ <span style="color: #0e0543;">65 </span></div>
                           </div>
                       </div>
                   </div>
               </div>
               <div class="col-sm-4">
                   <div class="best_shoes">
                       <p class="best_text">Chatpata Mixture </p>
                       <div class="shoes_icon"><img src="images/product2.png"></div>
                       <div class="star_text">
                           <div class="left_part">
                               <ul>
                                   <li><a href="#"><img src="images/star-icon.png"></a></li>
                           ...
                           <div class="right_part">
                               <div class="shoes_price">₹ <span style="color: #0e0543;">65</span></div>
                           </div>
                       </div>
                   </div>
               </div>
               <div class="col-sm-4">
                   <div class="best_shoes">
                       <p class="best_text">Healthy Diet Chiwda </p>
                       <div class="shoes_icon"><img src="images/product3.png"></div>
                       <div class="star_text">
                           <div class="left_part">
                               <ul>
                                   <li><a href="#"><img src="images/star-icon.png"></a></li>
                           ...
                           <div class="right_part">
                               <div class="shoes_price">₹ <span style="color: #0e0543;">50</span></div>
                           </div>
                       </div>
                   </div>
               </div>
           ...
           <div class="row">
               <div class="col-sm-4">
                   <div class="best_shoes">
                       <p class="best_text"> Navaratna Mixture</p>
                       <div class="shoes_icon"><img src="images/product4.png"></div>
                       <div class="star_text">
                           <div class="left_part">
                               <ul>
                                   <li><a href="#"><img src="images/star-icon.png"></a></li>
                           ...
                           <div class="right_part">
                               <div class="shoes_price">₹ <span style="color: #0e0543;">60</span></div>
                           </div>
                       </div>
                   </div>
               </div>
               <div class="col-sm-4">
                   <div class="best_shoes">
                       <p class="best_text"> Badam Pakoda</p>
                       <div class="shoes_icon"><img src="images/product5.png"></div>
                       <div class="star_text">
                           <div class="left_part">
                               <ul>
                                   <li><a href="#"><img src="images/star-icon.png"></a></li>
                           ...
                           <div class="right_part">
                               <div class="shoes_price">₹ <span style="color: #0e0543;">10</span></div>
                           </div>
                       </div>
                   </div>
               </div>
               <div class="col-sm-4">
                   <div class="best_shoes">
                       <p class="best_text"> Tak Jhal Misti</p>
                       <div class="shoes_icon"><img src="images/product6.png"></div>
                       <div class="star_text">
                           <div class="left_part">
                               <ul>
                                   <li><a href="#"><img src="images/star-icon.png"></a></li>
                           ...
                           <div class="right_part">
                               <div class="shoes_price">₹ <span style="color: #0e0543;">5, </span>₹ <span style="color: #0e0543;">65 </span></div>
                           </div>
                       </div>
                   </div>
               </div>
           ...
           <div class="buy_now_bt">
               <a href="products.php"><button class="buy_text">More Products</button></a>
           </div>
       </div>
   </div>
