...
<?php
//SITE TITLE
$title = "Premium carpentry work - Wood and art";

//SITE META DISCRIPTION
$metaDis = "Premium carpentry work";

//SITE META KEYWORDS
$metaKey = "Official Website of Wood and art";

//canonical
$canonical = "http://www.woodandart.in/";
...
<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    <ul class="nav ml-auto mt-2 mt-lg-0 nav-pills">
      <!--<li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="network.php">Our Network</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="contact.php">Contact Us</a>
      </li>-->
      <li class="nav-item">
        <a class="nav-link " href="#">Mobile No +91 9676-4516-18</a>
      </li>
    </ul>
  </div>
</div>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/1.jpg" alt="Home interior" width="100%">
      <div class="carousel-caption">
  </div>
    </div>
    <div class="carousel-item">
      <img src="img/portfolio.jpg" alt="Hall interior" width="100%">
      <div class="carousel-caption">
  </div>
    </div>
    <div class="carousel-item">
      <img src="img/home_interior_one.jpg" alt="Room interior" width="100%">
      <div class="carousel-caption">
  </div>
    </div>
  </div>
...
<div class="welcomeBox" >
  <div class="container text-center">
      <h1>Warm welcome to Wood and Art</h1>
      <hr class="star-primary">
      <p>Premium carpentry work for your living and working space in Hyderabad India. </p>
  </div>
</div> 
...
<div class="container homeProduct">
  <div class="row product">
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/kompally-13.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Kompally, Hyderabad <small>(Real work)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/kompally-12.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Kompally, Hyderabad <small>(Real work)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/kompally-11.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Kompally, Hyderabad <small>(Real work)</small></p>
    </div>
    
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/kompally-10.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Kompally, Hyderabad <small>(Real work)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/kompally-9.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Kompally, Hyderabad <small>(Real work)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/kompally-8.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Kompally, Hyderabad <small>(Real work)</small></p>
    </div>
    
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/kompally-7.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Kompally, Hyderabad <small>(Real work)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/kompally-15.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Kompally, Hyderabad <small>(Real work)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/kompally-5.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Kompally, Hyderabad <small>(Real work)</small></p>
    </div>
    ...
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/kompally-16.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Kompally, Hyderabad <small>(Real work)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/kompally-2.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Kompally, Hyderabad <small>(Real work)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/kompally-4.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Kompally, Hyderabad <small>(Real work)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/karmanghat_office_two.jpeg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Office Interior, Hyderabad <small>(3d)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/karmanghat_office_one.jpeg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Office Interior, Hyderabad <small>(3d)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/karmanghat_office.jpeg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Office Interior, Hyderabad <small>(3d)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/img9.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Rajapuspa, Hyderabad <small>(Real work image)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/img8.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Rajapuspa, Hyderabad <small>(Real work image)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/img7.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Rajapuspa, Hyderabad <small>(Real work image)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/img6.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Rajapuspa, Hyderabad <small>(Real work image)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/img5.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Rajapuspa, Hyderabad <small>(Real work image)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/img4.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>Rajapuspa, Hyderabad <small>(Real work image)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/chocolateroomvijaywada.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>The Chocolate room in Vijaywada <small>(Real work image)</small></p>
    </div>
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/chocolateroomvijaywada1.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>The Chocolate room in Vijaywada <small>(Real work image)</small></p>
      
    </div>

    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/chocolateroomvijaywada2.jpg" class="img-fluid" alt="The Chocolate room in Vijaywada">
      <p>The Chocolate room in Vijaywada <small>(Real work image)</small></p>
    </div>

     <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/Image_1_.jpg" class="img-fluid" alt="Thali House in Karimnagar">
        <p>Thali House in Karimnagar <small>(3d)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/Image_3_.jpg" class="img-fluid" alt="Thali House in Karimnagar">
        <p>Thali House in Karimnagar <small>(3d)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/Image_4_.jpg" class="img-fluid" alt="Thali House in Karimnagar">
        <p>Thali House in Karimnagar <small>(3d)</small></p>
    </div>
    
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/c2.jpg" class="img-fluid" alt="The Chocolate room in Warangal">
        <p>The Chocolate room in Warangal <small>(3d)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/c3.jpg" class="img-fluid" alt="The Chocolate room in Warangal">
        <p>The Chocolate room in Warangal <small>(3d)</small></p>
    </div>
    
    <div class="col-md-4 col-xs-12 w-100 div product">
      <img src="img/c5-1.jpg" class="img-fluid" alt="The Chocolate room in Warangal">
        <p>The Chocolate room in Warangal <small>(3d)</small></p>
    </div>
  </div>
</div>
