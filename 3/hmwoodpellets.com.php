  ...
  <body>
            ...
            <div class="thm-container">
              <div class="box valign-top home1_slide1">
                <div class="content text-left cnt_fr wdt55">
                  <h2 data-animation="animated fadeInUp">BIOMASS PELLETS.</h2>
                  <p data-animation="animated fadeInDown">Made out of Agriculture residue. Available in 8mm diameter, Eco Friendly Fuel as it is non-hazardous, safe to use and store and pollution free with lowest emissions.</p><a data-animation="animated fadeInUp" href="contact.php" data-text="Contact Us" class="button button--winona button--inverted2"><span>Contact Us</span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="thm-container">
              <div class="box valign-top home1_slide2">
                <div class="content text-left cnt_fl wdt55">
                  <h2 data-animation="animated fadeInUp">WOOD PELLETS</h2>
    <p data-animation="animated fadeInDown">Made out of Pure Wood Sawdust. Available in 6mm and 8mm diameter, Very low ash content 2-5%, consistent <br>moisture below 10%, and calorific value <br>above 4200kcal/kg.</p>
      <a data-animation="animated fadeInUp" href="contact.php" data-text="Contact Us" class="button button--winona button--inverted2"><span>Contact Us</span></a>
                </div>
              </div>
            </div>
          </div>
   ...
   <!-- History_Section Start-->
    <div class="wdt_100 pad_100">
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-4"><img src="images/aboutus_page/about_img.jpg" alt="image"></div>
          <div class="col-lg-8 col-md-8 col-sm-8 about_desc">
<h4 class="black-color mar_btm30" style="text-align: center;">WELCOME TO <span class="lytgreen-head">H M WOOD PELLETS</span>
  <p style="text-align: center;">Green Energy Solution</p>
   </h4>
            <p>H M WOOD PELLETS is a unit of H M INTERCRAFTS PVT. LTD. based in Delhi NCR manufacturing HUB, RAI Industrial Estate, Sonipat, Haryana.</p>
            <p>We are a manufacturing unit, producing highly efficient Biomass Pellet Fuel, Pellet Burners
and stoves etc. which are environment friendly and considered Green Energy / Fuel.</p>
<p>Wood pellets provide a clean, renewable heating fuel option for consumers reducing the
dependence on fossil fuels while simultaneously contributing an economic benefit to local
economies.</p>

<p>We are dedicated to provide best quality and services to our customers.</p>
    ...
    <div class="stop_location_col wdt_100 text-center">
      <div class="container">
        <h4>Download Our latest Company Brochure from here.</h4>
        <div class="stop_buttons"><a href="" class="view-all hvr-bounce-to-right slide_contact_btn slide_service_btn flnone margin_rght">
		<img src="images/services/Brochure.png" alt="image"></a></div>
      </div>
    </div>
    <!-- Stop_Location End-->
    ...
    <div class="pad_100 wdt_100">
      <div class="container">
	  <h3 class="black-color mar_btm40">Our <span class="lytgreen-head">Product</span></h3>
        <div class="quality-list service-list">
          <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 service_marbtm">
            	<a href="biomass-pellets.php" class="image_hover mbot_38"><img src="images/allservices_page/biomass.jpg" alt="image" class="zoom_img_effect"></a>
             <a href="biomass-pellets.php" class="view-all hvr-bounce-to-right view_gallery" data-gal="prettyPhoto[gal_8]" title="Walkout Patio">BIOMASS PELLETS</a>
              </div>
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 service_marbtm">
            	<a href="wood-pellets.php" class="image_hover mbot_38"><img src="images/allservices_page/wood.jpg" alt="image" class="zoom_img_effect"></a>
              <a href="wood-pellets.php" class="view-all hvr-bounce-to-right view_gallery" data-gal="prettyPhoto[gal_8]" title="Walkout Patio">WOOD PELLETS</a>
             </div>
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 service_marbtm">
            	<a href="pellet-burners-stoves.php" class="image_hover mbot_38"><img src="images/allservices_page/stove.jpg" alt="image" class="zoom_img_effect"></a>
               <a href="pellet-burners-stoves.php" class="view-all hvr-bounce-to-right view_gallery" data-gal="prettyPhoto[gal_8]" title="Walkout Patio">PELLET BURNERS / STOVES:</a>
             </div>
    ...
    <div class="pad_94_100 client_bg wdt_100">
      <div class="container">
        <h3 class="black-color mar_btm40">Our <span class="lytgreen-head">Testimonials</span></h3>
              ...
              <div class="item active">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="client_identity_Col"><span class="client_image"><img src="images/home_page/home_client_img1.png" alt="image"></span>
                    <div class="client_desc"><span class="client_name">Prame </span><span class="client_place">Mumbai</span></div>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="client_identity_Col"><span class="client_image"><img src="images/home_page/home_client_img2.png" alt="image"></span>
                    <div class="client_desc"><span class="client_name">Sonali </span><span class="client_place">New Delhi</span></div>
                  </div>
                </div>
              </div>
            </div>
...
<div style="display: none;">
    <a href="https://simatek-eng.umy.ac.id/assets/joker123/">joker123 </a>
    </div>
   
<div style="display: none;">
    <a href="https://sjp.depok.go.id/slot777/">slot777</a></div>
<div style="display: none;">
    <a href="https://sjp.depok.go.id/assets/gacor777/">gacor777</a></div>

</div>
<div style="display: none;">
  <a href="https://simatek-eng.umy.ac.id/assets.OLD/js/-/slot777/">slot777</a></div>
<div style="display: none;">
  <a href="https://simpeg.kalteng.go.id/assets/slot-pulsa/">slot pulsa</a></div>
