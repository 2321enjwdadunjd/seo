  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="img/new-banner/banner1.jpg" alt="Los Angeles" style="width:100%;">
      </div>

      <div class="item">
        <img src="img/new-banner/banner2.jpg" alt="Chicago" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="img/new-banner/banner3.jpg" alt="New york" style="width:100%;">
      </div>
        <div class="item">
        <img src="img/new-banner/banner4.jpg" alt="New york" style="width:100%;">
      </div>
    </div>
...
<!--<div class=pogoSlider id=js-main-slider>-->
	<!--<div class=pogoSlider-slide style=background-image:url(img/banner/Kwik-homepage-banner-B1.jpg) data-duration=1000 data-transition=slide>-->
	<!--	<div class=container>-->
	<!--		<div class=slider-content>-->
	<!--		</div>-->
	<!--	</div>-->
	<!--</div>-->
	<!--<div class=pogoSlider-slide style=background-image:url(img/banner/Kwik-homepage-banner-B2new.jpg) data-duration=1000 data-transition=slide>-->
	<!--	<div class=container>-->
	<!--		<div class=slider-content>-->
	...
	<!--	</div>-->
	<!--</div>-->
	<!--<div class=pogoSlider-slide style=background-image:url(img/banner/Kwik-homepage-banner-B3.jpg) data-duration=1000 data-transition=slide>-->
	<!--	<div class=container>-->
	<!--		<div class="slider-content center-slide-content">-->
	<!--		</div>-->
	<!--	</div>-->
	<!--</div>-->
 <!--  <div class=pogoSlider-slide style=background-image:url(img/banner/Kwik-homepage-banner-B4.jpg) data-duration=1000 data-transition=slide>-->
	<!--	<div class=container>-->
	<!--		<div class="slider-content center-slide-content">-->
	<!--		</div>-->
	<!--	</div>-->
	<!--</div>-->
 <!--  <div class=pogoSlider-slide style=background-image:url(img/banner/Kwik-homepage-banner-B5.jpg) data-duration=1000 data-transition=slide>-->
	<!--	<div class=container>-->
	<!--		<div class="slider-content center-slide-content">-->
	<!--		</div>-->
	<!--	</div>-->
...
<!--
	...
	<div class=pogoSlider-slide style="background-image:url(img/new-banner/banner1.jpg") data-duration=1000 data-transition=slide>
		<div class=container>
			<div class="slider-content center-slide-content">
			</div>
		</div>
	</div>
   <div class=pogoSlider-slide style="background-image:url(img/new-banner/banner2.jpg") data-duration=1000 data-transition=slide>
		<div class=container>
			<div class="slider-content center-slide-content">
			</div>
		</div>
	</div>
   <div class=pogoSlider-slide style="background-image:url(img/new-banner/banner3.jpg") data-duration=1000 data-transition=slide>
		<div class=container>
			<div class="slider-content center-slide-content">
			</div>
		</div>
...
-->
<!--
	<div class=pogoSlider-slide style="background-image:url(img/banner/kwik-banners4.jpg") data-duration=1000 data-transition=slide>
		<div class=container>
			<div class="slider-content center-slide-content">
			</div>
		</div>
...
-->
<!--
   <div class=pogoSlider-slide style="background-image:url(img/new-banner/banner4.jpg") data-duration=1000 data-transition=slide>
		<div class=container>
			<div class="slider-content center-slide-content">
			</div>
		</div>
...
-->
		...
		<div class="col-xs-12 col-sm-4 col-md-6">
                <div class="about0">
				<img alt=team src="images/about-us.jpg" class="rounded-border shadow-primary">
                    </div>
			</div>
		<div class="col-xs-12 col-sm-8 col-md-6">
			<div class="section-heading-left">
				<h2>Kwik Fastening Solutions Pvt. Ltd</h2>
				<div class="text-content">
					<p>Kwik Fastening Solutions Pvt. Ltd. - A Company dealing into manufacturing and marketing of Kwik range of anchoring and fastening systems, used at Infrastructure segments viz. airports, metro & monorail projects, flyovers, bridges and all other buildings & factories industry related construction projects. kwik brand / kwik anchors & bolts is synonym for high quality anchoring products used at construction sites all over India for all types of base materials.</p>
                    <p>Having set our footprints outside India in JV with our European counterpart with clear focus on anchoring and fastening BU, KWIK India started its operation in India in January 2013 having HO in Mumbai. We are one of the fast growing companies in India in fastening industry and registered as MSME with GOI.</p>
		          
		            <a class="mt-20 button-xs dark-button mb-15" href="about-us.php">Read More</a>
				</div>
			</div>
		</div>
...
<div class=" section-block-parallax spass" style="background-image:url(img/bg/par-1.jpg)">
	<div class=container>
		<div class=row>
			<div class="col-xs-12 col-sm-4 col-md-12">
				<div class=section-heading-white-left>
					<h2>Kwik Fastening Solutions Pvt. Ltd.</h2>
				</div>
			</div>
			<div class="col-xs-12 col-sm-8 col-md-12">
				<div class=row>
					<div class="col-xs-12 col-md-3 col-sm-3 col-xs-6">
						<div class=countup-box><i class=icon-sand-clock></i>
							<h4 class=countup>20</h4>
							<p>Years Of Experience</div>
					</div>
					<div class="col-xs-12 col-md-3 col-sm-3 col-xs-6">
...
<!--                            <i class=icon-loader></i>-->
							...
							<p>Total Projects</div>
					</div>
					<div class="col-xs-12 col-md-3 col-sm-3 col-xs-6">
						<div class=countup-box><i class=icon-engineer></i>
							<h4 class=countup>50</h4>
							<p>Team Members</div>
					</div>
					<div class="col-xs-12 col-md-3 col-sm-3 col-xs-6">
						<div class=countup-box><i class="fa fa-users" aria-hidden="true"></i>
		...
		<div class="row">
			<div class="col-md-4 col-sm-4 col-xs-12">
				<figure class="snip0016">
					<img src="images/vision.jpg" alt="sample41"/>
					<figcaption>
						<h2>Our<br><span>Vision</span></h2>
						<p>Be The Brand Of Choice In Fastening Industry For Transforming India</p>
						<a href="#"></a>
					</figcaption>			
				</figure>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-12">
				<figure class="snip0016">
					<img src="images/mission.jpg" alt="sample42"/>
					<figcaption>
						<h2>Our<br><span>Mission</span></h2>
						<p>Committed To Provide Innovative, Reliable And Sustainable Fastening Solutions</p>
						<a href="#"></a>
					</figcaption>			
				</figure>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-12">
				<figure class="snip0016">
					<img src="images/purpose.jpg" alt="sample43"/>
					<figcaption>
						<h2>Our<br><span>Value</span></h2>
<!--						<p>Service Transparency Ethics Politeness Sustainability</p>-->
                        <P>Courage, Commitment, Teamwork, Accountability, KWIK-Services</P>
						<a href="#"></a>
					</figcaption>			
				</figure>
			</div>	
	...
	<divclass=container>
		...
		<div class=row>
			<div class="col-xs-12 col-md-3 col-sm-6">
				<div class="clearfix service-grid">
                    <img alt=service-img src=images/products/1.jpg>

					
					<div class="content-holder service-grid-inner">
						<h4>CHEMICAL ANCHORING</h4>
						<a href="chemical-anchoring.php">Pure Epoxy Chemical Anchor</a>
                        <a href="vinylester-chemical-anchor.php">Vinylester Chemical Anchor</a>
                        <a href="polyester-chemical-anchor.php">Polyester Chemical Anchor</a>
                        <a href="threaded-anchor-rods.php">Threaded Anchor Rods</a>
                        <a href="caulking-gun.php">Caulking Gun</a>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-3 col-sm-6 ">
				<div class="clearfix service-grid">
                    <img alt=blog-img src=images/products/22.jpg>
					<div class="content-holder service-grid-inner">
						<h4>MECHANICAL  ANCHORING </h4>
						 <a href="throughbolt-wedge-anchor.php">Throughbolt  Wedge Anchor-GVZ </a>
                        <a href="through-bolt-wedge-anchor-ss.php">Throughbolt  Wedge Anchor-SS </a>
                        <a href="safety-anchor-eye-hook-anchor.php"> Safety Anchor-Eye Hook Anchor</a>
                        <a href="drop-in-bullet-anchor.php">Drop-in Bullet Anchor</a>
<!--                        <a href="#"> Hex Bolts</a>-->
			...
			<div class="col-xs-12 col-md-3 col-sm-6">
				<div class="clearfix service-grid">
					<img alt=service-img src=images/products/3(NEW).jpg>
					<div class="content-holder service-grid-inner">
						<h4>NYLON ANCHORING </h4>
						<a href="universal-frame-fixing-anchore.php">Universal Frame Fixing Anchor </a>
                        <a href="door-frame-fixing-ancho.php"> Door Frame Fixing Anchor </a>
                        <a href="hammerfix-anchors.php">Hammerfix Anchors </a>
                        <a href="#">Nylon Plugs </a>
            ...
            <div class="col-xs-12 col-md-3 col-sm-6">
				<div class="clearfix service-grid">
					<img alt=blog-img src=images/products/4.jpg>
					<div class="content-holder service-grid-inner">
						<h4>Polyurethane Foams </h4>
						<a href="polyurethane-foam.php"> Polyurethane Foam  </a>
                        <a href="polyurethane-foam-fire-rated.php"> Polyurethane Foam Fire Rated </a>
                        <a href="foam-gun-cleaner.php">Foam & Gun Cleaner </a>
                        <a href="polyurethane-foam-dispensing-gun.php">Polyurethane Foam Dispensing Gun </a>
...
<div class="section-block-parallax" style="background-image:url(images/construction.jpg)">
	<div class=container>
		<div class=row>
			<div class="col-xs-12 col-sm-6 col-md-6">
				<div class=quot-block>
					<form class=quot-form action="contactnewmail.php" method=post>
						<div class=col-xs-6>
							<input name="firstName" type="text" class="form" maxlength="150" placeholder="First Name" required>
						</div>
						<div class=col-xs-6>
							<input name="lastName" type="text" class="form" maxlength="150" placeholder="Last Name" required>
						</div>
                        <div class="clearfix"></div>
                        <div class=col-xs-6>
							<input name="Email" type="email" class="form" maxlength="150" placeholder="Email-Id" required>
						</div>
						<div class=col-xs-6>
							<input name="Phone" type="tel" class="form" placeholder="Phone Number" pattern="^\d{10}$" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" required title="enter 10 Digit Number" maxlength="10">
						</div>
                        <div class="clearfix"></div>
						<div class=col-xs-12>
							<textarea name="Message" class="form" maxlength="550" placeholder="Your Message" required></textarea>
						</div>
                        <div class="clearfix"></div>
						<div class=col-xs-6>
                    ...
                    <div class="clearfix"></div>
						<div class=center-holder>
							<button class="mt-20 button-xs dark-button mb-15" type=submit>Send Message</button>
						</div>
					</form>
				</div>
			</div>
			<div class="col-xs-12 col-md-5 col-sm-5 col-sm-offset-1">
				<div class="section-heading-white-left mt-15">
                    <img src="images/inq.png">
<!--
					<h2>Free Quote<br>Get in touch today</h2>
...
<div class="section-block-grey">
	<div class=container>
		...
		<div class="owl-carousel owl-theme partners" id=our-partners>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo1.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo2.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo3.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo4.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo5.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo6.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo7.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo8.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo9.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo10.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo11.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo12.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo13.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo14.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo15.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo16.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo17.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo18.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo19.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo20.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo21.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo22.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo23.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo24.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo25.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo26.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo27.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo28.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo29.png>
			</div>
			<div class=item>
				<img alt=partner-image src=img/content/partners/logo30.png>
			</div>
		</div>
	</div>
</div>
