...
$bsql = mysqli_query($conn, "SELECT * FROM `product` WHERE `type`='Best Value Pack'");
$bcount = mysqli_num_rows($bsql);

$rsql = mysqli_query($conn, "SELECT * FROM `product` WHERE `cat_id`='CAT_1653291841'");
$rcount = mysqli_num_rows($rsql);

$psql = mysqli_query($conn, "SELECT * FROM `product` WHERE `cat_id`='CAT_1653291966'");
$pcount = mysqli_num_rows($psql);

$basql = mysqli_query($conn, "SELECT * FROM `product` WHERE `cat_id`='CAT_1667496484'");
$bacount = mysqli_num_rows($basql);
?>
...
<div class="container">
    <!-- Hero Section Begin -->
    <div id="tinykiddoIndicators" class="carousel slide" data-ride="carousel">
        <!-- Indicators -->
        <ol class="carousel-indicators">
            <li data-target="#tinykiddoIndicators" data-slide-to="0" class="active"></li>
            <li data-target="#tinykiddoIndicators" data-slide-to="1"></li>
            <!-- <li data-target="#tinykiddoIndicators" data-slide-to="2"></li> -->
        </ol>
        <!-- Wrapper for slides -->
        <div class="carousel-inner">
            <?php $query = mysqli_query($conn, "select * from banner");
            $i = "0";
            while ($banner = mysqli_fetch_array($query)) {  ?>
                <div class="carousel-item <?php if ($i == 0) {
                                                echo "active";
                                            } ?>">
                    <img class="d-block w-100" src="admin/uploads/<?php echo $banner['bimg'] ?>" data-color="lightblue" alt="NEATH Tiny Kiddo Organic Cotton Brand">
                    <div class="carousel-caption d-md-block">
                        <div class="slideshow__slidetitle"><?php echo $banner['subheading'] ?></div>
                       <div class="slideshow__subtitle"><?php echo $banner['slidetitle'] ?></div>
                        <br>
                        <a href="shop.php">
                            <h5>Shop Now</h5>
                        </a>
        ...
        <!-- Controls -->
        <a class="carousel-control-prev" href="#tinykiddoIndicators" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" href="#tinykiddoIndicators" role="button" data-slide="next">
        ...
        <div class="row">
              ...
              <div class="services" id=""> 
                  	<a href="#" class="service service-1">
                    	<div class="service-icon service-icon_1"></div>
                        	<div class="service-description"> 
                            	<div class="service-title">100% Organic Cotton </div>
                                <div class="service-subtitle">GOTS Certified</div>
                        	</div>
                      	</a>
                   	<style>
                            .service-icon_1 {background-image: url(assets/img/cat-1_41x154.png);}
                        </style>
                  	<a href="#" class="service service-2">
                    	<div class="service-icon service-icon_2"></div>
                        	<div class="service-description"> 
                            	<div class="service-title">Chemical Free</div>
                                <div class="service-subtitle">Natural Extracts / Azo Free Dyes</div>
                        	</div>
                      	</a>
                   		<style>
                            .service-icon_2 {background-image: url('assets/img/cat-2_41x154.png');}
                        </style>
                       	<a href="#" class="service service-3">
                    	<div class="service-icon service-icon_3"></div>
                        	<div class="service-description"> 
                            	<div class="service-title">Handmade With Love</div>
                                <div class="service-subtitle">Traditional, Trendy Touch</div>
                        	</div>
                      	</a>
                   		<style>
                            .service-icon_3 {background-image: url('assets/img/cat-3_41x154.png');}
                        </style>
                       <a href="#" class="service service-4">
                    	<div class="service-icon service-icon_4"></div>
                        	<div class="service-description"> 
                            	<div class="service-title">Earth Friendly</div>
                                <div class="service-subtitle">Go Green for a Better Tomorrow</div>
                        	</div>
                      	</a>
                   		<style>
                            .service-icon_4 {background-image: url('assets/img/cat-4_41x154.png');}
                        </style>

              </div>
            </div>
         <!--   
            <ul class="col-lg-3 col-sm-6 col-6 service-data">
            ...
            <ul class="col-lg-3 col-sm-6 col-6 service-data">
                ...
                <li>
                    ...
                    <b>Chemical Free</b>
                    <p>Natural Extracts / Azo Free Dyes</p>
                </li>
            </ul>
            ...
            <ul class="col-lg-3 col-sm-6 col-6 service-data">
                ...
                <li>
                    ...
                    <p>Traditional, Trendy Touch</p>
                </li>
            </ul>

            <ul class="col-lg-3 col-sm-6 col-6 service-data border-0">
                <li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="product-slider owl-carousel">
                    <?php
                    while ($sub_row = mysqli_fetch_array($bsql)) {
                        $pd_sql = mysqli_query($conn, "SELECT * FROM `products_details` WHERE `product_id`='" . $sub_row['product_id'] . "'");
                        $pd_row = mysqli_fetch_assoc($pd_sql);
                        $img = explode(",", $sub_row['image']);
                        $offf = ($pd_row['offerprice'] * 100) / $pd_row['price'];
                        $off = 100 - $offf;
                    ?>
                        <div class="product-item">
                            <div class="pi-pic">
                               <a href="single_product.php?pid=<?php echo $sub_row['product_id']; ?>"> <img src="admin/uploads/products/<?php echo $img[0]; ?>" alt="<?php echo $sub_row['name']; ?>"></a>
                                <div class="sale"><?php echo round($off); ?>% Off</div>
                                <?php if (isset($_SESSION['uid'])) {
                                    $check_wish_sql = mysqli_query($conn, "SELECT * FROM `wishlist` WHERE `product_id`='" . $sub_row['product_id'] . "' AND `user_id`='" . $_SESSION['uid'] . "'");
                                    $check_wish = mysqli_num_rows($check_wish_sql);
                                    if ($check_wish != 0) {
                                        $cl = "fa fa-heart";
                                        $wishlink = "removewishlist.php?action=remove&uid=" . $_SESSION['uid'] . "&pid=" . $sub_row['product_id'] . "&url=" . basename($_SERVER['PHP_SELF']);
                                    } else {
                                        $cl = "fa fa-heart-o";
                                        $wishlink = "addwishlist.php?pid=" . $sub_row['product_id'] . "&uid=" . $_SESSION['uid'] . "&url=" . basename($_SERVER['PHP_SELF']);
                                    }

                                ?>
                                    <ul>
                                        <li class="w-icon active"><a href="single_product.php?pid=<?php echo $sub_row['product_id']; ?>"><i class="fa fa-shopping-cart"></i></a></li>
                                        <li class="quick-view"><a href="single_product.php?pid=<?php echo $sub_row['product_id']; ?>"><i class="fa fa-eye"></i></a></li>
                                        <li class="w-icon active"><a href="<?php echo $wishlink; ?>"><i class="<?php echo $cl; ?>" style="font-size:24px;color:#fff"></i></a></li>
                                    </ul>
                                <?php } else { ?>
                                    <ul>
                                        <li class="w-icon active"><a href="login.php"><i class="fa fa-shopping-cart"></i></a></li>
                                        <li class="quick-view"><a href="single_product.php?pid=<?php echo $sub_row['product_id']; ?>"><i class="fa fa-eye"></i></a></li>
                                        <li class="w-icon active"><a href="login.php"><i class="fa fa-heart-o"></i></i></a></li>
                                    </ul>
                                <?php } ?>
                            </div>
                            <div class="pi-text">
                               <!-- <div class="catagory-name">Neath</div> -->
                                <a href="single_product.php?pid=<?php echo $sub_row['product_id']; ?>">
                                    <h5><?php echo $sub_row['name']; ?></h5>
                                </a>
                                <div class="product-price">
                                    <sup><i class="fa fa-inr"></i></sup> <?php echo $pd_row['offerprice']; ?><sup> 00</sup> <span class="mrprs">M.R.P.: <sup><i class="fa fa-inr"></i></sup>
                                    <span><?php echo $pd_row['price']; ?><sup> 00</sup></span>
                                </div>
...
<?php if($rcount != 0){ ?>
        <div class="row">
            <div class="col-lg-3">
                <a href="shop.php">
                    <div class="product-large set-bg" data-setbg="assets/img/products/Side-img3.jpg">
                        <h2>Girl’s</h2>
                        <p>Shop More</p>
                    </div>
                </a>
            ...
            <div class="col-lg-8 offset-lg-1">
                ...
                <div class="product-slider owl-carousel">
                    <?php
                    while ($sub_row = mysqli_fetch_array($rsql)) {
                        $pd_sql = mysqli_query($conn, "SELECT * FROM `products_details` WHERE `product_id`='" . $sub_row['product_id'] . "'");
                        $pd_row = mysqli_fetch_assoc($pd_sql);
                        $img = explode(",", $sub_row['image']);
                        $offf = ($pd_row['offerprice'] * 100) / $pd_row['price'];
...
<section class="shopping-banner spad">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="shopping-content">
                   <!-- <p>NATURAL DYES</p> 
                    <h2><span class="naturally-dyes">NATURAL DYES</span>
                    <br>Extracted from Natural Soruces such as Plants or Vegetable Wastes... </h2>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="product-slider owl-carousel">
                    <?php
                    while ($sub_row = mysqli_fetch_array($psql)) {
                        $pd_sql = mysqli_query($conn, "SELECT * FROM `products_details` WHERE `product_id`='" . $sub_row['product_id'] . "'");
                        $pd_row = mysqli_fetch_assoc($pd_sql);
                        $img = explode(",", $sub_row['image']);
                        $offf = ($pd_row['offerprice'] * 100) / $pd_row['price'];
                            ...
                            <div class="pi-pic">
                                ...
                                ?>
                                    <ul>
                                        <li class="w-icon active"><a href="single_product.php?pid=<?php echo $sub_row['product_id']; ?>"><i class="fa fa-shopping-cart"></i></a></li>
                                        <li class="quick-view"><a href="single_product.php?pid=<?php echo $sub_row['product_id']; ?>"><i class="fa fa-eye"></i></a></li>
                                        <li class="w-icon active"><a href="<?php echo $wishlink; ?>"><i class="<?php echo $cl; ?>"></i></a></li>
                                    </ul>
                                <?php } else { ?>
                                    <ul>
                                        <li class="w-icon active"><a href="login.php"><i class="fa fa-shopping-cart"></i></a></li>
                                        <li class="quick-view"><a href="single_product.php?pid=<?php echo $sub_row['product_id']; ?>"><i class="fa fa-eye"></i></a></li>
                                        <li class="w-icon active"><a href="login.php"><i class="fa fa-heart-o"></i></a></li>
                                    </ul>
                                <?php } ?>
                            </div>
                            <div class="pi-text">
                                ...
                                <div class="product-price">
                                    <sup><i class="fa fa-inr"></i></sup> <?php echo $pd_row['offerprice']; ?><sup> 00</sup> <span class="mrprs">M.R.P.: <sup><i class="fa fa-inr"></i></sup> 
                                    <span><?php echo $pd_row['price']; ?><sup> 00</sup></span>
                                  <!--  Rs.<?php //echo $pd_row['offerprice']; ?>
                                    <span><?php //echo $pd_row['price']; ?></span> -->
                                </div>
            ...
            <div class="col-lg-3 offset-lg-1">
                <a href="shop.php">
                    <div class="product-large set-bg m-large" data-setbg="assets/img/products/Side-img2.jpg">
                        <h2>Boy’s</h2>
                        <p>Shop Now</p>
                    </div>
                </a>
...
<!-- larg Banner Section Begin -->
<div class="tinybanner-section spad">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-6  col-12">
                <div class="tinysingle-banner">
                    <a href="shop.php">
                        <div class="tiny-bannerimg">
                            <img src="assets/img/Slider-4.png" alt="banner image">
                            <div class="inner-text">
                                <h4>ROYAL</h4>
                                <!--<p>Royal look at lowest prices</p>-->
                                <div class="shopbtn">
                                    <p>Shop Now</p>
                                </div>
                            </div>
            ...
            <div class="col-lg-6 col-sm-6  col-12">
                <div class="tinysingle-banner">
                    <a href="shop.php">
                        <div class="tiny-bannerimg">
                            <img src="assets/img/Slider-5.png" alt="banner image">
                            <div class="inner-text">
                                <h4>PREMIUM</h4>
                                <!--<p>Products at low cost</p>-->
                                <div class="shopbtn">
                                    <p>Shop Now</p>
                                </div>
                            </div>
...
<section class="women-banner spad">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <a href="shop.php">
                    <div class="product-large set-bg" data-setbg="assets/img/products/NEATH_TinyKiddo_Organic_Cotton.jpg">
                        <h2>Girl’s</h2>
                        <p>Shop More</p>
                    </div>
                </a>
            ...
            <div class="col-lg-8 offset-lg-1">
                ...
                <div class="product-slider owl-carousel">
                    <?php
                    while ($sub_row = mysqli_fetch_array($basql)) {
                        $pd_sql = mysqli_query($conn, "SELECT * FROM `products_details` WHERE `product_id`='" . $sub_row['product_id'] . "'");
                        $pd_row = mysqli_fetch_assoc($pd_sql);
                        $img = explode(",", $sub_row['image']);
                        $offf = ($pd_row['offerprice'] * 100) / $pd_row['price'];
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6  col-12">
                <div class="single-banner" data-toggle="modal" data-target="#tinyModal">
                    <img src="assets/img/NEATH-Tiny-Kiddo-ButterFly.JPG" alt="banner">
                    <div class="inner-text">
                        <button class="btn btn-info btn-sm"><i class="fa fa-play"></i></button>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6  col-12">
                <div class="single-banner" data-toggle="modal" data-target="#tinyModal1">
                    <img src="assets/img/NEATH-Tiny-Kiddo-Car.JPG" alt="banner">
                    <div class="inner-text">
                        <button class="btn btn-info btn-sm"><i class="fa fa-play"></i></button>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-6 col-12">
                <div class="single-banner" data-toggle="modal" data-target="#tinyModal2">
                    <img src="assets/img/NEATH-Tiny-Kiddo-Elephant.JPG" alt="banner">
                    <div class="inner-text">
                        <button class="btn btn-info btn-sm"><i class="fa fa-play"></i></button>
                    </div>
                </div>
...
<!-- Modal -->
<div id="tinyModal" class="modal fade" role="dialog">
    <div class="modal-dialog">

        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Explore Our Butterfly Jhabla </h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <video id="vid" style="width: 100%;" controls autoplay muted>
                    <source src="assets/img/NEATH_TinyKiddo_Butterfly.MP4" type="video/mp4">
...
<div id="tinyModal1" class="modal fade" role="dialog">
    <div class="modal-dialog">

        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Explore Our Car Jhabla </h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <video id="vid1" style="width: 100%;" controls autoplay muted>
                    <source src="assets/img/NEATH_TinyKiddo_Car.MP4" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
            </div>
        </div>
...
<div id="tinyModal2" class="modal fade" role="dialog">
    <div class="modal-dialog">

        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Explore Our Elephant Jhabla </h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <video id="vid2" style="width: 100%;" controls autoplay muted>
                    <source src="assets/img/NEATH_TinyKiddo_Elephant.MP4" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
            </div>
        </div>
