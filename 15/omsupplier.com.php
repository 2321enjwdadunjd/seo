...
<?php
include 'top.php';
include 'Gh@58Rt$uH26/connection.php';
?>
<div class="home2-slider swiper-container">
        <div class="swiper-wrapper">
            <div class="home2-slide-item swiper-slide" data-swiper-autoplay="5000" data-bg-color="#EEE5DD">
                <div class="home2-slide1-image">
                    <img src="assets/images/slider/home2/sl1.png" alt="Slide One Image">

                    <div class="home2-slide1-product1">
                        <button class="slide-pointer"><span>+</span></button>
                        <div class="slide-product">
                            <div class="image"><img src="assets/images/slider/home2/sl1.png" alt="Slide Product Image"></div>
                            <h6 class="title">Designer Sweet Boxes </h6>
                            <span class="price">To enlighten every memorable moment of your's</span>
                        </div>
                    </div>

                </div>
                <div class="home2-slide-content">
                    <h5 class="sub-title">To enlighten every memorable moment of your's </h5>
                    <h2 class="title">Designer Sweet Boxes</h2>
            ...
            <div class="home2-slide-item swiper-slide" data-swiper-autoplay="5000" data-bg-color="#F5F1F1">
                <div class="home2-slide2-image">
                    <img src="assets/images/slider/home2/sl2.png" alt="Slide One Image">

                    <div class="home2-slide2-product1">
                        <button class="slide-pointer"><span>+</span></button>
                        <div class="slide-product">
                            <div class="image"><img src="assets/images/slider/home2/sl2.png" alt="Slide Product Image"></div>
                            <h6 class="title">Designer Branding Bags</h6>
                            <span class="price">Enhance your brand presence</span>
                        </div>
                    </div>
                    <div class="home2-slide2-product2">
                        <button class="slide-pointer"><span>+</span></button>
                        <div class="slide-product">
                            <div class="image"><img src="assets/images/slider/home2/sl3.png" alt="Slide Product Image"></div>
                            <h6 class="title">Designer Branding Bags </h6>
                            <span class="price">Enhance your brand presence</span>
                        </div>
                    </div>
                ...
                <div class="home2-slide-content">
                    <h5 class="sub-title">Enhance your brand presence</h5>
                    <h2 class="title">Designer Branding Bags </h2>
            ...
            <div class="home2-slide-item swiper-slide" data-swiper-autoplay="5000" data-bg-color="#F1DED0">
                <div class="home2-slide3-image">
                    <img src="assets/images/slider/home2/sl3.png" alt="Slide One Image">

                    <div class="home2-slide3-product1">
                        <button class="slide-pointer"><span>+</span></button>
                        <div class="slide-product">
                            <div class="image"><img src="assets/images/slider/home2/sl3.png" alt="Slide Product Image"></div>
                            <h6 class="title">Complete Branding </h6>
                            <span class="price">shop collection</span>
                        </div>
                    </div>
                    <div class="home2-slide3-product2">
                        ...
                        <div class="slide-product">
                            <div class="image"><img src="assets/images/slider/home2/sl3.png" alt="Slide Product Image"></div>
                            <h6 class="title">Complete branding Tags Catalogues </h6>
                            <span class="price">shop collection</span>
                        </div>
                    </div>
                ...
                <div class="home2-slide-content">
                    <h5 class="sub-title">Branding Maniac</h5>
                    <h2 class="title">Complete branding Tags & <br> Catalogues </h2>
                    <div class="link"><a href="shop.html">shop collection</a></div>
                </div>
                <div class="home2-slide-pages">
      ...
      <div class="section section-padding" data-bg-image="assets/images/bg/">
        <div class="container">
                ...
                <div class="col-lg-5 col-12 ms-auto align-self-center learts-mb-30">
                    <div class="about-us">
                        <div class="inner">
                            ...
                            <h2 class="title">Om Suppliers</h2>
                            <span class="special-title">Know us a bit</span>
                ...
                <div class="col-lg-5 col-md-6 col-12 ms-auto learts-mb-30">
                    <div class="category-banner2">
                        <a href="shop.html" class="inner">
                            <div class="image"><img src="assets/images/banner/category/about.jpg" alt=""></div>
                            <div class="content">
...
<div class="section section-padding">
                ...
                <div class="col-xl-7 col-lg-8 col-12 mx-auto">
                    <div class="about-us2">
                        <div class="inner">
                            ...
                            <h5 class="sub-title">WELCOME TO OM SUPPLIERS</h5>
                            <div class="desc">
                                <p>OM Suppliers is a brand of  passionate craftsmen where they sell handicrafts and arts’ works in India. We provide high-end unique branding items, cake base, branding accessories, and kullad.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row row-cols-lg-4 row-cols-sm-2 row-cols-1 learts-mb-n40">
                ...
                <div class="col learts-mb-40">
                    <div class="category-banner4">
                        <a href="https://omsupplier.com/allproducts.php?ctr=Cake%20Boxes" class="inner">
                            <div class="image"><img src="assets/images/content/cakebox.jpg" alt=""></div>
                            <div class="content" data-bg-color="#f4ede7">
                                <h3 class="title">Cake Box</h3>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col learts-mb-40">
                    <div class="category-banner4">
                        <a href="https://omsupplier.com/allproducts.php?ctr=Sweet%20Box" class="inner">
                            <div class="image"><img src="assets/images/content/sweetbox.jpg" alt=""></div>
                            <div class="content" data-bg-color="#e8f5f2">
                                <h3 class="title">Sweet Box</h3>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col learts-mb-40">
                    <div class="category-banner4">
                        <a href="https://omsupplier.com/allproducts.php?ctr=Cake%20Base" class="inner">
                            <div class="image"><img src="assets/images/content/cakebase.jpg" alt=""></div>
                            <div class="content" data-bg-color="#e3e4f5">
                                <h3 class="title">Cake Base</h3>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col learts-mb-40">
                    <div class="category-banner4">
                        <a href="https://omsupplier.com/allproducts.php?ctr=Paper%20Bags" class="inner">
                            <div class="image"><img src="assets/images/content/handbag.jpg" alt=""></div>
                            <div class="content" data-bg-color="#faf5e5">
                                <h3 class="title">Hand Bag</h3>
                            </div>
                        </a>
                    </div>
                </div>
 ...
 <?php
                ...
                $q = "select * from newproducts order by id asc limit 0,10";
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="productdetail.php?ctr=<?php echo $code; ?>" class="image">
                                <img src="Gh@58Rt$uH26/newproductimage/<?php echo $img; ?>" alt="<?php echo $name; ?>">
                                <img class="image-hover " src="Gh@58Rt$uH26/newproductimage/<?php echo $img; ?>" alt="<?php echo $name; ?>">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                            <h6 class="title"><a href="productdetail.php?ctr=<?php echo $code; ?>"><?php echo $name; ?></a></h6>
                           
                            <div class="product-buttons">
                                <a href="productdetail.php?ctr=<?php echo $code; ?>"  class="product-button hintT-top" data-hint="Quick View"><i class="fal fa-search"></i></a>
