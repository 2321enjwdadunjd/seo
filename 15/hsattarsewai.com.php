...
<div class="page-container">
                  ...
                  <div class="row">
                    <div class="col-md-5 col-sm-12 col-xs-12">
                      <div class="swin-sc swin-sc-title text-left wow fadeInUp">
                        ...
                        <h3 class="title white-color">Hafiz Sattar Son's Sewai</h3>
                      </div>
                      <p class="des wow fadeInUp">Hafiz sattar sons sewai has been a prime manufacturere of sewai in the state of U.P from more than a decade.</p>
                      <p class="des wow fadeInUp">We know how to make a best vermecellai for your festive as well as regular moments.We have been providing fresh vermecellai to generations and we have stick to our quality standards in all those years.</p><a href="javascript:void(0)" class="swin-btn wow fadeInUp"> <span>Read More</span></a>
                    </div>
                          ...
                          <div class="slides">
                            <div class="timeline-item item">
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-1-1-thumbnail.jpeg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-1-1.jpeg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-1-2-thumbnail.jpeg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-1-2.jpeg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-1-3-thumbnail.jpeg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-1-3.jpeg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                            </div>
                            <div class="timeline-item item">
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-2-1-thumbnail.jpeg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-2-1.jpeg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-2-2-thumbnail.jpeg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-2-2.jpeg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                              <div class="col-sm-4 item-inner">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="swin-sc swin-sc-title">
                        ...
                        <h3 class="title">Amazing Products</h3>
                      </div>
                      <div class="row">
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <div class="swin-sc sc-featured-box item wow fadeInUp"><img src="assets/images/featured-box-bg-1.jpg" alt="fooday" class="box-bg">
                            <div class="box-inner">
                              ...
                              <div class="showcase"><img src="assets/images/sewai.jpg" alt="" class="img-responsive img-showcase">
                                <div class="title-showcase">Sewai</div>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <div data-wow-delay="0.5s" class="swin-sc sc-featured-box item wow fadeInUp"><img src="assets/images/featured-box-bg-1.jpg" alt="fooday" class="box-bg">
                            <div class="box-inner">
                              ...
                              <div class="box-content">Lorem ipsum dolor sit amet, consec adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</div>
                              <div class="btn-wrap text-center"><a href="javascript:void(0)" class="btn swin-btn"><span>Read More</span></a></div>
                              <div class="showcase"><img src="assets/images/rusk.png" alt="" class="img-responsive img-showcase">
                                <div class="title-showcase">Rusk</div>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <div data-wow-delay="1s" class="swin-sc sc-featured-box item wow fadeInUp"><img src="assets/images/featured-box-bg-1.jpg" alt="fooday" class="box-bg">
                            <div class="box-inner">
                              ...
                              <div class="box-content">Lorem ipsum dolor sit amet, consec adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</div>
                              <div class="btn-wrap text-center"><a href="javascript:void(0)" class="btn swin-btn"><span>Read More</span></a></div>
                              <div class="showcase"><img src="assets/images/bharat.jpg" alt="" class="img-responsive img-showcase">
                                <div class="title-showcase">Bharat Sewai</div>
                              </div>
                            </div>
                          </div>
                        </div>
 ...
 <section id="gallery" class="gallery-section-01 padding-top-100">
              <div class="swin-sc swin-sc-title">
                ...
                <h3 class="title white-color">Rceipies from vermecellai</h3>
              </div>
              <div class="swin-sc swin-sc-isotope">
                <div class="grid">
                  <div class="grid-sizer col-sm-1"></div>
                  <div class="grid-item col-sm-3 grid-item-h2">
                    <div class="grid-wrap-item"><a href="#" class="gallery-title title">sewai</a><a href="assets/images/gallery/gallery-1.jpg" data-lightbox="image" class="view-lightbox swipebox"><i class="fa fa-search-plus"></i></a><a href="#" class="view-more"><i class="fa fa-link"></i></a>
                  ...
                  <div class="grid-item col-sm-4 grid-item-h1">
                    <div class="grid-wrap-item"><a href="#" class="gallery-title title">kiwami sewai</a><a href="assets/images/gallery/gallery-2.jpg" data-lightbox="image" class="view-lightbox swipebox"><i class="fa fa-search-plus"></i></a><a href="#" class="view-more"><i class="fa fa-link"></i></a>
                  ...
                  <div class="grid-item col-sm-2 grid-item-h1">
                    <div class="grid-wrap-item"><a href="#" class="gallery-title title">Sheer khurma</a><a href="assets/images/gallery/gallery-3.jpg" data-lightbox="image" class="view-lightbox swipebox"><i class="fa fa-search-plus"></i></a><a href="#" class="view-more"><i class="fa fa-link"></i></a>
                      <div class="img-wrap"><img src="assets/images/gallery/gallery-3.jpg" alt="" class="img img-responsive"></div>
                    </div>
                  </div>
                  <div class="grid-item col-sm-3 grid-item-h2">
                    <div class="grid-wrap-item"><a href="#" class="gallery-title title">sewai</a><a href="assets/images/gallery/gallery-4.jpg" data-lightbox="image" class="view-lightbox swipebox"><i class="fa fa-search-plus"></i></a><a href="#" class="view-more"><i class="fa fa-link"></i></a>
                      <div class="img-wrap"><img src="assets/images/gallery/gallery-4.jpg" alt="" class="img img-responsive"></div>
                    </div>
                  </div>
                  <div class="grid-item col-sm-2 grid-item-h1">
                    <div class="grid-wrap-item"><a href="#" class="gallery-title title">sheer sewai</a><a href="assets/images/gallery/gallery-5.jpeg" data-lightbox="image" class="view-lightbox swipebox"><i class="fa fa-search-plus"></i></a><a href="#" class="view-more"><i class="fa fa-link"></i></a>
                      <div class="img-wrap"><img src="assets/images/gallery/gallery-5.jpeg" alt="" class="img img-responsive"></div>
                    </div>
                  </div>
                  <div class="grid-item col-sm-4 grid-item-h1">
                    <div class="grid-wrap-item"><a href="#" class="gallery-title title">sheer khurma</a><a href="assets/images/gallery/gallery-6.jpeg" data-lightbox="image" class="view-lightbox swipebox"><i class="fa fa-search-plus"></i></a><a href="#" class="view-more"><i class="fa fa-link"></i></a>
                      <div class="img-wrap"><img src="assets/images/gallery/gallery-6.jpeg" alt="" class="img img-responsive"></div>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="row">
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="item icon-box-02 wow fadeInUpShort">
                          ...
                          <h4 class="title">Totally hygienic</h4>
                          <div class="description">vermecellai will beprepared with gloves on , there is no direct contact of hand</div>
                        </div>
                      </div>
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div data-wow-delay="0.5s" class="item icon-box-02 wow fadeInUpShort">
                          ...
                          <h4 class="title">Freshly prepared</h4>
                          <div class="description">Freshly prepared vermecellai with the wheat flour which is freshly processed.</div>
                        </div>
                      </div>
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div data-wow-delay="1s" class="item icon-box-02 wow fadeInUpShort">
                          ...
                          <h4 class="title">Vermecellai</h4>
                          <div class="description">We prepared fine vermecellai with properly baked process</div>
                        </div>
                      </div>
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div data-wow-delay="1.5s" class="item icon-box-02 wow fadeInUpShort">
                          ...
                          <div class="description">you can order now to enjoy our vermecellai with fast delivery</div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            //////////////////////////orders fetching script/////////

            $q = "select * from blogs order by id desc";
            $qe = mysqli_query($conn,$q); $c=1;
                ...
                ?>
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <div data-wow-delay="0s" class="blog-item swin-transition item wow fadeInUpShort">
                            ...
                            <div class="blog-featured-img"><img src="/Hf@786/blogs/<?php echo $img; ?>"alt="fooday" class="img img-responsive"></div>
                            <div class="blog-content">
                              <div class="blog-date"><span class="day">12</span><span class="month">Jun</span></div>
                              <h3 class="blog-title"><a href="singleblog.php?ctr=<?php echo $code;?>" class="swin-transition"><?php echo $name; ?></a></h3>
                             
                              <div class="blog-readmore"><a href="singleblog.php?ctr=<?php echo $code;?>" class="swin-transition">Read More <i class="fa fa-angle-double-right"></i></a></div>
                            </div>
                          </div>
                        </div>
                        <?php
                              ...
                              <div class="slides">
                                <div class="testi-item item"><i class="testi-icon fa fa-quote-left"></i>
                                  <div class="testi-content">
                                    <p> I have been using it from more than two years now and i must say this is the best vermecellai i have ever purchased</p>
                                  </div>
                                  <div class="testi-info"><span class="name">Shahin</span> <span class="position">Customer</span></div>
                                </div>
                                <div class="testi-item item"><i class="testi-icon fa fa-quote-left"></i>
                                  <div class="testi-content">
                                    <p>It cooked up really well and have a very nice taste, the best thing about hafiz sattar sewai is that  it  is really fresh and soft.It is very delicious also. </p>
                                  </div>
                                  <div class="testi-info"><span class="name">Sarah	Riaz</span> <span class="position">Customer</span></div>
                                </div>
                                <div class="testi-item item"><i class="testi-icon fa fa-quote-left"></i>
                                  <div class="testi-content">
                                    <p>Great product from hafiz sattar sons , i loved it as it always fresh and very good i taste.I have eaten sheer khurma from this vermecellai many times and i must say this is the best in market. </p>
                                  </div>
                                  <div class="testi-info"><span class="name">Nawaz</span> <span class="position">Customer</span></div>
                                </div>
                                <div class="testi-item item"><i class="testi-icon fa fa-quote-left"></i>
                                  <div class="testi-content">
                                    <p>Great in taste and very good in preparation.This is the best sewai in the market as i have been using it from more than 4 years.</p>
                                  </div>
                                  <div class="testi-info"><span class="name">Zoya</span> <span class="position">Customer</span></div>
                                </div>
                              </div>
                            </div>
