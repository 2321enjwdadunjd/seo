...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	// }else{
      ...
      $proData =array("quantity" => 1, "price" => $row_p['productPrice'],"type"=>'cat','proId'=>$id);
      array_push($_SESSION['cart'],$proData);
...
<?php include('inc/bannernew.php');?>
        ...
        <section class="newArrivalSection">
            <div class="container overFlowHidden">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="productCarousle owl-carousel">
						<?php
						$ret=mysqli_query($con,"select * from products WHERE status='1' LIMIT 10");
                               ...
                               <div class="pi01Thumb">
										<a href="product_details.php?pid=<?php echo htmlentities($row['id']); ?>">
											...
											<div class="slides slowFade">
												...
												<div class="slide">
													<img src="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage4']); ?>">
												</div>
												<div class="slide">
													<img src="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage5']); ?>">
												</div>
											</div>
										</a>
									</div>
											
							<div class="pi01Details" style="text-align:center;">
							    	<div class="pi01Action">
													<?php if ($row['productAvailability'] == 'In_Stock') { ?>
														<a href="sub_cat.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="pi01ACart"><i class="souq-cart-1-svgrepo-com"></i></a>
													<?php } ?>
													<a href="sub_cat.php?pid=<?php echo htmlentities($row['id']) ?>&&action=wishlist" class="pi01AWList"><i class="souq-heart-svgrepo-com"></i></a>
												</div>
							    
								<ul class="or_pp">
								<?php 
								$col=$row['productName'];
                               $rtt=mysqli_query($con,"select * from products where productName='$col'");
                               while($c=mysqli_fetch_array($rtt)){  
							    ?>
								<li>
							   <label class="containerrr" style="float:none; margin-bottom:0px;">
							    <input type="checkbox" name="color" class="common_selector ram" value="<?php echo $c['product_color']; ?>" pName="<?php echo $row['productName'];?>">
							  <span class="mark" style="background-color:<?php echo $c['product_color']; ?>;height: 22px;width: 22px; top:-4px;left:5px"></span>
							</label>	
							</li>						
								...
								<?php }?>
												...
												<h3 style="margin-top: -15px;"><a href="#"><?php echo htmlentities($row['productName']); ?></a></h3>
												<div class="productPrice" style="display:block; margin-bottom:10px;">
												<i class="fa fa-inr" aria-hidden="true">  <?php echo htmlentities($row['productPrice']); ?></i>
												</div>
											</div>
...
<section class="CTASection">
            <div class="container">
                 <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2 class="secTitle" style="padding-bottom: 50px">Popular Categories</h2>
                    </div>
                </div>
                  <div class="row">
			    	<?php
                        ...
                        <div class="col-xl-6 noPaddingRight">
                           <div class="ctaRightPart cat-1" style="background-image:url('admin/category/<?php echo $row['img']; ?>');">
                            <a href="shop.php?sid=<?php echo $row['id'];?>" class="souqBTN soqJSHover"><span class="mbText"><?php echo $row['categoryName'];?></span><span class="mbShape"></span></a>
                        </div>
                    </div>
                    <?php } ?>
        ...
        <!--section class="brandSection">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="collection02">
                            <img src="images/an.gif" alt="Souq Collection"/>
                            
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="brandContent">
                            <h2 class="secTitle">Try Glasses in 3D</h2>
                            <p class="secDesc">
                                There are many variations of passages of available but <br/>the majority top brand 
                            </p>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 noPaddingLeft noPaddingRight br_b br_r">
                                    <div class="brandLogo text-center">
                                         <button class="btn btn-outline-dark btn-icon-text">
                                             <i class="fa-brands fa-android btn-icon-prepend mdi-36px"></i>
                                ...
                                <div class="col-lg-6 col-md-6 noPaddingLeft noPaddingRight br_b">
                                    <div class="brandLogo bl2 text-center">
                                        <button class="btn btn-outline-dark btn-icon-text">
                                            <i class="fa-brands fa-apple btn-icon-prepend mdi-36px"></i>
        ...
        <!-- END: Brand Section -->
        <section class="newArrivalSection" style="margin-top:30px;">
            <div class="container overFlowHidden">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="secTitle">Our Best Product for You</h2>
                    </div>
                </div> 
                <div class="row">
                    <div class="col-lg-12">
                        <div class="productCarousle owl-carousel">
						<?php
						$kid=mysqli_query($con,"select * from subcategory WHERE subcategory	='Women'");
						while ($ki=mysqli_fetch_array($kid)){
						$k=$ki['id'];
						
						$rett=mysqli_query($con,"select * from products WHERE subCategory='$k' AND status='1' LIMIT 8");
						while ($roww=mysqli_fetch_array($rett)) 
						{
						?>				
                            <div class="productItem01">
							<div class="pi01Thumb">
									<a href="product_details.php?pid=<?php echo htmlentities($roww['id']); ?>">
										<img src="admin/productimages/<?php echo htmlentities($roww['id']); ?>/<?php echo htmlentities($roww['productImage1']); ?>">
										
										<div class="slides slowFade">
											<div class="slide">
												<img src="admin/productimages/<?php echo htmlentities($roww['id']); ?>/<?php echo htmlentities($roww['productImage2']); ?>">
											</div>
											<div class="slide">
												<img src="admin/productimages/<?php echo htmlentities($roww['id']); ?>/<?php echo htmlentities($roww['productImage3']); ?>">
											</div>
											<div class="slide">
												<img src="admin/productimages/<?php echo htmlentities($roww['id']); ?>/<?php echo htmlentities($roww['productImage4']); ?>">
											</div>
											<div class="slide">
												<img src="admin/productimages/<?php echo htmlentities($roww['id']); ?>/<?php echo htmlentities($roww['productImage5']); ?>">
											</div>
										</div>
									</a>
								</div>
							     <div class="pi01Details" style="text-align:center;">
						         	<div class="pi01Action">
										<?php if ($roww['productAvailability'] == 'In_Stock') { ?>
											<a href="sub_cat.php?page=product&action=add&id=<?php echo $roww['id']; ?>" class="pi01ACart"><i class="souq-cart-1-svgrepo-com"></i></a>
										<?php } ?>
										<a href="sub_cat.php?pid=<?php echo htmlentities($roww['id']) ?>&&action=wishlist" class="pi01AWList"><i class="souq-heart-svgrepo-com"></i></a>
									</div>
								<ul class="or_pp">
								<?php 
									$col=$roww['productName'];
                               $rtt=mysqli_query($con,"select * from products where productName='$col'");
                               while($c=mysqli_fetch_array($rtt))
                               {  
							    ?>
								<li>
							<label class="containerrr" style="float:none; margin-bottom:0px;">
							  <input type="checkbox" name="color" class="common_selector ram" value="<?php echo $c['product_color']; ?>" pName="<?php echo $roww['productName'];?>">
							  <span class="mark" style="background-color:<?php echo $c['product_color']; ?>;height: 22px;width: 22px; top:-4px;left:5px"></span>
							</label>	</li>						
								...
								<?php }?>
												...
												<h3 style="margin-top: -15px;"><a href="#"><?php echo htmlentities($roww['productName']); ?></a></h3>
												<div class="productPrice" style="display:block; margin-bottom:10px;">
												<i class="fa fa-inr" aria-hidden="true">  <?php echo htmlentities($roww['productPrice']); ?></i>
												</div>
											</div>
                            </div>
                          <?php }} ?>
   ...
   <section class="newArrivalSection">
      <?php 
        $qry="SELECT * FROM tbl_footer_banner where id='1'";
        $result=mysqli_query($con,$qry);
        $row=mysqli_fetch_assoc($result);
   
      ?> 
    <img src="admin/footer_banner/<?php echo $row['banner_img']; ?>" >
        ...
        <!--section class="testimonialSection">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h5 class="secSubTitle">Product Review</h5>
                        <h2 class="secTitle">Our Best Customers</h2>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="testimonialSlider owl-carousel">
							//<?php //$qry=mysqli_query($con,"select * from productreviews");
                            ...
                            <div class="singleTestimonial">
							 <?php //$qryy=mysqli_query($con,"select * from products where id='$d'"); 
							       //while($rv=mysqli_fetch_array($qryy)){
							     // ?>
                                <img src="admin/productimages/<?php //echo $d ;?>/<?php //echo $rv['productImage1'] ;?>" alt="Souq Author"/>
								 <?php //}?>
                                <div class="stHeader">
                                    <h3><?php //echo $rvw['name'];?></h3>
                                    <div class="stRating">
									 <div class="productRatings">
                                      <div class="star-rating" role="img">
                                         <span style="width:<?php //echo $re;?>%"></span>
                                           </div>
                                       </div>
									</div>
                                    <div class="stSign"><i class="souq-text-quote-svgrepo-com"></i></div>
                                </div>
                                <div class="stQuote">
                                    <?php// echo $rvw['review'];?>
                                </div>
