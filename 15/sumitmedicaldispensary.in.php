...
<html lang="en">
  <head>
    <title>Sumit Medical Dispensary || Home</title>
    <meta charset="utf-8">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.php"><i class="flaticon-pharmacy"></i><span>Sumit </span>Medical Dispensary</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item cta"><a href="contact.html" class="nav-link" data-toggle="modal" data-target="#modalAppointment"><span>Login</span></a></li>
        </ul>
      </div>
    </div>
  </nav>
  <!-- END nav -->
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
           <img src="images/radha swami ji.png" width="300" height="90" alt=""/>
        ...
        <div class="row no-gutters">
          <div class="col-md-4 ftco-animate py-5 nav-link-wrap">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <a class="nav-link px-4" id="v-pills-buffet-tab" data-toggle="pill" href="#v-pills-buffet" role="tab" aria-controls="v-pills-buffet" aria-selected="false"><img src="images/heart.png" width="25" height="25" alt=""/></span>&nbsp;&nbsp;&nbsp; Pulmonology</a>

              <a class="nav-link px-4" id="v-pills-sea-tab" data-toggle="pill" href="#v-pills-sea" role="tab" aria-controls="v-pills-sea" aria-selected="false"><span><img src="images/loung_small.png" width="25" height="25" alt=""/></span>&nbsp;&nbsp; Gastroenterology</a>

              <a class="nav-link px-4" id="v-pills-fitness-tab" data-toggle="pill" href="#v-pills-fitness" role="tab" aria-controls="v-pills-fitness" aria-selected="false"><span class="mr-3 flaticon-stethoscope"></span> General</a>
          ...
          <div class="col-md-8 ftco-animate p-4 p-md-5 d-flex align-items-center">
            ...
            <div class="tab-content pl-md-5" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active py-5" id="v-pills-master" role="tabpanel" aria-labelledby="v-pills-master-tab">
                ...
                <h2 class="mb-4">Cardiology (Heart)</h2>
                ...
                <p>A cardiologist is a heart doctor. They specialize in treating heart conditions and diseases as well as helping patients manage their heart conditions as much as possible. A cardiologist will treat any symptoms of heart conditions that you have and diagnose any possible conditions.</p>
              </div>

              <div class="tab-pane fade py-5" id="v-pills-buffet" role="tabpanel" aria-labelledby="v-pills-buffet-tab">
                <span><img src="images/heart.png" width="105" height="105" alt=""/></span>
                <h2 class="mb-4">Pulmonology (Chest)</h2>
                <p>Pulmonologists are specially trained in diseases and conditions of the chest, particularly pneumonia, asthma, tuberculosis, emphysema, and complicated chest infections.</p>
                <p>The Department of TB & Chest diseases is also known as Respiratory Diseases or Pulmonary Medicines. The consultants/specialist are called chest physicians, or Respiratory Physicians or Pulmonologist. The Department deals with diseases of respiratory system (nose, throat, windpipe, lungs, chest wall etc).</p>
              </div>
              
              <div class="tab-pane fade py-5" id="v-pills-sea" role="tabpanel" aria-labelledby="v-pills-sea-tab">
                <span><img src="images/loung.png" width="105" height="105" alt=""/></span>
                <h2 class="mb-4">Gastroenterology (Abdominal)</h2>
                <p>Gastroenterology is the branch of medicine focused on the digestive system and its disorders. Diseases affecting the gastrointestinal tract, which include the organs from mouth into anus, along the alimentary canal, are the focus of this speciality. </p>
                <p>If the pain is severe or debilitating, a person may need to seek medical help immediately. Stomach pain is the most common reason for emergency room visits. When a person is unsure about what to do, it may be best to call a doctor or nurse helpline to decide the best course of action.</p>
              </div>
              ...
              <div class="tab-pane fade py-5" id="v-pills-fitness" role="tabpanel" aria-labelledby="v-pills-fitness-tab">
                ...
                <h2 class="mb-4">General Treatment</h2>
                <p>General medicine is the medical specialty dedicated to the prevention, diagnosis and treatment of adult diseases.</p>
                <p>The division of general medicine at Sumit medical dispensary includes physicians or internists whose primary role is to provide medical care. Our general medicine team’s goal is to combine the latest evidence-based medicine with thoughtful considerations of each patient’s need to foster wellness and healing.</p>
              </div>
              ...
              <div class="tab-pane fade py-5" id="v-pills-spa" role="tabpanel" aria-labelledby="v-pills-spa-tab">
                ...
                <h2 class="mb-4">Emergency Treatment</h2>
                <p>Emergency medical services, also known as ambulance services or paramedic services, are emergency services that provide urgent pre-hospital treatment and stabilisation for serious illness and injuries and transport to definitive care.</p>
                <p>It is a well-accepted fact that a patient who receives basic care from trained professionals and is transported to the nearest healthcare facility within 15-20 minutes of an emergency has the greatest chance of survival.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="ftco-section-parallax">
      <div class="parallax-img d-flex align-items-center">
        <div class="container">
          <div class="row d-flex justify-content-center" style="background-color: ">
            <div class="col-md-7 text-center heading-section heading-section-white ftco-animate" style="background-image: linear-gradient( #133592, #582C2D )">
              <h2><i class="fa  fa-map-pin"></i> Free Medicale Camp</h2>
              <div><span class="icon-calendar"><?php echo $date; ?></span><span class="icon-person"><?php echo $user; ?></span></div>
              <p><?php echo $note; ?></p>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Our Experience in Medicine`s</h2>
          </div>
        </div>
        <div class="row">
        	<div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(images/Allopathic.jpg);">
	                <div class="box">
	                  <h2>Allopathic</h2>
	                  <p>Medicine`s</p>
	                </div>
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>&ldquo;The system of medical practice which treats disease by the use of remedies which produce effects different from those produced by the disease under treatment. &rdquo;</p>
	                </blockquote>
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <div class="img" style="background-image: url(images/Allopathic.jpg);"></div>
	                  </div>
	                  <div class="name align-self-center">Allopathic <span class="position">Medicine`s</span></div>
	                </div>
	              </div>
	            </div>
	          </div> <!-- .flip-container -->
	        ...
	        <div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(images/Homopathic.jpg);">
	                <div class="box">
	                  <h2>Homeopathic</h2>
	                  <p>Medicine`s</p>
	                </div>
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>&ldquo;Homeopathy is a medical system based on the belief that the body can cure itself. Those who practice it use tiny amounts of natural substances, like plants and minerals.&rdquo;</p>
	                </blockquote>
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <div class="img" style="background-image: url(images/Homopathic.jpg);"></div>
	                  </div>
	                  <div class="name align-self-center">Homeopathic<span class="position">Medicine`s</span></div>
	                </div>
	              </div>
	            </div>
	          </div> <!-- .flip-container -->
	        ...
	        <div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(images/Ayurvedic.jpg);">
	                <div class="box">
	                  <h2>Ayurvedic</h2>
	                  <p>Medicine`s</p>
	                </div>
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>&ldquo;It was developed more than 3,000 years ago in India. It's based on the belief that health and wellness depend on a delicate balance between the mind, body, and spirit.&rdquo;</p>
	                </blockquote>
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <div class="img" style="background-image: url(images/Ayurvedic.jpg);"></div>
	                  </div>
	                  <div class="name align-self-center">Ayurvedic <span class="position">Medicine's</span></div>
	                </div>
	              </div>
	            </div>
	          </div> <!-- .flip-container -->
	        ...
	        <div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(images/Unani.jpg);">
	                <div class="box">
	                  <h2>Unanni</h2>
	                  <p>Medicine`s</p>
	                </div>
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>&ldquo;The medicine helps in collecting the disease-causing factor in the body and then it is removed from the body. The natural forces in the body are used to keep the body in a disease-free state.&rdquo;</p>
	                </blockquote>
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <div class="img" style="background-image: url(images/Unani.jpg);"></div>
	                  </div>
	                  <div class="name align-self-center">Unani <span class="position">Medicine`s</span></div>
	                </div>
	              </div>
	            </div>
	          </div> <!-- .flip-container -->
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/bg_4.jpg);">
    	<div class="container">
          ...
          <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
            ...
            <span class="subheading">---: Amazing fun facts about human body :---</span>
          </div>
        </div>
    ...
    <?php require_once("includes/testimoni.php") ?>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex">
         ...
         <?php
			require_once("includes/dbconn.php"); 
			$que="select * from blogs order by id desc limit 4";
			$d=$conn->query($que);	
          ...
          <div class='col-md-6 ftco-animate'>
            <div class='blog-entry align-self-stretch d-flex'>
              <a href='blog-single.php?id=$id' class='block-20' style='background-image: url(blog_image/".$row['user']."/".$row['image'].");'>
              </a>
              <div class='text p-4 d-block'>
              	<div class='meta mb-3'>
                  <div><a href='filter_blog.php?row=blog_date & value=".$row['blog_date']."'><span class='icon-calendar'></span>".$row['blog_date']."</a></div>
                  <div><a href='filter_blog.php?row=user & value=".$row['user']."'><span class='icon-person'></span>".$row['user']."</a></div>
                  <div><a href='filter_blog.php?row=categories & value=".$row['categories']."' class='meta-chat'><span class='icon-chat'></span>".$row['categories']."</a></div>
                </div>
                <h3 class='heading mt-3'><a href='blog-single.php?id=$id'>".$row['heading']."</a></h3>
                <p>".substr($row['contant'],0,100)."...</p>
              </div>
            </div>
          </div>";
			}
          ...
          <div class="modal-body">
            <form method="post">
              <div class="form-group">
                <label for="appointment_name" class="text-black">User Name</label>
                <input type="text" name="username" class="form-control" id="appointment_name">
              </div>
              <div class="form-group">
                <label for="appointment_email" class="text-black">Password</label>
                <input type="password" name="password" class="form-control" id="appointment_email">
              </div>
              <div class="form-group">
  ...
  <!-- BLOCK THE POP UP ASKING ON REFRESH ONCE THE FORM IS SUBMITTED -->
  <script>
...
require_once("includes/dbconn.php");
    ...
    {  
        ...
        $check_user="select * from user WHERE user_name='$admin_id' AND password='$admin_pass'";  
        ...
        {  
            ...
            $_SESSION['admin_id']=$admin_id; //here session is used and value of $user_email store in $_SESSION. 
			}
			else{
				echo "<script>window.open('dashboard_user.php','_self')</script>";  
