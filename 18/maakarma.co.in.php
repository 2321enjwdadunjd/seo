...
<body id="t" class="neterror" style="font-family: system-ui, sans-serif; font-size: 75%" jstcache="0">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      ...
      <div id="main-message" jstcache="0">
        ...
        <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1">Check if there is a typo in <span jscontent="hostName" jstcache="22">maakarma.com</span>.</p>
  ...
  <div id="sub-frame-error" jstcache="0">
    ...
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1">Check if there is a typo in <span jscontent="hostName" jstcache="22">maakarma.com</span>.</div>
  </div>
...
</script><script jstcache="0">const pageData = {"details":"Details","errorCode":"DNS_PROBE_POSSIBLE","fontfamily":"system-ui, sans-serif","fontsize":"75%","heading":{"hostName":"maakarma.com","msg":"This site can’t be reached"},"hideDetails":"Hide details","iconClass":"icon-generic","language":"en","reloadButton":{"msg":"Reload","reloadUrl":"http://maakarma.com/"},"suggestionsDetails":[],"suggestionsSummaryList":[],"summary":{"failedUrl":"http://maakarma.com/","hostName":"maakarma.com","msg":"\u003Cstrong jscontent=\"hostName\">\u003C/strong>’s \u003Cabbr id=\"dnsDefinition\">DNS address\u003C/abbr> could not be found. Diagnosing the problem."},"textdirection":"ltr","title":"maakarma.com"};loadTimeData.data = pageData;var tp = document.getElementById('t');jstProcess(new JsEvalContext(pageData), tp);</script></body></html>