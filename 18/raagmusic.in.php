...
<?php include("admin/config.php");
             ...
             include_once("admin/lib/dboperation.php");
             include_once("admin/lib/getval.php");
     ...
     <head>
         ...
         <title>Raag Music</title>
         <meta name="description" content="From our fantastic studio RAAG, in the heart of Raipur, we offer professional tuition in Guitar, Octapad ,Piano/Keyboard, and Vocals... along with Workshops, Seminars and Clinics by some of todays top performers and professionals. Our centrally located studio Raag hosts a full band/Seminar/Lecture studio, a full production recording studio. So come along with us Learn, Practice and prepare for your next step to stard.">
                 ...
                 <div class="container">
                     ...
                     <div class="row">
                         ...
                         <div class="col-sm-12 col-md-12 col-lg-12">
                             <h2 class="jumbo-heading text-center">
                                 WHO  <span class="text-primary">WE</span> ARE
                             </h2>
                         </div>
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-12 col-md-12">
                             <H3 style="text-align: center; font-style: italic">"We Work With Dedication
     & Professionally"</H3>
                             
                             <P style="text-align: justify">From our fantastic studio <strong>RAAG</strong>, in the heart of Raipur, we offer professional tuition in Guitar, Octapad ,Piano/Keyboard, and Vocals... along with Workshops, Seminars and Clinics by some of todays top performers and professionals. Our centrally located studio Raag hosts a full band/Seminar/Lecture studio, a full production recording studio. So come along with us Learn, Practice and prepare for your next step to stard.</P>
                             
                             <P>A multi-track recording studio is situated at the heart of the Chhattisgarh capital i.e. RAIPUR.</P>
                         </div>					
         ...
         <!-- STORE -->
         <div id="store" class="section bgi-cover-fixed bg-overlay-secondary" data-background="images/guitar-1245856_1920.jpg">
                 ...
                 <div class="container">
                     ...
                     <div class="row">
                         ...
                         <div class="col-sm-12 col-md-12 col-lg-12">
                             ...
                             <p class="subheading text-center text-white">We Provide The Solutions</p>
                                   ...
                                   <div class="row mt-5">
                                     ...
                                     <div class="col-sm-6 col-md-6 col-lg-3">
                                         <div class="rs-shop-box mb-3">
                                             <div class="media">
                                                 <a href="#"><img src="img/raag-the-band.jpg" alt="" class="img-fluid"></a>
                                             </div>
                                             <div class="body-text">
                                                 <h4 class="title"><a href="">RAAG THE BAND</a></h4>
                                                 
                                                 <a href="services.php" class="btn btn-primary">INFO</a>
                                             </div>
                                         </div>
                                     </div>	
                                     ...
                                     <div class="col-sm-6 col-md-6 col-lg-3">
                                         <div class="rs-shop-box mb-3">
                                             <div class="media">
                                                 <a href="#"><img src="img/raag-studio.jpg" alt="" class="img-fluid"></a>
                                             </div>
                                             <div class="body-text">
                                                 <h4 class="title"><a href="#">RAAG STUDIO</a></h4>
                                     ...
                                     <div class="col-sm-6 col-md-6 col-lg-3">
                                         <div class="rs-shop-box mb-3">
                                             <div class="media">
                                                 <a href="#"><img src="img/raag-m-a.jpg" alt="" class="img-fluid"></a>
                                             </div>
                                             <div class="body-text">
                                                 <h4 class="title"><a href="#">RAAG MUSIC ACADEMY</a></h4>
                                     ...
                                     <div class="col-sm-6 col-md-6 col-lg-3">
                                         <div class="rs-shop-box mb-3">
                                             <div class="media">
                                                 <a href="#"><img src="img/music-cafy.jpg" alt="" class="img-fluid"></a>
                                             </div>
                                             <div class="body-text">
                                                 <h4 class="title"><a href="shop-single.html">RAAG MUSIC CAFE</a></h4>
                 ...
                 <div class="container">
                     ...
                     <div class="row">
                         ...
                         <div class="col-sm-12 col-md-12 col-lg-12">
                             ...
                             <p class="subheading text-center">Play our video music here</p>
                     ...
                     <div class="row mt-3">
                         ...
                         $sql_get = mysqli_query($connection,"select * from vedio_master where 1=1 order by v_id desc limit 6");
                         ...
                         <div class="col-sm-12 col-md-4">
                             <div class="box-video">
                             <iframe width="100%" height="315" src="<?php echo $row_get['videolink'] ; ?>" title="Raag Music" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                 
                                 
                                 <div class="title"><?php echo $row_get['video_name'] ; ?></div>
                         ...
                         <?php /*?><div class="col-sm-12 col-md-4">
                             <div class="box-video">
                                 ...
                                 <iframe width="300" height="200" src="https://www.youtube.com/embed/pK3grvG9wCE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                 
                                 <div class="title">Mor Raipur - Raag Music</div>
                         ...
                         <div class="col-sm-12 col-md-4">
                             <div class="box-video">
                                 <iframe width="300" height="200" src="https://www.youtube.com/embed/1XqJS1STSHg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                 
                                 
                                 <div class="title">chiraya la - Raag Music</div>
                         ...
                         <div class="col-sm-12 col-md-4">
                             <div class="box-video">
                                 ...
                                 <iframe width="300" height="200" src="https://www.youtube.com/embed/yAen_pxsHqU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                 
                                 
                                 <div class="title">Nanda jahi - Raag Music</div>
                         ...
                         <div class="col-sm-12 col-md-4">
                             <div class="box-video">
                                 <iframe width="300" height="200" src="https://www.youtube.com/embed/UUD6_QtX8vo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                 
                                 
                                 <div class="title">JABO PIYA - Raag The Band</div>
                         ...
                         <div class="col-sm-12 col-md-4">
                             <div class="box-video">
                                 <iframe width="300" height="200" src="https://www.youtube.com/embed/lkT_zsSyg7A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                 
                                 
                                 <div class="title">Lae Dooba - Raag Music</div>
                 ...
                 <div class="container">
                     ...
                     <div class="row">
                         ...
                         <div class="col-sm-12 col-md-12 col-lg-12">
                             ...
                             <p class="subheading text-center">Latest News from us</p>
                     ...
                     <div class="row mt-3">
                        ...
                        <?php
                                         $sql_get = mysqli_query($connection,"select * from news_master where 1=1 order by news_id desc limit 3");
                                         while($row_get = mysqli_fetch_assoc($sql_get))
                                         {
                             ...
                             <div class="rs-news-1 mb-1">
                                 ...
                                 <div class="media">
                                     <a href="news-single.html">
                                         <img src="admin/uploaded/news/<?php echo $row_get['news_image'] ;?>" style="height:350px;" alt="" class="img-fluid">
                                     </a>
                                     </a>
                                 </div>
                                 <div class="body">
                                     <div class="title"><a href="admin/uploaded/news/<?php echo $row_get['news_image'] ;?>"><?php echo $row_get['news_name'] ;?></a></div>
                                     <div class="meta-date" float:left;><?php echo date('d-m-Y',strtotime($row_get['news_date']))  ;?></div>
                                     <p><?php echo substr($row_get['news_descreption'],0,20);?></p>
                                     <a href="news-single.html" class="btn btn-primary">Read More</a>
                                 </div>
