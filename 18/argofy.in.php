...
<!DOCTYPE html>
<html lang="en">
<head><meta http-equiv="Content-Type" content="text/html; charset=us-ascii"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1">

	<title>ARGOFY - Develop and Design Websites, Apps and Services in Pune.</title>
	<meta name="description" content="Website and App Design Company. Argofy is a Pune based rapidly growing company specializing in providing custom digital solutions for our customers."><!-- Bootstrap Core CSS -->
	<link href="vendor/bootstrap/css/bootstrap.css" rel="stylesheet" /><!-- Custom Fonts -->
	...
	<link href="css/grayscale.css" rel="stylesheet" /><!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries --><!-- WARNING: Respond.js doesn't work if you view the page via file:// --><!--[if lt IE 9]>
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-9344611559677152",
    enable_page_level_ads: true
  });
</script>
</head>
<body data-spy="scroll" data-target=".navbar-fixed-top" id="page-top"><!-- Navigation -->

<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
<div class="container">
<div class="navbar-header"><button class="navbar-toggle" data-target=".navbar-main-collapse" data-toggle="collapse" type="button">Menu</button><a class="navbar-brand page-scroll" href="#page-top"><span class="light">Start</span> Argofy </a></div>
...
<ul class="nav navbar-nav"><!-- Hidden li included to remove active class from about link when scrolled up past about section -->
	...
	<li><a class="page-scroll" href="#intern">Internship</a></li>
...
<h1 class="brand-heading">ARGOFY</h1>

<p class="intro-text">Grow with us</p>
</div>
</div>
</div>
</div>
...
<p>We design apps to serve your business specific needs</p>
</div>
</div>
</div>
...
<p>We build your websites which are elegant, efficient and effortless to serve your customers</p>
</div>
</div>
</div>
...
<p>Want to upgrade, maintain your product ? We do that too ...</p>
</div>
</div>
</div>
</div><br><br><br>
<H3><p style="color:red">To submit a project requirement <a href ="info.php">click here</a></s></p></h3>
</div>
</div>
</section>
<!-- About Internship -->

<section class="content-section text-center" id="intern">
<div class="row">
<div class="col-lg-8 col-lg-offset-2">
<h2>Internship</h2>

<p align="justify">We are introducing our innovative six month training and internship program to induce fresh talent into our dynamic organisation. We are looking for ardent college graduates ( or students in their final semesters ) or experienced professionals who have a specific skill set in either marketing &amp; sales or product development, but lag behind in current corporate and industry standards.</p>

<p>Excellent performance during internship may get you a full time opportunity at Argofy !!!</p>
</div>
...
<ul class="list-inline banner-social-buttons">
	<li><a class="btn btn-default btn-lg" download="Internship_Argofy.pdf" href="/documents/Internship_Argofy.pdf"><span class="network-name">Download PDF</span></a></li>
</ul>
</div>
</div>
</section>
...
<div class="col-lg-8 col-lg-offset-2">
<h2>About Us</h2><br>
<p align="justify"><b>ArgoFy</b> was founded by Reshmi Datta Chowdhury and Shehbaz Vayani in February 2017  with a vision  to revolutionize the building material space to not only make quality building available all over the country but also bring down prices to make housing affordable for all.</p>
<h4>Our businesses</h4>
<p align="justify"><b>CHARCOALBUILD</b> - At charcoalbuild we pool our resources in collaboration with our manufacturing partners to give the best building material solutions to all our customers. Apart from being cost effective and beautifully designed our products go through stringent quality checks to make them the best in their category.
    Visit our website <a href="http://www.charcoalbuild.in" target="blank">CharcoalBuild.In</a> for more details.
</p>

<p align="justify"><b>IT SERVICES</b> -  We started as an IT solutions firm, and web development is an integral part of our organization.our team expertise gives us an edge over to create optimal websites which makes your business grow bigger without the fuss!</p>
...
<section class="content-section text-center" id="whyus">
<div class="row row-padded row-bordered row-centered">
<div class="col-sm-12">
<div class="row m-b-lg">
<div class="col-sm-8 col-sm-offset-2 text-center">
...
<div class="panel panel-default panel-profile m-b-0">
<div class="panel-body text-center">
<p>Create and maintain strong interpersonal relation with your client</p>
</div>
</div>
</div>
...
<div class="panel panel-default panel-profile m-b-0">
<div class="panel-body text-center">
<p>Increased sales and clientele</p>
</div>
</div>
</div>
...
<div class="panel panel-default panel-profile m-b-0">
<div class="panel-body text-center">
<p>User retention and client interaction</p>
</div>
</div>
</div>
</div>
...
<div class="panel panel-default panel-profile m-b-0">
<div class="panel-body text-center">
<p>Easy to reward loyal customers</p>
</div>
</div>
</div>
...
<div class="panel panel-default panel-profile m-b-0">
<div class="panel-body text-center">
<p>Compete with big businesses on level playing fields</p>
</div>
</div>
</div>
...
<!-- Team Section -->
<section class="content-section text-center" id="team">
<div class="team-section">
<div class="row row-padded row-bordered row-centered">
<div class="col-sm-12">
<div class="row m-b-lg">
<div class="col-sm-8 col-sm-offset-2 text-center">
<h2 style="color:#545454">Team</h2>
</div>
</div>
...
<div class="panel panel-default panel-profile m-b-0">
<p><img alt="" src="/css/reshmi.jpg" style="width: 213px; height: 213px; float: left; margin: 60px 30px;" /></p>
...
<h3></h3>
<br><br>
<h3 style="color:#f9f9f9">Reshmi D cHOWDHURY</h3>

<p style="color:#f9f9f9">Director</p>
</div>
</div>
</div>
...
<div class="col-lg-3 m-b-lg">
<div class="panel panel-default panel-profile m-b-0">
<p><img alt="" src="/css/shehbaz_1.jpg" style="width: 213px; height: 213px; float: left; margin: 60px 30px;" /></p>
...
<h3 style="color:#f9f9f9">SHEHBAZ VAYANI</h3>
...
<div class="col-lg-3 m-b-lg">
<div class="panel panel-default panel-profile m-b-0">
<p><img alt="" src="/css/206351.jpg" style="width: 213px; height: 213px; float: left; margin: 60px 30px;" /></p>
...
<h3 style="color:#f9f9f9">HITESH VERMA</h3>

<p style="color:#f9f9f9">VP Sales and Marketing</p>
</div>
</div>
</div>
...
<div class="panel-body text-center">
<h3 style="color:#f9f9f9">SAHIL SHAH</h3>

<p style="color:#f9f9f9">Investor/Advisor</p>
</div>
</div>

<div class="col-md-3 m-b-lg"></div>
</div>
</div>
</div>
</div>
...
<p><a href="mailto:feedback@argofy.in">feedback@argofy.in</a>,<a href="mailto:support@argofy.in">support@argofy.in</a></p>

<p>+91 9789733133</p>

<ul class="list-inline banner-social-buttons">
	<li><a class="btn btn-default btn-lg" href="https://twitter.com/teamargofy"><span class="network-name">Twitter</span></a></li>
</ul>
</div>
</div>
</section>
...
<p>Copyright &copy; Argofy 2017</p>
</div>
</footer>
<!-- jQuery --><script src="vendor/jquery/jquery.js"></script><!-- Bootstrap Core JavaScript --><script src="vendor/bootstrap/js/bootstrap.min.js"></script><!-- Plugin JavaScript --><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script><!-- Google Maps API Key - Use your own API key to enable the map feature. More information on the Google Maps API can be found at https://developers.google.com/maps/ --><script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCCd0opDF_nBkBn2xn-NVehD9zFyaiVd1U&sensor=false"></script><!-- Theme JavaScript --><script src="js/custom.js"></script></body>
</html>