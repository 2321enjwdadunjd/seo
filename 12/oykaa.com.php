...
?>
<?php 
include 'db.php'; include 'ecomerce_helper/helper_class.php'; include 'pagepart/home_page_head.php';    ?>
<style>
.ec-product-inner .ec-pro-image .percentage {
  ...
  <body class="home_page">
      <?php include 'pagepart/home_page_header.php'; ?>
     ...
     <div id="wowslider-container1">
        <div class="ws_images">
			...
			<?php 
			$sno = 0;
			$check_hp = mysqli_query($con, "SELECT * FROM `hp`");
			   while($fetch_hp = mysqli_fetch_array($check_hp)){				   
			?>
			     <li>
                    <img src="<?php echo $fetch_hp['fileIbanners']; ?>" id="wows1_<?php echo $sno++; ?>" />
                </li>
			   <?php
			   }
			   $total_button = $sno;
        ...
        <div class="ws_bullets">
			...
			<?php 
			$sno = 0;
			$check_hp1 = mysqli_query($con, "SELECT * FROM `hp`");
			   while($fetch_hp1 = mysqli_fetch_array($check_hp1)){
				$sn = $sno++;
			?>
                <a href="#" title="<?php echo $sn; ?>"><span><img src="<?php echo $fetch_hp1['fileIbanners']; ?>" alt="<?php echo $sn; ?>"/><?php echo $sn; ?></span></a>
				<?php
			   }
			   ?>
            </div>
    ...
    <!--/.Carousel Wrapper-->
      ...
      <!-- Trending Item Start -->
       <?php
                   $catagory_product = mysqli_query($con, "SELECT * FROM `product_catagory` WHERE `activeIhome_page_visiblity`='Y' ORDER BY id ASC LIMIT 0,5");
					     while($data_catagory_product = mysqli_fetch_array($catagory_product)){	
					         $product_catagory = $data_catagory_product['id'];
                   
				   
if($data_catagory_product['fileIbaner_image1'] != "" && $data_catagory_product['fileIbaner_image2'] != ""){
				   ?> 
                   
                   <!------------------------------ start two image of product category baner image 1 and 2 ------------------------>
                   
          <!-- ec Banner Section Start -->
      <section class="ec-banner section mt-3 section-space-p-2">
         <h2 class="d-none">Banner</h2>
         <div class="container">
            <div class="row">
               <div class="ec-banner-bottom">
                  <div class="ec-banner-inner">
                      <a href="https://www.oykaa.com/shop.php?id=<?php echo $product_catagory; ?>">
                     <div class="ec-banner-block ec-banner-block-4 mar-b-30">
                        <div class="banner-block">
                           <img style="width:100%; height:auto;" src="<?php echo $data_catagory_product['fileIbaner_image1']; ?>" alt="">
                     ...
                     <div class="ec-banner-block ec-banner-block-5">
                        <div class="banner-block">
                           <img style="width:100%; height:auto;" src="<?php echo $data_catagory_product['fileIbaner_image2']; ?>" alt="">
                           <div class="banner-content">
...
?>	
                    <!------------------------------ end two image of product category baner image 1 and 2 ------------------------>
      ...
      <section class="section ec-trend-product section-space-p">
         <div class="container">
            <div class="row">
               <div class="col-md-12 text-center">
                  <div class="section-title">
                    <a href="#" ><h2 class="ec-title"><?php echo $data_catagory_product['textIname']; ?></h2></a> <?php // https://www.oykaa.com/shop.php?id=<?php echo $product_catagory; ?>
                  </div>
               </div>
            </div>
            <div class="row">
               ...
               <!--</div> -->
               <?php 
               $check_product = mysqli_query($con, "SELECT * FROM `product` WHERE `selectIproduct_catagory`='$product_catagory' ORDER BY id ASC LIMIT 0,8");
               	while($row_product = mysqli_fetch_array($check_product)){
							
							
							?>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content col-6">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product_details.php?id=<?php echo $row_product['id']; ?>" class="image">
                                                     <?php
                                               if ($row_product['fileIimage'] != ""){ 
                                
                                    echo ' <img  class="main-image" src="'.$row_product['fileIimage'].'" alt="Product">';
                                    
                                }else{
                                    echo  ' <img  class="main-image" src="No_image_available.svg.png" alt="Product">';
                                }
                                
                                 if ($row_product['fileIimage_1'] != ""){ 
                                
                                    echo ' <img  class="hover-image" src="'.$row_product['fileIimage_1'].'" alt="Product">';
                                            ...
                                            ?>    
                                                ...
                                                <?php 
                                                if ($row_product['numberIpercent'] != "" && $row_product['numberIpercent'] >= 1){
                                                ?>
                                                <span class="percentage"><?php echo $row_product['numberIpercent']."% Off"; ?></span>
                                                <?php
                                                }
                                                ?>
                                                
                                                <div class="ec-pro-actions">
                                                    <!--<a href="compare.php" class="ec-btn-group compare" title="Compare"><img src="assets/images/icons/compare.svg" class="svg_img pro_svg" alt=""></a>-->
                                                    
													<button title="Add To Cart" id="<?php echo $row_product['id']; ?>" onclick="add_to_cart(this.id)" class="ec-btn-group compare add-to-cart"><img src="assets/images/icons/cart.svg" class="svg_img pro_svg" alt=""> </button>
                                                    <a class="ec-btn-group wishlist" title="Wishlist" id="<?php echo $row_product['id']; ?>" onclick="add_to_wish(this.id)"><img src="assets/images/icons/wishlist.svg" class="svg_img pro_svg" alt=""></a>
                                                     <a href="product_details.php?id=<?php echo $row_product['id']; ?>" class="ec-btn-group quick-view"   title="Quick view" ><img src="assets/images/icons/quickview.svg" class="svg_img pro_svg" alt=""></a>
                                                
                                                </div>
                                            </div>
                                        </div>
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product_details.php?id=<?php echo $row_product['id']; ?>"><?php if($row_product['textIname'] != ""){ echo substr($row_product['textIname'],0,25)."..."; }else{ echo "Unavailable";} ?></a></h5>
                                            <div class="ec-pro-rating">
                                            
                                                 <?php
							  
							  if( $row_product['selectIrating_options'] == "0" ){
								  echo ' <i class="ecicon eci-star"></i>';
								  echo ' <i class="ecicon eci-star"></i>';
								  echo ' <i class="ecicon eci-star"></i>';
								  echo ' <i class="ecicon eci-star"></i>';
								  echo ' <i class="ecicon eci-star"></i>';
							  }else if ($row_product['selectIrating_options'] == "1"){
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star"></i>';
								  echo ' <i class="ecicon eci-star"></i>';
								  echo ' <i class="ecicon eci-star"></i>';
								  echo ' <i class="ecicon eci-star"></i>';
							  }else if ($row_product['selectIrating_options'] == "2"){
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star"></i>';
								  echo ' <i class="ecicon eci-star"></i>';
							  ...
							  }else if ($row_product['selectIrating_options'] == "3"){
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star"></i>';
							  ...
							  }else if ($row_product['selectIrating_options'] == "4"){
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star"></i>';
							  }else if ($row_product['selectIrating_options'] == "5"){
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star fill"></i>';
								  echo ' <i class="ecicon eci-star fill"></i>';
							  ...
							  ?>
                                            ...
                                            <div class="ec-pro-list-desc"><?php echo substr($row_product['textIshort_details'],0,25); ?></div>
                                            <span class="ec-price">
                                                <span class="old-price"><?php if($row_product['numberIold_price'] != ""){ echo " Rs.".number_format((float)$row_product['numberIold_price'], 2, '.', ''); }else{ echo ""; } ?></span>
                                                <span class="new-price"><?php if($row_product['numberInew_price'] != ""){ echo " Rs.".number_format((float)$row_product['numberInew_price'], 2, '.', ''); }else{ echo ""; } ?></span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
			...
			<div class="row">
               <div class="col-md-12 text-center">
			<center><a class="btn btn-success"  href="shop.php?id=<?php echo $product_catagory; ?>">More Products...</a></center>
			   </div>
			</div>
         </div>
      </section>
	  <?php 
	  if ($data_catagory_product['fileIbaner_image3'] != ""){
		  
		  ?>
         <!----------------------------- footer of the section  baner image 3   ffrom db------------------->
        <section class="section ec-offer-section section-space-mt section-space-mb">
         <h2 class="d-none">Offer</h2>
         <img style="width:100%; height: auto;" src="<?php  echo $data_catagory_product['fileIbaner_image3']; ?>" alt="" class="offer_bg">
         ...
         <!----------------------------- end of footer of the section  baner image 3   ffrom db------------------->
      <?php
						 }else{ echo "";}	     }
					     ?>
...
<!------------------------------------------------------------------ these code will be received from db --------------------------
                        ...
                        <div class="ec-subscribe-form">
                           <form id="ec-newsletter-form" name="ec-newsletter-form" method="post" action="#">
                              <div id="ec_news_signup" class="ec-form">
                                 ...
                                 <button id="ec-news-btn" class="button btn-secondary" type="submit" name="subscribe" value="">Subscribe</button>
                              </div>
                           </form>
                        </div>
                     </div>
                  ...
                  <div class="row">
                        ...
                        <div class="ec-footer-widget">
                           ...
                           <div class="ec-footer-links">
                              <ul class="align-items-center">
                                <!-- <li class="ec-footer-link"><span><i class="ecicon eci-map-marker"></i></span>B-30 Bharat Vihar, Street No. 17, Delhi, Delhi - 110059, India
                                 </li>
                                 <li class="ec-footer-link"><span><i class="ecicon eci-phone"></i></span><a href="tel:+919716116965">+91 9716116965</a></li>
                                
                                 <li class="ec-footer-link"><span><i class="ecicon eci-envelope"></i></span><a href="mailto:yadav1@gmail.com">yadav1@gmail.com</a></li>-->
								 <?php
								 footer_contact_list("site_setting");   /// put value into product_cart page    tablename , user_id
									echo footer_contact_list_site_setting;     /// show all cart added product in cart page      show_$table_$user_table
								?>
                        ...
                        <div class="ec-footer-widget"> 
                           ...
                           <div class="ec-footer-links">
                              <ul class="align-items-center">
                                 ...
                                 <li class="ec-footer-link"><a href="#">Terms & conditions</a>
                                 </li>
                                 <li class="ec-footer-link"><a href="#">Contact us</a></li>-->
								 <?php
								    footer_menu_list("main_menu", "10");   /// put value into product_cart page    tablename , user_id
									echo footer_menu_list_main_menu_10;     /// show all cart added product in cart page      show_$table_$user_table
									?>
                              </ul>
                           </div>
                        </div>
                        ...
                        <div class="ec-footer-widget">
                           ...
                           <div class="ec-footer-links">
                              <ul class="align-items-center">
                                 ...
                                 <li class="ec-footer-link"><a href="cart.php">Cart</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
                     <div class="col-sm-12 col-lg-3 ec-footer-service">
                        <div class="ec-footer-widget">
                           ...
                           <div class="ec-footer-links">
                              <ul class="align-items-center">
                                 <li class="ec-footer-link"><a href="tearms_condition.php">Terms & conditions</a>
                                 </li>
                                 <li class="ec-footer-link"><a href="privacy_policy.php">Privacy policy</a></li>
                                 <li class="ec-footer-link"><a href="shipping_policy.php">Shipping Policy</a></li>
                                 <li class="ec-footer-link"><a href="return_policy.php">Return Policy</a></li>
                                 <li class="ec-footer-link"><a href="faq.php">FAQ</a></li>
								 <li class="ec-footer-link"><a href="blog.php">Our Blog</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
                     <div class="col-sm-12 ec-footer-social">
                        <div class="ec-footer-widget">
                           ...
                           <div class="ec-footer-links">
                              <ul class="align-items-center">
                                 <li class="ec-footer-link"><a href="https://www.facebook.com/OYKKA-112167224841130">facebook</a></li>
                                 <li class="ec-footer-link"><a href="https://twitter.com/OYKKA2">twitter</a></li>
                                 <li class="ec-footer-link"><a href="https://www.linkedin.com/company/oykka">linkedin</a></li>
                                 <li class="ec-footer-link"><a href="https://www.instagram.com/oykaa4/">Instagram</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col footer-copy">
                        <div class="footer-bottom-copy ">
                           <div class="ec-copy">© 2021 Oykaa All Rights
                              Reserved. Design by <a class="site-name" href="https://www.digienter.com/" target="_balank">Digienter</a>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-md-5 col-sm-12 col-xs-12">
                        ...
                        <div class="qty-product-cover">
                           <div class="qty-slide">
                              <img class="img-responsive" src="assets/images/product-image/2_1.jpg" alt="">
                           </div>
                           <div class="qty-slide">
                              <img class="img-responsive" src="assets/images/product-image/2_2.jpg" alt="">
                           </div>
                           <div class="qty-slide">
                              <img class="img-responsive" src="assets/images/product-image/2_3.jpg" alt="">
                           </div>
                           <div class="qty-slide">
                              <img class="img-responsive" src="assets/images/product-image/2_2.jpg" alt="">
                           </div>
                     ...
                     <div class="col-md-7 col-sm-12 col-xs-12">
                        <div class="quickview-pro-content">
                           <h5 class="ec-quick-title"><a href="#">Trainers GYM Backpack</a></h5>
                           ...
                           <div class="ec-quickview-qty">
                              ...
                              <div class="ec-quickview-cart ">
                                 <button class="btn btn-primary"><img src="assets/images/icons/pro_cart.svg" class="svg_img pro_svg" alt=""> </button>
                              </div>
                           </div>
                        </div>
                     </div>
      ...
      <div class="ec-chat animate__animated animate__fadeOutRight">
         ...
         <div class="row ec-setuser">
            ...
            <div class="col-md-12 p-0">
               <select class="ec-form form-control select2_el select2-hidden-accessible userreson" data-select2-id="1" tabindex="-1" aria-hidden="true">
         ...
         <div class="ec-reply">
            <input class="usermsg" type="text" placeholder="Type a message..." disabled=""><button class="send">Send</button>
         </div>
      </div>
