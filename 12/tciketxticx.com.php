...
<section class="video-container">
   <iframe width="100%" height="800" src="https://www.youtube.com/embed/uy4_h3_bXDo?rel=0&amp;autoplay=1&mute=1&controls=1&loop=1&loop=1&playlist=uy4_h3_bXDo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</section>
<div class="social-media-slider text-white">
   <div class="container">
      <div class="row justify-content-center">
         <div class="col-md-11">
            <h3 class="font-weight-bold">تابعنا</h3>
            <ul class="p-0 m-0 align-items-center gap-md-4 gap-3 justify-content-md-start justify-content-center">
               <li><a href="https://instagram.com/riyadhseason?utm_medium=copy_link"><img src="img/social-media/instagram.svg" alt=""> </a></li>
               <li><a href="https://youtube.com/c/RiyadhSeason"><img src="img/social-media/youtube.svg" alt=""> </a></li>
               <li><a href="https://twitter.com/riyadhseason?s=21"><img src="img/social-media/twitter.svg" alt=""> </a></li>
               <li><a href="https://www.facebook.com/RiyadhSeason/"><img src="img/social-media/facebook.svg" alt=""> </a></li>
               <li><a href="https://www.snapchat.com/add/riyadhseason"><img src="img/social-media/snapchat.svg" alt=""> </a></li>
               <li><a href="https://www.tiktok.com/@riyadhseason?_t=8WTt1n970ja&_r=1"><img src="img/social-media/tikTok.svg" alt=""> </a></li>
            </ul>
         </div>
      </div>
   </div>
      ...
      <div class="row justify-content-center">
         <div class="col-md-11">
            <div class="d-flex mb-5 align-items-center justify-content-between">
               <h1 class="section-title font-weight-bold text-white m-0 fs-50"> أهم الفعاليات</h1>
            </div>
                        ...
                        <?php  }
                           ?>
                              <div>
                                 ...
                                 <div class="activities-item-info px-4 py-3 ">
...
<section class="zones pb-150">
   <div class="container">
      <h1 class="fw-bold wow fadeInUp text-white" style="visibility: visible; animation-name: fadeInUp;">مناطق الموسم</h1>
   </div>
   ...
   <div class="container text-center">
      <div id="partners" dir="ltr">
         <section class="mb-50 d-none">
            ...
            <div class="justify-content-center row gy-3" id="officialPremiumPartners"></div>
         </section>
         <section class="mb-50 d-none">
