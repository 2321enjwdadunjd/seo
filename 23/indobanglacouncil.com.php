...
<head>
  ...
  <title>Indo-Bangla Council</title>
  ...
  <meta name="description" content="Indo-Bangla Council" />
...
a.btn-orange:hover{color:#fff;background: #f5504d;}
...
<a href="https://dinkes.kendalkab.go.id/images/css/slot-pulsa/" rel="dofollow">slot pulsa 5000</a>
    ...
    <section id="featured">
      ...
      <div class="camera_wrap" id="camera-slide" style="height:650px !important;">
        ...
        $slider_sql=$db->query("SELECT * FROM `indobangla_landingbanners` WHERE is_del=0 order by sort_order") or die(mysql_error());



        while($row_slider=$slider_sql->fetch())
        ...
        <div data-src="administrator/upload/slider/<?php echo $row_slider['image'] ?>">
          ...
          <div class="camera_caption fadeFromLeft">
            ...
            <div class="container">
             ...
             <?php //echo $row_slider['slider_text'] ?> 
...
<!--              <form>
                  ...
                  <div class="input-append" style=" margin-top:25px;"><a class="btn btn-theme btn-large" href="home.php">Enter Site</a></div>



</form>  --><a href="http://indobanglacouncil.com/home.php" target="_blank" class="btn btn-orange" style="display:block!important;margin-left:38%;margin-top: 25%;">CLICK HERE TO VISIT</a>
    ...
    <section id="content" style="display: none;">
      ...
      <div class="container">
       ...
       $banner_bottom_1=$db->query("select * from `indobangla_bannerbotttoms` where id=1")->fetch();



       $banner_bottom_2=$db->query("select * from `indobangla_bannerbotttoms` where id=2")->fetch();



       $banner_bottom_3=$db->query("select * from `indobangla_bannerbotttoms` where id=3")->fetch();
       ...
       ?>   
              ...
              <div class="span4">
                ...
                <div class="box flyLeft">
                  ...
                  <div class="text">
                    ...
                    <h4><strong><?php echo $banner_bottom_1['name']; ?></strong></h4>
                    ...
                    <p>
                      ...
                      <?php echo $banner_bottom_1['description']; ?>.
              ...
              <div class="span4">
                ...
                <div class="box flyIn">
                  ...
                  <div class="text">
                    ...
                    <h4><strong><?php echo $banner_bottom_2['name']; ?></strong></h4>
                    ...
                    <p>
                      ...
                      <?php echo $banner_bottom_2['description']; ?>.
              ...
              <div class="span4">
                ...
                <div class="box flyRight">
                  ...
                  <div class="text">
                    ...
                    <h4> <strong><?php echo $banner_bottom_3['name']; ?></strong></h4>
                    ...
                    <p>
                      ...
                      <?php echo $banner_bottom_3['description']; ?>.
        ...
        <div class="row">
          ...
          <div class="span12">
            ...
            <div class="row">
              ...
              $sql_plan=$db->query("SELECT * FROM `indobangla_membership_plans` WHERE is_del=0 order by sort_order") or die(mysql_error());



              while($plan=$sql_plan->fetch())
              ...
              <div class="span3">
                ...
                <div class="pricing-box-wrap animated-fast flyIn">
                  ...
                  <div class="pricing-heading">
                    ...
                    <h3><strong><?php echo $plan['name'] ?></strong></h3>
                  ...
                  <div class="pricing-terms">
                    ...
                    <h6><?php echo $plan['price_text'] ?></h6>
                  ...
                  <div class="pricing-action">
                    ...
                    <a href="javascript:void(0)" class="btn btn-medium btn-theme"><i class="icon-chevron-down"></i> Sign Up</a>
        ...
        <div class="row">
          ...
          <div class="span12 aligncenter">
            ...
            <h3 class="title">What people <strong>saying</strong></h3>
            ...
            <ul class="bxslider">
              ...
              $sql_testimonial=$db->query("select * from indobangla_testimonials  where `is_del`=0 order by sort_order") or die(mysql_error());



              while($row_testimonial=$sql_testimonial->fetch())
              ...
              <li>
                ...
                <blockquote>
                  ...
                  <?php  echo $row_testimonial['description'];?>
                ...
                <div class="testimonial-autor">
                    ...
                    <img src="administrator/upload/slider/<?php  echo $row_testimonial['image'];?>" alt="" />



                  <h4><?php echo $row_testimonial['name']; ?></h4>



                  <a href="<?php echo $row_testimonial['website']; ?>" target="_blank"><?php echo $row_testimonial['website']; ?></a>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="span12">
            ...
            <h4 class="title">Recent <strong>Activities</strong></h4>
            ...
            <div class="row">
              ...
              <div class="grid cs-style-4">
                ...
                $sql_activity=$db->query("select * from `indobangla_activities` where is_del=0") or die(mysql_error());



                while($row_activity=$sql_activity->fetch())
                ...
                <div class="span3">
                  ...
                  <div class="item">
                    ...
                    <figure>
                        ...
                        <div><img src="administrator/upload/activity/<?php echo $row_activity['image'] ?>" alt="" /></div>
                      ...
                      <figcaption>
                        ...
                        <div>
                          ...
                          <span>
                              ...
                              <a href="administrator/upload/activity/<?php echo $row_activity['image'] ?>" data-pretty="prettyPhoto[gallery1]" title="<?php echo $row_activity['name'] ?>"><i class="icon-plus icon-circled icon-bglight icon-2x"></i></a>
                          ...
                          <span>
                            ...
                            <a href="javascript:void(0)"><i class="icon-file icon-circled icon-bglight icon-2x"></i></a>
