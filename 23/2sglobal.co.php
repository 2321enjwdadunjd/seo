...
<script type="text/javascript"> 
    ...
    if (isMobile) { location.href="index_mob.php"; } else { } 
</script>
...
<title>2S Global Technologies Limited</title>
...
<section class="banner">
  <div data-ride="carousel" class="carousel slide carousel-fade" id="carousel-example-captions">
    <div role="listbox" class="carousel-inner">
      <?php $res22=$db->query("SELECT * FROM `skilltech_banners` WHERE 1 order By `list_order` ASC");
	  $tot=$res22->rowCount();$k=0;while($row22=$res22->fetch()){?>
      <div class="item <?php if($k==0){?>active<?php } ?>"><img src="upload/banner/<?php  echo stripslashes($row22['image']);?>" alt=""></div>
      <?php $k++;} ?>
      <div class="carousel-caption"> <a href="cms.php?id=40" class="btn hvr-bounce-to-right" style="width:195px;"><b>Corporate</b><span>Consultancy Services</span></a> <a href="cms.php?id=36" class="btn hvr-bounce-to-right" style="width:195px;"><b>Skills</b><span>Corporate Skilling</span></a> <a href="cms.php?id=24" class="btn hvr-bounce-to-right" style="width:195px;"><b>Process</b><span>Simplification & Automation</span></a> <a href="cms.php?id=21" class="btn hvr-bounce-to-right" style="width:195px;"><b>E-Content</b><span>E-Learning & E-Teaching</span></a> </div>
    </div>
    <a data-slide="prev" role="button" href="#carousel-example-captions" class="left carousel-control"> <span aria-hidden="true" class="glyphicon glyphicon-chevron-left"></span> <span class="sr-only">Previous</span></a> <a data-slide="next" role="button" href="#carousel-example-captions" class="right carousel-control"> <span aria-hidden="true" class="glyphicon glyphicon-chevron-right"></span> <span class="sr-only">Next</span> </a> </div>
</section>
        ...
        <div class="welcome-wrapper">
          <div class="row">
            <div class="col-md-6 col-sm-6">
              <div class="welcome-image"><img src="images/welcome.jpg" alt="" class="img-responsive"></div>
            </div>
            <div class="col-md-6 col-sm-6 text-center">
              <!--<h2>Welcome to</h2>								
			  <h3>2S Global Technologies Limited</h3>-->
              <h2><strong>Vision</strong> </h2>
              <p>Human Skilling using Technology and Technical Solutions using Human Skills. </p>
              <h2><strong>Mission</strong></h2>
              <p>Enhancement of Human skills  using various Technical aids and processes  &  increase employability among the  youths  and to provide Technological solutions to industries  using skilled manpower in a different manner which will increase system output in a significant way.</p>
              <p><a href="who_we_are.php" class="know">Know More</a></p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <!--<p class="text-center" style="color:#7f7e7e">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut<br> labore et dolore magna aliqua. Ut enim ad minim veniam aliquip</p>-->
        <ul class="bxslider2">
          <?php $res22=$db->query("SELECT * FROM `skilltech_products` WHERE 1 order By `list_order` ASC");$tot=$res22->rowCount();$k=0;while($row22=$res22->fetch()){?>
          <li>
            <div class="prod-image"> 
			<?php /*?><a href="product_details.php?id=<?php  echo stripslashes($row22['id']);?>"><?php */?>
			<a href="javascript:void(0);">
			<img src="upload/products/<?php  echo stripslashes($row22['image']);?>" alt="" style="padding:5%; height:147px;"> 
			</a> </div>
            <p class="prod-name" style="min-height:50px; font-size:13px; font-weight:bold; text-align:center">
<div style="display:none">
<a href="https://www.ucami.edu.ar/">slot88</a>
<a href="https://www.ucami.edu.ar/">sundajp</a>
<a href="https://www.ucami.edu.ar/">aktif4d</a>
<a href="https://logingila138.com/">gila138</a>
</div>
              <?php  echo stripslashes($row22['name']);?>
            </p>
          </li>
          <?php $k++;} ?>
        </ul>
...
<div style="display:none">
<a href="https://lp3m.unimus.ac.id/css/pic/site/situs-togel/" rel="dofollow">situs toto</a>
<a href="https://lp3m.unimus.ac.id/css/pic/site/situs-togel/" rel="dofollow">toto togel</a>
<a href="https://lp3m.unimus.ac.id/css/pic/site/situs-togel/" rel="dofollow">slot toto</a>
<a href="https://lp3m.unimus.ac.id/css/pic/site/situs-togel/" rel="dofollow">togel terpercaya</a>
<a href="https://lp3m.unimus.ac.id/css/pic/site/situs-togel/" rel="dofollow">bandar togel online</a>
</div>
<section class="latest-section">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <!--<p class="text-center" style="color:#7f7e7e">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut<br> labore et dolore magna aliqua. Ut enim ad minim veniam aliquip</p>-->
        <ul class="bxslider2">
             <?php $res22=$db->query("SELECT * FROM `skilltech_clients` WHERE 1 order By `list_order` ASC");
		  $tot=$res22->rowCount();
		  $k=0;
		  while($row22=$res22->fetch()){?>
          <li>
            <div class="prod-image"> 
			<?php /*?><a href="product_details.php?id=<?php  echo stripslashes($row22['id']);?>"><?php */?>
			<a href="javascript:void(0);">
			<img src="upload/clients/<?php  echo stripslashes($row22['image']);?>" alt="" style="padding:5%; height:147px;"> 
			</a> </div>
            <p class="prod-name" style="min-height:50px; font-size:13px; font-weight:bold; text-align:center">
              <?php  echo stripslashes($row22['name']);?>
            </p>
...
<section class="find-us">
  <div class="container">
    <div class="row">
      <div class="col-md-5 col-md-offset-1 col-sm-5 col-xs-1">
        <div class="hand"> <!--<img src="images/hand.png" alt=""> --></div>
      </div>
      <div class="col-md-6 col-sm-7 col-xs-10">
        <div class="find-content">
          <h2>Find Us On</h2>
          <p>2sglobal is launching on Google Play. Please stay connected with us.

</p>
          <div class="find-image"> <span><img src="images/google-play.png" alt="" class="img-responsive"></span> 
<!--              <span><img src="images/app-store.png" alt="" class="img-responsive"></span> -->
          </div>
        </div>
      </div>
    </div>
...
<style>
    ...
    .latest-section .bx-wrapper .bx-next{
...
<div style="display:none;">
<a href="http://slot-gacor.proposals.jll.com/">slot gacor 2023</a>
<a href="http://slot-gacor-2023.dpmptsp.biakkab.go.id/">slot gacor</a>
<a href="http://slot5000.dpmptsp.biakkab.go.id/">slot5000</a>
</div>
...
<div style="display:none">
<a href="https://utkarsheducation.co.in/" rel="dofollow">gemilang77</a>
<a href="https://hupelita.com/" rel="dofollow">gemilang 77</a>
<a href="https://situsgemilang77.powerappsportals.com/" rel="dofollow">gemilang77 slot</a>
<a href="https://mir2.club/" rel="dofollow">gemilang77 login</a>
<a href="https://heylink.me/linkgemilang77" rel="dofollow">gemilang77 alternatif</a>
</div>
</body>
</html>
