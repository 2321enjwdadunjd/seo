...
?>
<?php include "admin/connect_to_mysql.php"; ?>
<!DOCTYPE html>
<html lang="en">
<!-- head start -->
<head>
...
<body>
    ...
    <!-- Modal -->
    <?php include ("include/mobile-nav.php"); ?>
        ...
        <div class="hero-slider hero-slider-two">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <!-- swiper-slide start -->
                    <div class="hero-slide-item slider-height1 swiper-slide animate-style1 slide-bg3">
                    ...
                    <!-- swiper-slide start -->
                    <div class="hero-slide-item slider-height1 swiper-slide animate-style2 slide-bg4">
	...
	<?php 
					      ...
					      $result2="select * from m_topic";
						  
							$result3=mysqli_query($conn,$result2);
							
                           while($rowadd1=mysqli_fetch_array($result3))
							{
							 
							  $mainid=$rowadd1["mtid"];
							  $maint=$rowadd1["mtitle"];
							  
							?>

    <section class="new-arrival-carousel-section section-mb">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2 class="title"><?php echo $maint; ?></h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="new-arrival-carousel">
                        <div class="swiper-container">
							...
							<?php 
					      $resultgp="select * from spart where mtid=$mainid ORDER BY spid DESC limit 10";
							$resultgp=mysqli_query($conn,$resultgp);
                           while($rowaddgp=mysqli_fetch_array($resultgp))
							{
							  $spidc=$rowaddgp["spid"];
							  $mtidc=$rowaddgp["mtid"];
							  $sptitlec=$rowaddgp["sptitle"];
							  $pdesc=$rowaddgp["description"];
							  $pimg=$rowaddgp["imagename"];
							  ?>
                                <!-- swiper-slide start -->
                                    ...
                                    <div class="product-card-list">
                                        ...
                                        <div class="product-card">
                                            ...
                                            <div class="product-thumb-nail">
                                                <a href="offers-detail.php?spid=<?php echo $spidc; ?>">
                                                    <img class="product-image" src="admin/upload/coupon/<?php echo $pimg; ?>" alt="<?php echo $sptitlec; ?>" />
                                                </a>
                                               
                                            </div>
                                            <div class="product-content">
                                                
                                                <h3 class="product-title"><a href="offers-detail.php?spid=<?php echo $spidc; ?>"><?php echo $sptitlec; ?></a></h3>
                                                
                                                <div class="product-cart-btn-wrap">
                                                    <a href="offers-detail.php?spid=<?php echo $spidc; ?>"><button class="btn btn-dark add-to-cart-btn">Offer Details</button></a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- product-card end -->
    ...
    <div class="main-banner-section section-mt section-mb">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <a href="shop-grid-4-column.html" class="banner-box-animation">
    ...
    <div class="brand-carousel-section section-mt section-mb">
        <div class="container">
            <div class="row">
                <div class="col-12">
