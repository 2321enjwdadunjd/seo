...
?>
<?php
   require_once("u360643164_fatpos/config/connection.php");
   ?>
<!DOCTYPE html>
<html lang="en">
   <head>
      ...
      <meta name="google-site-verification" content="D3RcLwDMPpT7Jq9sukRDvpCDOBOZ38n3L8fONgL6qcc" />
      <meta name="keywords" content="market research, market research analyst, market research reports, industry analysis, syndicated research reports, business consultancy, consulting services,  syndicated research reports, market opportunity analysis, global industry analysis, Investment Research, Procurement research, global market research company, global market research reports, Market Trends">
      <meta name="description" content="Fatpos Global™ is an emerging market research company that delivers high-quality management consulting advice and market research services to its clients.">
      
     <title>Fatpos Global™| Management & Research Report Consulting Firm</title>
      <?php include("include/header_links.php"); ?>
   </head>
   <body class="version-drak home-page">
      <?php include("include/header.php"); ?>      
      <?php include("include/carousel.php"); ?> 
       <?php include("include/mobilecarousel.php"); ?>
      <div class="position-relative" style="overflow: hidden;">
         <div class="p-img1">
            <img src="img/circle.png" class="rotate">
         </div>
         <?php include("include/offerings.php"); ?> 
         <?php include("include/why_choose_us.php"); ?>
      </div>
     
      <section class="section-wrapper solution-clients">
        <div class="container">
            <div class="row">
                <?php
                $query1 = "SELECT COUNT(id) as rcount From `com_pressrelease` ORDER BY id ASC";
                $rrun = mysqli_query($conn, $query1);
                $rdata = mysqli_fetch_array($rrun);
                ?>
                <div class="col-lg-12 col-md-12 col-sm-12 grid2">
                    <div class="row">
                        <div class="col-6 col-xs-6 col-sm-3 col-md-3">
                            <h3><?= $rdata['rcount']; ?><span>+</span></h3>
                            <p>Reports</p>
                        </div>
                        <div class="col-6 col-xs-6 col-sm-3 col-md-3">
                            <h3>50<span>+</span></h3>
      ...
      <?php include("include/focue_industries.php"); ?>
     
      <?php include("include/trending_reports.php"); ?>
        <?php include('industry_snippet/client_snip.php'); ?>
      <?php include("include/featured_news_and_insights.php"); ?>
      <?php include("include/Expertise.php"); ?>
      <?php include("include/footer.php");  ?>
      <?php include("include/footer_links.php"); ?>
      
      <script>
        var input = document.querySelector("#CallToUsPhone");
       ...
       // $("table").addClass("table table-striped");
        ...
        $("#captcha-label").val(code);
        $("#captcha_code_hidden").val(code);
        $("#validation-error").html('');
        $("#validate-submit").click(function(event){
            $("#validation-error").html("");
            var captcha_code_hidden = $("#captcha_code_hidden").val();
            var captcha_code = $("#captcha_code").val();
            console.log("captcha_code_hidden======", captcha_code_hidden);
            console.log("captcha_code======", captcha_code);
            if(captcha_code_hidden == captcha_code){
               // $( "#sample-form-submit" ).submit();
                return true;
            } else {
                $("#validation-error").html("<span style='color:red'>The Validation code does not match!</span>");
                return false;
            }
         ...
         $(document).ready(function () {
                 ...
                 $(".call-to-action a").click(function(){
                  ...
                  var description = $(this).attr('data-description');
                   $("#BackdropLabel span.title").html(title);
                   $("#BackdropLabel span.description").html(description);
                   $(".call-to-action-modal input.description").val(description);
                    $(".call-to-action-modal input.title").val(title);
                });
                 

           $("#trending_slider_2").owlCarousel({
             items: 4,
             itemsDesktop: [1199, 4],
             nav: false,
           dots: true,
      ...
      <script>
         function myFunction(imgs) {
            ...
            if(imgs.alt == 'Healthcare & Pharmaceuticals'){
               document.getElementById("imgHref").href="industry/healthcare";
            } else if(imgs.alt == 'Aerospace & Defence'){
               document.getElementById("imgHref").href="industry/aerospace-defense";
            } else if(imgs.alt == 'Chemicals'){
               document.getElementById("imgHref").href="industry/chemicals";
            } else if(imgs.alt == 'Automotive'){
               document.getElementById("imgHref").href="industry/automotive";
            } else {
               document.getElementById("imgHref").href="industry/information-communication-technology-ict";
            }
...
<script type="text/javascript" id="hs-script-loader" async defer src="//js-na1.hs-scripts.com/23164240.js"></script>
