...
<html lang="en">
  ...
  <title>The Indian Conclave</title>
...
<header class="navigation">
	<?php include 'includes/upper_header.php';?>
...
<div class="main-wrapper ">
			    	...
			    	<video autoplay loop muted style='width: 100%' playsinline>
	...
	<div class="container">
		<div class="row">
		    <div class="col-lg-6" style="display: flex; align-items: center; justify-content:center">
		            <iframe width="100%" height="400px" src="https://www.youtube.com/embed/4tLDbUmckw4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		    </div>
		    <div class="col-lg-6">
			<!--<div class="col-lg-8 offset-lg-6 offset-md-0">-->
				<div class="about-item ">
					<h2 class="mt-3 mb-4 position-relative content-title">What is The Indian Conclave ?</h2>
					<div class="about-content">
						<p class="mb-4" align='justify'>The Indian Conclave is an organization with aspirations to promote youth leadership who focuses on serving the larger cause of humanity by imparting intellectual knowledge and organizational skills. We are a first of its kind organization in India which works with the institutions in providing them right source of guidance and trains them in leadership in hosting events which promotes youth leadership and right form of nation building.<br><br>
						<a href="about_us.php" class="btn btn-main btn-round-full">Know More About Us</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-7 ">
				<div class="section-title">
					<span class="h6 text-color">Buzz regarding TIC?</span>
					<h2 class="mt-3 content-title">Check out what others have to say about us..</h2>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row testimonial-wrap">
		    ...
		    <?php
	              ...
	              $sql = "SELECT * FROM testimonial ORDER BY timestamp DESC";
			...
			echo "<div class='testimonial-item position-relative'>
				...
				<div class='testimonial-item-content'>
					<p class='testimonial-text'>".$row['testimonial']."</p>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					<span class="h6 text-color">Latest Articles</span>
		...
		<div class="row justify-content-center">
		    <?php
                  error_reporting(E_ALL ^ E_WARNING);
	              include 'includes/dbcon.php';
	              $sql = "SELECT * FROM blog ORDER BY date DESC LIMIT 2";
	              $result = mysqli_query($conn, $sql);
                  while($row = mysqli_fetch_array($result))
	              {
	                $sql2 = "SELECT COUNT(*) FROM comments WHERE blog_id='".$row['blog_id']."'";
        			...
        			echo "<div class='col-lg-6 col-md-6 mb-6'>
        				<div class='card bg-transparent border-0'>
        					<img src='https://admin.theindianconclave.in/img/blog/".$row['cover']."' width='100%' alt='' class='img-fluid rounded'>
        
        					<div class='card-body mt-2'>
        						<div class='blog-item-meta'>
        							<a href='#' class='text-white-50'>".$row['author']."<span class='ml-2 mr-2'>/</span></a>
        							<a href='#'  class='text-white-50'>".$final_date."<span class='ml-2'>/</span></a>
        							<a href='#' class='text-white-50 ml-2'>".$comment."</a>
        						</div> 
        
        						<h3 class='mt-3 mb-5 lh-36'><a class='text-white '>".$row['title']."</a></h3>
        
        						<a href='view_blog.php?blog_id=".$row['blog_id']."&title=".$row['title']."' class='btn btn-small btn-solid-border btn-round-full text-white'>Read More</a>
        					</div>
        				</div>
        			</div>";
	              }
...
<section class="mt-70 position-relative">
	...
	<div class="cta-block-2 bg-gray p-5 rounded border-1">
		<div class="row justify-content-center align-items-center ">
			<div class="col-lg-9">
				<span class="text-color">Get yourself certified by publishing your articles on our website!</span>
				<h3 class="mt-2 mb-4 mb-lg-0">Email us your work at <a href="mailto:journalism@theindianconclave.in">journalism@ theindianconclave.in</a> following our Submission Guidelines (click to download)</h3>
			</div>
			<div class="col-lg-3">
				<a href="https://drive.google.com/uc?export=download&id=1_UgGaELDB8Kf4RPAmwalNLH2-XFcvTNr" class="btn btn-main btn-round-full float-lg-right" download>Download Submission Guidelines</a>
			</div>
		</div>
	</div>
</div>
