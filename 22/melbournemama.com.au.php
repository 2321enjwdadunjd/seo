...
<script src="js/slide.js" type="text/javascript"></script>
	...
	<div class="prs_vp_main_section_wrapper" style="background-image: url('images/slide-bg2.png');" class="img-responsive">
		<div class="container">
			<div class="row">
				
				<script src="js/jssor.slider-27.1.0.min.js" type="text/javascript"></script>
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:220px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
        <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="img/spin.svg"/>
        </div>
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:240px;overflow:hidden;">
            <div data-p="30.00">
                <img data-u="image" src="images/s1.png"/>
            </div>
            <div data-p="30.00">
                <img data-u="image" src="images/s2.png"/>
            </div>
            <div data-p="30.00">
                <img data-u="image" src="images/s3.png"/>
            </div>
            <div data-p="30.00">
                <img data-u="image" src="images/s4.png"/>
            </div>
            <div data-p="30.00">
                <img data-u="image" src="images/homeslide3.png"/>
            </div>
            <div data-p="30.00">
                <img data-u="image" src="images/homeslide4.png"/>
            </div>
            <!--<div data-p="30.00">-->
            <!--    <img data-u="image" src="images/homeslide2.png" />-->
            <!--</div>-->
            <!--<div data-p="30.00">-->
            <!--    <img data-u="image" src="images/homeslide3.png" />-->
            <!--</div>-->
            ...
            <!--</div>-->
            <!--<div data-p="30.00">-->
            <!--    <img data-u="image" src="images/homeslide1.png" />-->
            <!--</div>-->
            <!--<div data-p="30.00">-->
            <!--    <img data-u="image" src="images/homeslide2.png" />-->
            <!--</div>-->
	...
	<div class="prs_ln_main_wrapper" style="background-image: url('images/about7.png'); background-size: cover;">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
					<h2 style="font-family: 'Great Vibes', 'cursive'; color:black; font-size: 74px; margin-top:37px;"> About <span style="color:#cd2222;">Us</span> </h2>
					<p align="justify" style="color: black; margin-top: 20px;">
						MelbourneMAMA is all about  You ME WE AND US</p>
<li style="color:black;">International Student ADDA</li>
<li style="color:black;">Media/ Production House</li>
<li style="color:black;">Community (Celebrating our festivals and culture ).</li>
<li style="color:black;">Telugu Strength / Telangana Flavor .</li>
<li style="color:black; ">Together WE CAN  </li>
<li style="color:black;">Melbourne MAMA's business hub</li>
				</div>
			<div class="col-lg-5 col-md-12 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1" style="top:40px;">
					<img src="images/melbourne1.png" class="img-responsive image">
				</div>
			</div>
	</div>
	</div>
							...
							<div class="item">
								<div class="prs_feature_img_box_wrapper">
									<div class="prs_feature_img">
										<img src="images/bathukamma-celebrations.png" alt="feature_img">
										<div class="prs_ft_btn_wrapper">
											<ul>
												<li><a href="#"><img src="images/ticket-small.png"></a>
												</li>
											</ul>
										</div>
									</div>
									<div class="prs_feature_img_cont">
										<h2><a href="#">Bathukamma Celebrations</a></h2>
										<div class="prs_ft_small_cont_left">
											<p style="	color:#fca93d;
">Melbourne</p>
										</div>
							...
							<div class="item">
								<div class="prs_feature_img_box_wrapper">
									<div class="prs_feature_img">
										<img src="images/holimel.png" alt="feature_img">
										<div class="prs_ft_btn_wrapper">
											<ul>
												<li><a href="#"><img src="images/ticket-small.png"></a>
												</li>
...
">Melbourne</p>
							...
							<div class="item">
								<div class="prs_feature_img_box_wrapper">
									<div class="prs_feature_img">
										<img src="images/bonalumel.png" alt="feature_img">
										<div class="prs_ft_btn_wrapper">
											<ul>
												<li><a href="#"><img src="images/ticket-small.png"></a>
												</li>
									...
									<div class="prs_feature_img_cont">
										<h2><a href="#">Melbourne Telangana Bonalu</a></h2>
										<div class="prs_ft_small_cont_left">
											<p style="	color:#fca93d;
">Melbourne</p>
										</div>
							...
							<div class="item">
								<div class="prs_feature_img_box_wrapper">
									<div class="prs_feature_img">
										<img src="images/sainma.png" alt="feature_img">
										<div class="prs_ft_btn_wrapper">
											<ul>
												<li><a href="#"><img src="images/ticket-small.png"></a>
												</li>
									...
									<div class="prs_feature_img_cont">
										<h2><a href="#">Sainma awards 2k19</a></h2>
										<div class="prs_ft_small_cont_left">
											<p style="	color:#fca93d;
">Melbourne</p>
										</div>
								...
								<div class="prs_feature_img_box_wrapper">
									<div class="prs_feature_img">
										<img src="images/hyderabadi-dj-nyt.png" alt="feature_img">
										<div class="prs_ft_btn_wrapper">
											<ul>
												<li><a href="#"><img src="images/ticket-small.png"></a>
												</li>
									...
									<div class="prs_feature_img_cont">
										<h2><a href="#"> DJ night Poster Launch</a></h2>
										<div class="prs_ft_small_cont_left">
											<p>Melbourne</p>
										</div>
										<div class="prs_ft_small_cont_right">	<i class="fa fa-star"></i>
	...
	<!--</div>-->
		...
		<div class="container">
			<div class="row">
			    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="prs_ec_pe_heading_section_wrapper">
						<h2 style="color:black;margin-bottom:20px;">OUR BLOG</h2>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="prs_feature_img_box_wrapper prs_ec_ue_inner_feat_wrapper">
						<div class="prs_feature_img">
							<img src="images/hyderabad.png" alt="feature_img">
						</div>
						<div class="prs_feature_img_cont">
							<h2><a href="#">Hyderabadi DJ NIGHT</a></h2>
							<div class="prs_ft_small_cont_left">
								<p style="color:white;">Lorem Ipsum is simply dummy text of the printing and
								typesetting industry. Lorem Ipsum has been the industry's
								standard dummy text ever since the 1500s,</p>
							</div>
						 <div class="text-center"><a href="blog-single.php" class="btn btn-default">Read More</a></div>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="prs_feature_img_box_wrapper prs_ec_ue_inner_feat_wrapper">
						<div class="prs_feature_img">
							<img src="images/cristmasevent.png" alt="feature_img">
						</div>
						<div class="prs_feature_img_cont">
							<h2><a href="#">Candid Cristmas Event </a></h2>
							<div class="prs_ft_small_cont_left">
							<p style="color:white;">Lorem Ipsum is simply dummy text of the printing and
								typesetting industry. Lorem Ipsum has been the industry's
								standard dummy text ever since the 1500s,</p>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="prs_feature_img_box_wrapper prs_ec_ue_inner_feat_wrapper">
						<div class="prs_feature_img">
							<img src="images/republic.png" alt="feature_img">
						</div>
						<div class="prs_feature_img_cont">
		...
		<div class="prs_patner_main_section_wrapper" style="background-image:url('images/bg2.png');background-position:center top;background-repeat:repeat-x;background-color:#c64444;">
		<div class="container">
   <section class="customer-logos slider">
       <div class="slide"><img src="images/enew-logo.png"></div>
      <div class="slide"><img src="images/simplyindian-logo.png"></div>
      <div class="slide"><img src="images/sucess-logo.png"></div>
      <div class="slide"><img src="images/a-logo.png"></div>
      <div class="slide"><img src="images/coreflex-logo.png"></div>
      <div class="slide"><img src="images/xgs-logo.png"></div>
      <div class="slide"><img src="images/simplyindian-logo.png"></div>
      <div class="slide"><img src="images/sucess-logo.png"></div>
      <div class="slide"><img src="images/a-logo.png"></div>
      <div class="slide"><img src="images/coreflex-logo.png"></div>
