...
?>
    <!-- Header end -->
    <section class="page-header darken-2" style="background: url(assets/images/cover-2.jpg)">
        <div class="container">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="form-group">
                        <div class="input-group input-group-lg">
                            ...
                            <input type="text" class="form-control jobName" placeholder="Keyword: name, skills or tags">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="form-group">
                        <div class="input-group input-group-lg">
                            ...
                            <input type="text" class="form-control jobLocation" placeholder="Location: city, state or zip">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        <button class="btn btn-primary btn-block btn-lg jobSearch">Search</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <header class="section-header">
                ...
                <p>Check All New Updates Here</p>
            </header>
            <div class="row">
                <?php 
                $table				=   "tbl_missection";
                $where				=	"miscategoryId ='1' and missectionStatus = '1'";	
                $sectionDetails	    =	$classFetch->select_Record_Where($table,$where);
                foreach($sectionDetails as $sKey=>$sVal){
                ?>
                    ...
                    <div class="card" style="background-color:#00ccff;">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xs-11">
                                    <h5>
                                        <a href="http://www.findersstop.com/noti-detail.php?ntId=<?php echo $sVal['notificationLink']; ?>" style="color: white;"><?php echo $sVal['notificationName']; ?></a>
                                    </h5>
                                </div>
                            </div>
                        </div>
                ...
                <?php } ?>
                <!--<div class="col-lg-4 col-sm-12">
                    <div class="card" style="background-color:#74d778;">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xs-11">
                                    <h5>
                                        <a href="#" style="color:white;">UPSC CPF AC 2021 Apply Online</a>
                                    </h5>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="card" style="background-color:#ffc028;">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xs-11">
                                    <h5>
        ...
        <div class="container">
            <ul class="simple text-center">
                <li class="col-sm-4 col-xs-12">
                    <div class="circle-icon bg-blue lighten-2">
                        <i class="icon md-pin"></i>
                    </div>
                    <h5>Create resume</h5>
                    <p>Finder's Stop is one stop destination for all of the government, private and school jobs.</p>
                </li>
                <li class="col-sm-4 col-xs-12">
                    <div class="circle-icon bg-green lighten-2">
                        <i class="icon md-shield-security"></i>
                    </div>
                    <h5>Visiting job advertisements</h5>
                    <p>Register Yourself at the Finder's Stop and visit all job advertisements here.</p>
                </li>
                <li class="col-sm-4 col-xs-12">
                    <div class="circle-icon bg-orange lighten-2">
                        <i class="icon md-seat"></i>
                    </div>
                    <h5>Make an application</h5>
                    <p>Get your Dream at Finder's Stop Job by applying for the Job via your application.</p>
                </li>
            </ul>
        </div>
    </section> 
    <section>
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <?php
                    $table				=   "tbl_privatejob";
                    $where				=	"privateJobStatus ='1' LIMIT 4";	
                    $privateDetails	    =	$classFetch->select_Record_Where($table,$where);
                    foreach($privateDetails as $ptKey=>$ptVal){
                       $table				=   "tbl_state";
                        $where				=	"stateId = '".$ptVal['state']."' and stateStatus = '1'";	
                        $stateDetails	    =	$classFetch->select_Record_Where($table,$where);  
                
                        $table				=   "tbl_city";
                        $where				=	"city_id = '".$ptVal['city']."' and city_status = '1'";	
                        $cityDetails	    =	$classFetch->select_Record_Where($table,$where);
                    ?>
                    <div class="item-jobpost">
                        <div class="row">
                            <div class="col-md-5">
                                <h5>
                                <a href="#">
                                <?php echo $ptVal['jobTitle']; ?></a>
                                </h5>
                                <h6>
                                        <a href="#"><?php echo $ptVal['companyName']; ?></a>
                                </h6>
                                <ul class="list-inline">
                                    <li><a href="#">
                                        <div class="md-card-travel"></div>
                                        <?php echo $ptVal['experience']; ?>
                                            </a>
                                        </li>
                                        <li style="color:#00ccff;"><i class="fa fa-inr" aria-hidden="true"></i><?php echo " ".$ptVal['package']; ?></li>
                                </ul>
                            </div>
                            <div class="col-md-5 jobpost-location">
                                <span><i class="md-pin m-r-10"></i><?php echo $cityDetails[0]['city_name'].",".$stateDetails[0]['stateName']; ?></span>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
    ...
    <section>
        <div class="container">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <ul>
                                            <?php
                                        $table				=   "tbl_missection";
                                        $where				=	"miscategoryId ='2' and missectionStatus = '1'";	
                                        $sectionDetails	    =	$classFetch->select_Record_Where($table,$where);
                                        foreach($sectionDetails as $sKey=>$sVal){
                                        ?>
                                            <a href="https://www.findersstop.com/noti-detail.php?ntId=<?php echo $sVal['notificationLink']; ?>"><li><?php echo $sVal['notificationName']; ?></li></a>
                                        <?php } ?>
                                        </ul>
                                        </td>
                                    </tr>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <ul>
                                               <?php
                                        $table				=   "tbl_missection";
                                        $where				=	"miscategoryId ='3' and missectionStatus = '1'";	
                                        $sectionDetails	    =	$classFetch->select_Record_Where($table,$where);
                                        foreach($sectionDetails as $sKey=>$sVal){
                                        ?>
                                            <a href="https://www.findersstop.com/noti-detail.php?ntId=<?php echo $sVal['notificationLink']; ?>"><li><?php echo $sVal['notificationName']; ?></li></a>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <ul>
                                                <?php
                                        $table				=   "tbl_missection";
                                        $where				=	"miscategoryId ='4' and missectionStatus = '1'";	
                                        $sectionDetails	    =	$classFetch->select_Record_Where($table,$where);
                                        foreach($sectionDetails as $sKey=>$sVal){
                                        ?>
                                            <a href="https://www.findersstop.com/noti-detail.php?ntId=<?php echo $sVal['notificationLink']; ?>"><li><?php echo $sVal['notificationName']; ?></li></a>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <ul>
                                                <?php
                                        $table				=   "tbl_missection";
                                        $where				=	"miscategoryId ='5' and missectionStatus = '1'";	
                                        $sectionDetails	    =	$classFetch->select_Record_Where($table,$where);
                                        foreach($sectionDetails as $sKey=>$sVal){
                                        ?>
                                            <a href="https://www.findersstop.com/noti-detail.php?ntId=<?php echo $sVal['notificationLink']; ?>"><li><?php echo $sVal['notificationName']; ?></li></a>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <ul>
                                                <?php
                                        $table				=   "tbl_missection";
                                        $where				=	"miscategoryId ='6' and missectionStatus = '1'";	
                                        $sectionDetails	    =	$classFetch->select_Record_Where($table,$where);
                                        foreach($sectionDetails as $sKey=>$sVal){
                                        ?>
                                            <a href="https://www.findersstop.com/noti-detail.php?ntId=<?php echo $sVal['notificationLink']; ?>"><li><?php echo $sVal['notificationName']; ?></li></a>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <ul>
                                                <?php
                                        $table				=   "tbl_missection";
                                        $where				=	"miscategoryId ='7' and missectionStatus = '1'";	
                                        $sectionDetails	    =	$classFetch->select_Record_Where($table,$where);
                                        foreach($sectionDetails as $sKey=>$sVal){
                                        ?>
                                            <a href="https://www.findersstop.com/noti-detail.php?ntId=<?php echo $sVal['notificationLink']; ?>"><li><?php echo $sVal['notificationName']; ?></li></a>
            ...
            <div class="col-sm-4 col-sm-offset-4 col-xs-6 col-xs-offset-3">
                <a href="#" class="btn btn-primary btn-block m-t-20">View More</a>
            </div>
        </div>
    </section>
    <section class="bg-white">
        <div class="container">
            <header class="section-header">
                <h3>Government Jobs by Location</h3>
                <p>We list popular government Jobs here</p>
            </header>
            <ul class="simple category-list">
                ...
                $where				=	"stateStatus = '1'";	
                $stateDetails	    =	$classFetch->select_Record_Where($table,$where); 
                foreach($stateDetails as $sKey=>$sVal){
                ?>
                <li class="col-md-4 col-sm-6 col-xs-12">
                    <a href="stateWiseJobs.php?stId=<?php echo $sVal['stateId']; ?>&stdesc=<?php echo $sVal['stateName']; ?>-government-jobs"><i class="md-chevron-right m-r-10"></i>Govt. Jobs in <?php echo $sVal['stateName']; ?></a>
                </li>
                <?php } ?>
            </ul>
        </div>
    ...
    <section class="">
        <div class="container">
            ...
            <div class="row">
                ...
                $blogDDetails	    =	$classFetch->select_Record_Where($table,$where);
                ?>
                <div class="col-md-4">
                    <a href="blog-detail.php?bdlink=<?php echo $blogDDetails[0]['blogLink']; ?>">
                        <div class="card bg-grey lighten-4">
                            <img src="admin/blogPics/<?php echo $bdVal['blogPic']; ?>" alt="..." style="width: 400px; height: 275px;">
                            <div class="card-body">
                                <h5 class="m-b-0"><?php echo $bdVal['blogTitle']; ?></h5>
                            </div>
                        </div>
                    </a>
                </div>
   ...
   <!-- <section class="bg-white">
        <div class="container">
            <header class="section-header">
                <h3>References</h3>
                <p>Our references are here</p>
            </header>
            <div class="owl-carousel">
                <div class="item">
                    <a href="#">
                        <img src="assets/images/references/logo-1.png" alt="...">
                    </a>
                </div>
                <div class="item">
                    <a href="#">
                        <img src="assets/images/references/logo-2.png" alt="...">
                    </a>
                </div>
                <div class="item">
                    <a href="#">
                        <img src="assets/images/references/logo-3.png" alt="...">
                    </a>
                </div>
                <div class="item">
                    <a href="#">
                        <img src="assets/images/references/logo-4.png" alt="...">
                    </a>
                </div>
                <div class="item">
                    <a href="#">
                        <img src="assets/images/references/logo-5.png" alt="...">
                    </a>
                </div>
                <div class="item">
                    <a href="#">
                        <img src="assets/images/references/logo-6.png" alt="...">
                    </a>
                </div>
                <div class="item">
                    <a href="#">
                        <img src="assets/images/references/logo-7.png" alt="...">
                    </a>
                </div>
            </div>
        </div>
    </section>
    <!--<section class="darken-3" style="background: url(assets/images/cover-1.jpg)">
        <div class="container">
            <header class="section-header text-white">
                <h3>Subscription</h3>
                <p>To register for an email newsletter, register your email address</p>
            </header>
            <div class="col-md-6 col-md-offset-3">
                <form>
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" class="form-control" placeholder="Write and send email address">
