...
?>
	...
	<header id="gtco-header" class="gtco-cover headere" role="banner" >
		<!-- <div class="overlay"></div> -->
		<div class="gtco-container slidere">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="images/slider/s1.jpg" alt="img" style="width:100%;">
      </div>

      <div class="item ">
        <img src="images/slider/s2.jpg" alt="img" style="width:100%;">
      </div>
 
	   <div class="item ">
        <img src="images/slider/s5.jpg" alt="img" style="width:100%;">
      </div>
	  
	   <div class="item ">
        <img src="images/slider/s6.jpg" alt="img" style="width:100%;">
      </div>
	
	   <div class="item ">
        <img src="images/slider/s8.jpg" alt="img" style="width:100%;">
      </div>

	   <div class="item ">
        <img src="images/slider/s10.jpg" alt="img" style="width:100%;">
      </div>
	  
	   <div class="item ">
        <img src="images/slider/s11.jpg" alt="img" style="width:100%;">
      </div>
	  
	   <div class="item ">
        <img src="images/slider/s12.jpg" alt="img" style="width:100%;">
      </div>
	  
	  
	   <div class="item ">
        <img src="images/slider/s14.jpg" alt="img" style="width:100%;">
      </div>
	  
	   <div class="item ">
        <img src="images/slider/s19.jpg" alt="img" style="width:100%;">
      </div>
	  
	   <div class="item ">
        <img src="images/slider/s20.jpg" alt="img" style="width:100%;">
      </div>
	  
	  
	   <div class="item ">
        <img src="images/slider/s22.jpg" alt="img" style="width:100%;">
      </div>
	  
	   <div class="item ">
        <img src="images/slider/s23.jpg" alt="img" style="width:100%;">
      </div>
	  
	   <div class="item ">
        <img src="images/slider/s24.jpg" alt="img" style="width:100%;">
      </div>
	  
	   <div class="item ">
        <img src="images/slider/s25.png" alt="img" style="width:100%;">
      </div>
	  
	  <div class="item ">
        <img src="images/slider/s26.jpg" alt="img" style="width:100%;">
      </div>
	...
	<!-- <div class="gtco-section " data-aos="fade-up" data-aos-duration="1000"> -->
		<!-- <div class="gtco-container whycoose"> -->
			<!-- <div class="row animate-box"> -->
				<!-- <div class="col-md-12  text-center gtco-heading gtco-headinge"> -->
					<!-- <h2 class="headinge">Why Choose Us</h2> -->
					<!-- <p class="eshanp">Powerloom Industry is the major contributor to Indian Textile industry as 62% of the textiles production in India is done on Powerlooms. Indian Powerloom Industry is equipped with 2.43 million registered looms producing 54,000 sq. mtr fabrics and accounting for 57.45 lakhs number of direct & indirect employment. It is concentrated in clusters across Bhiwandi, Bhilwara, Erode, Salem,Surat, Madurai, Ichalkarnaji, Solapur and Malegaon, among others.  The industry produces wide range of fabrics ranging from grey, printed fabric, dyed fabric, cotton fabric, various mix of cotton, synthetic, and other fibres. In fact, Powerloom sector is major contributor in India’s export earnings. USA, EU, China, UAE, Vietnam, Sri Lanka, Saudi Arabia, the Republic of Korea, Bangladesh, Turkey and Brazil are some of the major markets for these exports.</p> -->
				<!-- </div> -->
			<!-- </div> -->
		<!-- </div> -->
	<!-- </div> -->

	<div id="gtco-features-2" class="section3" style="background: #c1c1c1;">
		<div class="gtco-container containerimpsel">
			<div class="row someseller">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2 class="headinge">Premium Sellers</h2>
...
$start=1;
$limit=3;
$rows=mysqli_num_rows(mysqli_query($mysqlConnection,"select * from tbl_seller"));
...
if(!$search=0)
{
$sel="Select * from tbl_seller where premium_seller = 1 ORDER BY id ASC LIMIT $start, $limit";
$result = mysqli_query($mysqlConnection,$sel);
}
...
$authorize_person = $row['authorize_person'];
$bature_of_business = $row['bature_of_business'];
$company_strength = $row['company_strength'];
$mobile_no = $row['mobile_no'];
$office_no_1 = $row['office_no_1'];
$office_no_2 = $row['office_no_2'];
...
?>			
				...
				<div class="col-xs-4 col-md-4">
					<div class="gtco-video gtco-video-sm gtco-bg" title="click here to see more information" style="background-image: url( admin/sellerlogo/<?php echo $image; ?>); ">
						<!-- <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal<?php echo $id; ?>"><i class=""><img src = "images/arrow.png" class="prodarrow" alt="click here to see more information"/></i></a> -->
						<!-- <div class="overlay"></div> -->
					</div>
				</div>
					...
					<div class="modal-dialog">
					  ...
					  <div class="modal-content">
						<div class="modal-header">
						  ...
						  <h4 class="modal-title headinge" ><?php echo $row['company_name']; ?></h4>
						</div>
						<div class="modal-body">
						  <div class="col-md-3"><img src="admin/sellerlogo/<?php echo $image; ?>" width="100%" /></div>
						  <div class="col-md-9">
								<div class="row">
									<div class="col-md-12">
									<h2 class="uppercase headinge">Textile Information</h2>
										<ul>
										<li>Company Name: <?php echo $company_name; ?></li>
										<li>Company Address: <?php echo $company_address; ?></li>
										<li>Authorise Person: <?php echo $authorize_person; ?></li>
										<li>Mobile No: <?php echo $mobile_no; ?></li>
										<li>Office No 1: <?php echo $office_no_1; ?></li>
									</ul>
									</div>
...
<?php } ?>
					...
					<div class="col-md-4 col-sm-4">
							<a href="sellerinfo.php"><button type="submit" class="btn btn-default btn-block moresleebtn">More Sellers</button></a>
						</div>
						<div class="col-md-4 col-sm-4 sellerbootom">
	...
	<div id="gtco-features" class="section2">
			...
			<div class="row">
				<div class="col-md-4 col-sm-4">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						<span class="icon">
							<!-- <i class="icon-eye"></i> -->
							<a href="product.php?clothid=1"><img src="images/fetimg/cot.jpg" class="fetimg" /></a>
						</span>
						<a href="product.php?clothid=1"><h3 style="color: #fff;">Cotton Fabric</h3></a>
				...
				<div class="col-md-4 col-sm-4">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						<span class="icon">
							<a href="product.php?clothid=13"><img src="images/fetimg/vis.jpg" class="fetimg" /></a>
						</span>
						<a href="product.php?clothid=13" ><h3 style="color: #fff;">Viscose fabrics</h3></a>
						<!-- <p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. </p> -->
						<!-- <p><a href="#" class="btn btn-primary btn-outline">Learn More</a></p> -->
					</div>
				</div>
				<div class="col-md-4 col-sm-4">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						<span class="icon">
							<a href="product1.php?clothid=10"><img src="images/fetimg/pol.jpg" class="fetimg" /></a>
						</span>
						<a href="product1.php?clothid=10"><h3 style="color: #fff;">Polyster Fabric </h3></a>
						<!-- <p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. </p> -->
						<!-- <p><a href="#" class="btn btn-primary btn-outline">Learn More</a></p> -->
					</div>
				</div>
...
<div id="gtco-subscribe" data-aos="fade-up" data-aos-duration="1000" style="background:#000;padding: 15px 0;">
		<div class="gtco-container" style="max-width:100%">
			<div class="row animate-box">
				<div class="col-md-12">
					<video width="100%" height="350px" autoplay controls >
					  <source src="video/vid1.mp4" type="video/mp4">
					  <source src="video/vid1.ogg" type="video/ogg">
