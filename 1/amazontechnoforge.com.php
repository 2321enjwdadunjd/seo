...
$i = 1;
$aboutquery = "select * from manage_about";
$aboutres = mysqli_query($link,$aboutquery);
$rowabout = mysqli_fetch_assoc($aboutres);
				...
				<div class="container">
					...
					<div class="inner-wrapper">
						<div id="primary" class="content-area">
							<main id="main" class="site-main" >
								<aside class="section section-featured-slider">
									<div id="main-slider"  class="cycle-slideshow overlay-enabled featrued-slider" data-cycle-fx="fadeout"  data-cycle-speed="1000"  data-cycle-pause-on-hover="true"  data-cycle-loader="true"  data-cycle-log="false"  data-cycle-swipe="true" data-cycle-auto-height="container"  data-cycle-timeout="3000"  data-cycle-slides="article" data-pager-template='<span class="pager-box"></span>'>
										...
										<?php 
										$i = 1;
										$sliderquery = "select * from manage_banner";
										$sliderres = mysqli_query($link,$sliderquery);
										while($rowslider = mysqli_fetch_assoc($sliderres)){
										?>
										<article <?php if($i == 1){ echo "class='first'"; } ?>>
											<div class="caption">
												<div class="cycle-caption <?php if($i == 1){ echo "text-aligncenter"; } else { echo "text-alignleft"; } ?>">
													<div class="container">
														<!--<h3><a href="javascript:void(0);" ><?php echo $rowslider['banner_title']; ?></a></h3>
														<p><?php echo $rowslider['banner_text']; ?></p>-->
														<!--<div class="slider-buttons">
															<a class="custom-button" href="<?php echo $baseurl; ?><?php echo $rowslider['blink']; ?>">Know More</a>
											...
											<a href="#">
												<img src="<?php echo $baseurl; ?>images/banner_img/<?php echo $rowslider['banner']; ?>" alt="Slider" />
											</a>
										</article> <!-- article -->
									<?php $i++;  } ?>
                           ...
                           {
                           		$masage = $_SESSION['done'];
                           		echo'<div class="msg msg-ok alert alert-success">
                           			<p><strong>'.$masage.'</strong></p>
                           		</div>';
                     		...
                     		{
                     			echo'<div class="msg msg-error alert alert-danger">
                           ...
                           ?>
										<img class="alignleft" alt="About Us" src="<?php echo $baseurl; ?>images/about/<?php echo $rowabout['about']; ?>">
										<div class="featured-page-section">
											<h2 class="section-title"><?php echo $rowabout['about_title']; ?></h2>
											<p><?php echo $rowabout['about_text1']; ?></p>
											<a href="<?php echo $baseurl; ?>about.php"  class="custom-button">Know More</a>
										</div><!-- .featured-page-section -->
									</div> <!-- .container -->
								</aside> <!-- .section-featured-page -->
							
							
								<aside class="section section-call-to-action cta-fluid background-img overlay-enabled">
									<div class="call-to-action-inner-wrapper">
										<div class="container">
											<div class="call-to-action-content">
												<div class="call-to-action-description">
													<h2 class="section-title">Need Product Quotation?</h2>
													<p class="section-subtitle">Please write your order requirements to support you accordingly. Thank you</p>
												</div><!-- .call-to-action-description -->
												<div class="call-to-action-buttons">
													<a href="<?php echo $baseurl; ?>contact.php"  class="custom-button custom-primary">Contact Us</a>
								...
								<aside class="section section-portfolio">
									...
									<div class="portfolio-main-wrapper">
											<div id="portfolio" class="masonry-wrapper portfolio-container row-fluid wow fadeInUp">
												<?php 	
												$proquery = "select * from product LIMIT 6";
												$prores = mysqli_query($link,$proquery);
												$proresf = mysqli_query($link,$proquery);
												$rowprof = mysqli_fetch_assoc($proresf);
												if(!empty($rowprof)){		
												while($rowpro = mysqli_fetch_assoc($prores)){ 
												?>

												<div class="portfolio-item  photography">
													<div class="item-inner-wrapper">
														<img src="images/product_img/<?php echo $rowpro['product_img']; ?>" alt="Portfolio" class="portfolio-thumb">
														<div class="overlay"></div>
														<div class="portfolio-content">
															<a data-gal="prettyPhoto[product-gallery]" rel="bookmark" href="images/product_img/<?php echo $rowpro['product_img']; ?>"><i class="fa fa-search" aria-hidden="true"></i></a>
															
														</div>
													</div>
													<div>
													<div style="padding:6px; background:blanchedalmond; width: 100%;color: black;text-align: center;"><?php echo $rowpro['product_title']; ?></div>
													<a href="javascript:void(0);" onclick="opmodel('<?php echo $rowpro['product_img']; ?>','<?php echo $rowpro['product_title']; ?>','<?php echo $rowpro['id']; ?>')" style="width: 100%; ; padding:8px; text-align:center; background-color:#9d2520; color:#fff; display: block;" id="myBtn">Get Quote</a>
												</div><!-- end item -->
												</div><!-- end item -->
												<?php  }  }else {?>
										...
										<div class="more-wrapper">
											<a href="<?php echo $baseurl; ?>product.php" class="custom-button">Explore More</a>
										</div>
									</div><!-- end masonry-wrapper -->
								</aside><!-- end portfolio -->
								
								<aside  class="section section-Quick-contact lite-background" style=" background-size:100%; background-image: url(<?php echo $baseurl; ?>images/call-back-background.jpg);">
									<div class="container">
										<div class="inner-wrapper">
										<div class="col-grid-6">
												<img src="images/call-back.jpg"/>
											</div>
											<div class="col-grid-6">
												<div class="contact-form-area contactdesc">
													<h3 class="contact-title">Request A Call Back</h3>
													<p>It would be great to hear from you! If you got any questions, please do not hesitate to send us a call back request. 
We are looking forward to hearing from you! Thank You.</p>
													<form id="contactform2" data-parsley-validate  action="<?php echo $baseurl; ?>save_call.php" name="contactform2" method="post" enctype="multipart/form-data">
										...
										<div class="g-recaptcha" data-sitekey="6Lc8uDIaAAAAAENnEKmB5eC9KxEA-0AEU1oVcf06"></div>  
															 </div>   
															<input type="hidden" name="message" id="message" value="Callback Request Received">
															 <div class="ln_solid"></div>
                  <div class="form-group">
                     <div class="pull-right" style="margin-top: 15px;margin-bottom: 10px">
                        <button type="submit" name="pass" id="sub" value="submit" class="btn btn-primary btn-lg">SEND REQUEST</button>
                     </div>
                  </div>
