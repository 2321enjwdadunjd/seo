...
$page='home';
$metapage='home';
$querybanner = "select * from manage_banner";
$resbanner= mysqli_query($link,$querybanner); 

$queryabout = "select * from manage_about";
$resabout=mysqli_query($link,$queryabout);      
$rowabout=mysqli_fetch_assoc($resabout);

$queryapp = "select * from client";
$resapp= mysqli_query($link,$queryapp);
  
$queryappp = "select * from product ORDER BY id DESC LIMIT 6";
$resappp= mysqli_query($link,$queryappp);  
			...
			<?php while($rowbanner = mysqli_fetch_assoc ($resbanner)){ ?>
			    <div class="item">
					<figure class="slider_image">
						<img class="wow fadeInLeft" src="<?php echo $baseurl; ?>images/banner_img/<?php echo $rowbanner['banner_img']; ?>" alt="slider_img"/>
					</figure>
					<!--<div class="slider-text text-center">
						<div class="container">
							<div class="row">
								<div class="col-md-10 col-sm-10 col-xs-10 col-md-offset-1 col-sm-offset-1 col-xs-offset-1 text-left slider_animation">
									<h1 class="theme_slider_title hidden-sm hidden-sx"><?php echo $rowbanner['title']; ?></h1>
									 <p class="slide-caption__desc">
                                     <?php echo $rowbanner['text']; ?>   </p>
									 <div class="sliderBtn">
                                        <a href="<?php echo $baseurl; ?><?php echo $rowbanner['blink']; ?>" class="themeBtn">Read More</a>
    ...
    <section class="commonSection aboutCont">
            <div class="container">
                <div class="row">
				  <div class="col-lg-6">
                        <div class="aboutimg">
                            <img class="img-responsive" src="<?php echo $baseurl; ?>images/about/<?php echo $rowabout['about']; ?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="aboutcontain">
                            ...
                            <p>
                                <?php echo substr($rowabout['about_text1'],0,500).'...'; ?>
                              
                            </p>
							<a href="<?php echo $baseurl; ?>about.php" class="themeBtn">Read More</a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1 noPadding text-center">
                        <div class="themeHeadding">
                            <h2>Provide All Type of Forge and Fitting</h2>
                            <p>
                               <?php echo $tagline; ?>
                            </p>
                        </div>
        ...
        <!--Call to Action End-->
		   ...
		   <section class="commonSection fillterProject">
            <div class="container">
                ...
                <div class="row">
				 <div class="col-lg-12 text-left portfolio_sec">
                        <div class="themeHeadding black">
                ...
                <div class="row">
                    <div class="filterCont">
                        <?php while($rowappser = mysqli_fetch_assoc($resappp)) { ?>
						<div class="col-lg-4 col-xs-12 col-sm-6 mix">
                            <div class="singlePortfolio">
                                <div class="portfolioImg">
                                    <img src="<?php echo $baseurl; ?>images/product_img/<?php echo $rowappser['product_img']; ?>" alt="">
                                </div>
                                <div class="portfolioHover">
                                    <a href="<?php echo $baseurl; ?>product-detail.php?id=<?php echo base64_encode($rowappser['id']); ?>"><i class="fa fa-link"></i></a>
                                    <a href="<?php echo $baseurl; ?>images/product_img/<?php echo $rowappser['product_img']; ?>" class="popUp"><i class="fa fa-search-plus"></i></a>
                                </div>
                            </div>
                        <a href="<?php echo $baseurl; ?>product-detail.php?id=<?php echo base64_encode($rowappser['id']); ?>" class="btn btn-info" style="width:100%;margin-bottom: 15px;" ><?php echo ucfirst(str_replace("_"," ",$rowappser['product_title'])); ?></a>
                	...
                	<center><a href="<?php echo $baseurl; ?>product.php" class="themeBtn">View More</a>
                       </center>
            </div>
        </section>
         <section class="commonSection fillterProject">
            <div class="container">
                ...
                <div class="row">
				 <div class="col-lg-12 text-left portfolio_sec">
                        <div style="text-align:center;" class="themeHeadding black">
                ...
                <div class="row">
                    <div class="filterCont">
						...
						<div class="col-lg-4 col-xs-12 col-sm-6 mix">
                            <div class="singlePortfolio">
                                <div class="portfolioImg">
                                    <img src="<?php echo $baseurl; ?>images/01.png" alt="01">
                                </div>
                                <div class="portfolioHover">
                                    <a href="<?php echo $baseurl; ?>images/01.png" class="popUp"><i class="fa fa-search-plus"></i></a>
                                </div>
                            </div>
						</div>
						<div class="col-lg-4 col-xs-12 col-sm-6 mix">
                            <div class="singlePortfolio">
                                <div class="portfolioImg">
                                    <img src="<?php echo $baseurl; ?>images/02.png" alt="02">
                                </div>
                                <div class="portfolioHover">
                                    <a href="<?php echo $baseurl; ?>images/02.png" class="popUp"><i class="fa fa-search-plus"></i></a>
                                </div>
                            </div>
						</div>
						<div class="col-lg-4 col-xs-12 col-sm-6 mix">
                            <div class="singlePortfolio">
                                <div class="portfolioImg">
                                    <img src="<?php echo $baseurl; ?>images/03.png" alt="03">
                                </div>
                                <div class="portfolioHover">
                                    <a href="<?php echo $baseurl; ?>images/03.png" class="popUp"><i class="fa fa-search-plus"></i></a>
                                </div>
                            </div>
						</div></div>
                </div>
                	<center><a href="<?php echo $baseurl; ?>awards.php" class="themeBtn">Explore More</a>
                       </center>
            </div>
        </section>
