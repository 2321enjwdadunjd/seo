...
<meta name="google-site-verification" content="leEFB-EKhglGC2h9yWmeGDAoJAdEF0uMygPjpNf2nhI" />
<title>Web Design India | Web Development Company | Mobile App Development Services | Web Soft IT Solution - WSitSolution.Com</title>
<meta content="Web Design India | Web Development Company | Mobile App Development Services | Web Soft IT Solution - WSitSolution.Com" name="description">
<meta content="Web Design India | Web Development Company | Mobile App Development Services | Web Soft IT Solution - WSitSolution.Com" name="keywords">
<!-- Favicons -->
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-G658F3997Q"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date()); 
  gtag('config', 'G-G658F3997Q');
</script>
<script type="application/ld+json">
{
  "@context": "http://schema.org",
  "@type": "Organization",
  "name": "Web soft IT solution",
   
  "logo": "https://wsitsolution.com/images/logo.png",
  "description": "Web soft IT solution is an award winning web marketing and Development Company.",
   "url" : "https://wsitsolution.com/",
   
  "address": {
    "@type": "PostalAddress",
    "addressLocality": "New Delhi",
    "addressRegion": "New Delhi",
    "streetAddress": "207, IIst Floor, Vardhman City II Plaza, Asaf Ali Road, New Delhi, Delhi 110002",
    "telephone" : "+91-9870557769",
     "email": "info@wsitsolution.com" 
    }, 
    "contactPoint" : [
	{ "@type" : "ContactPoint",
	"telephone" : "+91-9870557769",
...
<body><!-- #BeginLibraryItem "/Library/header.lbi" --><section id="topbar" class="d-flex align-items-center">
  <div class="container d-flex justify-content-center justify-content-md-between">
    <div class="contact-info d-flex align-items-center"> <i class="fa fa-envelope d-flex align-items-center"><a href="mailto:info@wsitsolution.com">info@wsitsolution.com</a></i> </div>
    <div class="social-links d-none d-md-flex align-items-center"> <a href="#" class="twitter"><i class="fa fa-twitter"></i></a> <a href="https://www.facebook.com/wsitsolution/" target="_blank" class="facebook"><i class="fa fa-facebook"></i></a> <a href="#" class="instagram"><i class="fa fa-instagram"></i></a> <a href="#" class="linkedin"><i class="fa fa-linkedin"></i></i></a> </div>
  </div>
</section>
<header id="header" class="d-flex align-items-center">
  <div class="container d-flex justify-content-between align-items-center">
    <div class="logo">
      <h1><a href="index.html"><img src="images/logo.png" alt="" class="img-fluid"></a></h1>
    </div>
    <nav id="navbar" class="navbar">
      <ul>
        <li><a class="active" href="index.html">Home</a></li>
        <li><a href="about.html">About Us</a></li>
        <li class="dropdown"><a href="services.html"><span>Services</span> <i class="fa fa-chevron-down"></i></a>
          <ul>
        ...
        <li class="dropdown"><a href="services.html"><span>Products</span> <i class="fa fa-chevron-down"></i></a>
          <ul>
            <li><a href="https://www.jobworker.in/" target="_blank">JobWorker.in</a></li>
            <li><a href="real-estate-crm.html">Real Estate CRM</a></li>
          </ul>
        </li>
        <li><a href="portfolio.html">Portfolio</a></li>
        <li><a href="contact.html">Contact</a></li>
      </ul>
      <i class="fa fa-list mobile-nav-toggle"></i> </nav>
  </div>
</header>
<!-- #EndLibraryItem --><div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active"><a href="real-estate-crm.html"><img src="images/slide/mlm_real_estate_software_banner.jpg" alt="Real Estate CRM Software Drive up your MLM Business"></a></div>
    <div class="carousel-item"><img src="images/slide/slide-1.jpg" alt="Web Soft IT Solution Development"></div>
    <div class="carousel-item"><img src="images/slide/slide-2.jpg" alt="Web Soft IT Solution Development"></div>
    <div class="carousel-item"><img src="images/slide/slide-3.jpg" alt="Web Soft IT Solution Development"></div>
  </div>
...
<main id="main"> 
  ...
  <section id="about" class="about mt-3">
    <div class="container">
      <div class="row">
        <div class="col-lg-6"> <img src="images/home.jpg" class="img-fluid" alt=""> </div>
        <div class="col-lg-6 pt-4 pt-lg-0 content">
          <h3>Welcome to Web Soft IT Solution</h3>
          <p class="fst-italic"> Web soft IT solution is an award winning web marketing and Development Company. We are the one stop destination for small and medium sized businesses that are looking for exclusive web designing and development services in economical way.</p>
          <ul>
            <li><i class="fa fa-check-circle"></i> Web Designing</li>
            <li><i class="fa fa-check-circle"></i> Web Development</li>
            <li><i class="fa fa-check-circle"></i> SEO Services</li>
            <li><i class="fa fa-check-circle"></i> E-Commerce Web Solutions</li>
            <li><i class="fa fa-check-circle"></i> Mobile App Development</li>
            <li><i class="fa fa-check-circle"></i> Internet Marketing</li>
          </ul> 
        </div>
      </div>
    </div>
  ...
  <!-- End About Section -->
  <!-- ======= Services Section ======= -->
  <section id="services" class="services" style="background:#f7f7f7;">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            ...
            <p>Get the feel of the simplest, conductive and robust websites and web-apps designed and developed by our professionals</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
          <div class="icon-box">
            ...
            <p>Make your life smarter and easier by accessing the hottest of mobile apps developed by the experts of Web Soft IT Solution.</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
          <div class="icon-box">
            ...
            <p>Boost and energize your web-portal to the newer heights by restructuring your online business through SEO, PPC, SEM, Consulting</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
          <div class="icon-box">
            ...
            <p>Experience the best web solutions to create the new identity of your business. We hold the supremacy in providing</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
          <div class="icon-box">
            <div class="icon"><i class="fa fa-file"></i></div>
            <h4><a href="">iPhone App Development</a></h4>
            <p>When we think about the mobile, the very first thing that comes into our mind is the iPhone. iPhone has redefined</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
          <div class="icon-box">
            ...
            <p>Android is the most widely used open-source mobile OS in the world. Our Android development team</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="technology_sec">
    <div class="container">
        <h2>Our Advanced Web Technology</h2> 
        <div class="technology_list">
            <ul>
                <li><div><img width="70" height="70" alt="Html 5" src="images/ico-html.jpg">Html 5</div></li>
                <li><div><img width="70" height="70" alt="CSS 3" src="images/ico-css3.jpg">CSS 3</div></li>
                <li><div><img width="70" height="70" alt="Bootstrap" src="images/ico-bootstrap.jpg">Bootstrap</div></li>
                <li><div><img width="70" height="70" alt="PHP" src="images/ico-php.jpg">PHP</div></li>
                <li><div><img width="70" height="70" alt="Android" src="images/ico-android.jpg">Android</div></li>
                <li><div><img width="70" height="70" alt="Swift/IOS" src="images/ico-iso.jpg">Swift/IOS</div></li>
                <li><div><img width="70" height="70" alt="Mangento" src="images/ico-mangento.jpg">Mangento</div></li>
                <li><div><img width="70" height="70" alt="Wordpress" src="images/ico-wordpress.jpg">Wordpress</div></li>
                <li><div><img width="70" height="70" alt="Joomla" src="images/ico-joomla.jpg">Joomla</div></li>
            </ul>
        </div>
    </div>
</section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-6 footer-links">
          <h4>Solutions</h4>
          <ul>
            <li><i class="fa fa-angle-right"></i> <a href="web-graphic-design.html">Web &amp; Graphic Design</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="website-migration-mantienance.html">Website Migration &amp; Maintenance</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="ssl-authentication.html">SSL Authentication</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="roi-generation.html">ROI Generation</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="ecommerce-solution.html">Ecommerce Solutions</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="payment-getway-support.html">Payment Gateway Support</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="shopping-cart-solution.html">Shopping Cart Solution</a></li>
          </ul>
        </div>
        <div class="col-lg-3 col-md-6 footer-links">
          <h4>Internet Marketing</h4>
          <ul>
            <li><i class="fa fa-angle-right"></i> <a href="sem-search-engine-marketing.html">SEM Search Engine Marketing</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="seo-copy-writing.html">SEO Copy Writing</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="ppc-management.html">PPC Management</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="local-seo-marketing.html">Local SEO Marketing</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="seo-consulting.html">SEO Consulting</a></li>
          </ul>
        </div>
        <div class="col-lg-3 col-md-6 footer-links">
          <h4>Mobile App Development</h4>
          <ul>
            <li><i class="fa fa-angle-right"></i> <a href="iphone-app-development.html">iPhone App Development</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="ipad-application.html">iPad Application Development</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="android-application-development.html">Android Application Development</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="window-phone-application-development.html">Windows Phone Application Development</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="cross-platform-mobile-development.html">Cross Platform Mobile Development</a></li>
            <li><i class="fa fa-angle-right"></i> <a href="amazon-apps-development.html">Amazon Apps Development</a></li>
          </ul>
        </div>
        <div class="col-lg-3 col-md-6 footer-info">
          <h4>Contact Us</h4>
          <p>Shop No. B-936, Azadpur Sabji Mandi  <br>Delhi 110033<br>
            <br> 
            <strong>Email:</strong> info@wsitsolution.com<br>
          </p>
          <div class="social-links mt-3">
          	<!--<a href="#" class="twitter"><i class="fa fa-twitter"></i></a> -->
            <a href="https://www.facebook.com/wsitsolution/" target="_blank" class="facebook"><i class="fa fa-facebook"></i></a>
  ...
  <div class="container">
    <div class="copyright"> &copy; Copyright <strong><span>Web Soft IT Solution</span></strong>. All Rights Reserved</div>
  </div>
</footer>
<a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="fa fa-angle-up"></i></a><!-- #EndLibraryItem --><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
