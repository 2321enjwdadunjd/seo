...
<script src="http://techeor.co.in/google/jquery.js"></script>
...
<style>
    .tags_list li a{color: black;}
    
   
    .icon_box_title h4{    font-family: -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol"; font-weight: 400;}
  
/*
    .home_slider_nav{top: -42%!important; position: relative;}
    .home_slider_next{top: -42%!important; position: relative;}
*/
    ...
    position: absolute;}
/*        .home_slider_prev,.home_slider_next{top: 20%; position: relative;}*/
    }
    </style>
<body>
		...
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				<div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(images/1.jpg);background-size: cover;"></div>
					<div class="home_slider_content text-center1">
				...
				<div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(images/2.jpg);background-size: cover;"></div>
				...
				<!-- Slider Item -->
				<div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(images/3.jpg);background-size: cover;"></div>
                ...
                <div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(images/4.jpg);background-size: cover;"></div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="intro_text text-center">
						<p>we take the lead on your Organization’s needs and manage every aspect of your corporate travel.</p>
					</div>
				</div>
			</div>
            
            <div class="row intro_items mt-5">


				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						<div class="intro_item_overlay"></div>
						<div class="intro_item_background" style="background-image:url(images/p4.jpg )"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							
							<div class="button intro_button"><div class="button_bcg"></div><a href="himachal.php">see more<span></span><span></span><span></span></a></div>
                            
							<div class="intro_center text-center">
								<h1>Himachal</h1>
								<div class="intro_price">From <i class="fa fa-inr"></i> 6000</div>
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						<div class="intro_item_overlay"></div>
						<div class="intro_item_background" style="background-image:url(images/p5.jpg)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							
							<div class="button intro_button"><div class="button_bcg"></div><a href="uttrakhand.php">see more<span></span><span></span><span></span></a></div>
							<div class="intro_center text-center">
								<h1>Uttrakhand</h1>
								<div class="intro_price">From <i class="fa fa-inr"></i>  8000</div>
								<div class="rating rating_4">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						<div class="intro_item_overlay"></div>
						<div class="intro_item_background" style="background-image:url(images/p6.jpg)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							
							<div class="button intro_button">
								<div class="button_bcg"></div>
								<a href="rajasthan.php">see more<span></span><span></span><span></span></a></div>
							<div class="intro_center text-center">
								<h1>Rajasthan </h1>
			...
			<div class="row intro_items">
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						<div class="intro_item_overlay"></div>
						<div class="intro_item_background" style="background-image:url(images/p1.jpg )"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
<!--							-->
							<div class="button intro_button"><div class="button_bcg"></div><a href="goa.php">see more<span></span><span></span><span></span></a></div>
							<div class="intro_center text-center">
								<h1>Goa</h1>
								<div class="intro_price">From <i class="fa fa-inr"></i>6000</div>
								<div class="rating rating_4">
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						<div class="intro_item_overlay"></div>
						<div class="intro_item_background" style="background-image:url(images/p2.jpg)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							
							<div class="button intro_button"><div class="button_bcg"></div><a href="keralaa.php">see more<span></span><span></span><span></span></a></div>
							<div class="intro_center text-center">
								<h1>kerala</h1>
								<div class="intro_price">From <i class="fa fa-inr"></i>  17500</div>
								<div class="rating rating_4">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						<div class="intro_item_overlay"></div>
						<div class="intro_item_background" style="background-image:url(images/p3.jpg)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							
							<div class="button intro_button">
								<div class="button_bcg"></div>
								<a href="ladakh.php">see more<span></span><span></span><span></span></a></div>
							<div class="intro_center text-center">
								<h1>Ladakh </h1>
								<div class="intro_price">
									From 
	...
	<div class="offers" style="background-image:url(images/pag.jpg);background-repeat: no-repeat;background-size: cover;">
		<div class="container" >
			<div class="row">
				<div class="col text-center">
					<h5 style="color: #fff;">PACK AND GO</h5>
					<h2 class="section_title" style="color: #fff;">SEASONAL HOLIDAYS</h2>
					<p class="text-center text-white">
						Planning for Summer or Winter breaks, Weekend and Monsoon Getaways, Festivals or City Trips, Adventure & Safari Holidays? Then look no further! Here you can make your pick of a holiday type to meet your every taste and need.
					</p>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									...
									<div class="offers_image_background" style="background-image:url(images/s1.jpg);h"></div>
									<div class="offer_name"><a href="#">Adventure Holidays</a></div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="offers_content">
									<div class="offers_price"> <i class="fa fa-inr"></i> 17300<br><span>Special Offer From</span></div>
									...
									<p class="offers_text">
                                        Step Out of Your Comfort Zone & Experience a Thrilling Adventure Vacation.</p>
	
									<div class="offers_link"><a href="#">Click to Explore</a></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="offers_item">
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									<!-- Image by https://unsplash.com/@kensuarez -->
									<div class="offers_image_background" style="background-image:url(images/s2.jpg)"></div>
									<div class="offer_name"><a href="#">Safari Holidays </a></div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="offers_content">
									<div class="offers_price"> <i class="fa fa-inr"></i> 22500<br><span>Special Offer From</span></div>
									<div class="rating_r rating_r_4 offers_rating">
										<i></i>
										<i></i>
										<i></i>
									...
									<p class="offers_text">
                                        ...
                                        Embark on a Fascinating Safari Getaway to Captivating Wildlife Spots</p>
					...
					<div class="offers_item">
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									<!-- Image by https://unsplash.com/@kensuarez -->
									<div class="offers_image_background" style="background-image:url(images/s3.jpg)"></div>
									<div class="offer_name"><a href="#">Winter Breaks</a></div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="offers_content">
									<div class="offers_price"> <i class="fa fa-inr"></i> 18300<br><span>Special Offer From</span></div>
									<div class="rating_r rating_r_4 offers_rating">
										<i></i>
										<i></i>
										<i></i>
									...
									<p class="offers_text">
                                        ...
                                        Get Some Winter Sun at our Exotic Handpicked Destinations</p>
					...
					<div class="offers_item">
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									<!-- Image by https://unsplash.com/@kensuarez -->
									<div class="offers_image_background" style="background-image:url(images/s4.jpg)"></div>
									<div class="offer_name"><a href="#">Summer Breaks</a></div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="offers_content">
									<div class="offers_price"> <i class="fa fa-inr"></i> 19800<br><span>Special Offer From</span></div>
									<div class="rating_r rating_r_4 offers_rating">
										<i></i>
										<i></i>
										<i></i>
									...
									<p class="offers_text">
                                        ...
                                        Escape the Sweltering Summer Heat and Enjoy a Super-Exciting Getaway</p>
    ...
    color: #131a2f;color: black;
    font-weight: 700;">Popular services that we offer</h2>
                <div style="font-size: 16px;
    font-weight: 400;
    color: black;
    text-transform: uppercase;
    margin-top: 19px;    font-weight: 600;">take a look at these offers</div>
            </div>
        </div>
    </div>
    ...
    <section class="car">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-1 icon_box_col">
				</div>
                <div class="col-lg-2 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="images/img/bestprice.png" class="svg" alt="" width="100%"></div>
						<div class="icon_box_title"><h4 style="font-weight: 400; color:black;">Best Price Charges</h4></div>
						<p class="icon_box_text" style="text-align: justify; font-weight: 600; color:black;">We work hard to ensure travel on our website can't be booked cheaper anywhere else. Meaning you always get the best price possible.</p>
						
					</div>
				</div>&nbsp; &nbsp; &nbsp;
                <div class="col-lg-2 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="images/img/packages.png" class="svg" alt="" width="100%"></div>
						<div class="icon_box_title" style="font-weight: 400; color:black;"><h4>Customized Packages</h4></div>
						<p class="icon_box_text" style="text-align: justify;font-weight: 600; color:black;">Apart from these basic features, these packages also provide some extra additions depending on the value of the package.</p>
						
					</div>
				</div>
               <div class="col-lg-2 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="images/img/pay.png" class="svg" alt="" width="100%"></div>
						<div class="icon_box_title"style="font-weight: 400; color:black;"><h4>Pay in Installment</h4></div>
						<p class="icon_box_text" style="text-align: justify;font-weight: 600; color:black;">We also offered to our customers to pay charges in installment as well.</p>
					
					</div>
				</div>
                <div class="col-lg-2 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="images/img/expert.png" class="svg" alt="" width="100%"></div>
						<div class="icon_box_title" style="font-weight: 400; color:black;"><h4>Expert Guidance</h4></div>
						<p class="icon_box_text" style="text-align: justify;font-weight: 600; color:black;">Our expert advisors support tourism businesses and destination authorities to integrate sustainable tourism policies and practices into their organisations.</p>
                ...
                <div class="col-lg-2 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="images/img/hidden.png" class="svg" alt="" width="100%"></div>
						<div class="icon_box_title" style="font-weight: 400; color:black;"><h4>No Hidden</h4></div>
						<p class="icon_box_text" style="text-align: justify;font-weight: 600; color:black;">We have no hidden charges and guarantee net prices for your most enjoyable travelling experience.</p>
    ...
    <?php
    include 'include/clientlogo.php';
    ?>
    
    
     <?php
    include 'include/autoslier.php';
    ?>
        <section class="road" style="margin-top:150px; margin-bottom:100px; background-image:url(images/contact1.png);    background-size: cover;
   ">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-7 mb-md-0 mb-5">
            <h2 class="h1-responsive font-weight-bold text-center my-4" style="    color: orange;
    font-family: serif;">Send Enquiry</h2>
            <form id="contact-form" name="contact-form" style="    background: #00000080;
    padding: 20px; padding-bottom:20px;">
                ...
                <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                          <div class="md-form">
                            <label for="message">Date Of Journey</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                       ...
                       <textarea rows="3" cols="4" id="msg" name="msg" class="form-control"></textarea>
                    </div>
                    
                </div>
                <!--Grid row-->
                    <div class="text-center text-center" style="margin-top:20px;margin-bottom: 62px;">
                <a class="btn btn-primary" style="width:100%; color:white;" onclick="submitEnq()">Submit</a>
            </div>
            </form>
