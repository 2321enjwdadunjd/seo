...
<?php 
            $sql3 = "SELECT * FROM `tb1_admin`";
            $run3 = mysqli_query($db,$sql3) or die("Query Not run");
            $data3 = mysqli_fetch_assoc($run3);
            //  seo work 
            
            $sql1 = "SELECT * FROM `tb_seo`";
            $run1 = mysqli_query($db,$sql1) or die("Query Not run");
            $data1 = mysqli_fetch_assoc($run1);
    ?>
<title><?php echo $data3['meta_title']?></title>
    <meta name="description" content="<?php echo $data3['meta_desc']?>">
    <?php echo $data1['index_follow']; ?><br>
    <meta name="google-site-verification" content="<?php echo $data1['site_verification']; ?>" />
    <?php echo $data1['google']; ?>
</head>
<body>
...
<!--    	<img class="img-fluid" src="image/logo/logo.png">-->
<!--    </a>-->
...
<?php include 'header.php';?>
  ...
  <div class="carousel-inner">
      <?php 
            // include_once('admin/config.php');
            $sql2 = "SELECT * FROM `tb3_slider`";
            $run2 = mysqli_query($db,$sql2) or die("Query Not run");
            while($data2 = mysqli_fetch_assoc($run2)){
        ?>
    <div class="carousel-item <?php echo ($data2['id'] == 3) ? 'active':'';?>">
      <img class="img-fluid" src="image/<?php echo $data2['image_name']?>" class="d-block w-100" alt="<?php echo $data2['image_name']?>">
    </div>
    <?php } ?>
    <!--<div class="carousel-item">-->
    <!--  <img class="img-fluid" src="image/slider2.png" class="d-block w-100" alt="...">-->
    <!--</div>-->
    <!--<div class="carousel-item">-->
    <!--  <img class="img-fluid" src="image/slider3.png" class="d-block w-100" alt="...">-->
    <!--</div>-->
  </div>
    ...
    <span class="visually-hidden">Next</span>
		...
		<div class="filter-btnn">
			<div id="myBtnContainer">
                <button class="filter-btn-f active" onclick="filterSelection('woman')">Women</button>
                <button class="filter-btn-m" onclick="filterSelection('men')">Men</button>
            </div>
        </div>
            ...
            <div class="filter-container">
            			...
            			<div class="row services">
            			 <?php 
                            include_once('admin/config.php');
                            $sql4 = "SELECT * FROM `tb_service_cat` ORDER BY id";
                            $run4 = mysqli_query($db,$sql4) or die("Query Not run");
                            while($data4 = mysqli_fetch_assoc($run4)){
                                if(mysqli_num_rows($run4) > 0){
                        ?>
            	    <div style="background-image: url(image/<?php echo $data4['image']?>); background-repeat:no-repeat; background-size:cover; " class="filterDiv <?php echo $data4['gen']?>"><div class="service-title"><a href="service.php?id=<?php echo $data4['id']?>"><?php echo $data4['name']?></a></div></div>
            		<?php }} ?>
            		<!--<div style="background-image: url(image/service/men-facial.jpg); background-repeat:no-repeat; background-size:cover;" class="filterDiv men"><div class="service-title"><a href="men-beauty.php">Beauty</a></div></div>-->
     <!--       		<div style="background-image: url(image/service/men-hair-smoothing.jpg); background-repeat:no-repeat; background-size:cover;" class="filterDiv men"><div class="service-title"><a href="keratin.php">Keratin</a></div></div>-->
     <!--       		<div style="background-image: url(image/service/men-hair-color.jpg); background-repeat:no-repeat; background-size:cover;" class="filterDiv men"><div class="service-title"><a href="hair-color.php">Colour</a></div></div>-->
     <!--       		<div style="background-image: url(image/service/men-hair-spa.jpg); background-repeat:no-repeat; background-size:cover;" class="filterDiv men"><div class="service-title"><a href="hair-spa.php">Hair Spa</a></div></div>-->
            		<!--<div style="background-image: url(image/service/men-facial.jpg); background-repeat:no-repeat; background-size:cover;" class="filterDiv men"><div class="service-title"><a href="facial.php">facial</a></div></div>-->
     <!--       		<div style="background-image: url(image/service/men-cleanup.jpg); background-repeat:no-repeat; background-size:cover;" class="filterDiv men"><div class="service-title"><a href="cleanup.php">Cleanup</a></div></div>-->
     <!--       		<div style="background-image: url(image/service/men-waxing.jpg); background-repeat:no-repeat; background-size:cover;" class="filterDiv men"><div class="service-title"><a href="waxing.php">Waxing</a></div></div>-->
					<!--<div style="background-image: url(image/service/men-threading.png); background-repeat:no-repeat; background-size:cover;" class="filterDiv men"><div class="service-title"><a href="threading.php">Threading</a></div></div>-->

            		<!--<div style="background-image: url(image/service/hair-cutting-slider.jpg); background-repeat:no-repeat; background-size:cover; " class="filterDiv woman"><div class="service-title"><a href="women-hair.php">Hair</a></div></div>-->
            		<!--<div style="background-image: url(image/service/facial-slider.png); background-repeat:no-repeat; background-size:cover;" class="filterDiv woman"><div class="service-title"><a href="beauty.php">Beauty</a></div></div>-->
            		<!--<div style="background-image: url(image/service/nails.png); background-repeat:no-repeat; background-size:cover; "  class="filterDiv woman"><div class="service-title"><a href="women-nails.php">Nails</a></div></div>-->
            		<!--<div style="background-image: url(image/service/makeup.png); background-repeat:no-repeat; background-size:cover; " class="filterDiv woman"><div class="service-title"><a href="makeup.php">Make Up</a></div></div>-->
            		<!--<div style="background-image: url(image/service/semi-permanent-makeup.png); background-repeat:no-repeat; background-size:cover; " class="filterDiv woman"><div class="service-title"><a href="semi-permanent-makeup.php">Semi-Permanent Make Up</a></div></div>-->
     <!--       		<div style="background-image: url(image/service/); background-repeat:no-repeat; background-size:cover;" class="filterDiv woman"><div class="service-title"><a href="women-facial.php">Dermatology</a></div></div>-->
     <!--       		<div style="background-image: url(image/service/facial-slider2.png); background-repeat:no-repeat; background-size:cover;" class="filterDiv woman"><div class="service-title"><a href="women-cleanup.php">Heaven Spa</a></div></div>-->
     <!--       		<div style="background-image: url(image/service/waxing-slider.jpg); background-repeat:no-repeat; background-size:cover;"  class="filterDiv woman"><div class="service-title"><a href="women-waxing.php">Hands & Feet</a></div></div>-->
					<!--<div style="background-image: url(image/service/threading-slider.jpg); background-repeat:no-repeat; background-size:cover;"  class="filterDiv woman"><div class="service-title"><a href="women-threading.php">Scrubs & Wraps</a></div></div>-->
