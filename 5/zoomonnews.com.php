...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-16 hot-news hidden-xs">
            <div class="row">
                <!--PHP code Breaking_News table in fetch today-data and print code start -->
                <?php
			           $query = "SELECT COUNT(*) FROM masnews WHERE isBreaking='1' AND status ='1' AND entDate >= NOW() - INTERVAL 5 hour";
                ...
                <?php
                       $sql = "SELECT * FROM masnews WHERE isBreaking='1' AND status ='1' AND entDate >= NOW() - INTERVAL 5 hour";     //Fetch data into masnews(Breaking_news) table & Display in Table
                       $result = mysqli_query($con, $sql);
                       while ($row = mysqli_fetch_array($result))  // While Loop start
                       {
                          $nId = $row['nId'];
						  $title = $row['title'];
                ?>
                            <li class="news-item"><a href="news_details.php?nId=<?php echo $nId; ?>"><h1><?php echo $title; ?></h1></a></li>
                <?php } } ?>
                        <!--PHP code breaking_news table in fetch today-data and print code end -->
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-16 col-md-10 col-lg-8">
                    ...
                    <div id="sync1" class="owl-carousel">
                        <?php
                              /* $sql = "SELECT masnews.nId,masnews.nTypeId,masusertype.uType,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
							   Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
							   Inner JOIN transnewstag ON transnewstag.nId = masnews.nId 
							   Inner JOIN mastag ON mastag.tagId = transnewstag.tagId 
							   Inner JOIN masmenu On masmenu.mId = masnews.mId  
							   Inner JOIN masuser On masuser.uId = masnews.uId Where  masnews.nTypeId='1' AND masnews.status='1' Group By nId ORDER BY nId DESC LIMIT 10";  */    //Fetch data into masnews table & Display in Table 
							   
							   $sql = "(SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,masmenu.mId,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
						       Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
						       Inner Join transnewstag ON transnewstag.nId = masnews.nId 
						       Inner Join mastag ON mastag.tagId = transnewstag.tagId 
						       Inner Join masmenu On masmenu.mId = masnews.mId 
						       Inner Join  masusertype On masusertype.uTypeId = masnews.uId 
							   Where   masnews.nTypeId='1'  and masnews.status='1' and masnews.mId=1 Group By nId DESC LIMIT 2 )
                               UNION 
							  ( SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,masmenu.mId,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
						       Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
						       Inner Join transnewstag ON transnewstag.nId = masnews.nId 
						       Inner Join mastag ON mastag.tagId = transnewstag.tagId 
						       Inner Join masmenu On masmenu.mId = masnews.mId 
						       Inner Join  masusertype On masusertype.uTypeId  = masnews.uId
							    Where  masnews.nTypeId='1'  and masnews.status='1' and masnews.mId=2 Group By nId DESC LIMIT 2)
							   UNION
                            ( SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,masmenu.mId,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
						       Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
						       ...
						       Inner Join masmenu On masmenu.mId = masnews.mId 
						       Inner Join  masusertype On masusertype.uTypeId  = masnews.uId 
							   Where  masnews.nTypeId='1'  and masnews.status='1' and masnews.mId=3 Group By nId DESC LIMIT 2)
							   UNION
							    ( SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,masmenu.mId,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
						       Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
						       ...
						       Inner Join masmenu On masmenu.mId = masnews.mId 
						       Inner Join  masusertype On masusertype.uTypeId  = masnews.uId 
							   Where  masnews.nTypeId='1'  and masnews.status='1' and masnews.mId=4 Group By nId DESC LIMIT 2)
							   UNION
							    ( SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,masmenu.mId,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
						       Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
						       ...
						       Inner Join masmenu On masmenu.mId = masnews.mId 
						       Inner Join  masusertype On masusertype.uTypeId  = masnews.uId 
							   Where  masnews.nTypeId='1'  and masnews.status='1' and masnews.mId=5 Group By nId DESC LIMIT 2)
							   UNION
							    ( SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,masmenu.mId,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
						       Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
						       ...
						       Inner Join masmenu On masmenu.mId = masnews.mId 
						       Inner Join  masusertype On masusertype.uTypeId  = masnews.uId 
							   Where  masnews.nTypeId='1'  and masnews.status='1' and masnews.mId=6 Group By nId DESC LIMIT 2)
							   UNION
							    ( SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,masmenu.mId,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
						       Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
						       ...
						       Inner Join masmenu On masmenu.mId = masnews.mId 
						       Inner Join  masusertype On masusertype.uTypeId  = masnews.uId 
							   Where  masnews.nTypeId='1'  and masnews.status='1' and masnews.mId=7 Group By nId DESC LIMIT 2)
							   UNION
							    ( SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,masmenu.mId,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
						       Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
						       ...
						       Inner Join masmenu On masmenu.mId = masnews.mId 
						       Inner Join  masusertype On masusertype.uTypeId  = masnews.uId 
							   Where  masnews.nTypeId='1' and masnews.status='1' and masnews.mId=8 Group By nId DESC LIMIT 2)
							   UNION
							    ( SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,masmenu.mId,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
						       Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
						       ...
						       Inner Join masmenu On masmenu.mId = masnews.mId 
						       Inner Join  masusertype On masusertype.uTypeId  = masnews.uId 
							   Where  masnews.nTypeId='1'  and masnews.status='1' and masnews.mId=9 Group By nId DESC LIMIT 2)
							   UNION
							    ( SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,masmenu.mId,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
						       Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
						       ...
						       Inner Join masmenu On masmenu.mId = masnews.mId 
						       Inner Join  masusertype On masusertype.uTypeId  = masnews.uId 
							   Where  masnews.nTypeId='1'  and masnews.status='1' and masnews.mId=10 Group By nId DESC LIMIT 2)
							   UNION
							    ( SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,masmenu.mId,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
						       Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
						       ...
						       Inner Join masmenu On masmenu.mId = masnews.mId 
						       Inner Join  masusertype On masusertype.uTypeId  = masnews.uId 
							   Where  masnews.nTypeId='1'  and masnews.status='1' and masnews.mId=11 Group By nId DESC LIMIT 2)";
                                ...
                                while ($row = mysqli_fetch_array($result))  // While Loop start
                                {
								   ...
								   $tagName = $row['tagName'];
  								   ...
  								   $sql1 = "Select * from transnewsurl where nid='".$nId."'";    //nid through fetch image into tansnewsurl  table

  								   $result1 = mysqli_query($con,$sql1);
 								   while($row1= mysqli_fetch_array($result1))
  								   {
     							      $newsUrl=$row1['newsUrl'];
  								   }
                        ?>
                            <div class="box item"><a href="news_details.php?nId=<?php echo $nId; ?>">
                                    <!--nid through redirect news_details.php page -->
                                    <div class="carousel-caption" style="color:#f1430f"><?php echo $title; ?></div>
                                    <img class="img-responsive" src="../images/news/<?php echo $newsUrl; ?>" width="100%" height="50px" alt="" style="height:300px;"/>
                                    <div class="overlay"></div>
                                    <div class="overlay-info">
                                        <div class="cat">
                                            <p class="cat-data" style="color:#f1430f"><span class="ion-pricetag icon"></span>
											<?php echo $tagName; ?></p>
                                        </div>
                                        <div class="info">
                                            <p style="color:#f1430f"><span class="ion-android-data"></span><?php echo date('d/m/Y h:i:s a', strtotime($entDate));?>
											<spanclass="ion-eye"></span><?php echo $views; ?></p>
                                        </div>
                                    </div>
                                </a></div>
                      <?php } ?>
                      ...
                      <?php
                            ...
                            ( SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,masmenu.mId,
						       ...
						       Inner Join  masusertype On masusertype.uTypeId  = masnews.uId 
							   Where  masnews.nTypeId='1' and masnews.status='1' and masnews.mId=8 Group By nId DESC LIMIT 2)";
                            // $sql = "SELECT * FROM masnews where nTypeId='1' and status ='1'";      //Fetch data into news table & Display in Table
                       ...
                       ?>
								...
								<img class="img-responsive" src="../images/news/<?php echo $newsUrl; ?>" width="1600px"  height="972" alt=""/>
								</div>
                       <?php } ?>
                        </div>
                    </div>
                </div>
                <!--news order by desc in after 10th news display one code start-->
                <div class="col-sm-6 col-md-6 col-lg-8 hidden-sm hidden-xs">
                      <?php
					         ...
					         Inner Join masmenu ON masmenu.mId = masnews.mId 
					         Inner Join  masusertype On masusertype.uTypeId  = masnews.uId 
							 Where masnews.nTypeId='1' and masnews.status='1' Group By nId ORDER BY nId DESC LIMIT 10,1";
                      ...
                      ?>
                         <div class="row">
							 ...
							 <a href="news_details.php?nId=<?php echo $nId; ?>">
                                <!--nId through redirect news_details.php page -->
                                <div class="box">
                                    <div class="carousel-caption" style="color:#f1430f"><?php echo $title; ?></div>
                                    <img class="match-height" src="../images/news/<?php echo $newsUrl; ?>" width="236" height="378"
                                         alt=""/>
                                    <div class="overlay"></div>
                                    <div class="overlay-info">
                                        <div class="cat">
                                            <p class="cat-data" style="color:#f1430f">
											<span class="ion-pricetag icon"></span><?php echo $tagName; ?></p>
                                        </div>
                                        <div class="info">
                                            <p style="color:#f1430f"><span class="ion-android-data"></span><?php echo date('d/m/Y h:i:s a', strtotime($entDate));?>
											<span class="ion-eye"></span><?php echo $views; ?></p>
                                        </div>
                                    </div>
                                </div>
                            </a></div>
                      <?php } ?>
                        <!--news order by desc in after 10th news display one code end-->

                        <!--LIVE TV code start in index page -->
                         <div class="col-sm-16 col-md-16 col-lg-10">
               
                 
				   <?php  include('right_sponsor1.php'); ?>
    ...
    <div class="row ">
        ...
        <div class="col-md-11 col-sm-11">
            <div class="row">
                ...
                <!--1st menu news display code start -->
                <div class="col-sm-16 business  wow fadeInDown animated" data-wow-delay="1s" data-wow-offset="50">
                    <div class="main-title-outer pull-left">
                        <?php
							   $sql = "SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,
						       GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
						       Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
						       Inner Join transnewstag ON transnewstag.nId = masnews.nId 
						       Inner Join mastag ON mastag.tagId = transnewstag.tagId 
						       Inner Join masmenu On masmenu.mId = masnews.mId 
						       Inner Join  masusertype On masusertype.uTypeId  = masnews.uId 
							   Where  masnews.nTypeId='1' and masnews.status='1'  and masnews.mId=1 Group By nId ORDER BY nId DESC LIMIT 1";
                        ...
                        ?>
                        <div class="main-title"><?php echo $mName; ?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-11 col-sm-16">
                            <div class="row">
                                <div class="col-md-8 col-sm-9 col-xs-16">
                                    <div class="topic">
                                        <a href="news_details.php?nId=<?php echo $nId; ?>">
                                            <img class="img-thumbnail" src="../images/news/<?php echo $newsUrl; ?>" width="600"
                                                 height="398" alt=""/>
                                            <h3><?php echo $title; ?></h3>
                                            <div class="text-danger sub-info-bordered">
                                                <div class="time">
                                                    <span class="ion-android-data icon"></span><?php echo date('d/m/Y h:i:s a', strtotime($entDate));?>
                                                </div>
                                                <div class="comments">
                                                    <span class="ion-eye icon"></span><?php echo $views; ?> Views
                                                </div>
                                            </div>
                                            <p><?php echo $small = substr($description, 0, 350); ?>.....</p>
                                        </a>
                                    </div>
                                </div>
                       <?php } ?>
					   ...
					   <?php
						      $sql = "SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masmenu.mId,masnews.title,masnews.description,masnews.views,masnews.entDate,
							  GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
							  Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
							  Inner Join transnewstag ON transnewstag.nId = masnews.nId 
							  Inner Join mastag ON mastag.tagId = transnewstag.tagId 
							  Inner Join masmenu On masmenu.mId = masnews.mId 
							  Inner Join  masusertype On masusertype.uTypeId = masnews.uId
							   Where masnews.nTypeId='1' and masnews.mId=1 and masnews.status='1' Group By nId ORDER BY nId DESC LIMIT 4";
                          ...
                          ?>
                                            <li><a href="news_details.php?nId=<?php echo $nId; ?>">
                                                    <div class="row">
                                                        <div class="col-sm-5 hidden-sm hidden-md">
                                                            <img class="img-thumbnail pull-left"
                                                                 src="../images/news/<?php echo $newsUrl; ?>" width="76" height="76"
                                                                 alt=""/></div>
                                                        <div class="col-sm-16 col-md-16 col-lg-11">
                                                            <h4><?php echo $title; ?></h4>
                                                            <div class="text-danger sub-info">
                                                                <div class="time"><span
                                                                            class="ion-android-data icon"></span><?php echo date('d/m/Y h:i:s a', strtotime($entDate));?>
                                                                </div>
                                                                <div class="comments"><span
                                                                            class="ion-eye icon"></span><?php echo $views; ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <?php } ?>
                                        <!--1st menu news display code end -->
                                    </ul>
                                    <div align="right"><a href="m_details.php?mId=<?php echo $mId; ?>"
                                                          style="color:#0000FF;">अधिक बातम्यांसाठी येते क्लिक करा...</a></div>
                                </div>
                            </div>
                        </div>
                        <!--Random news Display code start -->
                        <div class="col-md-5 col-sm-16 hidden-sm hidden-xs left-bordered">
                            <div id="vid-thumbs" class="owl-carousel">
                                <div class="item">
                                    <div class="vid-thumb-outer" style="height:420px">
                                        <!--first tab in 2 random news display code start -->
                            <?php
								   $sql = "SELECT masnews.nId,masnews.nTypeId,masusertype.uType,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,
								   GROUP_CONCAT(DISTINCT mastag.tagName) as tagName FROM `masnews` 
								   Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
								   ...
								   Inner Join masmenu On masmenu.mId = masnews.mId 
								   Inner Join  masusertype On masusertype.uTypeId = masnews.uId 
								   Where masnews.nTypeId='1' and masnews.status='1' Group By nId ORDER BY RAND() LIMIT 2 ";
                             ...
                             ?>
                                            <div class="vid-thumb"><a href="news_details.php?nId=<?php echo $nId; ?>">
                                                    <div class="vid-box">
                                                        <img class="img-thumbnail img-responsive"
                                                             src="../images/news/<?php echo $newsUrl; ?>" width="250" height="143"
                                                             alt=""/></div>
                                                    <h4><?php echo $title; ?></h4>
                                                </a></div>
                             <?php } ?>
                                ...
                                <!--First tab in two random news display code end -->

                                <!--Second tab in two random news display code start -->
                                <div class="item">
                                    <div class="vid-thumb-outer" style="height:420px">
                             <?php
								    $sql = "SELECT masnews.nId,masnews.nTypeId,masusertype.uType,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,
                              ...
                              <?php } ?>
                                ...
                                <!--Second tab in two random news display code end -->

                                <!--3rd tab in another two news display code start -->
                                <div class="item">
                                    <div class="vid-thumb-outer" style="height:420px">
                              <?php
							         $sql = "SELECT masnews.nId,masnews.nTypeId,masusertype.uType,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,
                                ...
                                <!--3rd tab in two random news display code end -->
                            </div>
                        </div>
                    </div>
                    <hr>
                </div>
                <!--Random News Display code end -->
                <!-- business end -->
                <!-- Second menu news display code start -->
                <div class="col-sm-16">
                    <div class="row">
                        	  <?php
								    $sql = "SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,
								    ...
								    Inner Join masmenu On masmenu.mId = masnews.mId 
								    Inner Join  masusertype On masusertype.uTypeId = masnews.uId 
									Where masnews.nTypeId='1' and masnews.status='1' and masnews.mId=2 Group By nId ORDER BY nId DESC LIMIT 1";
                                    $result = mysqli_query($con, $sql);
                        			while ($row = mysqli_fetch_array($result))  // While Loop start
                        		    {
                                	   $nId = $row['nId'];
                        ...
                        <div class="col-xs-16 col-sm-8  wow fadeInLeft animated science" data-wow-delay="0.5s" data-wow-offset="130">
                            <div class="main-title-outer pull-left">
                                <div class="main-title"><?php echo $mName; ?></div>
                                <div class="span-outer"><span class="pull-right text-danger last-update"></span></div>
                            </div>
                            <div class="row">
                                <div class="topic col-sm-16"><a href="news_details.php?nId=<?php echo $nId; ?>">
                                        <img style="height:227px;" class=" img-thumbnail" src="../images/news/<?php echo $newsUrl; ?>"
                                             width="600" height="227" alt=""/>
                                        <h3> <?php echo $title; ?></h3>
                                        <div class="text-danger sub-info-bordered ">
                                            <div class="time"><span
                                                        class="ion-android-data icon"></span><?php echo date('d/m/Y h:i:s a', strtotime($entDate));?></div>
                                            <div class="comments"><span
                                                        class="ion-eye icon"></span><?php echo $count; ?> Views
                                            </div>
                                            <p><?php echo $small = substr($description, 0, 400); ?>.....</p>
                                        </div>
                                    </a>
                            <?php } ?>
                               		 </div>
                            ...
                            <?php
								   ...
								   Inner Join masmenu On masmenu.mId = masnews.mId 
								   Inner Join  masusertype On masusertype.uTypeId = masnews.uId 
								   Where masnews.nTypeId='1' and masnews.status='1' and masnews.mId=2 Group By nId ORDER BY nId DESC LIMIT 1,3";
                                            ...
                                            <li><a href="news_details.php?nId=<?php echo $nId; ?>">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-4 hidden-sm  ">
                                                            <img width="76" height="76" alt=""
                                                                 src="../images/news/<?php echo $newsUrl; ?>"
                                                        ...
                                                        <div class="col-lg-13 col-md-12">
                                                            ...
                                                            <div class="text-danger sub-info">
                                                                ...
                                                                <div class="comments">
                                                                    <span class="ion-eye icon"></span><?php echo $views; ?>
                                                                    Views
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <!--Second menu display code end -->

                        <!--3rd menu display code start -->
                        <div class="col-sm-8 col-xs-16 wow fadeInRight animated" data-wow-delay="0.5s"
                            ...
                            <?php
								   ...
								   Inner Join masmenu On masmenu.mId = masnews.mId 
								   Inner Join  masusertype On masusertype.uTypeId = masnews.uId 
								   Where masnews.nTypeId='1' AND masnews.status='1' and masnews.mId=3 Group By nId ORDER BY nId DESC LIMIT 1";
                                ...
                                <div class="topic col-sm-16"><a href="news_details.php?nId=<?php echo $nId; ?>">
                                        ...
                                        <div class="text-danger sub-info-bordered">
                                            <div class="time"><span
                                                        class="ion-android-data icon"></span><?php echo date('d/m/Y h:i:s a', strtotime($entDate));?></div>
                                            <div class="comments"><span
                                                        class="ion-eye icon"></span><?php echo $views; ?> Views
                                            </div>
                                            <p><?php echo $small = substr($description, 0, 400); ?>..... </p>
                                        </div>
                                    </a></div>
                           ...
                           <?php
								  ...
								  Inner Join masmenu On masmenu.mId = masnews.mId 
								  Inner Join  masusertype On masusertype.uTypeId = masnews.uId 
								  Where masnews.nTypeId='1' AND masnews.status='1' and masnews.mId=3 Group By nId ORDER BY nId DESC LIMIT 1,3";
                              ...
                              ?>
                                            <li><a href="news_details.php?nId=<?php echo $nId; ?>">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-4 hidden-sm  ">
														<img width="76" height="76" alt=""  src="../images/news/<?php echo $newsUrl; ?>"  class="img-thumbnail pull-left">
                                                        </div>
                                                        <div class="col-lg-13 col-md-12">
                                                            <h4><?php echo $title; ?> </h4>
                                                            <div class="text-danger sub-info">
                        ...
                        <!--3rd menu news display code endd -->
                    </div>
                    <hr>
                </div>
                <!-- Scince & Travel end -->
        ...
        <div class="col-sm-5 hidden-xs right-sec">
            <div class="bordered top-margin">
                <div class="row ">
                   <!--4th menu display code start -->
                        <div class="col-sm-16 col-xs-16 wow fadeInRight animated" data-wow-delay="0.5s"
                             data-wow-offset="130">
                            <div class="main-title-outer pull-left">
                            <?php
								   $sql = "SELECT masnews.nId,masnews.nTypeId,masmenu.mName,masnews.title,masnews.description,masnews.views,masnews.entDate,
								   ...
								   Inner Join masmenu On masmenu.mId = masnews.mId 
								   Inner Join  masusertype On masusertype.uTypeId = masnews.uId 
								   Where masnews.nTypeId='1' AND masnews.status='1' and masnews.mId=4 Group By nId ORDER BY nId DESC LIMIT 1";
                           ...
                           <?php
								  ...
								  Inner Join masmenu On masmenu.mId = masnews.mId 
								  Inner Join  masusertype On masusertype.uTypeId = masnews.uId 
								  Where masnews.nTypeId='1' AND masnews.status='1' and masnews.mId=4 Group By nId ORDER BY nId DESC LIMIT 1,3";
                        ...
                        <!--4th menu news display code endd -->
                ...
                <div class="col-sm-16 bt-space wow fadeInUp animated" data-wow-delay="1s" data-wow-offset="50">
                           <?php  include('right_sponsor.php'); ?> <br/>
        ...
        <div class="col-sm-16 wow fadeInUp animated " data-wow-delay="0.5s" data-wow-offset="100">
            ...
            <div class="main-title-outer pull-left">
                <div class="main-title">Photo Gallery</div>
            </div>
            <div class="row">
                <div id="owl-lifestyle" class="owl-carousel owl-theme lifestyle pull-left">

                    <!--Dynamic multiple image display (only first_image) code start -->
                          <?php
					             $sql = "SELECT transnewsurl.tnuId,transnewsurl.nid,transnewsurl.newsUrl,masnews.title,masnews.nTypeId,masnews.description,masnews.status,masnews.views,masnews.entDate,
					             COUNT(*) ,GROUP_CONCAT(DISTINCT newsUrl) as image FROM transnewsurl 
								 Inner JOIN masnews ON masnews.nId = transnewsurl.nid 
							  	 WHERE masnews.status='1' 
								 GROUP BY transnewsurl.nid HAVING COUNT(*) > 1  ORDER BY `masnews`.`nId` DESC";

                    		 	 //Data display in order by Desc order
                    			 $result = mysqli_query($con, $sql);
                    			 while ($row = mysqli_fetch_array($result))  // While Loop start
                    			 {
                        	        $nid = $row['nid'];
									...
									$image = $row['image'];
                          ?>
                        <div class="item topic"><a href="news_details.php?nId=<?php echo $nid; ?>">
                                <img style="height:220px;" class="img-thumbnail" src="../images/news/<?php echo $newsUrl; ?>"
                                     width="300" height="132" alt=""/>
                                <h4 style="height:40px;"><?php echo $title; ?></h4>
                                <div class="text-danger sub-info-bordered remove-borders">
								<div class="time">
									<span class="ion-android-data icon"></span><?php echo date('d/m/Y h:i:s a', strtotime($entDate));?>
                                </div>
                                <div class="comments">
						            <span class="ion-eye icon">
									</span><?php echo $views; ?> Views </div>                                 
                                </div>
                            </a></div>
                          <?php } ?>
                </div>
        ...
        <div class="col-xs-16 banner  pull-left  wow fadeInLeft animated" data-wow-delay="0.5s" data-wow-offset="50">
            <div class="row">
                <div class="main-title">Videos Gallery</div>
                <div id="banner-thumbs" class="owl-carousel">

                          <?php
					             $sql = "SELECT masnews.nId,masnews.nTypeId,transnewsurl.newsUrl,masnews.title,masnews.description,masnews.views,masnews.entDate
							 	  FROM `masnews`
								 Inner JOIN transnewsurl ON transnewsurl.nId = masnews.nId 
								 Where masnews.nTypeId='2' AND masnews.status='1' Group By nId ORDER BY nId DESC LIMIT 10";
                    			 ...
                    			 while ($row = mysqli_fetch_array($result))  // While Loop start
                    			 {
									...
									while($row1= mysqli_fetch_array($result1))
									{
                        			   ...
                        			   $newsUrl1 = preg_replace("#.*youtube\.com/watch\?v=#","",$newsUrl);
                          ?>
                        <div class="item">
                            <div class="box"><a class="popup-youtube" href="<?php echo $newsUrl; ?>"> 
                          ...
                          <?php
                           ...
                           ?>
										...
										<img class="img-thumbnail" src="http://img.youtube.com/vi/<?php echo $newsUrl1; ?>/hqdefault.jpg"
                                                    width="300" height="132" alt="Video Image"/> <?php echo $title; ?>
                                        </div>
                           <?php } ?>
                                    ...
                                    <div class="overlay-info">
                                        ...
                                        <div class="info">
                                            <p><span class="ion-android-data"></span><?php echo date('d/m/Y h:i:s a', strtotime($entDate));?></p>
                                        </div>
                                    </div>
                                 </div>
                               </a> </div>
