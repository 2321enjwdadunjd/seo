...
?>
    ...
    <?php
        if($message === "successful"){
            echo "
                <div class='alert alert-success' style='z-index:999' id='message'>
                <strong>Success!</strong> Your message has been successfully send.
                </div>
            ";
        }else if($message === "error"){
            echo "
                <div class='alert alert-danger' style='z-index:999' id='message'>
                <strong>Oh Sorry!</strong> There is some error.
                </div>
            ";            
        }
    ...
    <div class="container">
      ...
      <div class="layout_padding2">
        ...
        <div class="detail-box">
          <p>
            <b>Hello Dear, We are Digitbees Business Solutions.</b> <br/>As according to the name, we are providing adaptive and formulated business solutions that helps businesses and startups to gain stability in a long run. We provide mordern methodologies, scientific and psycological research patterns and new technical approach which helps to take a systematic step towards perfect establishment. 
          </p>
          <div>
            <a href="">
              Read More
      ...
      <div class="service_container layout_padding2">
        <div class="service_box">
          ...
          <div class="detail-box">
            ...
            <p>
              Our Business Marketing Solutions providing systems that are according to marketing sessions as per your product value in market via both Online or Digital Marketing and Offline Marketing
            </p>
          </div>
        </div>
        <div class="service_box">
          ...
          <div class="detail-box">
            ...
            <p>
                            Our Business Supporting Technical Solutions setup a system for your business that may be help in creation of brand identity, e-order portal or unfolding of internal/external problem 
            </p>
          </div>
        </div>
        <div class="service_box">
          ...
          <div class="detail-box">
            ...
            <p>
                            Our Printing Media Solution consist all types of printing categories, and systems. From A to Z we print stationary to marketing materials, without any hassle or any hidden charges
            </p>
          </div>
        </div>
      </div>
  ...
  <section class="problem_section layout_padding">
    <div class="container">
      ...
      <div class="layout_padding2">
        ...
        <div class="detail-box">
          <p>
            There are many ups and downs comes in the path of business. Some can be solved but some are like unsolved puzzles. We are here to help you here.
          </p>
          <div>
            <a href="">
              Read More
    ...
    <div class="container">
      <form method="POST" action="send_message.php">
        ...
        <div class="form-group">
          ...
          <input type="text" name='message' class="form-control" id="inputMessage" placeholder=""/>
        </div>
    </div>
