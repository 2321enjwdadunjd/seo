...
<head>
  ...
  <link href="assets/img/favicon5.png" rel="apple-touch-icon">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/home1.jpeg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Welcome to <span>RR Communication</span></h2>
              <p class="animate__animated animate__fadeInUp">We are doing Online-E-Seva Realted all services e-ticket,Aadhar editing,hall tickets,exam results,Xeros and printing etc..in best quality </p>
        ...
        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url(assets/img/slide/home5.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Finance</h2>
              <p class="animate__animated animate__fadeInUp">Dream to by a vechile, start for new bussiness,build a newhome come for RRC all type loan available</p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
            </div>
          </div>
        </div>
        ...
        <!-- Slide 3 -->
        <div class="carousel-item" style="background-image: url(assets/img/slide/home6.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Online Purchase</h2>
              <p class="animate__animated animate__fadeInUp">Purchase product for your home all type of online shopping offers and emi purchase available</p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="icon-box">
              ...
              <h4><a href="#">Online Registration</a></h4>
              <p>We are doing online exam apply,Hall tickets,Birth & Death certificates download,Pancard,Gst Registration, </p>
            </div>
          </div>
          <div class="col-md-6 mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <p>All Type of Loans Availble , 1.Personal Loan 2.Vechile Loan 3.Home Loan 4.Business Loan</p>
            </div>
          </div>
          <div class="col-md-6 mt-4 mt-md-0">
            <div class="icon-box">
              <i class="bi bi-bar-chart"></i>
              <h4><a href="#">Propery Sales & Service</a></h4>
              <p>If you have a land or a plot to sell, you've arrived at the right destination.connect directly with geniuine buyers</p>
            </div>
          </div>
          <div class="col-md-6 mt-4 mt-md-0">
            <div class="icon-box">
              <i class="bi bi-binoculars"></i>
              <h4><a href="#">Amount Transfer & Recharge </a></h4>
              <p>Fastag,Mobile & DTH Recharge  Aadharcard & ATM money withdrawal contant any time for recharge and transfer money </p>
            </div>
          </div>
          <div class="col-md-6 mt-4 mt-md-0">
            <div class="icon-box">
              <i class="bi bi-brightness-high"></i>
              <h4><a href="#">EMI Purchase</a></h4>
              <p>EMI Instalments for any Product in JIO Mart and any other Purchase.Mainly doing jio mart product offers</p>
            </div>
          </div>
          <div class="col-md-6 mt-4 mt-md-0">
            <div class="icon-box">
              <i class="bi bi-calendar4-week"></i>
              <h4><a href="#">Certificate Correction</a></h4>
              <p>Goverment realated certificates like PF Correction,Aadhar card correction,Employment renewal all process avilable.</p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" href="#tab-1">FEATURES</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-2">FACILITIES</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-3">SERVICES</a>
              </li>
          <!--<li class="nav-item  ">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-4">ADVANTAGES</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-5">MAINTANTANCE </a>
              </li>--->
            </ul>
          </div>
          <div class="col-lg-9 mt-4 mt-lg-0">
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    ...
                    <p class="fst-italic">Doing all services in online and offlines</p>
                    <p>We are doing all online process digitally, like hall tickets,exam results, government job application forms,travel bookings , passport, aadhar, ration card,pancard corrections etc,just send your details ,no need to come just ping the call or msg button below</p>
                  </div>
              ...
              <div class="tab-pane" id="tab-2">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Our Digital Facilities</h3>
                    <p class="fst-italic">A well- maintained safe working environment</p>
                    <p>Once you registered with our centre all updates will remain to your phone like exam date , results, government jobs,.......etc If have no time ,just relax we are there ,click our centre we are done all your online registrations with in a minute .....RR COMMUNICATION CLICK AND GET</p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
              ...
              <div class="tab-pane" id="tab-3">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Browsing centres and their  services</h3>
                    <p class="fst-italic">The board of a browsing centre offering online services in the city.</p>
                    <p>Need to pay the electricity bill or to decide where to go out for dinner? Irked by the garbage on your street and need to post a complaint? The questions might be different but solutions to these questions are just a click away.
					People just have to bring the residence and address proof or the required document and we help them register and navigate through the procedures online,” </p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
