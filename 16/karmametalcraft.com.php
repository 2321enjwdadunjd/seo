...
<head>
<meta charset="utf-8">
<title>Welcome To Karma Metalcraft</title>
<!-- Stylesheets -->
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-BTXTZ2QND6"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-BTXTZ2QND6');
</script>
...
<div class="ws_images"><ul>
		<li><a href="https://karmametalcraft.com/products.php" target="_self"><img src="data1/images/karmametalcraft_brass_ball_valve_slider.jpg" alt="Brass Ball Valves" title="Brass Ball Valves" id="wows1_0"/></a></li>
		<li><a href="https://karmametalcraft.com/products.php" target="_self"><img src="data1/images/karmametalcraft_all_brass_products_slider.jpg" alt="All Types Of Brass Products" title="All Types Of Brass Products" id="wows1_1"/></a></li>
		<li><a href="https://karmametalcraft.com/products.php" target="_self"><img src="data1/images/karmametalcraft_brass_electrical_parts_slider.jpg" alt="Brass Electrical Parts" title="Brass Electrical Parts" id="wows1_2"/></a></li>
	</ul></div>
	<div class="ws_bullets"><div>
		<a href="#" title="Brass Ball Valves"><span><img src="data1/tooltips/karmametalcraft_brass_ball_valve_slider.jpg" alt="Brass Ball Valves"/>1</span></a>
		<a href="#" title="All Types Of Brass Products"><span><img src="data1/tooltips/karmametalcraft_all_brass_products_slider.jpg" alt="All Types Of Brass Products"/>2</span></a>
		<a href="#" title="Brass Electrical Parts"><span><img src="data1/tooltips/karmametalcraft_brass_electrical_parts_slider.jpg" alt="Brass Electrical Parts"/>3</span></a>
...
<!-- End WOWSlider.com BODY section -->
        	...
        	<div class="row clearfix">
                ...
                <div class="content-column col-md-8 col-sm-12 col-xs-12">
                	<div class="inner-column">
                    	<div class="sec-title">
                        	<h2>About Karma Metalcraft</h2>
                            <div class="separator"></div>
                        </div>
                        <div class="bold-text">We are Karma Metalcraft is India based an ISO 9001:2015 certified largest manufacturer and exporter of precision brass components, metal turned parts, brass fittings and fasteners.</div>
                        <div class="text">We at Karma Metalcraft, are committed to quality maintenance, timely delivery and adhering to buyers specifications. Apart from our huge production capacity, we also have associates to cope with any level of mass productions.
                        </div>
                        <div class="text">Karma Metalcraft, a leading name for brass & ss Products, is situated in Jamnagar, in the western part of India. Karma Metalcraft believes in Quality and timely delivery. Contact us today for more information on our product. </div>
                    	...
                    	<div class="single-item-carousel owl-carousel owl-theme">
                            ...
                            <div class="testimonial-block-three">
                            	<div class="inner-box">
                                    ...
                                    <div class="text">To provide world class quality to our customers keeping inline commitments with regards to quality incumbency, well-timed shipments and a transparent business approach.</div>
                                </div>
                            </div>
                            ...
                            <div class="testimonial-block-three">
                            	<div class="inner-box">
                                    ...
                                    <div class="text">Our mission is to create value to our clients by delivering Best quality solutions to move products more efficiently and effectively with the best people, systems and processes.</div>
                                </div>
                            </div>
                            ...
                            <div class="testimonial-block-three">
                            	<div class="inner-box">
                                    ...
                                    <div class="text">We believe that accountability to each other and to our clients is paramount for success.We support and respect our team members in order to promote a positive environment</div>
                                </div>
                            </div>
    	...
    	<div class="auto-container">
        	<div class="row clearfix">
                ...
                <div class="info-block col-md-3 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        <div class="icon-box">
                            <span class="icon flaticon-layers" style="color: #434242;"></span>
                        </div>
                        <h3><a href="#" style="color: #434242;">1.Exploration</a></h3>
                    </div>
                </div>
                ...
                <div class="info-block col-md-3 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        <div class="icon-box">
                            <span class="icon flaticon-oil-platform" style="color: #434242;"></span>
                        </div>
                        <h3><a href="#" style="color: #434242;">2.Development</a></h3>
                    </div>
                </div>
                ...
                <div class="info-block col-md-3 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        <div class="icon-box">
                            <span class="icon flaticon-idea-1" style="color: #434242;"></span>
                        </div>
                        <h3><a href="#" style="color: #434242;">3.Production</a></h3>
                    </div>
                </div>
                ...
                <div class="info-block col-md-3 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        <div class="icon-box">
                            <span class="icon flaticon-security" style="color: #434242;"></span>
                        </div>
                        <h3><a href="#" style="color: #434242;">4.Abandonment</a></h3>
                    </div>
                </div>
    ...
    <section class="choose-section">
    	<div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <!--Choose Block-->
                <div class="choose-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="icon-box">
                        	<span class="icon flaticon-three-buildings"></span>
                        </div>
                        <h3><a href="javascript:void(0);" style="color: #009CC1;">Infrastructure</a></h3>
                        <div class="text">We are empowered with a sound and sophisticated infrastructure coupled with cutting edge technology.</div>
                    </div>
                </div>
                ...
                <div class="choose-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <h3><a href="javascript:void(0);" style="color: #009CC1;">Smart Technology</a></h3>
                        <div class="text">Always updated, technology innovation and services through long lasting and mutually rewarding relationships.</div>
                    </div>
                </div>
                ...
                <div class="choose-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <h3><a href="javascript:void(0);" style="color: #009CC1;">Our Excellence</a></h3>
                        <div class="text">We are able to maintain high quality standards through our committed personnel. Quality is our prime concern.</div>
                    </div>
                </div>
                ...
                <div class="choose-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <h3><a href="javascript:void(0);" style="color: #009CC1;">Team Of Professionals</a></h3>
                ...
                <div class="choose-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <h3><a href="javascript:void(0);" style="color: #009CC1;">Trusted Company</a></h3>
                        <div class="text">Be the subject matter experts in our core competencies Look out for their best interests Keep their confidences.</div>
                    </div>
                </div>
                ...
                <div class="choose-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <h3><a href="javascript:void(0);" style="color: #009CC1;">Compatibility</a></h3>
                        <div class="text">Our strength is in Brass Drop in Anchors Brass Cable Glands, Brass Casting, Hex Nuts, Lock Nuts, Brass Screws, Machine Screws</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="call-to-action-section-two" style="background-image:url(img/quality-banner.jpg)">
    	<div class="auto-container">
			<h2 style="color: #009CC1;">Quality Control</h2>
            <div class="text">Besides passing through inspection at every level of process, every piece finally assembled, is passed through checking for every aspects and cleared for final packaging.</div>
        </div>
    </section>
        	...
        	<div class="row clearfix">
                ...
                <div class="content-column col-md-6 col-sm-12 col-xs-12">
                	<div class="inner-column">
                        ...
                        <div class="text">Karma Metalcraft is committed to providing our clients - The highest quality products, excellent customer service, cost-effective pricing and on-time delivery.</div>
                        <ul class="list-style-one">
                        	<li><strong>We've Reputation for Excellence</strong></li>
                        	<li><strong>On Time Delivery</strong></li>
                        	<li><strong>Efficiant and Cost-Effective Engineering Solutions</strong></li>
                        	<li><strong>We Compliance with international standards</strong></li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="project-section-three" style="background-image:url(images/background/2.jpg)">
    	<div class="auto-container">
        	<!--Sec Title-->
            ...
            <?php
                include "./admin_km/db.php";
                $res = mysqli_query($link, "select * from megma_products");
                while ($row = mysqli_fetch_array($res)) {
            ?>
                <div class="project-block-four">
                	<div class="inner-box">
                    	<div class="image">
                        	<a href="javascript:void(0);"><img src="./product/<?php echo $row['megma_pro_img'];?>" alt="<?php echo $row['megma_pro_name'];?>" /></a>
                        </div>
                        <div class="lower-content">
                        	<h3 style="text-align: center;"><a href="javascript:void(0);"><?php echo $row['megma_pro_name'];?></a></h3>
                        </div>
                    </div>
                </div>
                <?php } ?>
...
<!-- Mirrored from st.ourhtmldemo.com/new/metron/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Apr 2021 22:06:59 GMT -->
</html>