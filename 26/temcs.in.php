...
<html lang="en">
  <head>
    ...
    <title>THEOPHILUS ENGLISH MEDIUM CHRISTIAN SCHOOL, NAMPHAI 2, ARUNACHAL PRADESH</title>
  </head>

  <body data-bs-spy="scroll" data-bs-target=".navbar">
    

  <?php $main = "home"; $sub = "home"; include('config-navigation.php'); ?>
    ...
    <?php
        $sqlS = "SELECT * FROM tbl_slides WHERE status = 'ACTIVE' ORDER BY sortby ASC";
        ...
        if($queryS->num_rows > 0)
        {
          while($rowS = $queryS->fetch_array())
          {
            ...
            echo '<div style="background: url(images/slider/'.$img.');" class="custom-height bg-cover d-flex align-items-center"></div>';
...
<div class="marquee">
	<div class="track">
		<span class="text -twox">

    <?php
      $sql2 = "SELECT * FROM tbl_scrolling WHERE status = 'ACTIVE' ORDER BY id DESC";
      ...
      if($query2->num_rows > 0)
      {
        while($row2 = $query2->fetch_array())
        {
          ...
          echo "&nbsp;&nbsp;<img src='./images/new.gif' width='24px' height='24px'>
          &nbsp;&nbsp;<a href='".$link."'>".$title."</a>&nbsp;&nbsp;|&nbsp;&nbsp;";
        }
      }
    ...
    <section id="about">
      <div class="container">
        ...
        <div class="col-lg-5">
            <img src="./images/school.jpg" class="img img-fluid" />
          </div>
          <div class="col-lg-7">
              <h5>Welcome to Theophilus English Medium Christian School</h5><hr>
                      <p style="text-align:justify">
                      As God expects excellence, the Theophilus English Medium Christian School encourages students 
                      to develop their abilities to the fullest extent possible to use them for the glory of 
                      God and the good of their fellow man.</p>
                      <p style="text-align:justify">
                      As man is created in the image of God, students are taught respect for all people, regardless of 
                      social, religious. economic, ethnic and physical status.</p>
                      <p style="text-align:justify">
                      TEMCS is a college preparatory program, and its academic requirements are designed for students 
                      to realize their potential and enable students to be successful in higher educational pursuits.
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-sm-4">
            <div class="service-box" style="background:linear-gradient(rgb(165, 205, 254), rgb(126, 183, 252));">
              <h5>Think positive to stay focused.</h5>
            </div>
          </div>

          <div class="col-lg-4 col-sm-4">
            <div class="service-box" style="background:linear-gradient(rgb(176, 255, 152), rgb(217, 255, 152));">
              <h5>Strive for excellence.</h5>
            </div>
          </div>
          <div class="col-lg-4 col-sm-4">
            <div class="service-box" style="background:linear-gradient(rgb(255, 181, 204), rgb(253, 78, 132));">
              <h5>Build good study habits</h5>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="milestone" class="bg-cover">
      <div class="container">
        ...
        <div class="col-md-2">
            <img src="./images/director.jpg" class="img img-fluid">
          </div>
        <div class="col-md-10">
          <h1 style="color: white">From the Director's Desk</h1>
          <p style="color: white;text-align:justify">
          <p>
                I was born in Rome, Georgia in 1954. My parents and grandparents were faithful members of
            the church. After completing high school I attended David Lipscomb University then served in
            the U.S. Army. Upon completion of my military service I desired to become a preacher of the
            Gospel of Christ.<br><br>
            Following my time in the U.S. Army, I graduated from South-eastern Biblical Institute (Doraville,
            Georgia) in May of 1980 with a BSL degree in Bible. I hold a BA degree in History from N.C.
            Wesleyan College and also a BS degree in Education from N.C. Wesleyan. I received my
            master’s degree in Educational Administration from the University of Georgia in 1993. I
            received my Series 7 (Investment) license. I have been married for forty-seven years to my wife
            Cindy and we have three married daughters and seven grandchildren. All of my family faithfully
            serves in the Lord’s church. My son-in-law, Bruce Holt, preaches for the church in Oliver
            Springs, Tennessee and my son-in-law Gentry Jackson is a deacon at Karns church of Christ in
            Knoxville.<br><br>
            Since 1980 I have preached for congregations in North Carolina, Georgia, Illinois and Tennessee.
            The congregations I preached for on a full-time basis include:
            Rocky Mount church of Christ in Rocky Mount, North Carolina
            Monroe church of Christ in Monroe, Georgia
            Mount Pleasant church of Christ in Valdosta, Georgia
            Quincy church of Christ in Quincy Illinois
            Clinton church of Christ in Clinton, Tennessee
            In addition, I have held numerous Gospel Meetings and Parenting Seminars in several states. I
            have also worked in secular work over the years as I preached the Gospel. I taught in both
            Middle School and High School for approximately ten years. I served as principal of Knoxville
            Christian School from 1995 through 1998 while also preaching for the Central church of Christ
            in Harriman, Tennessee.
            From 2000 until 2007 as I served as the full time minister of the Clinton church of Christ, I did
            overseas mission work (one month per year). First in Ghana, Africa and then in Nepal and India.
            For a number of years, I went over and taught a Bible class for in Nepal and then in Shillong,
            India. It is during this time that I developed a strong desire to enter the foreign mission field on
            a full-time basis. I have taught in schools of preaching in Ghana, Nepal and India.
            In 2007 the Clinton church of Christ accepted the oversight of my work and I began to work full
            time in India. In 2008 I began the Mustard Seed Village orphanage in Lakla, Assam and a two
            year school of preaching in Dibrugarh, Assam which I combined with the Mustard Seed Village
            in 2011. In 2014 we opened a separate Girls orphanage, the Rainbow Village orphanage close
            to Miao, Arunachel Pradesh. The Mustard Seed Village will be for the boys and the Rainbow
            Village for the girls. At present we have 72 orphans at the Mustard Seed Village and Rainbow
            Village. In 2016 we built a new Christian school at Namphai 2 in Arunachal Pradesh where our
            work is primarily located.
            I have now completed fourteen years of full time work in India. My work encompasses a
            number of activities that work together to fulfill the great commission as well as 2 Timothy 2:2,
            Galatians 6:10 and James 1:27.
    ...
    <section id="services">
      <div class="container">
        <div class="row">
        <div class="col-md-4">
          <!--<img src="images/IMG-20220814-WA0021-1086x1536.jpg" class="img img-fluid">-->
            ...
            <div class="col-12 intro text-center">
              ...
              <?php
                $sql2 = "SELECT * FROM tbl_notifications WHERE category = 'For Student' AND status = 'ACTIVE' ORDER BY id DESC LIMIT 0,2";
                $query2 = $conn->query($sql2);
                ...
                if($query2->num_rows > 0)
                {
                  while($row2 = $query2->fetch_array())
                  {
                    ...
                    <p align='left'>
                    <span style='font-weight: bold;font-size: 12px;color:darkcyan'>".$date."</span><br>".$msg."</p>
                  </div>
              ...
              <a href="news-and-events.php" class="btn btn-brand"> View All</a><br><br>
        ...
        <div class="col-md-4">
          <!--<img src="images/IMG-20220814-WA0021-1086x1536.jpg" class="img img-fluid">-->
            ...
            <div class="col-12 intro text-center">
              ...
              <?php
                $sql2 = "SELECT * FROM tbl_notifications WHERE category = 'For Staff' AND status = 'ACTIVE' ORDER BY id DESC LIMIT 0,2";
                $query2 = $conn->query($sql2);
        ...
        <div class="col-md-4">
          <!--<img src="images/IMG-20220814-WA0021-1086x1536.jpg" class="img img-fluid">-->
            ...
            <div class="col-12 intro text-center">
              ...
              <?php
                $sql2 = "SELECT * FROM tbl_notifications WHERE category = 'For All' AND status = 'ACTIVE' ORDER BY id DESC LIMIT 0,2";
                $query2 = $conn->query($sql2);
