 ...
 ?>
			...
			<div role="main" class="main">
						...
						<ul>
							<li data-transition="fade">
								...
								<div class="tp-caption top-label"
									...
									data-y="180"
									data-start="500"
									data-transform_in="y:[-300%];opacity:0;s:500;">DO YOU NEED THE BEST</div>
								...
								<div class="tp-caption main-label"
									...
									data-mask_in="x:0px;y:0px;">SANITARY FITTINGS</div>
				
								<div class="tp-caption bottom-label"
									data-x="227"
									data-y="280"
									data-start="2000"
									data-transform_in="y:[100%];opacity:0;s:500;">Check out our Products.</div>
								...
								<div class="tp-caption blackboard-text"
									...
									data-transform_in="y:[300%];opacity:0;s:300;">Premium</div>
								...
								<div class="tp-caption blackboard-text"
									...
									data-transform_in="y:[300%];opacity:0;s:300;">Sanitary</div>
								...
								<div class="tp-caption blackboard-text"
									...
									data-transform_in="y:[300%];opacity:0;s:300;">Fittings !!!</div>
							</li>
				...
				<div class="container" style="margin-top:40px">
					...
					<div class="row center">
						<div class="col-md-12">
							...
							<p class="lead">
								We are the manufacturers of the Sanitaryware Fitting items. We provide Premium Quality and designs for the fittings. 
							</p>
						</div>
					</div>
				...
				<ul class="image-gallery sort-destination full-width mb-none">
					<?php
                                    $query = mysql_query("select * from product_master LIMIT 0, 5") or die(mysql_error());
                                    while ($row = mysql_fetch_array($query)) {
                                        $id = $row['product_id'];
                                        ?>
                    <li class="isotope-item">
						<div class="image-gallery-item mb-none">
							<a href="product-details.php<?php echo '?id=' . $id; ?>">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										<img src="admin/<?php echo $row['product_image']; ?>" class="img-responsive" alt="<?php echo $row['product_name']; ?>">
										<span class="thumb-info-title">
											<span class="thumb-info-inner"><?php echo $row['product_name']; ?></span>
...
<!-- Mirrored from preview.oklerthemes.com/porto/4.9.2/index-classic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Nov 2016 09:07:15 GMT -->
</html>