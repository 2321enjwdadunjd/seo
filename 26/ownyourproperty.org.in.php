...
<?php include 'header.php'; ?>
        ...
        <?php
        session_start();
        $conn = mysqli_connect("localhost", "u366456395_oyp_users", "OYPuser@123", "u366456395_oyp_db");

        ?>
        <!-- END HERO -->
  <?php
  $banner_sql = "SELECT * FROM `banner_tbl` WHERE banner_id = 1";;
  $b_data = mysqli_query($conn,$banner_sql);
   $b1 = mysqli_fetch_assoc($b_data);?>
   <?php
   $banner_sql2 = "SELECT * FROM `banner_tbl` WHERE banner_id = 2";;
   $b_data2 = mysqli_query($conn,$banner_sql2);
    $b2 = mysqli_fetch_assoc($b_data2);?>
    <?php
    $banner_sql3 = "SELECT * FROM `banner_tbl` WHERE banner_id = 4";;
    $b_data3 = mysqli_query($conn,$banner_sql3);
     $b3 = mysqli_fetch_assoc($b_data3);?>
    <!-- END HEADER -->
                ...
                <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active banner-max-height">
                            <img class="d-block w-100" src="erp/banner_images/<?php echo $b1['banner_id'];?>.<?php echo $b1['banner_image'];?>" alt="First slide">
                                            ...
                                            <div class="col-lg-8 col-md-12 col-sm-12 text-center">
                                              <div class="slider__content-title ">
                                                  <h2 data-animation="animated fadeInDown"
                                                      ...
                                                      The Place To Find Your Dream Home</h2>

                                                  <!-- <a href="contact.php" class="btn btn-primary text-uppercase animated fadeInUp">
                                                      contact us
                      ...
                      <?php //endwhile; ?>
                        <div class="carousel-item banner-max-height">
                            <img class="d-block w-100" src="erp/banner_images/<?php echo $b2['banner_id'];?>.<?php echo $b2['banner_image'];?>" alt="Second slide">
                            <div class="carousel-caption banner__slide-overlay d-flex h-100">
                                <div class="carousel__content">
                                    <div class="container">
                                        <div class="row justify-content-center">
                       ...
                       <div class="carousel-item banner-max-height">
                            <img class="d-block w-100" src="erp/banner_images/<?php echo $b3['banner_id'];?>.<?php echo $b3['banner_image'];?>" alt="Third slide">
                            <div class="carousel-caption banner__slide-overlay d-flex h-100">
                                <div class="carousel__content">
                                    <div class="container">
                                        <div class="row justify-content-center">
    ...
    <div class="clearfix"></div>
    <!-- #7c0000  -->
    <div class="" style="position:relative;padding:20px 0;">
      <div class="search__area search__area-1" id="search__area-1">
          <div class="container">
              <div class="search__area-inner">

                  <form class="search__form">
                  <p class="err text-danger" style="display:none;"></p>
                  <div class="row" style="margin:0">
                      <div class="col-12 col-lg-2 col-md-2" style="padding:0 5px">
                          <div class="form-group">
                            <select class="wide select_option property_type"name="property_type">
                      ...
                      <div class="col-12 col-lg-2 col-md-2" style="padding:0 5px">
                          <div class="form-group">
                            <select class="wide select_option rooms_no" name="rooms_no">
                                <option value="0">Rooms Number</option>
                      ...
                      <div class="col-12 col-lg-2 col-md-2" style="padding:0 5px">
                          <div class="form-group">
                            <select class="wide select_option purpose"name="purpose">
                      ...
                      <div class="col-12 col-lg-3 col-md-3" style="padding:0 5px">
                          <div class="form-group">
                            <?php $sql = "SELECT * FROM `prop_area`";
                            $data = mysqli_query($conn, $sql); ?>
                                <select class="wide select_option area" name="area">
                      ...
                      <div class="col-12 col-lg-3 col-md-3" style="padding:0 5px">
                          <div class="form-group">
                              <button class="btn btn-primary text-uppercase btn-block" type="submit"> search <i
    ...
    <!-- END POPULAR CITY -->
<?php $p_sql = "SELECT * FROM `property_tbl` ORDER BY `create_at` DESC LIMIT 12";
$p_data = mysqli_query($conn,$p_sql);
$p_row = mysqli_num_rows($p_data);?>



    <!-- FEATURED PROPERTY -->
    <section class="recent__property pt-0" style="background:white">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                              ...
                              <div class="listing-badges">
                                ...
                                <div class="card__image-content">
                                    <div class="card__image-content-desc">
                                        <h6> <?php echo $p['property_name'] ?></h6>
                                        <p class="mb-0"> &#8377; <?php echo $p['property_price']?></p>
                                    </div>
                                    <ul class="list-inline card__hidden-content">
                                        <li class="list-inline-item">
                                            Baths
                                            <span>
                                                <i class="fa fa-bath"></i> <?php echo $p['bathrooms'] ?>
                                            </span>
                                        </li>
                                        <li class="list-inline-item">
                                            Beds
                                            <span>
                                                <i class="fa fa-bed"></i> <?php echo $p['bedrooms'] ?>
                                            </span>
                                        </li>
                                        <li class="list-inline-item">
                                          Balcony
                                            <span>
                                                <i class="fa fa-inbox"></i> <?php echo $p['balcony'] ?>
                                            </span>
                                        </li>
                                        <li class="list-inline-item">
                                            Area
                                            <span>
                                                <i class="fa fa-map"></i> <?php echo $p['property_area']. " Sqft"; ?>
                                            </span>
                                        </li>

                                    </ul>
                                </div>
                                <img alt="" src="erp/images/<?php echo $p['property_id'] .'.'.$p['property_image1'];?>" class="img-fluid h-40 ">
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <?php $p_sql2 = "SELECT * FROM `property_tbl`";
            $p_data2 = mysqli_query($conn,$p_sql2);
            $p_row2 = mysqli_num_rows($p_data2);?>
            <?php if ($p_row2 > 12) : ?>
            <div class="row">
              <div class="col-12 text-center">
                <a href="property.php" class="btn btn-primary mt-3 text-capitalize"> see more   <i class="fa fa-angle-right ml-3 "></i></a>
              </div>
            </div>
          <?php endif; ?>
        </div>
    ...
    <style media="screen">
      .bg-theme-v7:before{
        background: rgb(36 42 53)!important;
      }
    </style>
    <?php $a_sql = "SELECT * FROM `about_us`";
    $a_data = mysqli_query($conn,$a_sql);
    $about = mysqli_fetch_assoc($a_data);?>
    <section class="home__about bg-theme-v7 pp"data-aos="fade-up" style="background-image:url(a.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-md-7" style="background:#000;">
                    <div class="title__leading" style="padding:25px 10px;">
                        <!-- <h6 class="text-uppercase">trusted By thousands</h6> -->
                        <h2 class="text-capitalize" style="color:white;">why choose us?</h2>
                        <p style="color:white;text-align:justify">
                            <?php echo substr($about['about1'],0,500); ?>
                        </p>

                        <a href="about.php" style="border-color:white!important;"class="btn btn-primary mt-3 text-capitalize"> read more
...
$(".search__form").on('submit',function(e){
        ...
        var rooms_no = $('.rooms_no').val();
        var purpose = $('.purpose').val();
        // console.log(area);
        if (property_type == 0) {
          $('.err').css('display','block');
          $('.err').html('Please select property  type');
          return false;
        }
        if (rooms_no == 0) {
          $('.err').css('display','block');
          $('.err').html('Please select rooms number');
          return false;
        }
        if (area == 0) {
        $('.err').css('display','block');
          $('.err').html('Please select area');
          return false;
        }
        if (purpose == 0) {
        $('.err').css('display','block');
          $('.err').html('Please select purpose');
          return false;
        }

    // var data = $("#search__form").serialize();

        window.location.href="search.php?rooms_no="+rooms_no+"&property_type="+property_type+"&area="+area+"&purpose="+purpose;
