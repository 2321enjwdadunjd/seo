...
<head>
    ...
    <title>Best Computer Institute in Tinsukia, Assam | National Computer Institute</title>
    <meta name="title" content="Best Computer Institute in Tinsukia, Assam | National Computer Institute">
    <meta name="description" content="National Computer Institute is the best computer institute in Tinsukia, Assam. We offer quality computer education with experienced faculties and modern infrastructure. Enroll now to start your career in the IT industry.">
    <meta name="keywords" content="Computer Institute, Tinsukia, Assam, Best Computer Institute, IT Courses, Computer Education, Programming Courses, Web Development Courses, Software Development Courses, Computer Science, Information Technology, Job-oriented Courses, Advanced Training, Modern Infrastructure, Experienced Faculties, Affordable Fees, Placement Assistance">
...
?>
    ...
    <main>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.2s">National Computer Institute</h1>
                                    <p data-animation="fadeInLeft" data-delay="0.4s">Tinsukia's No. 1 Computer Institute | Affiliated to EMAX India</p>
                                    <a href="enroll.php" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s" style="background-color:#f7bf50">Enroll Now</a>
                                </div>
                            </div>
                        </div>
                    </div>          
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            ...
                            <div class="features-caption">
                                ...
                                <p>Explore a variety of skill based courses</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            ...
                            <div class="features-caption">
                                ...
                                <p>Learn from Qualified & Experienced instructors</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            ...
                            <div class="features-caption">
                                ...
                                <p>Our Certificates are Govt. Approved.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="section-tittle section-tittle2 mb-55">
                            <div class="front-text">
                                <h2 class="">Welcome to National Computer Institute</h2>
                                <p>National Computer Institute is an emerging Computer Training Service Provider in Tinsukia, Assam. 
                                    We are one of the market leaders in the field of IT education and associated skills. We are an emerging Professional 
                                    organization with a mission to provide business, software & applications for serving the requirements of Indian Computer 
                                    Training business Community.</p>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="single-features">
                                        ...
                                        <div class="features-caption">
                                            <p>Recognized By Govt. of India as well as Govt. of Assam</p>
                                            <P>
                                        </div>
                                    </div>
                                    ...
                                    <div class="single-features">
                                        ...
                                        <div class="features-caption">
                                            <p>Authorization by MSME (Ministry of Micro, Small and Medium Enterprises)</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="single-features">
                                        ...
                                        <div class="features-caption">
                                            <p>Wide range of Job Oriented Courses</p>
                                        </div>
                                    </div>
                                    <div class="single-features">
                                        <div class="features-icon">
                                    ...
                                    <div class="single-features">
                                        ...
                                        <div class="features-caption">
                                            <p>Govt. Approved Certification</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="single-features">
                                        ...
                                        <div class="features-caption">
                                            <p>Online Student/Certificate Verification.</p>
                                        </div>
                                    </div>
                                    <div class="single-features">
                                        <div class="features-icon">
                                        ...
                                        <div class="features-caption">
                                            <p>Courses From Basic Level to Advance Level. Full Practical Knowledge</p>
                                        </div>
                                    </div>
                                    <div class="single-features">
                                        <div class="features-icon">
                                    ...
                                    <div class="single-features">
                                        ...
                                        <div class="features-caption">
                                            <p>Experience and Knowledgeable Faculty.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="single-features">
                                        ...
                                        <div class="features-caption">
                                            <p>Courses are Designed According to Market Need.</p>
                                        </div>
                                    </div>
        ...
        <div class="topic-area section-padding40">
            <div class="container">
                ...
                <?php
                    include('config.php');
                    $sql = "SELECT * FROM tbl_course ORDER BY id ASC";
                        ...
                        while($row = $query->fetch_array())
                        {
                            ...
                            ?>
                              <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="single-topic text-center mb-30" style="cursor: pointer;" onClick="loadCourse(<?php echo $id; ?>)">
                                        <div class="topic-img">
                                            <img src="assets/img/courses/<?php echo $course_img; ?>" alt="" style="border-radius:20px">
                                            <div class="topic-content-box">
                                                <div class="topic-content">
                                                    <h3 style="color:white;font-size:21px;font-weight:bold"></h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="support-wrapper align-items-center">
                ...
                <div class="left-content3">
                    ...
                    <div class="single-features">
                        ...
                        <div class="features-caption">
                            <p>Recognition by the Government of India under MSME</p>
                        </div>
                    </div>
                    <div class="single-features">
                        <div class="features-icon">
                    ...
                    So, if you are searching for <b>“Best Computer Institute Near Me”</b> from Tinsukia, NCI is just the right place for you.
                </div>
            </div>
        </section>
        <!-- About Area End -->
            ...
            <div class="container">
                ...
                <div class="team-active">
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                            <img src="assets/img/pratik.jpeg" alt="">
                        </div>
                        <div class="cat-cap">
                            <h5><a href="#">Mr. Pratik Bhattacharjee</a></h5>
                        </div>
                    </div>
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                            <img src="assets/img/bhai.jpeg" alt="">
                        </div>
                        <div class="cat-cap">
                            <h5><a href="#">Mr. Prantik Bhattacharjee</a></h5>
                        </div>
                    </div>
                ...
                <div class="left-content2">
                    ...
                    <div class="section-tittle section-tittle2 mb-20">
                        <div class="front-text">
                            ...
                            with us.</h2>
                            <p></p>
                            <a href="enroll.php" class="btn" style="background-color:red">Enroll Now</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        function loadCourse(i)
        {
            ...
            /*if(i==1)//DCA
            {
                bootbox.alert('<h3>DCA (Diploma in Computer Application)</h3><p><ul><li>FUNDAMENTAL OF COMPUTER , Windows/DOS, MS- Office ( word, Excel, PowerPoint)</li><li>Programming in C</li><li>HTML/ DHTML</li><li>INTERNET & EMAIL</li><li>Project / Viva</li></ul></p>');
            }
            else if(i==2)//DCA
            {
                bootbox.alert('<h3>DCA (Diploma in Computer Application)</h3><p><ul><li>FUNDAMENTAL OF COMPUTER , Windows/DOS, MS- Office ( word, Excel, PowerPoint)</li><li>Programming in C</li><li>HTML/ DHTML</li><li>INTERNET & EMAIL</li><li>Project / Viva</li></ul></p>');
            ...
            {
                bootbox.alert('<h3>ADCA (Advanced Diploma in Computer Application)</h3><p><b>Semester 1 ( 6 Months)</b><ul><li>Fundamental of Computer, Windows/ DOS</li><li>MS Office ( Word, Excel, PowerPoint & Access)</li><li>Computer Lab Practical</li><li>Project/Viva</li></ul><br><b>Semester 2 (6 Months)</b><ul><li>Programming In C & C++ or Java Programming or FoxPro</li><li>HTML/DHTML, JavaScript, Visual Basic</li><li>Computer Lab Practical</li><li>Project/Viva</li></ul></p>');
            }
            else if(i==6)//PGDCA
            {
                bootbox.alert('<h3>PGDCA (Post Graduate Diploma in Computer Application)</h3><ul><li>Eligibility- Min. Graduate<br>Duration – 1 Year<br><b>Semester 1 ( 6 Months)</b><ul></li>Fundamental of Computer, Windows/ DOS</li></li>MS Office ( Word, Excel, PowerPoint & Access)</li></li>Computer Lab Practical</li><li>Project/Viva</li></ul><br><b>Semester 2 (6 Months)</b><ul><li>Programming In C & C++ or Java Programming or FoxPro</li><li>HTML/DHTML, JavaScript, Visual Basic</li><li>Computer Lab Practical</li></li>Project/Viva</li></ul></p>');
            }
            else if(i==7)//TALLY WITH GST
            {
                bootbox.alert('<h3>TALLY WITH GST</h3><p><ul><li>Basic Accounting</li><li>Company Creation</li><li>Ledgers</li><li>Accounting & Inventory Vouchers</li><li>Day Book in Tally</li><li>Outstanding Report</li><li>Payroll</li><li>Import & Export</li><li>GST – Goods and Services Tax with Online payment.</li><li>Purchase Voucher with GST</li><li>Sales Voucher with GST</li><li>GST Returns and Payment</li><li>Debit and Credit Notes</li><li>Project.</li></ul></p>');
            }
            else
            {
                bootbox.alert('<p>Course Not Found</p>');
            }*/
