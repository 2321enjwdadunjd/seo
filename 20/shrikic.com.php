...
?>
<?php ob_start(); 
require_once "web-manage/settings/script_func.php"; 
?>
<!doctype html>
...
<div class="main-wrapper">
   ...
   <?php include('banner.php');?>
                    ...
                    <div class="course-categories-two-wrap">
                        ...
                        <div class="coustom-col-3">
                            ...
                            <div class="single-course-categories-two brilliantrose  wow fadeInBottom" data-wow-duration="1.6s">
                              ...
                              <?php $about=fetch(query("select id, name, description from contents where id='7'"));?>
                                    <a class="cours-title" href="contents?q=<?php echo encrypted($about['id']);?>">
                            <h4><?php echo $about['name'];?></h4>
                                     <img src="assets/images/04.jpg" style="border-radius: 30px 0px 30px 0;">
                            <p><?php  if(strlen(stripslashes($about['description']))>100) echo (substr((stripslashes(strip_tags($about['description'],'<p>'))),0,100)),"..."; else echo (stripslashes(strip_tags($about['description'],'<p>'))); ?></p>
                        </a>
                                </div>
                        ...
                        <div class="coustom-col-3">
                            ...
                            <div class="single-course-categories-two malachite wow fadeInBottom" data-wow-duration="0.4s">
                                <div class="item-inner"> 
                                  ...
                                  <?php $about=fetch(query("select id, name, description from contents where id='4'"));?>
                                    <a class="cours-title" href="contents?q=<?php echo encrypted($about['id']);?>">
                                        <h4><?php echo $about['name'];?></h4>
                                        <img src="assets/images/01.jpg" style="border-radius: 30px 0px 30px 0;">
                                        <p><?php  if(strlen(stripslashes($about['description']))>100) echo (substr((stripslashes(strip_tags($about['description'],'<p>'))),0,100)),"..."; else echo (stripslashes(strip_tags($about['description'],'<p>'))); ?></p>
                        ...
                        <div class="coustom-col-3">
                            ...
                            <div class="single-course-categories-two sunglow  wow fadeInBottom" data-wow-duration="0.8s">
                                <div class="item-inner">
                                     ...
                                     <?php $about=fetch(query("select id, name, description from contents where id='5'"));?>
                                    <a class="cours-title" href="contents?q=<?php echo encrypted($about['id']);?>">
                                        <h4><?php echo $about['name'];?></h4>
                                        <img src="assets/images/02.jpg" style="border-radius: 30px 0px 30px 0;">
                                        <p><?php  if(strlen(stripslashes($about['description']))>100) echo (substr((stripslashes(strip_tags($about['description'],'<p>'))),0,100)),"..."; else echo (stripslashes(strip_tags($about['description'],'<p>'))); ?></p>
                                    </a>
                                </div>
                            </div><!--// single-course-categories -->
                        ...
                        <?php $about=fetch(query("select id, name, description from contents where id='6'"));?>
                                    <a class="cours-title" href="contents?q=<?php echo encrypted($about['id']);?>">
                            <h4><?php echo $about['name'];?></h4>

                                        <img src="assets/images/03.jpg" style="border-radius: 30px 0px 30px 0;">
                            <p><?php  if(strlen(stripslashes($about['description']))>100) echo (substr((stripslashes(strip_tags($about['description'],'<p>'))),0,100)),"..."; else echo (stripslashes(strip_tags($about['description'],'<p>'))); ?></p>
                        </a>
                                </div>
                            </div><!--// single-course-categories -->
    ...
    <div class="what-provide-area" style="padding-top: 30px;">
        <div class="container">
            <div class="row">
               <div class="col-lg-6 col-md-12">
                    <div class="section-title-three" align="left"> 
                           <?php $about=fetch(query("select name, description from contents where id='1'"));?>
                        <h4><?php echo $about['name'];?></h4>
                        <p><?php  if(strlen(stripslashes($about['description']))>600) echo (substr((stripslashes(strip_tags($about['description']))),0,600)),"...<a href='contents?q=".encrypted('1')."' class='btn'>View all...</a>"; else echo (stripslashes(strip_tags($about['description']))); ?></p>
                        </br>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="section-title-three text-left text-white"> 
   <marquee behavior="scroll" direction="up" onmouseover="this.stop();" onmouseout="this.start();" style="height:320px; border: 1px dashed #a3a4a5; background:#1f3340; padding:10px; border-radius: 60px 0px 60px 0;">
<ul style="list-style:circle; list-style-position:outside;">
                                            
<?php   
$news=query("select id, name from news_events where status=1 order by id desc");  
while ($proAbo=fetch($news)){ ?>    
<li><a href="news_events?q=<?php echo encrypted($proAbo['id']);?>"><div style="text-align:left;  font-size: 15px; padding: 0; margin: 0;">
<?php echo (stripslashes(strip_tags($proAbo['name']))); ?><img src="assets/images/new.gif" style="height:40px;"> </div></a><hr></li> 
<?php } ?>
    ...
    <!-- Our Team Area -->
    <div class="project-count-area  project-count-bg" style="padding:30px 0 10px 0;">
        <div class="container">
               ...
               <div class="row">
                <div class="col-lg-8 m-auto">
                    ...
                    <div class="section-title">
                        <h4>OUR TEAM</h4>
                        <h3 class="text-white">Our Administrator</h3>
                    </div><!--// section-title -->
                </div>
            </div> 
  ...
  <?php  $banneas=query("select * from  administrator where status=1  order by id asc");
 while($disbanas=fetch($banneas)) {
?>                    
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-team mt--30">
                        <div class="row">
                        <div class="single-team-image col-6">
                            <img src="upload/administrator/<?php echo $disbanas['img'];?>" alt="">
                        </div>
                         <div class="col-6" style="line-height: 26px; background: #5b606e; color: #fff;">
                             <b><?php echo $disbanas['name'];?></b> 
                            <p><?php  if(strlen(stripslashes($disbanas['description']))>140) echo (substr((stripslashes(strip_tags($disbanas['description']))),0,140)),"..."; else echo (stripslashes(strip_tags($disbanas['description']))); ?></p>
                        </div>
                    </div>
                        <a class="single-team-info"  href="administrator?q=<?php echo encrypted($disbanas['id']);?>">
                            <h5><?php echo $disbanas['title'];?></h5> 
                        </a>
...
<?php } ?>                 
    ...
    <!-- Our Gallery Area -->
    <div class="gallery-area section-pt section-pb">
            <div class="container">
                 <div class="row">
                <div class="col-lg-8 m-auto">
                ...
                <div class="row">
<?php  $photoQur=query("select name, img from photo_gallery where status=1  order by id asc limit 8");
while($photFetch=fetch($photoQur)) {
?>          
                    <!--Single Gallery Image Start-->
                    <div class="col-md-3 col-sm-4">
                        <div class="single-gallery-img mb--30">
            <a href="upload/photo_gallery/<?php echo $photFetch['img'];?>" data-fancybox="images">
                <img src="upload/photo_gallery/small/<?php echo $photFetch['img'];?>" alt="" style="height: 180px;">
            </a>
             <div align="center" style="background: #f24f46; color:#fff;"><?php  if(strlen(stripslashes($photFetch['name']))>15) echo (substr((stripslashes(strip_tags($photFetch['name']))),0,15)),"..."; else echo (stripslashes(strip_tags($photFetch['name']))); ?></div>
                        </div>
                    </div>
