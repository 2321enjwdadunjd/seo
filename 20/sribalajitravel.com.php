...
<meta name="title" content="Tirupati Darshan Package|Bangalore To Tirupati Car Package"/>
<meta name="description" content="We offer the best tirupati package from bangalore at affordable rates. One day packages, Tirumala packages from Bangalore by car with comfortable, ambient and convenient services to our esteemed clients and customers. Tirupati darshan package from Bangalore">
<meta name="keywords" content="Tirupathi package from Bangalore, Bengaluru to tirupathi packages, Best travel agent for thirupathi">
<title>Bangalore to tirupati package | Sri Balaji Travel</title>
<link rel="canonical" href="https://sribalajitravel.com/"/>
...
<div id="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/sribalaji.jpg" alt="tirupati darshan online booking">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="images/tirupati.jpg" alt="best tirupati package from bangalore">
      
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/two_day_package.jpg" alt="tirupati tour package from bangalore">
      
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/three_day_package.jpg" alt="bangalore to tirupati car package">
...
<div class="package_tab">
    <div class="container">
        ...
        <h1 style="text-align:center; color: #a3238e; font-weight: 600;text-transform: uppercase; font-size:28px;">Tirupati Darshan Package From Bangalore</b></h1>
        <p>Are looking for the Best Tirupati package from Bangalore? We arrange complete Tirupati darshan package from Bangalore to Tirupati tour package from Bangalore on daily basis. We customise the package according to customer requirement basis on one and two as many days you require. Sri Balaji Travel is dependable travel agencies throughout south India to consume better quality and outstanding on time services.</p>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-sm-12 col-12">
            ...
            <li class="item-head">
               <h5>One Day Tirupati package from Bangalore</h5>
                </li>
<table class="table" id="table">
  <thead>
   <?php
include 'config.php';
$sel = "SELECT * FROM cars where car_name='Etios' && day='1'";
$rs = $conn->query($sel);
...
?> 
    <tr>
      ...
      <th scope="col"><?php echo $rws['capacity'];?> Persons</th>
      <th scope="col">Rs. <?php echo $rws['hire_cost'];?>/-</th>
      <th scope="col">
      <a href="sri_balaji_booking.php?id=<?php echo $rws['car_id'] ?> " class="book">Book</a></th>
...
?>
                ...
                <li class="item-foot details">
                <a href="one-day-package-from-bangalore.php" class="book">More Details</a>
                </li>
        ...
        <div class="col-lg-4 col-sm-12 col-12">
            ...
            <li class="item-head">
               <h5>Two Days Tirupati package from Bangalore</h5>
                </li>
<table class="table" id="table">
  <thead>
   <?php
include 'config.php';
$sel = "SELECT * FROM cars where car_type='Etios2' || car_type='Innova2' || car_type='Tempo2' && day='2'";
$rs = $conn->query($sel);
while($rws = $rs->fetch_assoc()){
?> 
    <tr>
      
      <th scope="col"><i class="fa fa-car"></i></th>
      <th scope="col"><?php echo $rws['car_name'];?>&nbsp;<?php echo $rws['capacity'];?></th>
      <th scope="col">Rs. <?php echo $rws['hire_cost'];?>/-</th>
      <th scope="col">
      <a href="sri_balaji_booking.php?id=<?php echo $rws['car_id'] ?> " class="book">Book</a></th>
...
?>
                ...
                <li class="item-foot details">
                <a href="two-day-package-from-bangalore.php" class="book">More Details</a>
                </li>
        ...
        <div class="col-lg-4 col-sm-12 col-12">
            <div class="card">  
            <div class="item-head">
               <h5>Three Days Tirupati package from Bangalore</h5>
                </div>  
                <table class="table" id="table">
  <thead>
   <?php
include 'config.php';
$sel = "SELECT * FROM cars where car_type='Etios3' || car_type='Innova3' || car_type='Tempo3' && day='3'";
$rs = $conn->query($sel);
while($rws = $rs->fetch_assoc()){
?> 
    <tr>
...
?>
                  ...
                  <div class="item-foot details">
                <a href="three-day-package-from-bangalore.php" class="book">More Details</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="about_sribalaji">
    <div class="container">
        <h2><b>Best Tirupati package from Bangalore</b></h2>
    <div class="row content">
       ...
       <div class="col-lg-8 col-sm-12 col-12">
           <div class="text">
            <p>Sri Balaji Travel provides outstanding service included Tirupati darshan package from bangalore at an affordable Price on a daily basis. Best deal Tirupati darshan online booking from a Bangalore Based Company. We offer a great assistance starting from the departure point till you come back home after a divine Darshan of Balaji. Our Tirupati package from Bangalore includes Door Pick up and drops in Bangalore City limits, food, accommodation, special Darshan ticket of Rs.300 per person, Personal guide will be allocated for Tonsure and Thulabaram. <br><br>
In our Tirupati package from Bangalore, we make travel more comfortable and easier, arranging travel as per our customers’ requirements and preferences. We make arrangements for visit to Tirupati Balaji Temple, Padmavathy Temple, Kalahasti temple and many other temples to make the Tirupati tour package from Bangalore even more pleasing. With Sri Balaji Travel, we ensure you will have a memorable Tirupati darshan package from Bangalore where you can have Balaji darshan without any waiting time.
Sri Balaji travel provides a best Tirupati package from Bangalore reach us on - +91 82963 59444, +91 82963 19444. <br><br>
Tirupati is one of the most favourite sacred destination in the World. You can get the blessings of Lord Venkateshwara at Tirupati and bring all your vision to Truth. You can find lot of Travel services in Bangalore so that you can enjoy your trip without any hassles. <br><br>
We have Tirupati tour package from Bangalore for those who would like to travel on a budget and also for those who are looking for an option of luxury travel to Tirupati. Our team of qualified and experienced staff are well trained to serve our customers to their satisfaction.</p>
            
            <span><b> Sri Balaji Travels offers more Tirupati Tour Packages</b>
               <b>
            <ol>
                <a href="one-day-tirupati-package-from-bangalore.php"><li> One Day Tirupati package from Bangalore </li></a>
                <a href="two-day-tirupati-package-from-bangalore.php"><li> Two Days Tirupati package from Bangalore</li></a>
                <a href="three-day-tirupati-package-from-bangalore.php"><li> Three Days Tirupati package from Bangalore</li></a>
                <a href="bangalore-to-tirupati-car-rental.php"><li>Bangalore to Tirupati Car Rental Package</li></a>
            </ol>
               </b>
               </span>
        </div>
								...
								<div class="media">
									...
									<div class="media-body">
										<div class="testimonial">
											<p>Sri Balaji travels have arranged a very very nice trip to Thirupati. They have taken care of us very well in all aspects. We really enjoyed the trip. The driver Mr Uma Shankar was very good courteous and always pleasant. I highly recommend Sri Balaji Travels for trip to Thirupati.</p>
											
											<p class="overview"><b>Subbarayalu Babu</b></p>
											<span>
											    <ul>
                                    <li>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="media">
									...
									<div class="media-body">
										<div class="testimonial">
											<p>One of the finest travel agency in Bangalore I have ever seen so far. Very well co-ordinated and executed with decency , punctuality and helpfulness. Where some cheating agencies are there to leave you helpless on the roads in midnight, but Sri Balaji tours and travels is there to treat you as a family and will take good care of you. Thanks a lot to the manager and driver to made our tour memorable.</p>
											
											<p class="overview"><b>Ranjan Dash</b></p>
											<span>
											    <ul>
                                    <li>
                                        <i class="fa fa-star"></i>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="media">
									...
									<div class="media-body">
										<div class="testimonial">
											<p>Committed as per promise. All the things were scheduled properly and timely . Driver was good and humble. Special Darshan Tickets were arranged as promised. Good for family tour.</p>
											
											<p class="overview"><b>Akarsh Srivastava</b></p>
											<span>
											    <ul>
                                    <li>
                                        <i class="fa fa-star"></i>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="media">
									...
									<div class="media-body">
										<div class="testimonial">
											<p>Over all it was nice , people are very polite . Moreover response is very good at all the time. Thank you balaji travels for the wonderful experience.</p>
											
											<p class="overview"><b>Gururaj Shetty</b></p>
											<span>
											    <ul>
                                    <li>
                                        <i class="fa fa-star"></i>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="media">
									...
									<div class="media-body">
										<div class="testimonial">
											<p>Ganesh was very helpful and assured end to end at very first call , we had no problem, it was very good arranged , I had travelled with my g.ma and g.pa, we covered darshan within 45mins, our family members were very happy with the spiritual trip, thank you team.</p>
											
											<p class="overview"><b>Pushpa Subramanyam</b></p>
											<span>
											    <ul>
                                    <li>
                                        <i class="fa fa-star"></i>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="media">
									...
									<div class="media-body">
										<div class="testimonial">
											<p>Excellent service by Sri Balaji tours and travels. I have booked cab for 3 days . Tirupati -Banglore-Mysore-Banglore and airport . Drivers were very cooperative and excellent clean cars. This made my journey comfortable. I would suggest to go for it , specially you are travelling with family. Thanks Ganesh wish you best luck.</p>
											
											<p class="overview"><b>Shrikant Rangire</b></p>
											<span>
											    <ul>
                                    <li>
                                        <i class="fa fa-star"></i>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="media">
									...
									<div class="media-body">
										<div class="testimonial">
											<p>I booked one day tirupati package by sri balaji travels mr ganesh helped us getting better package and rates are very competitive compared with other travel agencies, the driver was very friendly and very professional, the guide helped us to complete our darshan within an hour , the overall trip was pleasant, thank you team and I will highly recommend your services.</p>
											
											<p class="overview"><b>Srinivas G</b></p>
											<span>
											    <ul>
                                    <li>
                                        <i class="fa fa-star"></i>
...
<div class="includes">
    <div class="container">
        <h2><b>Sri Balaji Travels - Provides Bangalore to Tirupati car package</b></h2>
        <p>Our cars are fitted with ergonomic seats with entertainment systems. Sri Balaji Travels has vehicles like Dzire, Etios , Innova, Tempo Traveller , we have both Air-conditioned and non air conditioned vehicles for the benefit of our customers. our drivers will be the guide and support with well versed in multiple languages to serve customers  across the country. Our Tirupati Packages include temple visit , sightseeing and travel. We follow our itinerary which saves time and enhances the  experience . we assure 100% secure Bangalore to Tirupati car package.</p>
...
<!--Google Maps-->
    <div id="google_map"> <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1079.0284943477545!2d77.56724257199511!3d12.943695118689206!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae3fbc6ddd0ecb%3A0xedc20bcdcb0a882f!2sSri%20Balaji%20Tours%20and%20Travels%20Bangalore%20-%20Tirupati%20Tour%20Package%20Provider!5e1!3m2!1sen!2sin!4v1650992984537!5m2!1sen!2sin" width="100%" height="350" style="border:0; margin: 0 0 -6px 0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
<!-- Scroll Top Button -->
<button onclick="topFunction()" id="myBtn" title="Go to top">
<i class="fa fa-angle-double-up"></i>    
</button>
<!-- onload Special Darashana -->
<div class="modal" role="dialog" id="myModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <p><b>Rs/- 300 Special Darshan | Contact: +91 82963 59444 </b><br>
<span>NOTE : PRICE MAY CHANGE FOR SPECIAL DARSHAN</span>
<br>
        <marquee behavior="scroll" direction="left"
           onmouseover="this.stop();"
           onmouseout="this.start();" style="color:white;">
<b>For passengers kind information, Website shows package price is not available for now. Only 45 days prior booking can avail the website shown price. To know more Details for Tirupati Trip for the upcoming days kindly call us on  8296319444/8296359444</b></marquee>
</p>
