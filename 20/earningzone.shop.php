         ...
         <div class="slide-1 home-slider home-60">
            <?php 
               ...
               $img1=explode("/assets/",$values['image']);
                     $url="https://earningzone.shop/Admin/assets/upload/banner/".$values['image'];
               ?>
            <div>
			   ...
			   $img=explode("SHOPKIRANA",$values['image']);
				...
				<div class="col-md-2 mb-2 ">
                           <div class="product-box  product" style="border:1px solid #dfdfdf;padding:10px !important">
                              <div class="img-block">
                                 <a href="product-details?id=<?php echo $values['id'];?>" style="height:150px !important"><img src="https://earningzone.shop/Admin/API/v1/uploads/products/<?php echo $img['0'];?>" class=" img-fluid bg-img" alt="" ></a>
                  ...
                  <div class="logo-4 text-center border-logo">
					  ...
					  ?>
						<div class="logo-img" style="">
							<a href="https://earningzone.shop/Admin/assets/upload/brand/<?php echo $result['image'] ;?>" target="_blank">
							   <img src="https://earningzone.shop/Admin/assets/upload/brand/<?php echo $result['image'] ?>" class=" " alt="" style="height:150px;width:150px;border-radius:50%"></a>
