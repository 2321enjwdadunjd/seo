   ...
   <body>
      ...
      <section class="p-0 full-slider">
         <div class="slide-1 home-slider home-60">
            <?php 
               $query="SELECT * FROM `banner` WHERE `del_status`='false' ORDER BY `id` DESC";
                    $result=$conn->query($query);
                    while($values=$result->fetch_assoc()){
               $img1=explode("/assets/",$values['image']);
                     $url="https://karunamritmart.com/Admin/assets/upload/banner/".$values['image'];
               ?>
            <div>
               <div class="home text-white text-end p-right bg-position-unset " style="background-image:url(<?php echo $url;?>);background-size:100% 100%;">
                  <!--<img src="<?php # echo $url;?>" class="bg-img bg-left " alt="">-->
                  <div class="container">
                     <div class="row">
                        <div class="col">
            ...
            <?php } ?>
            <!--div>
               <div class="home text-white text-end p-right">
                   <img src="assets/images/home-banner/28.jpg" class="bg-img bg-right " alt="">
                   <div class="container">
                       <div class="row">
                           <div class="col">
                               <div class="slider-contain">
...
<section class="ratio_45">
    <div class="container-fluid">
        <div class="row partition-6">
           <div class="col-sm-12">
			 <h3 style="font-weight:bold;margin-left:12px;" >LATEST PRODUCTS</h3>
			<hr>
		   </div>
		   <?php
		   
			   $i=1;
			   $query="SELECT * FROM `product` where  del_status='false' ORDER BY rand()  limit 12";
			   $result=$conn->query($query);
			   while($values=$result->fetch_assoc()){
			   $img=explode("SHOPKIRANA",$values['image']);
                        
				?>
				<div class="col-md-2 mb-2 ">
                           <div class="product-box  product" style="border:1px solid #dfdfdf;padding:10px !important">
                              <div class="img-block">
                                 <a href="product-details?id=<?php echo $values['id'];?>" style="height:150px !important"><img src="https://karunamritmart.com/Admin/API/v1/uploads/products/<?php echo $img['0'];?>" class=" img-fluid bg-img" alt="" ></a>
                                 <!--a href="product-page.html"><img src="assets/images/sports/pro/19.jpg" class=" img-fluid bg-img" alt=""></a-->
								 <style>
                                 ...
                                 <div class="lable-wrapper" >
                                    <span class="lable3 bg-danger text-center"><?php echo $values['discount']."% off";?></span>
                                 </div>
                                 <div class="cart-wrap">
                                    <a href="javascript:void(0)"  class="addcart-box" title="Quick shop"><i class="fa fa-shopping-cart" style="font-size:25px"  ></i></a>
									<?php 
							if(isset($_SESSION['uid']) && !empty($_SESSION['uid'])) {	
							         ?>
                                    <a href="javascript:void(0)" onclick="wishlist('<?php echo $user_id=$_SESSION['uid']?>','<?php echo $product_id=$values['id']?>')" data-bs-target="#wishlist" tabindex="0" title="Add to Wishlist"><i class="fa fa-heart" aria-hidden="true" style="font-size:25px"></i></a>
									<?php } else { ?>
									 
                                    <a href="login" onclick="wishlist" data-bs-target="#wishlist" tabindex="0" title="Add to Wishlist"><i class="fa fa-heart" aria-hidden="true" style="font-size:25px"></i></a>
							<?php } ?>
                                 </div>
                              </div>
                              <div class="product-info">
                                 <a href="#" >
                                    <h6 style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"><?php echo $values['name'];?></h6>
                                 </a>
                                 <h5>
								 <del>Rs. <?php echo $values['mrp'];?></del>&nbsp;&nbsp; Rs. 
							...
							?>
								 ...
								 <!--<h6>Business Value : ₹ <?php echo $values['bv'];?></h6>-->
                              </div>
							...
							?>
                                    <div>
                                       <div class="addtocart_btn">
                                          <a href="javascript:void(0)" onclick="addtocart('<?php echo $user_id=$_SESSION['uid']?>','<?php echo $product_id=$values['id']?>')" >add to cart</a>
                                       </div>
                                    </div>
							<?php } else { ?>
...
<!-- Category banner section end -->
      ...
      <section class="section-b-space category grey-bg no-arrow">
		...
		<div class="row">
			...
			<div class="col-12"> <h3 style="font-weight:bold;" >TOP CATEGORIES</h3></div>
		</div>
		</div>
         <div class="container">
            ...
            <div class="cat-slide-6">
               <?php
                  $i=1;
                  $query="SELECT * FROM `category` where rand() ORDER BY `id` DESC";
                  $result=$conn->query($query);
                  while($values=$result->fetch_assoc()){
                  //$img=explode("SHOPKIRANA",$values['image']);
                  ?>
               <div>
                  <a href="category_wise_product?id=<?php echo $values['id'];?>">
                     <div class="category-wrap" style="height:250px;" >
                        <div>
                           <img src="Admin/assets/upload/category/<?php echo $values['image'];?>" alt="" class=" img-fluid" style="width:200px; height:150px;">
                           <!--h6>20% off</h6-->
                           <h5 style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"><?php echo $values['name'];?></h5>
                        </div>
                     </div>
                  </a>
               </div>
...
<section class="ratio_45">
    <div class="container-fluid">
        <div class="row partition-6">
           <div class="col-sm-12">
			 <h3 style="font-weight:bold;margin-left:12px;" >TOP PRODUCTS</h3>
			<hr>
		   </div>
		   <?php
			   $i=1;
			   $query="SELECT * FROM `product` where  del_status='false' ORDER BY rand()  limit 24";
			   $result=$conn->query($query);
			   while($values=$result->fetch_assoc()){
			   $img=explode("SHOPKIRANA",$values['image']);
...
<!-- Category banner section end -->
         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-sm-6 col-12">
                  ...
                  <div class="logo-4 text-center border-logo">
					  <?php 
					  ...
					  ?>
						<div class="logo-img" style="">
							<a href="https://karunamritmart.com/Admin/assets/upload/brand/<?php echo $result['image'] ;?>" target="_blank">
							   <img src="https://karunamritmart.com/Admin/assets/upload/brand/<?php echo $result['image'] ?>" class=" " alt="" style="height:150px;width:150px;border-radius:50%"></a>
							<h4 class="text-dark"  style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"><?php echo $result['name'];?>   </h4>
						</div>
					  <?php } ?>
				  </div>
               </div>
               <div class="col-sm-6 col-12 ">
					<div class="row">
						<div class="col-sm-6">
							 <div class="img-block">
								<img src="images/logic350.png" class=" img-fluid" alt="">
							 </div>
						</div>
						<div class="col-sm-6">
							 <div class="img-block">
								<img src="images/logic.png" class=" img-fluid mt-5" alt="">
							 </div>
						</div>
					</div>
               </div>
	  ...
	  <script>
	   function productdetail(product_id)
	   {
		  ...
		  $.ajax({
		    type: "POST",
		    url: 'Admin/Admin/code/ManageUser.php?flag=ProductDetail',
	  ...
	  function wishlist(user_id,product_id){
		...
		$.ajax({
		    type: "POST",
		    url: 'Admin/Admin/code/ManageUser.php?flag=wishlist',
