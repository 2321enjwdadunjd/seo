...
?>
<?php ob_start(); 
require_once ("controller/script_func.php"); 
?>
<!DOCTYPE html>
...
<head>
	...
	<title><?php echo $SITE_HTITLE; ?></title> 
...
<body id="bd" class="homepage home-layout1 res" >
 ...
 <?php $baneFetch=mysqli_query($link,"select img from banners where status=1 and id=16 ") or die(mysqli_error($link)); 
		if(mysqli_num_rows($baneFetch)>0){ 
			$febbane=mysqli_fetch_array($baneFetch);
?>	
<div id="dropin" style="position: fixed; visibility: visible; left: 300px; top: 110px; width: 630px; height: 490px; background-color: rgb(255, 240, 0); z-index: 99999999;">
<div align="right"><a href="#" onclick="dismissbox();return false">[Close Box]&nbsp;</a></div>
<table width="100%" border="0" cellspacing="5" cellpadding="0">
<tbody><tr>
<td align="center" valign="top"><img src="upload/banners/<?php echo $febbane['img'];?>" width="600" height="450"></td>
</tr>
</tbody></table>
</div>
<?php } ?>
	...
	<div id="yt_wrapper" class="layout-wide">
		...
		<?php include('banner.php'); ?>
             ...
             <section id="yt_spotlight7" class="block" style="padding:10px 5px;  background:#DF4E17;">						<div class="container">
							<div class="row">
									<div id="top11"  class="col-md12 col-sm-12" style="padding:0; margin:0;">
			    	
	<div>
	    		    
	   <marquee behavior="scroll" direction="left" scrollamount="2" onMouseOver="stop()" onMouseOut="start()" style="color: #fff; FONT-FAMILY: Arial Unicode MS; font-size: 18px;">
<?php 
 $newScrol=mysqli_query($link,"select name, description from  contents where id=21 and status=1 ") or die(mysqli_error($link));
 $fetScro=mysqli_fetch_array($newScrol);
 echo $fetScro['description'];
?>
	...
	<div class="module  k2-slider-style-one " >
	    		    <h3 class="modtitle"><?php echo $SITE_HTITLE; ?></h3>
	    	    <div class="modcontent clearfix">
					<div id="sj_k2_slider_5428823231527567367" class="sj-k2-container-slider" style="">
			...
			<div class="vpo-wrap">
				<div class="vp">
					...
					<?php 
					 $imgasr=array('img/977257caee2c701e202cbcea0874801b.jpg','img/29b535898136b567c4af03016f78c999.jpg','img/4f715b3c6faa4a0b6968245babe31260.jpg');
					$fetcAbot=mysqli_query($link,"select * from  about where  status=1 order by id asc limit 3") or die(mysqli_error($link));
					$tt=0;
 					while ($fetAbou=mysqli_fetch_array($fetcAbot)) {
					?>
						<div class="item">
							<div class="item-wrap">							
								...
								<div class="item-info  ">
									<div class="item-inner">
											...
											<a title="Lazen miten pakem rasem "  ><?php echo normal_filter($fetAbou['name']);?></a>
										</div>
										<div class="item-content">
														<div class="item-des" style="FONT-FAMILY: Arial Unicode MS; ">
												 <?php if(strlen(stripslashes($fetAbou['description']))>500) echo ucfirst(substr((stripslashes($fetAbou['description'])),0,500)),"..."; else echo ucfirst(stripslashes($fetAbou['description']));?>	
												</div>
													<div class="item-read">
													<a href="about?id=<?php echo enc($fetAbou['id']);?>" ><i class="fa fa-check"></i><span>Read more</span>
													</a>
												</div>
											</div>	
									</div>
    ...
    jQuery(document).ready(function($){
		;(function(element){
			...
			$('.slider', $element).responsiver({
				...
				pause: 'hover',
				control:{
					prev: '#sj_k2_slider_5428823231527567367 .control-button li[class="preview"]',
					next: '#sj_k2_slider_5428823231527567367 .control-button li[class="next"]'
				},
				getColumns: function(element){
					...
					$slider.touchSwipeRight(function(){LLLLKLL                     L LLLKM
						$slider.responsiver('prev');
						}
					);
					
			$('.control-button',$element).removeClass('preload');
		})('#sj_k2_slider_5428823231527567367');
    });
//]]>
</script>
	    </div>
	...
	<div class="module  cus-admissions " >
	    	    <div class="modcontent clearfix" style="background:#d0eaf7;">
<ul>
<li> 
 
<h3><a title="" href="#">New & Events</a></h3>
<style type="text/css">
marquee p{ padding:0; margin:0;}
</style>
<marquee behavior="scroll" direction="up" scrollamount="2" onMouseOver="stop()" onMouseOut="start()" height="360px;">
			 <?php 
                 $aboutQue=mysqli_query($link,"select * from news  where status=1 ") or die(mysqli_error($link));
				while( $fetAbou=mysqli_fetch_array($aboutQue)){
                ?><br>

<a href="news?vid=<?php echo enc($fetAbou['id']);?>" style="text-decoration: underline;"><?php if(strlen(stripslashes($fetAbou['name']))>30) echo ucfirst(substr((stripslashes($fetAbou['name'])),0,30)),"..."; else echo ucfirst(stripslashes($fetAbou['name']));?></a>
<?php if(strlen(stripslashes($fetAbou['description']))>30) echo ucfirst(substr((stripslashes($fetAbou['description'])),0,30)),"..."; else echo ucfirst(stripslashes($fetAbou['description']));?>
<br>
  <?php } ?>
 </marquee>
</li> 
	...
	<!--[if gt IE 9]><!--><div id="sjextraslider_7264022151527567367" class="sj-extraslider slide  extra-resp01-3 extra-resp02-3 extra-resp03-1 extra-resp04-1"   data-interval="0" data-pause="hover"><!--<![endif]-->
	    ...
	    <div class="extraslider-inner">
					...
					<?php 
					 $imgdasr=array('img/879f8c33fc4103d764509776abe81d9b.jpg','img/120f8939156bb612d15ba7fe6b4df02a.jpg','img/b34f99f98c3d5f8be74600bbf6932bbf.jpg');
					$fetcAbost=mysqli_query($link,"select * from messages where  status=1 order by id asc limit 3") or die(mysqli_error($link));
					$tts=0;
 					while ($fetAbou=mysqli_fetch_array($fetcAbost)) {
					?>		
									
									<div class="item-wrap style2">
						<div class="item-wrap-inner">
														<div class="item-image">
								<img src="<?php echo $imgdasr[$tts];?>" alt="<?php echo $imgdasr[$tts];?>"/> 
						...
						<div class="item-info">
															<div class="item-title">
								<a style="FONT-FAMILY: Arial Unicode MS; font-size:16px;">
									<?php echo normal_filter($fetAbou['name']);?>			</a>    			     
								</div>
																					 
							  
															<div class="item-content">
									<div class="item-description" style="FONT-FAMILY: Arial Unicode MS; ">
									 <?php if(strlen(stripslashes($fetAbou['description']))>500) echo ucfirst(substr((stripslashes($fetAbou['description'])),0,500)),"..."; else echo ucfirst(stripslashes($fetAbou['description']));?>	</div>																																						<div class="item-readmore">
											<a href="institute?id=<?php echo enc($fetAbou['id']);?>" ><i class="fa fa-long-arrow-right"></i></a>                                
										</div> 
