...
<div id="main-slider" class="main-slider">
                ...
                <?php
$selcat=mysqli_query($conn,"select * from tbl_banner where banner_category='banner'");
$sn=1;
while($respage=mysqli_fetch_object($selcat)){

?>
            <div class="single-slide">
                <div class="bg-img kenburns-top" style="background-image: url(upload/banner/<?php echo $respage->banner_image;?>);"></div>
...
<section class="about-section padding bd-bottom">
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-md-12 sm-padding wow fadeInLeft" data-wow-delay="200ms">
                        <div class="section-heading mb-30">
                          <center>  <h2>ABOUT <span>US</span></h2></center>
                            <p><?php
                    $selcat=mysqli_query($conn,"select * from tbl_page where pg_id='2'");
                    $reslc=mysqli_fetch_object($selcat);
                    ?>
                    <?php echo str_replace("^",",",$reslc->description);?></p>
                        </div>
                        
                        <div class="sign">
                            <a href="https://api.whatsapp.com/send?phone=917011363706&text=" class="default-btn">Connect Us <span></span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
               <div class="section-heading mb-40 text-center wow fadeInUp" data-wow-delay="200ms">
                ...
                <div class="row">
                                              ...
                                              <?php
$selcat=mysqli_query($conn,"select * from tbl_product");
$sn=1;
while($respage=mysqli_fetch_object($selcat)){
?>
                    ...
                    <div class="col-lg-4 col-md-6 sm-padding wow fadeInUp" data-wow-delay="200ms">
                        <div class="service-box">
                            <img src="upload/small/<?php echo $respage->image;?>" alt="post" style="width:100%;">
                            <div class="service-icon">
                                <i class="dl dl-factory-1"></i>
                            </div>
                            <div class="service-content">
                                <a href="service.php?id=<?php echo $respage->product_id;?>"><h3><?php echo $respage->product_title;?></h3></a>
                               
                                <a href="service.php?id=<?php echo $respage->product_id;?>" class="read-more">Read More</a>
                            </div>
                        </div>
                    </div>
...
<section class="project-section bd-bottom">
            <div class="container">
                ...
                <div class="slider project-carousel nav-style dl-lb-gallery">
                                                ...
                                                <?php
$selcat=mysqli_query($conn,"select * from tbl_blog");
$sn=1;
while($respage=mysqli_fetch_object($selcat)){
?>
                    ...
                    <div class="project-item">
                       <div class="project-thumb">
                           <img src="upload/blog/<?php echo $respage->image;?>" alt="project">
                            <div class="project-view">
                                <a class="dl-lightbox" href="assets/img/project-1-768x600%20.jpg"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                        <div class="project-content">
                            <a href="blog-details.php?id=<?php echo $respage->blog_id;?>" class="cat">Architecture</a>
                            <h3><a href="blog-details.php?id=<?php echo $respage->blog_id;?>"><?php echo $respage->blog_title;?></a></h3>
                        </div>
                    </div>
               ...
               <div class="bg-pattern"></div>
                <div class="container">
                    ...
                    <div class="col-lg-2 col-md-6 sm-padding wow fadeInUp" data-wow-delay="300ms">
                        <div class="counter-item">
                            <div class="counter-content">
                                <h3><span class="odometer" data-count="3,245">1200</span></h3>
                    ...
                    <div class="col-lg-2 col-md-6 sm-padding wow fadeInUp" data-wow-delay="400ms">
                        <div class="counter-item">
                            <div class="counter-content">
                                <h3><span class="odometer" data-count="2,518">300</span></h3>
                    ...
                    <div class="col-lg-2 col-md-6 sm-padding wow fadeInUp" data-wow-delay="500ms">
                        <div class="counter-item">
                            <div class="counter-content">
                                <h3><span class="odometer" data-count="6274">700</span></h3>
                                <h4>Hours Worked</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 sm-padding wow fadeInUp" data-wow-delay="600ms">
                        <div class="counter-item">
                            <div class="counter-content">
                                <h3><span class="odometer" data-count="3245">1400</span></h3>
...
<section class="testimonials-section bg-grey padding bd-bottom">
            <div class="container">
                ...
                <div class="slider testimonials-carousel nav-style carousel-dots">
                                               ...
                                               <?php
$selcat=mysqli_query($conn,"select * from tbl_testimonial");
$sn=1;
while($respage=mysqli_fetch_object($selcat)){
?>
                    ...
                    <div class="testi-item">
                       <div class="testi-thumb">
                           <img src="upload/testimonial/<?php echo $respage->image;?>" alt="'img">
                       </div>
                        <div class="testi-content">
                            <p> <?php echo $respage->description;?></p>
                            <h3><?php echo $respage->client_name;?></span></h3>
                            <ul class="ratings">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d448183.7391989541!2d76.81305833597047!3d28.646677229758147!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfd5b347eb62d%3A0x37205b715389640!2sDelhi!5e0!3m2!1sen!2sin!4v1660816236704!5m2!1sen!2sin" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
