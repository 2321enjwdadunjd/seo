...
?>
<?php include_once('connectone.php'); ?>
...
<head>
    ...
    <link rel="stylesheet" href="admin-login/dist/fontawesome-5.11.2/css/all.min.css">
...
<script type="text/javascript" src="https://code.jquery.com/jquery-1.8.2.js"></script>
    ...
    <?php include_once('includes/side-fixed-call.php'); ?>



    <!-- Student Section Start -->

    <?php include_once('includes/student-section.php'); ?>
    ...
    <?php include_once('includes/fake-sts.php'); ?>
    ...
    <?php include_once('includes/sts-online.php'); ?>

    <!-- STS Online End -->



    <!-- ACHEIVEMENTS Section Start-->

    <?php include_once('includes/home-achievement.php'); ?>

    <!-- ACHEIVEMENTS Section End -->



    <!-- Centre Testimonial -->

    <?php include_once('includes/centre-testimonial.php'); ?>

    <!-- Centre Testimonial End -->
    ...
    <?php include_once('includes/student-testimonial.php'); ?>
    ...
    <?php include_once('includes/home-gallery.php'); ?>
    ...
    <?php include_once('includes/sts-glance.php'); ?>
    ...
    <?php include_once('includes/sts-awards.php'); ?>
    ...
    <?php include_once('includes/other-information.php'); ?>
    ...
    <?php include_once('includes/home-partners.php'); ?>

    <!-- Partners End -->

    <!-- linkage Start -->

    <?php include_once('includes/home-linkage.php'); ?>
    ...
    (function() {
        ...
        s1.src = 'https://embed.tawk.to/63299cf337898912e96a3d62/1gdd8q686';
