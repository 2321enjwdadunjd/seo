    ...
    <div class="home-slider">
            ...
            <div class="banner-content-wrap">
                <div class="container">
                    <div class="banner-content text-center">
                        <h2 class="banner-title">If your love for mountains is true, then you must head to Nainital.</h2>
                        <a href="packeg.php" class="button-primary">Our Activites</a>
                    </div>
                </div>
            </div>
        ...
        <div class="home-banner-items">
            ...
            <div class="banner-content-wrap">
                <div class="container">
                    <div class="banner-content text-center">
                        <h2 class="banner-title">At its best, the world is a place of many sapphire lakes and snowcapped hills.</h2>
                        <a href="packeg.php" class="button-primary">Our Activites</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="package-inner">
            <div class="row">
                ...
                <?php
$selcat=mysqli_query($conn,"select * from tbl_brand");
$sn=1;
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="package-wrap">
                        <figure class="feature-image">
                            <a href="#">
                                <img src="upload/brand/<?php echo $respage->image;?>" alt="" style="height:250px; width:100%;">
                            </a>
                        </figure>
                        <div class="card-body text-center bg-dark " style="min-height:400px;">
                            <h4 class="bg-light text-black m-auto" style="width:90%;"> <?php echo $respage->brand_title;?></h4>
                            <p></p>
                        <?php 
		                   ...
		                   foreach($kk  as $ccvbss[$i])
                            {
                            ?>
                            <h4 class="bg-light text-black m-auto" style="width:90%;"> <?php echo $ccvbss[$i]; ?> </h4>
                            <p></p>
                            <?php
                            }
                            ?>    <a href="https://wa.me/+919634618444" class="btn btn-warning mt-2 ">₹ <?php echo $respage->pg_meta_title; ?>/</a>
                        </div>
...
?>
                <div class="col-md-3  col-sm-6 col-xs-6  mt-2">
                    <div class="card">
                        <img src="upload/blog/small/<?php echo $respage->simage;?>" class="card-img-top" alt="..." style=" height:200px;">
                        <div class="card-body text-center">
                            <h3 class="card-title text-center"><?php echo $respage->blog_title;?></h3>
                            <a href="https://wa.me/+919634618444" class="btn btn-warning ">Book Now</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="section-heading">
                    ...
                    <p>Our travel agents of Uttarakhand, provide tour travel and holiday packages at best budget price for entire Uttarakhand region. We make best and memorable holiday tour packages by our dedicated and experienced team for our valued guests from India and abroad.
                    </p>
                </div>
...
<!---========================google map========================--->
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3478.783790836752!2d79.58343850000001!3d29.318017200000007!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39a097a129fd4c3d%3A0x69e70501fa47a25f!2sNainital%20Adventure%20zone.!5e0!3m2!1sen!2sin!4v1660379458762!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
