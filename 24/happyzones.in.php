...
?>
    ...
    <section class="about-us-slider swiper-container ">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide-item">
                <img src="https://rajarshisolutions.net/wp-content/uploads/2016/06/banner.jpg" class="img-fluid full-width" alt="Banner">
                <div class="transform-center">
                    <div class="container">
            ...
            <div class="swiper-slide slide-item">
                <img src="https://fiverr-res.cloudinary.com/images/q_auto,f_auto/gigs/115189545/original/8664a7c83fc0a59973579c1f325065a85eaa28a0/a-professional-banner-design-and-hoarding-poster.jpg" class="img-fluid full-width" alt="Banner">
                <div class="transform-center">
                    <div class="container">
  ...
  <section class="browse-cat u-line">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-header-left">
                        <h3 class="text-light-black header-title title">Product Category <span class="fs-14"><a href="#">Category</a></span></h3>
                    </div>
                </div>  <?php
          $sql="SELECT * FROM `addctg` ORDER BY uid";
    ...
    while($data=mysqli_fetch_assoc($run))
    {
        ...
        ?>
                            ...
                            <div class="swiper-slide">
                                <a href="User/ctgproduct?Product=<?php echo $data['ctgname']; ?>" class="categories">
                                    <div class="icon icon-parent text-custom-white bg-light-green"> <img src="../Happyzones/<?php echo $data['ctgimg'];?>">
                                    </div> <span class="text-light-black cat-name"><?php echo $data['ctgname'];?></span>
                                </a>
                            </div>
...
?>
  ...
  <section class="browse-cat u-line p-3">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-header-left">
          ...
          $sql34="SELECT * FROM `productunder` ORDER BY uid";
    $run34=mysqli_query($conn,$sql34);

    if(mysqli_num_rows($run34)<1)
    {
       // echo '<script>alert("No Found")</script>';
    }
else{
...
<?php
    $count=0;
    while($data34=mysqli_fetch_assoc($run34))
    {
        $count++;
        ?>
               
                            <div class="swiper-slide">
                                <a href="Productunder?Product=<?php echo $data34['price']; ?>" title="Buy Product" style="background-color:#993399;color:white;" class="btn ">&#8377; <?php echo $data34['price']; ?></a>
                            </div>
    ...
    <section class="ex-collection ">
        ...
        <div class="container">
            ...
            <div class="row shadow p-3 mb-5 bg-white rounded">
                    ...
                    <div class="section-header-left">
                        <h3 class="text-light-black header-title title"><input type="range" min="1" max="100000" value="30000" class="slider" id="myRange" name="amount">  <p>Price:  &#8377;<span id="demo"></span></p>
                         <input type="submit" name="check" style="height:25px;width:80px;color:white;font-size:12px; background: linear-gradient(to top right, #cc3300 0%, #663300 100%);border:2px solid #ffffcc;" value="Apply">
                        </h3>
...
slider.oninput = function() {
  output.innerHTML = this.value;
                ...
                <div  class="col-lg-12 col-md-12">
                    ...
                    <div class="row">
                                           <?php
          $sql="SELECT * FROM `productuploads` WHERE status='1' ORDER BY uid DESC LIMIT 52";
    $run=mysqli_query($conn,$sql);
...
<?php
    ...
    while($data=mysqli_fetch_assoc($run))
    {
        $count++;
        ?>
                        <div  class="col-lg-3 col-md-3 col-sm-3"id="myDIV">
                            <div class="product-box mb-xl-20">
                                <div class="product-img">
                                    <a href="restaurant.html">
                                        <center><img src="Happyzones/<?php echo $data['photo1'];?>" class="" alt="product-img" style="Height:140px;" ></center>
                                    </a>
                                    <div class="overlay">
                        ...
                        <img src="assets/img/svg/013-heart-1.svg" alt="tag">
                          ...
                          10%
                                ...
                                <div class="product-caption">
                                    <div class="title-box">
                                        <h6 class="product-title"><a href="Checkout?Product=<?php echo $data['productrnd']; ?>" class="text-light-black "> <?php echo $data['productitle'];?></a></h6>
                                        <div class="tags"> <span class="text-custom-white rectangle-tag bg-yellow">
                      <?php echo(rand(1,10));?>.<?php echo(rand(1,9));?>
                      </span>
                                        </div>
                                    </div>
                                    <p class="text-light-white">Indian, <?php echo $data['ctg'];?></p>
                                    <div class="product-details">
                                        <div class="price-time"> <span class="text-light-black time">7-10 Days</span>
                                            <span class="text-light-white price">&#8377;<?php echo $data['productamount'];?></span>
                                        </div>
                        ...
                        <i class="fas fa-star text-yellow"></i>
                                            ...
                                            <span class="text-light-white text-right"><?php echo(rand(100,999));?> ratings</span>
                                        </div>
                                    </div>
                                    <div class="product-footer"> <span class="text-custom-white square-tag">
                     <a href="#"   
                     onclick="window.open('http://happyzones.in/Happyzones/<?php echo $data['photo1'];?>','popUpWindow','height=500,width=600,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');"> <img src="Happyzones/<?php echo $data['photo1'];?>" alt="tag" style="height:10px"></a>
                    </span>
                                        <span class="text-custom-white square-tag">
                     <a href="#"   
                     onclick="window.open('http://happyzones.in/Happyzones/<?php echo $data['photo2'];?>','popUpWindow','height=500,width=600,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');"> <img src="Happyzones/<?php echo $data['photo1'];?>" alt="tag" style="height:10px"></a>
                    </span>
                                       <span class="text-custom-white square-tag">
                     <a href="#"   
                     onclick="window.open('http://happyzones.in/Happyzones/<?php echo $data['photo3'];?>','popUpWindow','height=500,width=600,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');"> <img src="Happyzones/<?php echo $data['photo1'];?>" alt="tag" style="height:10px"></a>
                    </span>
                     &nbsp;&nbsp;&nbsp;
                            <span class="text-custom-white square-tag">
                                <a href="User/Checkout?Product=<?php echo $data['productrnd']; ?>" title="Buy Product" style="background-color:#993399;color:white;" class="btn ">BUY</a>
                                </span>
...
?>
               ...
               <a href="" class="btn btn-warning">Load.....</a>        
            ...
            <div class="row">
                <div class="col-12">
                    <div class="banner-adv2 mb-xl-20">
                        <img src="https://images.freekaamaal.com/post_images/1510417673.gif" class="img-fluid full-width" alt="banner"> <span class="text">Happy-Zones Application <img src="https://cdn.dribbble.com/users/42880/screenshots/2879771/attachments/594991/3.png?compress=1&resize=400x300" alt="logo"> 
                            <a href="" class="btn-second btn-submit">APP DOWNLOAD</a></span>
            ...
            <div class="row">
                 <div class="col-lg-3 col-md-2">
                    <div class="large-product-box mb-xl-20 p-relative">
                        <img src="https://i.pinimg.com/originals/03/4c/72/034c72ba886015f2fdebd9916c8b1307.gif" class="img-fluid full-width" alt="image">
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="row">
                                                            ...
                                                            <?php
          $sql="SELECT * FROM `productuploads`WHERE status='1' LIMIT 8";
    $run=mysqli_query($conn,$sql);
...
?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="banner-adv2 mb-xl-20">
                        <img src="https://t3.ftcdn.net/jpg/03/47/39/04/360_F_347390410_yWGfLwNcJXoHcQqFgZ4gzYoIjZB6DR81.jpg" class="img-fluid full-width" alt="banner"> <span class="text">Happy-Zones Application <img src="https://cdn.dribbble.com/users/42880/screenshots/2879771/attachments/594991/3.png?compress=1&resize=400x300" alt="logo"> 
                            <a href="" class="btn-second btn-submit">APP DOWNLOAD</a></span>
                        <span class="close-banner"></span>
                        <div class="overlay overlay-bg"></div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4">
                    <div class="large-product-box mb-xl-20 p-relative">
                        <img src="https://emaildesign.beefree.io/wp-content/uploads/2015/12/melissa-doug.gif" class="img-fluid full-width" alt="image">
                        <div class="category-type overlay padding-15">
                            <button class="category-btn">Most popular near you</button> <a href="restaurant.html" class="btn-first white-btn text-light-black fw-600 full-width">See all</a>
                        </div>
                    </div>
                   ...
                   <div class="col-lg-9 col-md-8">
                    <div class="row">
                                                            ...
                                                            <?php
          $sql="SELECT * FROM `productuploads` WHERE status='1' LIMIT 12";
    $run=mysqli_query($conn,$sql);
    ...
    while($data=mysqli_fetch_assoc($run))
    {
        ...
        ?>
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="product-box mb-xl-20">  
                                <div class="product-img">
                                                <a href="Checkout?Product=<?php echo $data['productrnd']; ?>">
                                       <center> <img src="Happyzones/<?php echo $data['photo1'];?>" class="" alt="product-img" style="Height:140px;" ></center>
                                    </a>
                                    <div class="overlay">
                                        <div class="product-tags padding-10"> <span class="circle-tag">
...
?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="banner-adv2 mb-xl-20">
                        <img src="assets/img/restaurants/1110x100/vbanner-1.jpg" class="img-fluid full-width" alt="banner"> <span class="text">Happy-Zones Application <img src="https://cdn.dribbble.com/users/42880/screenshots/2879771/attachments/594991/3.png?compress=1&resize=400x300" alt="logo"> 
                            <a href="" class="btn-second btn-submit">APP DOWNLOAD</a></span>
                        <span class="close-banner"></span>
                        <div class="overlay overlay-bg"></div>
                    </div>
