...
<meta name="viewport" content="width=device-width, initial-scale=1">
 <meta name="facebook-domain-verification" content="iq0tpctwm4n9ih6es3lsscqiqi6bdc" />
    <meta name="description" content="Advanced Personality Development Course - Confidence Building | Communication Skills | Stress Management | Fitness and Nutrition | Guided Meditation"/>
<meta name="keywords" content="Stress management,Personality development,confidence building,speech correction" />
    <title>Reboot Personality - ADVANCED PERSONALITY DEVELOPMENT COURSE.</title>
<!-- Favicon Icon -->
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12 order-first">
                <div class="banner_text_s2 text_md_center">
                    <h1 class="animation text-white" data-animation="fadeInUp" data-animation-delay="1.1s"><strong  style="color:#ffe135;font-size: 35px;">11-Steps To Bring Clarity, Success & Happiness In Life.</strong> </h1>
                    <h5 class="animation presale_txt text-white" data-animation="fadeInUp" data-animation-delay="1.3s">Learn the steps that can help transform you to the best version of yourself </h5>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 order-first" style="text-align: center;">
                <div class="banner_image_right res_md_mb_50 res_xs_mb_30 animation" data-animation-delay="1.5s" data-animation="fadeInRight"> 
                   <iframe src="https://player.vimeo.com/video/576390698" width="100%" height="260" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                   
                   
                        <a href="home.php" class="btn btn-default btn-radius">Go To Website <i class="ion-ios-arrow-thin-right"></i></a> 
                </div>
