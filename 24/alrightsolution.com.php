              ...
              <div class="carousel-caption">
                <div class="row">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                    <div class="text-bg">
                      <h1>Leading B2C Company.</h1>
                      <p>We provide wide range of education,insurance, & financial products in india.</p>
                      <a href="https://files.appsgeyser.com/AlrightSolution_15466974.apk">Download App</a> <a href="#">get a qoute</a>
                    </div>
                  </div>
                  <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                    <div class="images_box">
                      <figure><img src="https://www.pointtobusinessservices.com/img/banner_img.png"style="height:550px;"></figure>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="container-fluid padding_dd">
              <div class="carousel-caption">
                ...
                <div class="row">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                    <div class="text-bg">
                      <h1>Education & Training Programme.</h1>
                     <p>To provide world class market demandable Education & Training Programme.</p>
                     <a href="https://files.appsgeyser.com/AlrightSolution_15466974.apk">Download App</a><a href="#">get a qoute</a>
                    </div>
                  </div>
                  ...
                  <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                    <div class="images_box">
                      <figure><img src="https://imgv3.fotor.com/images/side/Create-graphic-designs-easily-with-Fotor.png"style="height:550px;"></figure>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                    <div class="text-bg">
                      ...
                      <p>To provide valuable insurance and  financial products & services across india</p>
                      <a href="#">Read more</a> <a href="#">get a qoute</a>
                    </div>
                  </div>
                  <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                    <div class="images_box">
                      <figure><img src="https://img.freepik.com/free-vector/car-insurance-concept-idea-security-protection-property-life-from-damage-safety-from-disaster_277904-6104.jpg?size=626&ext=jpg&ga=GA1.2.256562859.1627689600" style="height:550px;"></figure>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          <h2>About <strong class="yellow">Our Company</strong></h2>
          <p style="text-align:justify";> Alright Solution“ is a revolutionary idea that has transcended itself beyond the ordinary. It is a commitment that is bringing a positive change in the lives of people it touches through its genuine quality products & services that are value-for-money and by opening profitable and career-oriented opportunities for the motivated youth. The company’s interests lie in various categories like Education, Banking & Finance, Sharemarket. It has also earned the reputation of being one of the largest companies  conscious efforts in promoting computer education and financial  awareness. Alright Solution is contributing to the enhancement of overall quality of living and is helping create Financially free and happy life.</p>
          <a href="Javascript:void(0)">Read more</a>
        </div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          <figure><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/Digital_marketing_1.webp/460px-Digital_marketing_1.webp.png"  width="100%"alt="#" /></figure>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="titlepage">
          ...
          <span>We provide wide range of education,insurance, & financial products in india.</span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
        ...
        <div class="box_bg">
          <div class="box_bg_img">
            <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="https://content.jdmagicbox.com/comp/agra/j3/0562px562.x562.190514091834.e5j3/catalogue/jetinder-kaur-khandari-agra-life-insurance-agents-lic-cj77ch5iv0.jpg"style="height:200px;"></figure>
                  <div class="overlay">
                    <h3>Insurance </h3>
                    <p>To provide valuable insurance and financial products & services across india.</p>
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="https://ncftpc.com/wp-content/uploads/education.png"style="height:200px;"></figure>
                  <div class="overlay">
                    <h3>Education </h3>
                    <p>To provide world class market demandable Education & Training Programme.</p>
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="https://qph.fs.quoracdn.net/main-qimg-ec651214dd00c8ad49d9efcd38538548" style="height:200px;"></figure>
                  <div class="overlay">
                    <h3>Leading B2C Company</h3>
                    <p>One of the Leading B2C Company.</p>
                  </div>
                </div>
              </div>
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="https://i2.wp.com/marketbusinessnews.com/wp-content/uploads/2020/06/What-is-networking-definition-and-examples.jpg?resize=763%2C451&ssl=1"style="height:200px;"></figure>
                  <div class="overlay">
                    <h3>Business Networking</h3>
                    <p>A strong network across india.</p>
                  </div>
                </div>
              </div>
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 border_right">
        <div class="box_text">
		  ...
		  <ul>
		  <li><i class="fa fa-hand-o-right"></i> To provide world class market demandable Education & Training Programme.
		  </li>
		   <li><i class="fa fa-hand-o-right"></i> To provide valuable insurance and  financial products & services across india.
		  </li>
		   <li><i class="fa fa-hand-o-right"></i> To provide our learn with earn concept across india.
		  </li>
		   <li><i class="fa fa-hand-o-right"></i> To create financial freedom fighter our society.
		  </li>
		  </ul>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="titlepage">
          ...
          <span>“Alright Solution” is dedicated to spread knowledge in the  Society and provide financial freedom.</span>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="learn_box">
          <figure><img src="https://www.digitalsolutionservices.com/img/services/main.gif" alt="img"/></figure>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid padding_left2">
    <div class="white_color">
      <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3629.303838804995!2d81.33147731499665!3d24.544160284204064!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39845bb324bb273d%3A0x1aae2c24bbb7f4b4!2sAlright%20Solution!5e0!3m2!1sen!2sin!4v1627924174171!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <input type="text" class="contactus"required placeholder="Your Name" name="s1">
                </div>
                <div class="col-md-12">
                  <input type="email" class="contactus" required placeholder="Your Email" name="s2">
                </div>
                <div class="col-md-12">
                  <input type="number" class="contactus" required placeholder="Your Phone"  name="s3">
                </div>
                <div class="col-md-12">
                  <textarea class="textarea" placeholder="Message" required type="text" name="s4"></textarea>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                  <input  class="send" type="submit" name="s5" value="Send">
                </div>
              </div>
            </form>
          </div>
