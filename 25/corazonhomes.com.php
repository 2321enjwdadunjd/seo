...
<?php include("header.php"); ?>
        ...
        <div class="col-lg-12">
          <div class="home_content home1 custom_width">
            <div class="home-text text-center">
              <p class="fz18 color-white">It's great to be home!</p>
              <h2 class="fz50">Find Your Perfect Home</h2>
            </div>
            <div class="home_tabs pb-100">
              <ul class="nav justify-content-center nav-tabs" id="myTab2" role="tablist">
                <li class="nav-item" role="presentation">
                  <a class="nav-link active" id="Residential-tab" data-toggle="tab" href="#Residential" role="tab" aria-controls="Residential" aria-selected="true">Residential</a>
                </li>
                <li class="nav-item" role="presentation">
              ...
              <div class="tab-content" id="myTabContent2">
                  ...
                  <div class="home_adv_srch_opt mt0">
                    <div class="wrapper">
                      <div class="home_adv_srch_form home3">
                        <form class="p20" name="resid" method="POST" action="search.php">
                            <input type="hidden" name="project_type" value="Residential"/>
                          <div class="form-row align-items-center">
                            <div class="col-auto home_form_input mb15-md">
                              <div class="form-group">
                                <div class="select-wrap">
                                  <select class="selectpicker" name="flat_type" required>
                                    <option value="">Unit Type</option>
									<?php
									$qur="Select *from tblflat";
									$rsr=$db->query($qur);
									while($rowr=mysqli_fetch_array($rsr,MYSQLI_ASSOC))
									{
									?>
                                    <option value="<?php echo $rowr['flat']; ?>"><?php echo $rowr['flat']; ?></option>
									<?php
									}
									?>
                                  </select>
                            ...
                            <div class="col-auto home_form_input mb15-md">
                              <div class="form-group">
                                <div class="select-wrap text-box-wrap">
                                  <input type="text" class="form-control form_control" name="city" placeholder="Search city" required>                                  
                                </div>
                              </div>
                            </div>                            
                            <div class="col-auto home_form_input mb15-md">
                              <div class="form-group">
                                <div class="select-wrap">                                 
                                   <select class="selectpicker" name="budget">
                                    <option value="">Budget</option>
									<?php
									$qurs="Select *from tblbudget";
									$rsrs=$db->query($qurs);
									while($rowrs=mysqli_fetch_array($rsrs,MYSQLI_ASSOC))
									{
									?>
									<option value="<?php echo $rowrs['budget']; ?>"><?php echo $rowrs['budget']; ?></option>
									<?php
									}
									?>
                                  </select>                                
                            ...
                            <div class="col-auto home_form_input2 ml20 ml0-1200 p0-lg">
                              <button type="submit" name="residence" class="btn search-btn mt0-md ml0-md"><span class="fa fa-search"></span> Search</button>
                            </div>
                          </div>
                        </form>
                      </div>
                ...
                <div class="tab-pane fade" id="Commercial" role="tabpanel" aria-labelledby="Commercial-tab">
                  <div class="home_adv_srch_opt mt0">
                    <div class="wrapper">
                      <div class="home_adv_srch_form home3">
                        <form class="p20" name="comr" method="POST" action="search.php">
                              ...
                              <div class="form-group">
                                <div class="select-wrap">                                 
                                   <select class="selectpicker">
                                    ...
                                    <option value="3 BHK">1CR</option>
                                  </select>                                
                                </div>
                              </div>
                            </div>                            
                            <div class="col-auto home_form_input2 ml20 ml0-1200 p0-lg">
                              <button type="submit" name="comrsi" class="btn search-btn mt0-md ml0-md"><span class="fa fa-search"></span> Search</button>
                            </div>
                          </div>
                        </form>
                      </div>
           ...
           <div class="hot-stats">            
			   <div class="row">
               	   <div class="projctbox_1">
						<div class="countlistbox br">
						   <h2>Presence</h2>
                           <h3>Asia Pacific-India & UAE </h3>						                          
					   </div>
  ...
  <section id="our-partners" class="our-partners pt60 pb60 gray-bg">
    <div class="container">
      <div class="row justify-content-center">
       ...
       <section class="customer-logos slider">
        <?php
        $qupimg="select *from tblpartner ORDER BY id DESC";
        $rspimg=$db->query($qupimg);
        while($rwpimg=mysqli_fetch_array($rspimg,MYSQLI_ASSOC))
        {
        ?>
          <div class="partner-item">
            <img src="partner_img/<?php echo $rwpimg['partner_logo']; ?>" class="custom-partner-slider">
          </div>
        <?php
        }
        ?>  
  ...
  <!-- Feature Properties -->
  <section id="feature-property" class="feature-property pt60 pb60 ">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="main-title text-center">
            <h2>Discover Our Trending Projects</h2>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
          ...
          <?php
          $qupimgtr="select *from tblproperty_post where other='Trending Projects' ORDER BY id DESC";
          $rspimgtr=$db->query($qupimgtr);
          while($rwpimgtr=mysqli_fetch_array($rspimgtr,MYSQLI_ASSOC))
          {
          ?>
            <div class="item">
              <div class="feat_property">
               <a href="property-details.php?vid=<?php echo $rwpimgtr['id']; ?>">
                    <div class="thumb"> 
                        <img class="img-whp" src="upload/<?php echo $rwpimgtr['banner_1']; ?>">                 
                    </div>
                </a>
                <div class="details">
                  <div class="tc_content">
                    <h4><a href="property-details.php?vid=<?php echo $rwpimgtr['id']; ?>"><?php echo $rwpimgtr['property_name']; ?></a></h4>
                    <p><?php echo $rwpimgtr['city']; ?></p>
                    <ul class="prop_details mb0">
                      <li class="list-inline-item"><span class="flaticon-bed pr5"></span><?php echo $rwpimgtr['flat_type']; ?></li>
                      <li class="list-inline-item"><span class="flaticon-ruler pr5"></span><?php echo $rwpimgtr['project_area']; ?></li>
                    </ul>
                  </div>
                  <div class="fp_footer">
                  <h4><?php echo $rwpimgtr['start_price']; ?> - <?php echo $rwpimgtr['last_price']; ?></span></h4>
                  </div>
                </div>
              </div>
  ...
  <!-- Property Cities -->
  <section id="property-city" class="property-city pt60 pb60 gray-bg">
    <div class="container">
      <div class="row">
      ...
      <div class="row">
        <?php
        $qupimgc="select *from tblcategory";
        $rspimgc=$db->query($qupimgc);
        while($rwpimgc=mysqli_fetch_array($rspimgc,MYSQLI_ASSOC))
        {
        ?>
        <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
            <a href="curated-collection.php?cid=<?php echo $rwpimgc['category']; ?>">
              <div class="cv--img">
                <div class="grid posR"> <img class="img-responsive" src="upload/<?php echo $rwpimgc['imgs']; ?>">
                  <div class="blackStp"><span><?php echo $rwpimgc['category']; ?></span></div>
                </div>
              </div>
            </a>
        </div>
  ...
  <!-- Property Cities -->
  <section class="property-city pt60 pb60">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="main-title text-center">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <?php
          $qupimgtrf="select *from tblcity ORDER BY id DESC";
          $rspimgtrf=$db->query($qupimgtrf);
          while($rwpimgtrf=mysqli_fetch_array($rspimgtrf,MYSQLI_ASSOC))
          {
              $qupimgtrfc="select *from tblproperty_post where city='".$rwpimgtrf['city']."'";
              $rspimgtrfc=$db->query($qupimgtrfc);
              $count=mysqli_num_rows($rspimgtrfc);
          ?>
            <div class="item featured-city-scroll">
            	<a href="featured-cities.php?city=<?php echo $rwpimgtrf['city']; ?>">
                 <div class="top-ct">
                      <div class="featured-city"><img class="img-responsive" src="upload/<?php echo $rwpimgtrf['imgs']; ?>">
                      <div class="featured-city-title"><span><?php echo $rwpimgtrf['city']; ?></span></div>
                      </div>
                   </div>               
    ...
    <!--Our Testimonials-->
  <section id="our-partners" class="our-testimonial gray-bg pt60 pb60">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8">
           <div class="main-title text-center">
       ...
       <div class="row justify-content-center">
            <div class="col-lg-10">  
               <section class="customer-testimonials slider">
                <?php
        		$qupimgtrft="select *from tbltestimonials ORDER BY id DESC";
        		$rspimgtrft=$db->query($qupimgtrft);
        		while($rwpimgtrft=mysqli_fetch_array($rspimgtrft,MYSQLI_ASSOC))
        		{
        		?>
                  <div class="testimonials-item text-center">
                    <div class="details">
                      <p><?php echo $rwpimgtrft['message']; ?></p>
                    </div>
                    
                    <div class="thumb justify-content-center">
                          <div class="rating">
        				  <?php
        				  for($i=0; $i < $rwpimgtrft['star']; $i++)
        				  {
        				  ?>
                          ...
                          <h4 class="title"><?php echo $rwpimgtrft['name']; ?></h4>
                        </div>
                  </div>
                <?php
                }
  ...
  <!--Our Testimonials Section End Here--> 
