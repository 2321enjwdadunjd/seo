...
<title>India's Most Trusted Donation Platform - Danveer Aashraya Foundation</title>
...
<h2>India's First <b class="text-white">Platform</b><br>Where You Can <b class="text-white">Track</b> Your <b class="text-white">Donations</b></h2>	
</div>	
</div>	
</section>
...
<div class="row">
<div class="col-md-6">
<div class="text-left pbo">
<img src="images/flag.png" alt="Flag" title="Flag" class="img-fluid">	
</div>	
</div>
...
<div class="row">
<div class="col-md-6">
<div class="pb-3"><span><img src="images/icon/01.png" alt="Check" title="Check" class="img-fluid"></span> <span>Debited From Your A/C</span></div>
<div class="pb-3"><span><img src="images/icon/01.png" alt="Check" title="Check" class="img-fluid"></span> <span>Credited To Danveer</span></div>
<div class="pb-3"><span><img src="images/icon/01.png" alt="Check" title="Check" class="img-fluid"></span> <span>Placed Order To Vendor</span></div>
<div class="pb-3"><span><img src="images/icon/01.png" alt="Check" title="Check" class="img-fluid"></span> <span>Received Products By NGO</span></div>
<div class="text-truncate pb-3"><span><img src="images/icon/video.png" alt="Video" title="Video" class="img-fluid"></span> <span>Video And Individual Picture With Donor's Name</span></div>
</div>
<div class="col-md-6">
<div class="text-left">
<img src="images/img.png" alt="India's First Platform Where You Can Track Your Donations" title="India's First Platform Where You Can Track Your Donations" class="img-fluid">	
</div>	
</div>
</div>
</div>	
...
<section class="bg-green pt-4 pb-2">
<div class="container-fluid">
<div class="text-center">
<h2>Open Your <b class="text-white">Heart</b> And Become A<br><b class="text-white h2">DANVEER</b></h2>	
</div>	
</div>	
</section>
...
<div class="cols-11">
<div class="mb-3">
<input type="search" name="search" placeholder="Search By Campaign Title Or NGO Name" class="form-control shadow-none py-3 px-4" required>
</div>	
</div>
<div class="cols-1">
<div class="mb-3">
<button type="submit" class="btn btn-successs text-white shadow-none py-3 px-4"><i class="bi bi-search"></i></button>
</div>	
</div>
</div>	
</form>
...
$keyword = $_GET['search'];
$postQuery = "SELECT * FROM `posts` WHERE title LIKE '%$keyword%' and posts.status=1 ORDER BY posts.position ASC LIMIT $result, $post_per_page";
}else{
$postQuery = "SELECT posts.*,SUM(donations.amount) as total_donations,COUNT(donations.id) as doners_count FROM `posts` LEFT JOIN donations ON donations.post_id=posts.id  where posts.status=1 GROUP BY posts.id ORDER BY posts.position ASC LIMIT $result, $post_per_page";
...
<img src="images/posts/<?=$image['image']?>" class="card-img-top" alt="<?=$post['title']?>" title="<?=$post['title']?>">
</div>
<?php
}
?>
...
<div class="card-body">
<a href="post.php?id=<?php echo $post['id'];?>" class="text-black text-decoration-none">
<h5 class="card-title text-truncates"><?=$post['title']?></h5>
<div class="pt-2">
<span class="p dn"><?=getCategory($db,$post['category'])?></span> <span class="px-2"><?=date('F jS, Y', strtotime($post['date/time']))?></span>
<img src="data:image/svg+xml;base64," width="16" class="gm-added gm-observing gm-observing-cb" loading="lazy">
<span class="mx-1 fw-bold"><?=$post['doners_count']?> Doners</span>
</div>
<div class="pt-3">
<span class="p">₹<?=$post['total_donations']??0?></span> <span class="rp">raised out of ₹<?=$post['raised_amount']?></span>	
...
<div class="py-2">
    ...
    if($post['total_donations']!=0 && $post['raised_amount']!=0){
   $paid= (($post['total_donations'])*100)/$post['raised_amount'];
    }
    else{
      $paid=0;  
    }
...
<div class="progress-bar pba" style="width:<?=$paid??0?>% !important"></div>
</div>	
</div>
...
<div class="mt-3">
<button class="btn btn-outline-success py-2 px-4"><a href="https://wa.me/8923598431" class="text-success"><i class="bi bi-whatsapp"></i> Share</a></button> <a  href="post.php?id=<?php echo $post['id'];?>" class="btn btn-successs right text-white py-2 px-4">Donate</a>	
</div>
</a>
</div>
</div>	
...
echo "<div class='btn btn-successs text-center py-2 px-4'>No Ads Found</div>";
}
?>
</div>
</div>	
...
<div class="row py-3">
<div class="col-md-3">
<div class="card cs my-5">
<img src="images/how-it-works/01.webp" class="card-img-top" alt="Choose A Cause" title="Choose A Cause">
<div class="card-body">
<h5 class="card-title text-truncates text-center">Choose A Cause</h5>
<p class="text-center">Browse different campaigns and<br>select a cause.</p>
</div>
</div>		
</div>
<div class="col-md-3">
<div class="card cs my-5">
<img src="images/how-it-works/02.webp" class="card-img-top" alt="Select Products" title="Select Products">
<div class="card-body">
<h5 class="card-title text-truncates text-center">Select Products</h5>
<p class="text-center">Select products and quantity<br>you wish to donate.</p>
</div>
</div>	
</div>
<div class="col-md-3">
<div class="card cs my-5">
<img src="images/how-it-works/03.webp" class="card-img-top" alt="Choose A Cause" title="Choose A Cause">
<div class="card-body">
<h5 class="card-title text-truncates text-center">Order Processing</h5>
<p class="text-center">Checkout and pay for your<br>contributions.</p>
</div>
</div>	
</div>
<div class="col-md-3">
<div class="card cs my-5">
<img src="images/how-it-works/04.webp" class="card-img-top" alt="Choose A Cause" title="Choose A Cause">
<div class="card-body">
<h5 class="card-title text-truncates text-center">Delivery Report</h5>
<p class="text-center">Organisation updates about product utilization.</p>
</div>
</div>	
</div>
</div>	
...
<div class="container">
<div class="text-left">
<h3 class="h">Testimonial</h3>	
</div>
<div class="row py-5">
<div class="col-md-4">
<div class="card css my-5">
<center><img src="images/testimonial/01.jpg" class="cw" alt="Select Products" title="Select Products"></center>
<div class="card-body">
<h5 class="card-title text-truncates">Shanti Mohan</h5>
<p align="justify">Founder of LetsVenture</p>
<p align="justify">What struck me most about this venture is the passion and commitment of the founders to make the process of giving easy. They have a good understanding of the problem statement and have an even better solution.</p>
</div>
</div>	
</div>
<div class="col-md-4">
<div class="card css my-5">
<center><img src="images/testimonial/02.jpg" class="cw" alt="Choose A Cause" title="Choose A Cause"></center>
<div class="card-body">
<h5 class="card-title text-truncates">Vijay Shekhar Sharma</h5>
<p align="justify">Founder of One97 & Paytm</p>
<p align="justify">Anyone who donates often thinks about whether they’re actually making a difference. This is why <strong>DANVEER</strong> is an incredible idea - you can clearly see the impact your donations have made in the form of products delivered to the NGOs.</p>
</div>
</div>	
</div>
<div class="col-md-4">
<div class="card css my-5">
<center><img src="images/testimonial/03.jpg" class="cw" alt="Choose A Cause" title="Choose A Cause"></center>
<div class="card-body">
<h5 class="card-title text-truncates">Yuvraj Singh</h5>
<p align="justify">Former Indian International Cricketer</p>
<p align="justify"><strong>DANVEER</strong> is a unique platform where you can be assured that the products you donate are delivered responsibly to NGOs. I’m so happy to have partnered with them to help so many people during the pandemic.</p>
</div>
</div>	
</div>
</div>	
...
<div class="container">
<div class="text-left">
<h3 class="h">Featured In</h3>	
</div>
<div class="row mt-5 mb-3">
<div class="cols-2">
<div class="text-center">
<img src="images/client/01.webp" alt="Client" title="Client" class="img-fluid">	
</div>	
</div>
<div class="cols-2">
<div class="text-center">
<img src="images/client/02.webp" alt="Client" title="Client" class="img-fluid">	
</div>	
</div>
<div class="cols-2">
<div class="text-center">
<img src="images/client/03.webp" alt="Client" title="Client" class="img-fluid">	
</div>	
</div>
<div class="cols-2">
<div class="text-center">
<img src="images/client/04.webp" alt="Client" title="Client" class="img-fluid">	
</div>	
</div>
<div class="cols-2">
<div class="text-center">
<img src="images/client/05.webp" alt="Client" title="Client" class="img-fluid">	
</div>	
</div>
<div class="cols-2">
<div class="text-center">
<img src="images/client/06.webp" alt="Client" title="Client" class="img-fluid">	
</div>	
</div>
</div>	
</div>	
